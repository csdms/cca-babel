// 
// File:          vect_vDivByZeroExcept_Impl.cxx
...
// 
// 
#include "vect_vDivByZeroExcept_Impl.hxx"
...
#endif
// DO-NOT-DELETE splicer.begin(vect.vDivByZeroExcept._includes)
// Nothing needed here.
// DO-NOT-DELETE splicer.end(vect.vDivByZeroExcept._includes)

// special constructor, used for data wrapping(required).  Do not put code here unless you really know what you're doing!
vect::vDivByZeroExcept_impl::vDivByZeroExcept_impl() : StubBase(
  reinterpret_cast< void*>(::vect::vDivByZeroExcept::_wrapObj(reinterpret_cast< 
...
void vect::vDivByZeroExcept_impl::_ctor() {
...
void vect::vDivByZeroExcept_impl::_dtor() {
...
void vect::vDivByZeroExcept_impl::_load() {
