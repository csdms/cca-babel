...
C       Symbol Type:   class
C       Babel Version: 2.0.0 (Revision: 7372  trunk)
...
C       
        ...
        subroutine s_StructTest_passinEmpty_fi(self, s, retval, 
     &     exception)
        implicit none
C        in s.StructTest self
        integer*8 :: self
...
C       
        ...
        subroutine s_StructTest_passoutEmpty_fi(self, s, retval, 
     &     exception)
        implicit none
C        in s.StructTest self
        integer*8 :: self
...
C       
        ...
        subroutine s_StructTest_passinoutEmpty_fi(self, s, retval, 
     &     exception)
        implicit none
C        in s.StructTest self
        integer*8 :: self
...
C       
        ...
        subroutine s_StructTest_passinSimple_fi(self, s, retval, 
     &     exception)
        implicit none
C        in s.StructTest self
        integer*8 :: self
...
C       
        ...
        subroutine s_StructTest_passoutSimple_fi(self, s, retval, 
     &     exception)
        implicit none
C        in s.StructTest self
        integer*8 :: self
...
C       
        ...
        subroutine s_StructTest_passinoutSimple_fi(self, s, retval, 
     &     exception)
        implicit none
C        in s.StructTest self
        integer*8 :: self
...
C       
        ...
        subroutine s_StructTest_passinHard_fi(self, s, retval, 
     &     exception)
        implicit none
C        in s.StructTest self
        integer*8 :: self
...
C       
        ...
        subroutine s_StructTest_passoutHard_fi(self, s, retval, 
     &     exception)
        implicit none
C        in s.StructTest self
        integer*8 :: self
...
C       
        ...
        subroutine s_StructTest_passinoutHard_fi(self, s, retval, 
     &     exception)
        implicit none
C        in s.StructTest self
        integer*8 :: self
...
C       
        ...
        subroutine s_StructTest_passinCombined_fi(self, s, retval, 
     &     exception)
        implicit none
C        in s.StructTest self
        integer*8 :: self
...
C       
        ...
        subroutine s_StructTest_passoutCombined_fi(self, s, retval, 
     &     exception)
        implicit none
C        in s.StructTest self
        integer*8 :: self
...
C       
        ...
        subroutine s_StructTest_passinoutCombined_fi(self, s, retval, 
     &     exception)
        implicit none
C        in s.StructTest self
        integer*8 :: self
C        inout s.Combined s
        integer*8 :: s
C        out bool retval
        logical :: retval
C        out sidl.BaseInterface exception
...
C       
        ...
        subroutine s_StructTest_passinRarrays_fi(self, s, retval, 
     &     exception)
        implicit none
C        in s.StructTest self
        integer*8 :: self
...
C       
        ...
        subroutine s_StructTest_passinoutRarrays_fi(self, s, retval, 
     &     exception)
        implicit none
C        in s.StructTest self
        integer*8 :: self
