...
"""
Gantlet:  A Minimal Package for Testing software
"""

#__all__ = [ "scoreboard", "events", "commandline", "tparser_factory", "classic_display" ]
...
AUTHORS="""
----------------------------------------------------------------------
  Gary Kumfert, Ph.D.                              <kumfert@llnl.gov>
...
(c) 2001-2003 by Lawrence Livermore National Security, LLC.
All rights reserved.
Reference: UCRL-CODE-2002-043.
