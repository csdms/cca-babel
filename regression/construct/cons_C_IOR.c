...
static VAR_UNUSED struct cons_C__epv s_my_epv_contracts__cons_c;
...
static struct cons_C__pre_epv s_preEPV;
static struct cons_C__post_epv s_postEPV;
...
extern void cons_C__set_epv(
  struct cons_C__epv* epv,
    struct cons_C__pre_epv* pre_epv,
    struct cons_C__post_epv* post_epv);

extern void cons_C__call_load(void);
#ifdef __cplusplus
}
#endif
...
cons_C_isSame__exec(
  ...
  iobj = skel_cons_C_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct cons_C__object*) (*iobj_bc->d_epv->f__cast)(iobj_bc, "cons.C",
      _ex);
    if(iobj != NULL) {
...
static void ior_cons_C__set_contracts(
  struct cons_C__object* self,
  sidl_bool   enable,
...
static void ior_cons_C__dump_stats(
  struct cons_C__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_cons_C__ensure_load_called(void) {
  /*
...
static void ior_cons_C__set_hooks(
  struct cons_C__object* self,
...
static void ior_cons_C__delete(
  struct cons_C__object* self, struct sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  cons_C__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct cons_C__object));
  free((void*) self);
}
...
static void
ior_cons_C__raddRef(
    struct cons_C__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_cons_C__isRemote(
    struct cons_C__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct cons_C__method {
  const char *d_name;
  void (*d_func)(struct cons_C__object*,
...
ior_cons_C__exec(
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct cons_C__method  s_methods[] = {
    { "_cast", cons_C__cast__exec },
    { "addRef", cons_C_addRef__exec },
    { "deleteRef", cons_C_deleteRef__exec },
    { "destruct", cons_C_destruct__exec },
    { "getClassInfo", cons_C_getClassInfo__exec },
    { "init", cons_C_init__exec },
    { "isSame", cons_C_isSame__exec },
    { "isType", cons_C_isType__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct cons_C__method);
  *_ex  = NULL; /* default to no exception */
...
static void cons_C__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct cons_C__epv*             epv  = &s_my_epv__cons_c;
  ...
  struct cons_B__epv*         s1 = NULL;
  struct cons_A__epv*         s2 = NULL;
  ...
  s2  =  s_par_epv__cons_a;
  s1  =  s_par_epv__cons_b;

  epv->f__cast                 = ior_cons_C__cast;
  epv->f__delete               = ior_cons_C__delete;
  epv->f__exec                 = ior_cons_C__exec;
  epv->f__getURL               = ior_cons_C__getURL;
  epv->f__raddRef              = ior_cons_C__raddRef;
  epv->f__isRemote             = ior_cons_C__isRemote;
  epv->f__set_hooks            = ior_cons_C__set_hooks;
  epv->f__set_contracts        = ior_cons_C__set_contracts;
  epv->f__dump_stats           = ior_cons_C__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_init                  = (void (*)(struct cons_C__object*,struct sidl_BaseInterface__object **)) s1->f_init;
  epv->f_destruct              = (void (*)(struct cons_C__object*,struct sidl_BaseInterface__object **)) s1->f_destruct;
  epv->f_addRef                = (void (*)(struct cons_C__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct cons_C__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct cons_C__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct cons_C__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct cons_C__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;

  cons_C__set_epv(epv, &s_preEPV, &s_postEPV);
  ...
  ior_cons_C__ensure_load_called();
}

/*
 * cons_C__getEPVs: Get my version of all relevant EPVs.
 */

void cons_C__getEPVs (
...
static struct cons_B__epv* cons_C__getSuperEPV(void) {
  return s_par_epv__cons_b;
}
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "cons.C", _ex);
...
static void
initMetadata(struct cons_C__object* self, sidl_BaseInterface* _ex)
{
  *_ex = 0; /* default no exception */
  if (self) {
    struct sidl_BaseClass__data *data = (struct sidl_BaseClass__data*)((*self).d_cons_b.d_cons_a.d_sidl_baseclass.d_data);
    if (data) {
...
/*
 * cons_C__createObject: Allocate the object and initialize it.
 */
...
{
  struct cons_C__object* self =
    (struct cons_C__object*) sidl_malloc(
      sizeof(struct cons_C__object),
      "Object allocation failed for struct cons_C__object",
        __FILE__, __LINE__, "cons_C__createObject", _ex);
  if (!self) goto EXIT;
  cons_C__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void cons_C__init(
  ...
  struct sidl_BaseInterface__object **_ex)
{
  struct cons_C__object*         s0 = self;
  struct cons_B__object*         s1 = &s0->d_cons_b;
  struct cons_A__object*         s2 = &s1->d_cons_a;
  ...
  *_ex = 0; /* default no exception */
  ...
  cons_B__init(s1, NULL, _ex); SIDL_CHECK(*_ex);

  s3->d_sidl_baseinterface.d_epv = &s_my_epv__sidl_baseinterface;
  s3->d_epv                      = &s_my_epv__sidl_baseclass;

  s2->d_epv    = &s_my_epv__cons_a;

  s1->d_epv    = &s_my_epv__cons_b;

  s0->d_epv    = &s_my_epv__cons_c;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  s2->d_epv    = s_par_epv__cons_a;

  s1->d_epv    = s_par_epv__cons_b;

  cons_B__fini(s1, _ex); SIDL_CHECK(*_ex);
...
void
cons_C__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct cons_C__external
s_externalEntryPoints = {
  cons_C__createObject,
  cons_C__getSuperEPV,
  2, 
  0
};
