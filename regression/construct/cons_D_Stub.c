 ...
 * Description:   Client-side glue code for cons.D
 * 
 * WARNING: Automatically generated; changes will be lost
 * 
 */

#define CONS_D_INLINE_DECL
#include "cons_D.h"
...
cons_D
cons_D__create(sidl_BaseInterface* _ex)
{
  return (*(_getExternals()->createObject))(NULL,_ex);
}

/**
 * Wraps up the private data struct pointer (struct cons_D__data) passed in rather than running the constructor.
 */
cons_D
cons_D__wrapObj(void* data, sidl_BaseInterface* _ex)
{
...
static cons_D cons_D__remoteCreate(const char* url, sidl_BaseInterface *_ex);
/*
 * RMI constructor function for the class.
 */

cons_D
cons_D__createRemote(const char* url, sidl_BaseInterface *_ex)
{
  return cons_D__remoteCreate(url, _ex);
}

static struct cons_D__object* cons_D__remoteConnect(const char* url, sidl_bool 
  ar, sidl_BaseInterface *_ex);
static struct cons_D__object* cons_D__IHConnect(struct 
...
cons_D
cons_D__connect(const char* url, sidl_BaseInterface *_ex)
{
  return cons_D__remoteConnect(url, TRUE, _ex);
}
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if (!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("cons.D", (void*)cons_D__IHConnect,
      _ex);SIDL_CHECK(*_ex);
  }
#endif /*WITH_RMI*/
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (cons_D) (*base->d_epv->f__cast)(
      base->d_object,
      "cons.D", _ex); SIDL_CHECK(*_ex);
  }
...
{
  return !cons_D__isRemote(self, _ex);
}
 ...
 * NULL.
 */
struct cons_D__array*
cons_D__array_createCol(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct cons_D__array*)sidl_interface__array_createCol(dimen, lower, 
    upper);
}
 ...
 */
struct cons_D__array*
cons_D__array_createRow(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct cons_D__array*)sidl_interface__array_createRow(dimen, lower, 
    upper);
}
 ...
 */
struct cons_D__array*
cons_D__array_create1d(int32_t len)
{
  return (struct cons_D__array*)sidl_interface__array_create1d(len);
}
 ...
 */
struct cons_D__array*
cons_D__array_create1dInit(
  int32_t len, 
  cons_D* data)
{
  return (struct cons_D__array*)sidl_interface__array_create1dInit(len, (struct 
 ...
 */
struct cons_D__array*
cons_D__array_create2dCol(int32_t m, int32_t n)
{
  return (struct cons_D__array*)sidl_interface__array_create2dCol(m, n);
}
 ...
 */
struct cons_D__array*
cons_D__array_create2dRow(int32_t m, int32_t n)
{
  return (struct cons_D__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct cons_D__array*)sidl_interface__array_borrow(
 ...
 */
struct cons_D__array*
cons_D__array_smartCopy(
  struct cons_D__array *array)
{
  return (struct cons_D__array*)
...
cons_D
cons_D__array_get1(
  const struct cons_D__array* array,
  const int32_t i1)
{
  return (cons_D)
...
void
cons_D__array_copy(
  const struct cons_D__array* src,
  struct cons_D__array* dest)
{
...
static struct cons_D__epv s_rem_epv__cons_d;

static struct cons_A__epv  s_rem_epv__cons_a;

static struct cons_B__epv  s_rem_epv__cons_b;

static struct cons_C__epv  s_rem_epv__cons_c;
...
static void* remote_cons_D__cast(
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if ((*self->d_epv->f_isType)(self,name, _ex)) {
    ...
    cast =  (*func)(((struct cons_D__remote*)self->d_data)->d_ih, _ex);
  }
...
static void remote_cons_D__delete(
  struct cons_D__object* self,
  struct sidl_BaseInterface__object* *_ex)
{
  *_ex = NULL;
...
static void remote_cons_D__raddRef(
  struct cons_D__object* self,struct sidl_BaseInterface__object* *_ex)
{
...
static void
remote_cons_D__set_hooks(
  /* in */ struct cons_D__object*self ,
  /* in */ sidl_bool enable,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      ...
      "Exception unserialized from cons.D._set_hooks.",
        &throwaway_exception);
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from cons.D._set_contracts.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from cons.D._dump_stats.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void remote_cons_D__exec(
  struct cons_D__object* self,const char* methodName,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from cons.D.init.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from cons.D.destruct.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    struct cons_D__remote* r_obj = (struct cons_D__remote*)self->d_data;
    LOCK_STATIC_GLOBALS;
    r_obj->d_refcount++;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from cons.D.isSame.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from cons.D.isType.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from cons.D.getClassInfo.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void cons_D__init_remote_epv(void)
{
  /* assert( HAVE_LOCKED_STATIC_GLOBALS ); */
  struct cons_D__epv*             epv = &s_rem_epv__cons_d;
  struct cons_A__epv*             e0  = &s_rem_epv__cons_a;
  struct cons_B__epv*             e1  = &s_rem_epv__cons_b;
  struct cons_C__epv*             e2  = &s_rem_epv__cons_c;
  struct sidl_BaseClass__epv*     e3  = &s_rem_epv__sidl_baseclass;
  struct sidl_BaseInterface__epv* e4  = &s_rem_epv__sidl_baseinterface;

  epv->f__cast               = remote_cons_D__cast;
  epv->f__delete             = remote_cons_D__delete;
  epv->f__exec               = remote_cons_D__exec;
  epv->f__getURL             = remote_cons_D__getURL;
  epv->f__raddRef            = remote_cons_D__raddRef;
  epv->f__isRemote           = remote_cons_D__isRemote;
  epv->f__set_hooks          = remote_cons_D__set_hooks;
  epv->f__set_contracts      = remote_cons_D__set_contracts;
  epv->f__dump_stats         = remote_cons_D__dump_stats;
  epv->f__ctor               = NULL;
  epv->f__ctor2              = NULL;
  epv->f__dtor               = NULL;
  epv->f_init                = remote_cons_D_init;
  epv->f_destruct            = remote_cons_D_destruct;
  epv->f_addRef              = remote_cons_D_addRef;
  epv->f_deleteRef           = remote_cons_D_deleteRef;
  epv->f_isSame              = remote_cons_D_isSame;
  epv->f_isType              = remote_cons_D_isType;
  epv->f_getClassInfo        = remote_cons_D_getClassInfo;
  ...
  e1->f__cast          = (void* (*)(struct cons_B__object*, const char*, struct 
    sidl_BaseInterface__object**)) epv->f__cast;
  e1->f__delete        = (void (*)(struct cons_B__object*, struct 
    sidl_BaseInterface__object**)) epv->f__delete;
  e1->f__getURL        = (char* (*)(struct cons_B__object*, struct 
    sidl_BaseInterface__object**)) epv->f__getURL;
  e1->f__raddRef       = (void (*)(struct cons_B__object*, struct 
    sidl_BaseInterface__object**)) epv->f__raddRef;
  e1->f__isRemote      = (sidl_bool (*)(struct cons_B__object*, struct 
    sidl_BaseInterface__object**)) epv->f__isRemote;
  e1->f__set_hooks     = (void (*)(struct cons_B__object*, sidl_bool, struct 
    sidl_BaseInterface__object**)) epv->f__set_hooks;
  e1->f__set_contracts = (void (*)(struct cons_B__object*, sidl_bool, const 
    char*, sidl_bool, struct sidl_BaseInterface__object**)) 
    epv->f__set_contracts;
  e1->f__dump_stats    = (void (*)(struct cons_B__object*, const char*, const 
    char*, struct sidl_BaseInterface__object**)) epv->f__dump_stats;
  e1->f__exec          = (void (*)(struct cons_B__object*,const char*,struct 
    sidl_rmi_Call__object*,struct sidl_rmi_Return__object*,struct 
    sidl_BaseInterface__object **)) epv->f__exec;
  e1->f_init           = (void (*)(struct cons_B__object*,struct 
    sidl_BaseInterface__object **)) epv->f_init;
  e1->f_destruct       = (void (*)(struct cons_B__object*,struct 
    sidl_BaseInterface__object **)) epv->f_destruct;
  e1->f_addRef         = (void (*)(struct cons_B__object*,struct 
    sidl_BaseInterface__object **)) epv->f_addRef;
  e1->f_deleteRef      = (void (*)(struct cons_B__object*,struct 
    sidl_BaseInterface__object **)) epv->f_deleteRef;
  e1->f_isSame         = (sidl_bool (*)(struct cons_B__object*,struct 
    sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) 
    epv->f_isSame;
  e1->f_isType         = (sidl_bool (*)(struct cons_B__object*,const char*,
    struct sidl_BaseInterface__object **)) epv->f_isType;
  e1->f_getClassInfo   = (struct sidl_ClassInfo__object* (*)(struct 
    cons_B__object*,struct sidl_BaseInterface__object **)) epv->f_getClassInfo;

  e2->f__cast          = (void* (*)(struct cons_C__object*, const char*, struct 
    sidl_BaseInterface__object**)) epv->f__cast;
  e2->f__delete        = (void (*)(struct cons_C__object*, struct 
    sidl_BaseInterface__object**)) epv->f__delete;
  e2->f__getURL        = (char* (*)(struct cons_C__object*, struct 
    sidl_BaseInterface__object**)) epv->f__getURL;
  e2->f__raddRef       = (void (*)(struct cons_C__object*, struct 
    sidl_BaseInterface__object**)) epv->f__raddRef;
  e2->f__isRemote      = (sidl_bool (*)(struct cons_C__object*, struct 
    sidl_BaseInterface__object**)) epv->f__isRemote;
  e2->f__set_hooks     = (void (*)(struct cons_C__object*, sidl_bool, struct 
    sidl_BaseInterface__object**)) epv->f__set_hooks;
  e2->f__set_contracts = (void (*)(struct cons_C__object*, sidl_bool, const 
    char*, sidl_bool, struct sidl_BaseInterface__object**)) 
    epv->f__set_contracts;
  e2->f__dump_stats    = (void (*)(struct cons_C__object*, const char*, const 
    char*, struct sidl_BaseInterface__object**)) epv->f__dump_stats;
  e2->f__exec          = (void (*)(struct cons_C__object*,const char*,struct 
    sidl_rmi_Call__object*,struct sidl_rmi_Return__object*,struct 
    sidl_BaseInterface__object **)) epv->f__exec;
  e2->f_init           = (void (*)(struct cons_C__object*,struct 
    sidl_BaseInterface__object **)) epv->f_init;
  e2->f_destruct       = (void (*)(struct cons_C__object*,struct 
    sidl_BaseInterface__object **)) epv->f_destruct;
  e2->f_addRef         = (void (*)(struct cons_C__object*,struct 
    sidl_BaseInterface__object **)) epv->f_addRef;
  e2->f_deleteRef      = (void (*)(struct cons_C__object*,struct 
    sidl_BaseInterface__object **)) epv->f_deleteRef;
  e2->f_isSame         = (sidl_bool (*)(struct cons_C__object*,struct 
    sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) 
    epv->f_isSame;
  e2->f_isType         = (sidl_bool (*)(struct cons_C__object*,const char*,
    struct sidl_BaseInterface__object **)) epv->f_isType;
  e2->f_getClassInfo   = (struct sidl_ClassInfo__object* (*)(struct 
    cons_C__object*,struct sidl_BaseInterface__object **)) epv->f_getClassInfo;
...
static struct cons_D__object*
cons_D__remoteConnect(const char *url, sidl_bool ar, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct cons_D__object* self = NULL;

  struct cons_D__object* s0;
  struct cons_C__object* s1;
  struct cons_B__object* s2;
  struct cons_A__object* s3;
  struct sidl_BaseClass__object* s4;

  struct cons_D__remote* r_obj = NULL;
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    struct cons_D__object* retobj = NULL;
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_BaseInterface bi = (
      sidl_BaseInterface)sidl_rmi_InstanceRegistry_getInstanceByString(objectID,
      _ex); SIDL_CHECK(*_ex);
    (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    retobj = (struct cons_D__object*) (*bi->d_epv->f__cast)(bi->d_object, 
      "cons.D", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
  ...
  instance = sidl_rmi_ProtocolFactory_connectInstance(url, "cons.D", ar, _ex ); 
    SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct cons_D__object*) malloc(
      sizeof(struct cons_D__object));

  r_obj =
    (struct cons_D__remote*) malloc(
      sizeof(struct cons_D__remote));
  ...
  if(!self || !r_obj) {
    ...
    sidl_MemAllocException_add(ex, __FILE__, __LINE__, "cons.D.EPVgeneration", 
      _ex);
    SIDL_CHECK(*_ex);
  ...
  s3->d_epv  = &s_rem_epv__cons_a;

  s2->d_data = (void*) r_obj;
  s2->d_epv  = &s_rem_epv__cons_b;

  s1->d_data = (void*) r_obj;
  s1->d_epv  = &s_rem_epv__cons_c;

  s0->d_data = (void*) r_obj;
  s0->d_epv  = &s_rem_epv__cons_d;
...
static VAR_UNUSED struct cons_D__object*
cons_D__IHConnect(sidl_rmi_InstanceHandle instance, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct cons_D__object* self = NULL;
...
static struct cons_D__object*
cons_D__remoteCreate(const char *url, struct sidl_BaseInterface__object **_ex)
{
...
cons_D__connectI(const char* url, sidl_bool ar, struct 
  sidl_BaseInterface__object **_ex)
{
  return cons_D__remoteConnect(url, ar, _ex);
}
