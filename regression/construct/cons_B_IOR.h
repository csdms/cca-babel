...
struct cons_B__object {
  struct cons_A__object d_cons_a;
  struct cons_B__epv*   d_epv;
  struct cons_B__cstats d_cstats;
  void*                 d_data;
};

struct cons_B__external {
  struct cons_B__object*
  (*createObject)(void* ddata, struct sidl_BaseInterface__object **_ex);

  struct cons_A__epv*(*getSuperEPV)(void);
...
extern struct cons_B__object*
cons_B__createObject(void* ddata,struct sidl_BaseInterface__object ** _ex);

extern void cons_B__init(
  struct cons_B__object* self, void* ddata, struct sidl_BaseInterface__object 
    ** _ex);

extern void cons_B__getEPVs(
...
extern void cons_B__fini(
  struct cons_B__object* self, struct sidl_BaseInterface__object ** _ex);

extern void cons_B__IOR_version(int32_t *major, int32_t *minor);
