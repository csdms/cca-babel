...
static const struct cons_A__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct cons_A__external* _loadIOR(void)
/*
...

{
  ...
  _externals = cons_A__externals();
#else
  _externals = (struct cons_A__external*)sidl_dynamicLoadIOR("cons.A",
    "cons_A__externals") ;
  sidl_checkIORVersion("cons.A", _externals->d_ior_major_version, 
...
static cons_A cons_A__remoteCreate(const char* url, sidl_BaseInterface *_ex);
/*
...
{
  return cons_A__remoteCreate(url, _ex);
}

static struct cons_A__object* cons_A__remoteConnect(const char* url, sidl_bool 
  ar, sidl_BaseInterface *_ex);
static struct cons_A__object* cons_A__IHConnect(struct 
...
cons_A
cons_A__connect(const char* url, sidl_BaseInterface *_ex)
{
  return cons_A__remoteConnect(url, TRUE, _ex);
}
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if (!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("cons.A", (void*)cons_A__IHConnect,
      _ex);SIDL_CHECK(*_ex);
  }
#endif /*WITH_RMI*/
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (cons_A) (*base->d_epv->f__cast)(
      base->d_object,
      "cons.A", _ex); SIDL_CHECK(*_ex);
  }
...
{
  return !cons_A__isRemote(self, _ex);
}
...
cons_A__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct cons_A__array*)sidl_interface__array_createCol(dimen, lower, 
    upper);
}
...
cons_A__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct cons_A__array*)sidl_interface__array_createRow(dimen, lower, 
    upper);
}
...
{
  return (struct cons_A__array*)sidl_interface__array_create1d(len);
}
...
cons_A__array_create1dInit(
  ...
  cons_A* data)
{
  return (struct cons_A__array*)sidl_interface__array_create1dInit(len, (struct 
...
{
  return (struct cons_A__array*)sidl_interface__array_create2dCol(m, n);
}
...
{
  return (struct cons_A__array*)sidl_interface__array_create2dRow(m, n);
}
...
{
  return (struct cons_A__array*)sidl_interface__array_borrow(
...
#ifdef HAVE_PTHREAD
static struct sidl_recursive_mutex_t cons_A__mutex= SIDL_RECURSIVE_MUTEX_INITIALIZER;
#define LOCK_STATIC_GLOBALS sidl_recursive_mutex_lock( &cons_A__mutex )
#define UNLOCK_STATIC_GLOBALS sidl_recursive_mutex_unlock( &cons_A__mutex )
/* #define HAVE_LOCKED_STATIC_GLOBALS (sidl_recursive_mutex_trylock( &cons_A__mutex )==EDEADLOCK) */
#else
...
static void* remote_cons_A__cast(
  struct cons_A__object* self,
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if ((*self->d_epv->f_isType)(self,name, _ex)) {
    ...
    cast =  (*func)(((struct cons_A__remote*)self->d_data)->d_ih, _ex);
  }
...
static void remote_cons_A__delete(
  struct cons_A__object* self,
  struct sidl_BaseInterface__object* *_ex)
{
  *_ex = NULL;
...
static void remote_cons_A__raddRef(
  struct cons_A__object* self,struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      ...
      "Exception unserialized from cons.A._set_hooks.",
        &throwaway_exception);
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from cons.A._set_contracts.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from cons.A._dump_stats.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void remote_cons_A__exec(
  struct cons_A__object* self,const char* methodName,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from cons.A.init.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from cons.A.destruct.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    struct cons_A__remote* r_obj = (struct cons_A__remote*)self->d_data;
    LOCK_STATIC_GLOBALS;
    r_obj->d_refcount++;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from cons.A.isSame.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from cons.A.isType.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from cons.A.getClassInfo.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void cons_A__init_remote_epv(void)
{
  /* assert( HAVE_LOCKED_STATIC_GLOBALS ); */
  struct cons_A__epv*             epv = &s_rem_epv__cons_a;
  struct sidl_BaseClass__epv*     e0  = &s_rem_epv__sidl_baseclass;
  struct sidl_BaseInterface__epv* e1  = &s_rem_epv__sidl_baseinterface;

  epv->f__cast               = remote_cons_A__cast;
  epv->f__delete             = remote_cons_A__delete;
  epv->f__exec               = remote_cons_A__exec;
  epv->f__getURL             = remote_cons_A__getURL;
  epv->f__raddRef            = remote_cons_A__raddRef;
  epv->f__isRemote           = remote_cons_A__isRemote;
  epv->f__set_hooks          = remote_cons_A__set_hooks;
  epv->f__set_contracts      = remote_cons_A__set_contracts;
  epv->f__dump_stats         = remote_cons_A__dump_stats;
  epv->f__ctor               = NULL;
  epv->f__ctor2              = NULL;
  epv->f__dtor               = NULL;
  epv->f_init                = remote_cons_A_init;
  epv->f_destruct            = remote_cons_A_destruct;
  epv->f_addRef              = remote_cons_A_addRef;
  epv->f_deleteRef           = remote_cons_A_deleteRef;
  epv->f_isSame              = remote_cons_A_isSame;
  epv->f_isType              = remote_cons_A_isType;
  epv->f_getClassInfo        = remote_cons_A_getClassInfo;
...
static struct cons_A__object*
cons_A__remoteConnect(const char *url, sidl_bool ar, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct cons_A__object* self = NULL;

  struct cons_A__object* s0;
  struct sidl_BaseClass__object* s1;

  struct cons_A__remote* r_obj = NULL;
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    struct cons_A__object* retobj = NULL;
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_BaseInterface bi = (
      sidl_BaseInterface)sidl_rmi_InstanceRegistry_getInstanceByString(objectID,
      _ex); SIDL_CHECK(*_ex);
    (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    retobj = (struct cons_A__object*) (*bi->d_epv->f__cast)(bi->d_object, 
      "cons.A", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
  ...
  instance = sidl_rmi_ProtocolFactory_connectInstance(url, "cons.A", ar, _ex ); 
    SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct cons_A__object*) malloc(
      sizeof(struct cons_A__object));

  r_obj =
    (struct cons_A__remote*) malloc(
      sizeof(struct cons_A__remote));
  ...
  if(!self || !r_obj) {
    ...
    sidl_MemAllocException_add(ex, __FILE__, __LINE__, "cons.A.EPVgeneration", 
      _ex);
    SIDL_CHECK(*_ex);
...
static VAR_UNUSED struct cons_A__object*
cons_A__IHConnect(sidl_rmi_InstanceHandle instance, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct cons_A__object* self = NULL;
...
static struct cons_A__object*
cons_A__remoteCreate(const char *url, struct sidl_BaseInterface__object **_ex)
{
...
cons_A__connectI(const char* url, sidl_bool ar, struct 
  sidl_BaseInterface__object **_ex)
{
  return cons_A__remoteConnect(url, ar, _ex);
}
