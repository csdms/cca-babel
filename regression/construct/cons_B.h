...
typedef struct cons_B__object* cons_B;
...
#if !defined(CONS_B_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define CONS_B_INLINE_DECL inline
#else
#define CONS_B_INLINE_DECL extern inline
#endif
 ...
 */
cons_B
cons_B__connect(const char *, sidl_BaseInterface *_ex);
