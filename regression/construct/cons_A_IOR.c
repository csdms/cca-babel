...
static VAR_UNUSED struct cons_A__epv s_my_epv_contracts__cons_a;
...
static struct cons_A__pre_epv s_preEPV;
static struct cons_A__post_epv s_postEPV;
...
extern void cons_A__set_epv(
  struct cons_A__epv* epv,
    struct cons_A__pre_epv* pre_epv,
    struct cons_A__post_epv* post_epv);

extern void cons_A__call_load(void);
#ifdef __cplusplus
}
#endif
...
cons_A_isSame__exec(
  ...
  iobj = skel_cons_A_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct cons_A__object*) (*iobj_bc->d_epv->f__cast)(iobj_bc, "cons.A",
      _ex);
    if(iobj != NULL) {
...
static void ior_cons_A__set_contracts(
  struct cons_A__object* self,
  sidl_bool   enable,
...
static void ior_cons_A__dump_stats(
  struct cons_A__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_cons_A__ensure_load_called(void) {
  /*
...
static void ior_cons_A__set_hooks(
  struct cons_A__object* self,
...
static void ior_cons_A__delete(
  struct cons_A__object* self, struct sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  cons_A__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct cons_A__object));
  free((void*) self);
}
...
static void
ior_cons_A__raddRef(
    struct cons_A__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_cons_A__isRemote(
    struct cons_A__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct cons_A__method {
  const char *d_name;
  void (*d_func)(struct cons_A__object*,
...
ior_cons_A__exec(
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct cons_A__method  s_methods[] = {
    { "_cast", cons_A__cast__exec },
    { "addRef", cons_A_addRef__exec },
    { "deleteRef", cons_A_deleteRef__exec },
    { "destruct", cons_A_destruct__exec },
    { "getClassInfo", cons_A_getClassInfo__exec },
    { "init", cons_A_init__exec },
    { "isSame", cons_A_isSame__exec },
    { "isType", cons_A_isType__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct cons_A__method);
  *_ex  = NULL; /* default to no exception */
...
static void cons_A__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct cons_A__epv*             epv  = &s_my_epv__cons_a;
  ...
  epv->f__cast                 = ior_cons_A__cast;
  epv->f__delete               = ior_cons_A__delete;
  epv->f__exec                 = ior_cons_A__exec;
  epv->f__getURL               = ior_cons_A__getURL;
  epv->f__raddRef              = ior_cons_A__raddRef;
  epv->f__isRemote             = ior_cons_A__isRemote;
  epv->f__set_hooks            = ior_cons_A__set_hooks;
  epv->f__set_contracts        = ior_cons_A__set_contracts;
  epv->f__dump_stats           = ior_cons_A__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_init                  = NULL;
  epv->f_destruct              = NULL;
  epv->f_addRef                = (void (*)(struct cons_A__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct cons_A__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct cons_A__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct cons_A__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct cons_A__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;

  cons_A__set_epv(epv, &s_preEPV, &s_postEPV);
  ...
  ior_cons_A__ensure_load_called();
}

/*
 * cons_A__getEPVs: Get my version of all relevant EPVs.
 */

void cons_A__getEPVs (
...
static struct sidl_BaseClass__epv* cons_A__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "cons.A", _ex);
...
static void
initMetadata(struct cons_A__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * cons_A__createObject: Allocate the object and initialize it.
 */
...
{
  struct cons_A__object* self =
    (struct cons_A__object*) sidl_malloc(
      sizeof(struct cons_A__object),
      "Object allocation failed for struct cons_A__object",
        __FILE__, __LINE__, "cons_A__createObject", _ex);
  if (!self) goto EXIT;
  cons_A__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void
cons_A__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct cons_A__external
s_externalEntryPoints = {
  cons_A__createObject,
  cons_A__getSuperEPV,
  2, 
  0
};
