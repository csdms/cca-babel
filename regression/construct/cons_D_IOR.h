...
struct cons_D__epv {
  ...
  /* Methods introduced in cons.D-v1.0 */
};
...
struct cons_D__object {
  struct cons_C__object d_cons_c;
  struct cons_D__epv*   d_epv;
  struct cons_D__cstats d_cstats;
  void*                 d_data;
};

struct cons_D__external {
  struct cons_D__object*
  (*createObject)(void* ddata, struct sidl_BaseInterface__object **_ex);

  struct cons_C__epv*(*getSuperEPV)(void);
...
extern struct cons_D__object*
cons_D__createObject(void* ddata,struct sidl_BaseInterface__object ** _ex);

extern void cons_D__init(
  struct cons_D__object* self, void* ddata, struct sidl_BaseInterface__object 
    ** _ex);

extern void cons_D__getEPVs(
...
extern void cons_D__fini(
  struct cons_D__object* self, struct sidl_BaseInterface__object ** _ex);

extern void cons_D__IOR_version(int32_t *major, int32_t *minor);
