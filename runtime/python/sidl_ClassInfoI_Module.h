...
#define sidl_ClassInfoI__wrap_PROTO (const struct sidl_ClassInfoI__object *sidlobj)
...
#define sidl_ClassInfoI__API_NUM 10
...
{ \
  ...
  if (!sidl_ClassInfoI__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidl.ClassInfoI"); \
    if (_imp_module != NULL) { \
