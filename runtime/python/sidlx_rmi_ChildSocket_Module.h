...
#define sidlx_rmi_ChildSocket__wrap_PROTO (const struct sidlx_rmi_ChildSocket__object *sidlobj)
...
#define sidlx_rmi_ChildSocket__API_NUM 10
...
{ \
  ...
  if (!sidlx_rmi_ChildSocket__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidlx.rmi.ChildSocket"); \
    if (_imp_module != NULL) { \
