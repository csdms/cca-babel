/*
 * File:          sidlx_rmi_RetryException_IOR.h
...
#define included_sidlx_rmi_RetryException_IOR_h
...
struct sidlx_rmi_RetryException__epv {
  ...
  /* Methods introduced in sidlx.rmi.RetryException-v0.1 */
};
...
struct sidlx_rmi_RetryException__cstats {
  sidl_bool use_hooks;
};
...
struct sidlx_rmi_RetryException__object {
  ...
  struct sidlx_rmi_RetryException__epv*         d_epv;
  void*                                         d_data;
};

struct sidlx_rmi_RetryException__external {
  struct sidlx_rmi_RetryException__object*
...
extern struct sidlx_rmi_RetryException__object*
sidlx_rmi_RetryException__createObject(void* ddata,struct 
  sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_RetryException__init(
  struct sidlx_rmi_RetryException__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_RetryException__getEPVs(
...
extern void sidlx_rmi_RetryException__fini(
  struct sidlx_rmi_RetryException__object* self, struct 
    sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_RetryException__IOR_version(int32_t *major, int32_t 
  *minor);
...
struct sidl_io_Serializer__object* 
  ...
  sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct sidlx_rmi_RetryException__remote{
  int d_refcount;
