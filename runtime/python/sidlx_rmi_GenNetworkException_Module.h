...
#define sidlx_rmi_GenNetworkException__wrap_PROTO (const struct sidlx_rmi_GenNetworkException__object *sidlobj)
...
#define sidlx_rmi_GenNetworkException__type_NUM 10

#define sidlx_rmi_GenNetworkException__API_NUM 11
...
{ \
  ...
  if (!sidlx_rmi_GenNetworkException__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidlx.rmi.GenNetworkException"); \
    if (_imp_module != NULL) { \
