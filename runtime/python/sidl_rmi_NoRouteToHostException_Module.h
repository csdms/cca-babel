...
#define sidl_rmi_NoRouteToHostException__wrap_PROTO (const struct sidl_rmi_NoRouteToHostException__object *sidlobj)
...
#define sidl_rmi_NoRouteToHostException__type_NUM 10

#define sidl_rmi_NoRouteToHostException__API_NUM 11
...
{ \
  ...
  if (!sidl_rmi_NoRouteToHostException__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidl.rmi.NoRouteToHostException"); \
    if (_imp_module != NULL) { \
