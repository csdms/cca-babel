...
#define sidlx_rmi_SimpleTicket__wrap_PROTO (const struct sidlx_rmi_SimpleTicket__object *sidlobj)
...
#define sidlx_rmi_SimpleTicket__API_NUM 10
...
{ \
  ...
  if (!sidlx_rmi_SimpleTicket__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidlx.rmi.SimpleTicket"); \
    if (_imp_module != NULL) { \
