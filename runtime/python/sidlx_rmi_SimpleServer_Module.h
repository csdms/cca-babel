...
#define sidlx_rmi_SimpleServer__wrap_PROTO (const struct sidlx_rmi_SimpleServer__object *sidlobj)
...
#define sidlx_rmi_SimpleServer__API_NUM 10
...
{ \
  ...
  if (!sidlx_rmi_SimpleServer__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidlx.rmi.SimpleServer"); \
    if (_imp_module != NULL) { \
