...
struct sidl_rmi_BindException__epv {
  ...
  int32_t (*f_getErrno)(
    /* in */ struct sidl_rmi_BindException__object* self,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in sidl.rmi.BindException-v0.9.17 */
};
...
struct sidl_rmi_BindException__cstats {
  sidl_bool use_hooks;
};
...
sidl_rmi_BindException__createObject(void* ddata,struct 
...
extern void sidl_rmi_BindException__IOR_version(int32_t *major, int32_t *minor);
