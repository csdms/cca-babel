...
#define sidl_rmi_ConnectRegistry__wrap_PROTO (const struct sidl_rmi_ConnectRegistry__object *sidlobj)
...
#define sidl_rmi_ConnectRegistry__API_NUM 10
...
{ \
  ...
  if (!sidl_rmi_ConnectRegistry__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidl.rmi.ConnectRegistry"); \
    if (_imp_module != NULL) { \
