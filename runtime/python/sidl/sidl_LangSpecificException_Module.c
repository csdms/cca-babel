  ...
  struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    ...
    retobj = (struct sidl_LangSpecificException__object*) (                   \
      *bi->d_epv->f__cast)(bi->d_object, "sidl.LangSpecificException", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
    return retobj;
...
{
  struct sidl_LangSpecificException__object *sidlobj = NULL;
...
C++ or Java."
  ...
  if (PyErr_Occurred()) {
    Py_FatalError("Cannot initialize Python module sidl.LangSpecificException.");
  }
