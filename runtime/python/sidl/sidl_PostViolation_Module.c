  ...
  sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  ...
  instance = sidl_rmi_ProtocolFactory_connectInstance(url,                    \
    "sidl.PostViolation", ar, _ex ); SIDL_CHECK(*_ex);
...
\
<code>PostViolation</code> indicates an assertion within a postcondition\n\
clause of the interface contract has been violated.", /* tp_doc */
  0,      /* tp_traverse */
  0,       /* tp_clear */
  0,       /* tp_richcompare */
  0,       /* tp_weaklistoffset */
...
{
  struct sidl_PostViolation__object *sidlobj = NULL;
...
clause of the interface contract has been violated."
  ...
  if (PyErr_Occurred()) {
    Py_FatalError("Cannot initialize Python module sidl.PostViolation.");
  }
