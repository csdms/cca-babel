  ...
  *_ex = NULL;
  {
    ...
    struct sidl_rmi_InstanceHandle__object * _conn = ((struct                 \
      sidl_ClassInfoI__remote*)self->d_data)->d_ih;
    sidl_rmi_Invocation _inv = sidl_rmi_InstanceHandle_createInvocation(      \
      _conn, "setVersion", _ex ); SIDL_CHECK(*_ex);
  ...
  *_ex = NULL;
  {
    ...
    struct sidl_rmi_InstanceHandle__object * _conn = ((struct                 \
      sidl_ClassInfoI__remote*)self->d_data)->d_ih;
    sidl_rmi_Invocation _inv = sidl_rmi_InstanceHandle_createInvocation(      \
      _conn, "getVersion", _ex ); SIDL_CHECK(*_ex);
...
static PyObject *
pStub_ClassInfoI_setVersion(PyObject *_self, PyObject *_args, PyObject        \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_ClassInfoI__object *_self_ior =
    ((struct sidl_ClassInfoI__object *)
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      (*(_self_ior->d_epv->f_setVersion))(_self_ior, ver, &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
...
Set the name of the class."
  ...
  { "setVersion", (PyCFunction)pStub_ClassInfoI_setVersion,
  (METH_VARARGS | METH_KEYWORDS),
"\
setVersion( in string ver)\n\
RETURNS\n\
    None\n\
RAISES\n\
    sidl.RuntimeException\n\
...
{
  struct sidl_ClassInfoI__object *sidlobj = NULL;
