...
static char* remote_sidl_io_IOException__getURL(
  struct sidl_io_IOException__object* self, struct                            \
    sidl_BaseInterface__object* *_ex)
{
...
{
  struct sidl_io_IOException__object *sidlobj = NULL;
...
\
 generic exception for I/O issues "
  ...
  if (PyErr_Occurred()) {
    Py_FatalError("Cannot initialize Python module sidl.io.IOException.");
  }
