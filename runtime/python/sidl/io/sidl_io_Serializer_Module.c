...
static char* remote_sidl_io__Serializer__getURL(
  struct sidl_io__Serializer__object* self, struct                            \
    sidl_BaseInterface__object* *_ex)
{
  ...
  sidl_BaseInterface__object* *_ex)
{
  ...
  ret_self = (struct sidl_io_Serializer__object*) (*self->d_epv->f__cast)(    \
    self, "sidl.io.Serializer", _ex);
...
{
  struct sidl_io_Serializer__object *sidlobj = NULL;
