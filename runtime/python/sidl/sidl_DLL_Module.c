  ...
  sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  ...
  instance = sidl_rmi_ProtocolFactory_connectInstance(url, "sidl.DLL", ar,    \
    _ex ); SIDL_CHECK(*_ex);
...
static struct sidl_DLL__object*
sidl_DLL__remoteCreate(const char *url, struct sidl_BaseInterface__object     \
  **_ex)
{
...
{
  struct sidl_DLL__object *sidlobj = NULL;
