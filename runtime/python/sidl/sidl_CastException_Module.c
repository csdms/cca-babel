  ...
  sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  ...
  instance = sidl_rmi_ProtocolFactory_connectInstance(url,                    \
    "sidl.CastException", ar, _ex ); SIDL_CHECK(*_ex);
...
{
  struct sidl_CastException__object *sidlobj = NULL;
...
throw this exception)"
  ...
  if (PyErr_Occurred()) {
    Py_FatalError("Cannot initialize Python module sidl.CastException.");
  }
