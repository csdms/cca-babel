  ...
  struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    ...
    retobj = (struct sidl_rmi_InstanceRegistry__object*) (                    \
      *bi->d_epv->f__cast)(bi->d_object, "sidl.rmi.InstanceRegistry", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
    return retobj;
...
{
  struct sidl_rmi_InstanceRegistry__object *sidlobj = NULL;
...
objectID, this capability should probably be added."
  ...
  _sepv = (*_implEPV->getStaticEPV)();
  if (PyErr_Occurred()) {
    Py_FatalError("Cannot initialize Python module sidl.rmi.InstanceRegistry.");
  }
