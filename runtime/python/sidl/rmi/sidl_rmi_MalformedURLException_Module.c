  ...
  *_ex = NULL;
  ...
  if(objectID) {
    ...
    retobj = (struct sidl_rmi_MalformedURLException__object*) (               \
      *bi->d_epv->f__cast)(bi->d_object, "sidl.rmi.MalformedURLException",    \
      _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
...
{
  struct sidl_rmi_MalformedURLException__object *sidlobj = NULL;
...
is malformed."
  ...
  if (PyErr_Occurred()) {
    Py_FatalError("Cannot initialize Python module sidl.rmi.MalformedURLException.");
  }
