  ...
  struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    ...
    retobj = (struct sidl_rmi_NetworkException__object*) (                    \
      *bi->d_epv->f__cast)(bi->d_object, "sidl.rmi.NetworkException", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
    return retobj;
...
static PyObject *
pStub_NetworkException_getErrno(PyObject *_self, PyObject *_args, PyObject    \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_NetworkException__object *_self_ior =
    ((struct sidl_rmi_NetworkException__object *)
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      _return = (*(_self_ior->d_epv->f_getErrno))(_self_ior, &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      ...
      if (_notSuper) {
        ...
        (*(((*_implEPV->getSuperEPV)())->f_packObj))(&(                       \
          _self_ior->d_sidl_io_ioexception), ser, &_exception);
      }
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
...
static PyObject *
pStub_NetworkException_setErrno(PyObject *_self, PyObject *_args, PyObject    \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidl_rmi_NetworkException__object *_self_ior =
    ((struct sidl_rmi_NetworkException__object *)
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      (*(_self_ior->d_epv->f_setErrno))(_self_ior, err, &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      ...
      if (_notSuper) {
        ...
        (*(((*_implEPV->getSuperEPV)())->f_unpackObj))(&(                     \
          _self_ior->d_sidl_io_ioexception), des, &_exception);
      }
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
...
Method to enable/disable method hooks invocation."
  ...
  { "getErrno", (PyCFunction)pStub_NetworkException_getErrno,
  (METH_VARARGS | METH_KEYWORDS),
"\
getErrno()\n\
RETURNS\n\
...
"
  ...
  { "setErrno", (PyCFunction)pStub_NetworkException_setErrno,
  (METH_VARARGS | METH_KEYWORDS),
"\
setErrno( in int err)\n\
RETURNS\n\
...
{
  struct sidl_rmi_NetworkException__object *sidlobj = NULL;
...
Generic Network Exception"
  ...
  if (PyErr_Occurred()) {
    Py_FatalError("Cannot initialize Python module sidl.rmi.NetworkException.");
  }
