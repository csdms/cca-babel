...
static void sidl_rmi_NoRouteToHostException__init_remote_epv(void)
{
  ...
  epv->f__raddRef            =                                                \
    remote_sidl_rmi_NoRouteToHostException__raddRef;
  epv->f__isRemote           =                                                \
    remote_sidl_rmi_NoRouteToHostException__isRemote;
  epv->f__set_hooks          =                                                \
    remote_sidl_rmi_NoRouteToHostException__set_hooks;
...
{
  struct sidl_rmi_NoRouteToHostException__object *sidlobj = NULL;
...
a router is down."
  ...
  if (PyErr_Occurred()) {
    Py_FatalError("Cannot initialize Python module sidl.rmi.NoRouteToHostException.");
  }
