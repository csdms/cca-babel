...
static void sidl_rmi_UnexpectedCloseException__init_remote_epv(void)
{
  ...
  epv->f__delete             =                                                \
    remote_sidl_rmi_UnexpectedCloseException__delete;
  epv->f__exec               = remote_sidl_rmi_UnexpectedCloseException__exec;
  epv->f__getURL             =                                                \
    remote_sidl_rmi_UnexpectedCloseException__getURL;
  epv->f__raddRef            =                                                \
...
sidl_rmi_UnexpectedCloseException_createCast(PyObject *self, PyObject *args,  \
  ...
  if (_okay) {
    if (!optarg && !url && !implObj) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      optarg = sidl_rmi_UnexpectedCloseException__remoteCreate(url,           \
        &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
...
{
  struct sidl_rmi_UnexpectedCloseException__object *sidlobj = NULL;
...
software connection abort, connection reset by peer, etc. "
  ...
  if (PyErr_Occurred()) {
    Py_FatalError("Cannot initialize Python module sidl.rmi.UnexpectedCloseException.");
  }
