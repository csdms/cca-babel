...
static char* remote_sidl_rmi__Call__getURL(
  struct sidl_rmi__Call__object* self, struct sidl_BaseInterface__object*     \
    *_ex)
{
  ...
  sidl_BaseInterface__object* *_ex)
{
  ...
  instance = sidl_rmi_ProtocolFactory_connectInstance(url, "sidl.rmi.Call",   \
    ar, _ex );
...
{
  struct sidl_rmi_Call__object *sidlobj = NULL;
