  ...
  sidl_BaseInterface__object* *_ex)
{
  ...
  ret_self = (struct sidl_rmi_InstanceHandle__object*) (                      \
    *self->d_epv->f__cast)(self, "sidl.rmi.InstanceHandle", _ex);
...
{
  struct sidl_rmi_InstanceHandle__object *sidlobj = NULL;
