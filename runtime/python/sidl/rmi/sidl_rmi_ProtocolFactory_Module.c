...
pStub_ProtocolFactory_connectInstance(PyObject *_ignored, PyObject *_args,    \
  ...
  if (_okay) {
    ...
    sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
    _return = (*(_sepv->f_connectInstance))(url, typeName, ar, &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
...
{
  struct sidl_rmi_ProtocolFactory__object *sidlobj = NULL;
...
<code>sidl.rmi.InstanceHandle</code>."
  ...
  _sepv = (*_implEPV->getStaticEPV)();
  if (PyErr_Occurred()) {
    Py_FatalError("Cannot initialize Python module sidl.rmi.ProtocolFactory.");
  }
