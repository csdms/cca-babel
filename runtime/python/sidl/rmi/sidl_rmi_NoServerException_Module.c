  ...
  struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    ...
    retobj = (struct sidl_rmi_NoServerException__object*) (                   \
      *bi->d_epv->f__cast)(bi->d_object, "sidl.rmi.NoServerException", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
    return retobj;
...
{
  struct sidl_rmi_NoServerException__object *sidlobj = NULL;
...
there is no local server running to serve the object"
  ...
  if (PyErr_Occurred()) {
    Py_FatalError("Cannot initialize Python module sidl.rmi.NoServerException.");
  }
