...
static char* remote_sidl_rmi__TicketBook__getURL(
  struct sidl_rmi__TicketBook__object* self, struct                           \
    sidl_BaseInterface__object* *_ex)
{
  ...
  sidl_BaseInterface__object* *_ex)
{
  ...
  ret_self = (struct sidl_rmi_TicketBook__object*) (*self->d_epv->f__cast)(   \
    self, "sidl.rmi.TicketBook", _ex);
...
{
  struct sidl_rmi_TicketBook__object *sidlobj = NULL;
