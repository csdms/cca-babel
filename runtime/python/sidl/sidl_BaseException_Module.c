...
static char* remote_sidl__BaseException__getURL(
  struct sidl__BaseException__object* self, struct                            \
    sidl_BaseInterface__object* *_ex)
{
  ...
  sidl_BaseInterface__object* *_ex)
{
  ...
  ret_self = (struct sidl_BaseException__object*) (*self->d_epv->f__cast)(    \
    self, "sidl.BaseException", _ex);
...
{
  struct sidl_BaseException__object *sidlobj = NULL;
