...
sidl_NotImplementedException_createCast(PyObject *self, PyObject *args,       \
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)sidl_NotImplementedException__convert, &optarg, &url, &implObj);
  if (_okay) {
...
sidl_NotImplementedException__wrap sidl_NotImplementedException__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidl_NotImplementedExceptionType.tp_new(                        \
...
{
  struct sidl_NotImplementedException__object *sidlobj = NULL;
...
placed into the _Impl files automatically when they are generated."
  ...
  PyTuple_SetItem(_sidl_NotImplementedExceptionType.tp_bases,0, (PyObject     \
    *)sidl_SIDLException_PyType());
  PyTuple_SetItem(_sidl_NotImplementedExceptionType.tp_bases,1, (PyObject     \
  ...
  Py_INCREF(&_sidl_NotImplementedExceptionType);
  PyDict_SetItemString(dict, "NotImplementedException", (PyObject             \
    *)&_sidl_NotImplementedExceptionType);
  ...
  if (PyErr_Occurred()) {
    Py_FatalError("Cannot initialize Python module sidl.NotImplementedException.");
  }
