...
static char* remote_sidl__BaseInterface__getURL(
  struct sidl__BaseInterface__object* self, struct                            \
    sidl_BaseInterface__object* *_ex)
{
  ...
  sidl_BaseInterface__object* *_ex)
{
  ...
  ret_self = (struct sidl_BaseInterface__object*) (*self->d_epv->f__cast)(    \
    self, "sidl.BaseInterface", _ex);
...
{
  struct sidl_BaseInterface__object *sidlobj = NULL;
