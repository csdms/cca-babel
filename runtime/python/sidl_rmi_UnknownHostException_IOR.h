...
struct sidl_rmi_UnknownHostException__epv {
  ...
  int32_t (*f_getErrno)(
    /* in */ struct sidl_rmi_UnknownHostException__object* self,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in sidl.rmi.UnknownHostException-v0.9.17 */
};
...
struct sidl_rmi_UnknownHostException__cstats {
  sidl_bool use_hooks;
};
...
sidl_rmi_UnknownHostException__createObject(void* ddata,struct 
...
extern void sidl_rmi_UnknownHostException__IOR_version(int32_t *major, int32_t 
  *minor);
