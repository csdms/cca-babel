/*
 * File:          sidlx_rmi_OutOfAddressesException_IOR.h
...
#ifndef included_sidlx_rmi_OutOfAddressesException_IOR_h
#define included_sidlx_rmi_OutOfAddressesException_IOR_h
...
struct sidlx_rmi_OutOfAddressesException__epv {
  ...
  /* Methods introduced in sidlx.rmi.OutOfAddressesException-v0.1 */
};
...
struct sidlx_rmi_OutOfAddressesException__cstats {
  sidl_bool use_hooks;
};
...
struct sidlx_rmi_OutOfAddressesException__object {
  ...
  struct sidlx_rmi_OutOfAddressesException__epv* d_epv;
  void*                                          d_data;
};

struct sidlx_rmi_OutOfAddressesException__external {
  struct sidlx_rmi_OutOfAddressesException__object*
...
extern struct sidlx_rmi_OutOfAddressesException__object*
sidlx_rmi_OutOfAddressesException__createObject(void* ddata,struct 
  sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_OutOfAddressesException__init(
  struct sidlx_rmi_OutOfAddressesException__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_OutOfAddressesException__getEPVs(
  ...
  struct sidlx_rmi_OutOfAddressesException__epv 
    **s_arg_epv__sidlx_rmi_outofaddressesexception);

extern void sidlx_rmi_OutOfAddressesException__fini(
  struct sidlx_rmi_OutOfAddressesException__object* self, struct 
    sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_OutOfAddressesException__IOR_version(int32_t *major, 
  int32_t *minor);

struct sidl_io_Deserializer__object* 
  skel_sidlx_rmi_OutOfAddressesException_fconnect_sidl_io_Deserializer(const 
  char* url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct sidl_BaseInterface__object* 
  skel_sidlx_rmi_OutOfAddressesException_fconnect_sidl_BaseInterface(const 
  char* url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct sidl_io_Serializer__object* 
  skel_sidlx_rmi_OutOfAddressesException_fconnect_sidl_io_Serializer(const 
  char* url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct sidlx_rmi_OutOfAddressesException__remote{
  int d_refcount;
