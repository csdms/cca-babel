...
struct sidl_PreViolation__epv {
  ...
  /* Methods introduced in sidl.PreViolation-v0.9.17 */
};
...
struct sidl_PreViolation__cstats {
  sidl_bool use_hooks;
};
...
sidl_PreViolation__createObject(void* ddata,struct sidl_BaseInterface__object 
  ** _ex);
