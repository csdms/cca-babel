...
#define sidl_BaseException__wrap_PROTO (const struct sidl_BaseException__object *sidlobj)
...
#define sidl_BaseException__type_NUM 10

#define sidl_BaseException__API_NUM 11
...
{ \
  ...
  if (!sidl_BaseException__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidl.BaseException"); \
    if (_imp_module != NULL) { \
