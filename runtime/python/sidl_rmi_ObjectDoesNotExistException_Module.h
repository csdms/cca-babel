...
#define sidl_rmi_ObjectDoesNotExistException__wrap_PROTO (const struct sidl_rmi_ObjectDoesNotExistException__object *sidlobj)
...
#define sidl_rmi_ObjectDoesNotExistException__type_NUM 10

#define sidl_rmi_ObjectDoesNotExistException__API_NUM 11
...
{ \
  ...
  if (!sidl_rmi_ObjectDoesNotExistException__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidl.rmi.ObjectDoesNotExistException"); \
    if (_imp_module != NULL) { \
