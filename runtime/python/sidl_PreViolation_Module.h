...
#define sidl_PreViolation__wrap_PROTO (const struct sidl_PreViolation__object *sidlobj)
...
#define sidl_PreViolation__type_NUM 10

#define sidl_PreViolation__API_NUM 11
...
{ \
  ...
  if (!sidl_PreViolation__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidl.PreViolation"); \
    if (_imp_module != NULL) { \
