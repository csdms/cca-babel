...
#define sidl_Finder__wrap_PROTO (const struct sidl_Finder__object *sidlobj)
...
#define sidl_Finder__API_NUM 10
...
{ \
  ...
  if (!sidl_Finder__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidl.Finder"); \
    if (_imp_module != NULL) { \
