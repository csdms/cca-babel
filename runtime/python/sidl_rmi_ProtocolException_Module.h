...
#define sidl_rmi_ProtocolException__wrap_PROTO (const struct sidl_rmi_ProtocolException__object *sidlobj)
...
#define sidl_rmi_ProtocolException__type_NUM 10

#define sidl_rmi_ProtocolException__API_NUM 11
...
{ \
  ...
  if (!sidl_rmi_ProtocolException__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidl.rmi.ProtocolException"); \
    if (_imp_module != NULL) { \
