...
#define sidlx_rmi_SimpleOrb_INTERNAL 1
#include "sidlx_rmi_SimpleOrb_Module.h"
...
static char* remote_sidlx_rmi_SimpleOrb__getURL(
  struct sidlx_rmi_SimpleOrb__object* self, struct                            \
    sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    struct sidl_rmi_InstanceHandle__object * _conn = ((struct                 \
      sidlx_rmi_SimpleOrb__remote*)self->d_data)->d_ih;
    sidl_rmi_Invocation _inv = sidl_rmi_InstanceHandle_createInvocation(      \
      _conn, "setCookie", _ex ); SIDL_CHECK(*_ex);
  ...
  *_ex = NULL;
  {
    ...
    struct sidl_rmi_InstanceHandle__object * _conn = ((struct                 \
      sidlx_rmi_SimpleOrb__remote*)self->d_data)->d_ih;
    sidl_rmi_Invocation _inv = sidl_rmi_InstanceHandle_createInvocation(      \
      _conn, "setNumSecurityRetries", _ex ); SIDL_CHECK(*_ex);
  ...
  *_ex = NULL;
  {
    ...
    struct sidl_rmi_InstanceHandle__object * _conn = ((struct                 \
      sidlx_rmi_SimpleOrb__remote*)self->d_data)->d_ih;
    sidl_rmi_Invocation _inv = sidl_rmi_InstanceHandle_createInvocation(      \
      _conn, "requestLocalPort", _ex ); SIDL_CHECK(*_ex);
  ...
  *_ex = NULL;
  {
    ...
    struct sidl_rmi_InstanceHandle__object * _conn = ((struct                 \
      sidlx_rmi_SimpleOrb__remote*)self->d_data)->d_ih;
    sidl_rmi_Invocation _inv = sidl_rmi_InstanceHandle_createInvocation(      \
      _conn, "requestLocalPortInRange", _ex ); SIDL_CHECK(*_ex);
...
static void sidlx_rmi_SimpleOrb__init_remote_epv(void)
{
  ...
  e3->f__set_contracts          = (void (*)(struct                            \
    sidlx_rmi_SimpleServer__object*, sidl_bool, const char*, sidl_bool,       \
    struct sidl_BaseInterface__object**)) epv->f__set_contracts;
  ...
  if (_okay) {
...
#endif /* Python 2.4 or later */
    self = sidlx_rmi_SimpleOrb__remoteConnect(url,1,&_exception);
#if (PY_VERSION_HEX >= 0x02040000)
    ...
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)sidlx_rmi_SimpleOrb__wrap, self);
    }
  }
...
#endif /*WITH_RMI*/
staticforward PyTypeObject _sidlx_rmi_SimpleOrbType;

static const struct sidlx_rmi_SimpleOrb__external *_implEPV = NULL;
...
_loadClassImpl(void) {
  if (!_implEPV) {
    ...
    sidl_DLL dll = NULL;
    char *errmsg = NULL;
    struct sidlx_rmi_SimpleOrb__external*(*_extFunc)(void) = NULL;
    ...
    if (dll && sidl_DLL_loadLibrary(dll, "main:", TRUE, FALSE,                \
      &throwaway_exception)) {
      _extFunc = (struct sidlx_rmi_SimpleOrb__external*(*)(void))
        sidl_DLL_lookupSymbol(dll, "sidlx_rmi_SimpleOrb__externals",          \
          &throwaway_exception);
    ...
    if (!_implEPV) {
      dll = sidl_Loader_findLibrary("sidlx.rmi.SimpleOrb",
      ...
      if (dll) {
        ...
        if (!throwaway_exception && _extFunc) {
          ...
          errmsg = sidl_String_concat3(
            "babel: The shared library containing SIDL type sidlx.rmi.SimpleOrb, ",
            name,
            ", was loaded but is missing a required symbol (sidlx_rmi_SimpleOrb__externals).");
          sidl_String_free(name);
        }
        sidl_DLL_deleteRef(dll, &throwaway_exception);
      }
      else {
        errmsg = sidl_String_strdup("babel: Unable to find or load a shared library containing the implementation of SIDL type sidlx.rmi.SimpleOrb. To get more debugging information trying setting the SIDL_DEBUG_DLOPEN environment variable and rerunning.");
      }
    }
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    ...
    if (!_implEPV) {
      ...
      else PyErr_SetString(PyExc_RuntimeError, "Unexpected error loading SIDL implementation for sidlx.rmi.SimpleOrb.");
...
static PyObject *
pStub_SimpleOrb__exec(PyObject *_self, PyObject *_args, PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimpleOrb__object *_self_ior =
    ((struct sidlx_rmi_SimpleOrb__object *)
     sidl_Cast(_self, "sidlx.rmi.SimpleOrb"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a sidlx.rmi.SimpleOrb");
  }
  return _return_value;
}

static PyObject *
pStub_SimpleOrb__getURL(PyObject *_self, PyObject *_args, PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimpleOrb__object *_self_ior =
    ((struct sidlx_rmi_SimpleOrb__object *)
     sidl_Cast(_self, "sidlx.rmi.SimpleOrb"));
  ...
  *_kwdict) {
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      _return = (*(_self_ior->d_epv->f_getProtocol))(_self_ior, &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
...
pStub_SimpleOrb_getServerURL(PyObject *_self, PyObject *_args, PyObject       \
  *_kwdict) {
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      char* _return = NULL;
      const int _notSuper = !sidl_IsSuper(_self);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_BEGIN_ALLOW_THREADS
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      if (_notSuper) {
        ...
        _return = (*(((*_implEPV->getSuperEPV)())->f_getServerURL))(&(        \
          _self_ior->d_sidlx_rmi_simpleserver), objID, &_exception);
      }
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
...
static PyObject *
pStub_SimpleOrb_setCookie(PyObject *_self, PyObject *_args, PyObject          \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimpleOrb__object *_self_ior =
    ((struct sidlx_rmi_SimpleOrb__object *)
  ...
  if (_self_ior) {
    ...
    _okay = PyArg_ParseTupleAndKeywords(
      _args, _kwdict, 
      "O&", _kwlist,
      (void *)sidl_char__borrow_python_array, &cookie);
    if (_okay) {
#if (PY_VERSION_HEX >= 0x02040000)
      Py_BEGIN_ALLOW_THREADS
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      (*(_self_ior->d_epv->f_setCookie))(_self_ior, cookie, &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      sidl_python_deleteRef_array((struct sidl__array *)cookie);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
...
static PyObject *
pStub_SimpleOrb_setNumSecurityRetries(PyObject *_self, PyObject *_args,       \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimpleOrb__object *_self_ior =
    ((struct sidlx_rmi_SimpleOrb__object *)
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      (*(_self_ior->d_epv->f_setNumSecurityRetries))(_self_ior, retries,      \
        &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
  ...
  *kwds) {
  ...
  if (_okay) {
    if (!optarg && !url && !implObj) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      optarg = sidlx_rmi_SimpleOrb__remoteCreate(url,&_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
...
static PyMethodDef _SimpleOrbModuleMethods[] = {

#ifdef WITH_RMI

  { "_connect", (PyCFunction)pStub_SimpleOrb__connect,
  (METH_VARARGS | METH_KEYWORDS),
"\
_connect( in string url)\n\
RETURNS\n\
   ( out sidlx.rmi.SimpleOrb self)\n\
RAISES\n\
...
static PyMethodDef _SimpleOrbObjectMethods[] = {
  { "_exec", (PyCFunction)pStub_SimpleOrb__exec,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Select and execute a method by name"
  ...
  { "_getURL", (PyCFunction)pStub_SimpleOrb__getURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
_getURL()\n\
RETURNS\n\
...
Get the URL of the Implementation of this object (for RMI)"
  ...
  { "_isLocal", (PyCFunction)pStub_SimpleOrb__isLocal,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isLocal()\n\
RETURNS\n\
...
TRUE if this object is local, false if remote"
  ...
  { "_isRemote", (PyCFunction)pStub_SimpleOrb__isRemote,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isRemote()\n\
RETURNS\n\
...
TRUE if this object is remote, false if local"
  ...
  { "_set_hooks", (PyCFunction)pStub_SimpleOrb__set_hooks,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Method to enable/disable method hooks invocation."
  ...
  { "getExceptions", (PyCFunction)pStub_SimpleOrb_getExceptions,
  (METH_VARARGS | METH_KEYWORDS),
"\
getExceptions()\n\
RETURNS\n\
...
THIS IS SOMETHING OF A TEST! THIS MAY CHANGE!"
  ...
  { "getProtocol", (PyCFunction)pStub_SimpleOrb_getProtocol,
  (METH_VARARGS | METH_KEYWORDS),
"\
getProtocol()\n\
RETURNS\n\
...
Get the short name of the protocol this ORB supports"
  ...
  { "getServerURL", (PyCFunction)pStub_SimpleOrb_getServerURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Get the full URL for exporting objects"
  ...
  { "isLocalObject", (PyCFunction)pStub_SimpleOrb_isLocalObject,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
users should never need this.  Returns the objectID if is local, Null otherwise. "
  ...
  { "serviceRequest", (PyCFunction)pStub_SimpleOrb_serviceRequest,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
"
  ...
  { "setCookie", (PyCFunction)pStub_SimpleOrb_setCookie,
  (METH_VARARGS | METH_KEYWORDS),
"\
setCookie( in rarray<char> cookie(len))\n\
RETURNS\n\
    None\n\
RAISES\n\
    sidl.RuntimeException\n\
...
are undefined. "
  ...
  { "setNumSecurityRetries", (                                                \
    PyCFunction)pStub_SimpleOrb_setNumSecurityRetries,
  (METH_VARARGS | METH_KEYWORDS),
"\
setNumSecurityRetries( in int retries)\n\
RETURNS\n\
    None\n\
RAISES\n\
    sidl.RuntimeException\n\
...
static PyTypeObject _sidlx_rmi_SimpleOrbType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "sidlx.rmi.SimpleOrb.SimpleOrb", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
  ...
  "\
\
A simple example orb, using the simhandle protocol (written by Jim)", /* tp_doc */
  0,      /* tp_traverse */
  0,       /* tp_clear */
  0,       /* tp_richcompare */
  0,       /* tp_weaklistoffset */
  0,       /* tp_iter */
  0,       /* tp_iternext */
  _SimpleOrbObjectMethods, /* tp_methods */
  0,       /* tp_members */
  0,       /* tp_getset */
  0,       /* tp_base */
  0,       /* tp_dict */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  sidlx_rmi_SimpleOrb_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};

sidlx_rmi_SimpleOrb__wrap_RETURN
sidlx_rmi_SimpleOrb__wrap sidlx_rmi_SimpleOrb__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_SimpleOrbType.tp_new(&_sidlx_rmi_SimpleOrbType, NULL, \
      NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
sidlx_rmi_SimpleOrb__weakRef_RETURN
sidlx_rmi_SimpleOrb__weakRef sidlx_rmi_SimpleOrb__weakRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_SimpleOrbType.tp_new(&_sidlx_rmi_SimpleOrbType, NULL, \
      NULL);
...
sidlx_rmi_SimpleOrb_deref_RETURN
sidlx_rmi_SimpleOrb_deref sidlx_rmi_SimpleOrb_deref_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
sidlx_rmi_SimpleOrb__newRef_RETURN
sidlx_rmi_SimpleOrb__newRef sidlx_rmi_SimpleOrb__newRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_SimpleOrbType.tp_new(&_sidlx_rmi_SimpleOrbType, NULL, \
      NULL);
...
sidlx_rmi_SimpleOrb__addRef_RETURN
sidlx_rmi_SimpleOrb__addRef sidlx_rmi_SimpleOrb__addRef_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
sidlx_rmi_SimpleOrb_PyType_RETURN
sidlx_rmi_SimpleOrb_PyType sidlx_rmi_SimpleOrb_PyType_PROTO {
  Py_INCREF(&_sidlx_rmi_SimpleOrbType);
  return &_sidlx_rmi_SimpleOrbType;
}

sidlx_rmi_SimpleOrb__convert_RETURN
sidlx_rmi_SimpleOrb__convert sidlx_rmi_SimpleOrb__convert_PROTO {
  if (*sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
#if (PY_VERSION_HEX >= 0x02040000)
    Py_BEGIN_ALLOW_THREADS
  ...
  *sidlobj = sidl_Cast(obj, "sidlx.rmi.SimpleOrb");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) sidlx.rmi.SimpleOrb");
    return 0;
  }
  return 1;
}
...
{
  struct sidlx_rmi_SimpleOrb__object *sidlobj = NULL;
  if (sidlx_rmi_SimpleOrb__convert(pyobj, &sidlobj)) {
...
sidlx_rmi_SimpleOrb__convert_python_array_RETURN
sidlx_rmi_SimpleOrb__convert_python_array                                     \
  sidlx_rmi_SimpleOrb__convert_python_array_PROTO {
  int result = 0;
  if (*sidlarray) {
#if (PY_VERSION_HEX >= 0x02040000)
    Py_BEGIN_ALLOW_THREADS
  ...
  if (obj == Py_None) {
    ...
    if (pya) {
      if (PyArray_OBJECT == ((PyArrayObject *)pya)->descr->type_num) {
        ...
        {
            *sidlarray = (struct                                              \
              sidlx_rmi_SimpleOrb__array*)sidl_interface__array_createRow
            (dimen, lower, upper);
...
{
  struct sidlx_rmi_SimpleOrb__object *sidlobj = (struct                       \
    sidlx_rmi_SimpleOrb__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = sidlx_rmi_SimpleOrb__wrap(sidlobj);
  return (*dest == NULL);
}

sidlx_rmi_SimpleOrb__convert_sidl_array_RETURN
sidlx_rmi_SimpleOrb__convert_sidl_array                                       \
  sidlx_rmi_SimpleOrb__convert_sidl_array_PROTO {
  PyObject *pya = NULL;
  if (sidlarray) {
...
initSimpleOrb(void) {
  ...
  static void *ExternalAPI[sidlx_rmi_SimpleOrb__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  module = Py_InitModule3("SimpleOrb", _SimpleOrbModuleMethods, "\
\
A simple example orb, using the simhandle protocol (written by Jim)"
  );
