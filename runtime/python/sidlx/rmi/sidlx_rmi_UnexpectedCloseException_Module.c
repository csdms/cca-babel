/*
 * File:          sidlx_rmi_UnexpectedCloseException_Module.c
 ...
 * sidl type sidlx.rmi.UnexpectedCloseException.
 */
...
#define sidlx_rmi_UnexpectedCloseException_INTERNAL 1
#include "sidlx_rmi_UnexpectedCloseException_Module.h"
...
static void sidlx_rmi_UnexpectedCloseException__init_remote_epv(void)
{
  ...
  epv->f__cast               =                                                \
    remote_sidlx_rmi_UnexpectedCloseException__cast;
  epv->f__delete             =                                                \
    remote_sidlx_rmi_UnexpectedCloseException__delete;
  epv->f__exec               =                                                \
    remote_sidlx_rmi_UnexpectedCloseException__exec;
  epv->f__getURL             =                                                \
...
sidlx_rmi_UnexpectedCloseException__IHConnect(sidl_rmi_InstanceHandle         \
  ...
  if (_okay) {
...
#endif /* Python 2.4 or later */
    self = sidlx_rmi_UnexpectedCloseException__remoteConnect(url,1,           \
      &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
    ...
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)sidlx_rmi_UnexpectedCloseException__wrap, self);
    }
  }
...
#endif /*WITH_RMI*/
staticforward PyTypeObject _sidlx_rmi_UnexpectedCloseExceptionType;

static const struct sidlx_rmi_UnexpectedCloseException__external *_implEPV =  \
  NULL;
...
_loadClassImpl(void) {
  if (!_implEPV) {
    ...
    sidl_DLL dll = NULL;
    char *errmsg = NULL;
    struct sidlx_rmi_UnexpectedCloseException__external*(*_extFunc)(void) =   \
      NULL;
    ...
    if (dll && sidl_DLL_loadLibrary(dll, "main:", TRUE, FALSE,                \
      &throwaway_exception)) {
      _extFunc = (struct sidlx_rmi_UnexpectedCloseException__external*(*)(    \
        void))
    ...
    if (!_implEPV) {
      dll = sidl_Loader_findLibrary("sidlx.rmi.UnexpectedCloseException",
      ...
      if (dll) {
        ...
        if (!throwaway_exception && _extFunc) {
          ...
          errmsg = sidl_String_concat3(
            "babel: The shared library containing SIDL type sidlx.rmi.UnexpectedCloseException, ",
            name,
            ", was loaded but is missing a required symbol (sidlx_rmi_UnexpectedCloseException__externals).");
          sidl_String_free(name);
        }
        sidl_DLL_deleteRef(dll, &throwaway_exception);
      }
      else {
        errmsg = sidl_String_strdup("babel: Unable to find or load a shared library containing the implementation of SIDL type sidlx.rmi.UnexpectedCloseException. To get more debugging information trying setting the SIDL_DEBUG_DLOPEN environment variable and rerunning.");
      }
    }
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    ...
    if (!_implEPV) {
      ...
      else PyErr_SetString(PyExc_RuntimeError, "Unexpected error loading SIDL implementation for sidlx.rmi.UnexpectedCloseException.");
...
pStub_UnexpectedCloseException__exec(PyObject *_self, PyObject *_args,        \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_UnexpectedCloseException__object *_self_ior =
    ((struct sidlx_rmi_UnexpectedCloseException__object *)
     sidl_Cast(_self, "sidlx.rmi.UnexpectedCloseException"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a sidlx.rmi.UnexpectedCloseException");
  }
  return _return_value;
}
...
static int
sidlx_rmi_UnexpectedCloseException_createCast(PyObject *self, PyObject *args, \
  PyObject *kwds) {
  struct sidlx_rmi_UnexpectedCloseException__object *optarg = NULL;
  char* url = NULL;
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)sidlx_rmi_UnexpectedCloseException__convert, &optarg, &url, &implObj);
  if (_okay) {
    if (!optarg && !url && !implObj) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      optarg = sidlx_rmi_UnexpectedCloseException__remoteCreate(url,          \
        &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
...
RETURNS\n\
   ( out sidlx.rmi.UnexpectedCloseException self)\n\
RAISES\n\
...
static PyTypeObject _sidlx_rmi_UnexpectedCloseExceptionType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "sidlx.rmi.UnexpectedCloseException.UnexpectedCloseException", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
  ...
  "\
SIDL wrapper for the sidlx.rmi.UnexpectedCloseException type.\
", /* tp_doc */
  0,      /* tp_traverse */
  0,       /* tp_clear */
  0,       /* tp_richcompare */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  sidlx_rmi_UnexpectedCloseException_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};
...
sidlx_rmi_UnexpectedCloseException__wrap                                      \
  ...
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_UnexpectedCloseExceptionType.tp_new(                  \
      &_sidlx_rmi_UnexpectedCloseExceptionType, NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
sidlx_rmi_UnexpectedCloseException_PyType                                     \
  ...
  Py_INCREF(&_sidlx_rmi_UnexpectedCloseExceptionType);
  return &_sidlx_rmi_UnexpectedCloseExceptionType;
}
...
sidlx_rmi_UnexpectedCloseException__convert                                   \
  ...
  *sidlobj = sidl_Cast(obj, "sidlx.rmi.UnexpectedCloseException");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) sidlx.rmi.UnexpectedCloseException");
    return 0;
  }
  return 1;
}
...
{
  struct sidlx_rmi_UnexpectedCloseException__object *sidlobj = NULL;
  if (sidlx_rmi_UnexpectedCloseException__convert(pyobj, &sidlobj)) {
...
{
  struct sidlx_rmi_UnexpectedCloseException__object *sidlobj = (struct        \
    sidlx_rmi_UnexpectedCloseException__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = sidlx_rmi_UnexpectedCloseException__wrap(sidlobj);
  return (*dest == NULL);
}
...
initUnexpectedCloseException(void) {
  ...
  static void *ExternalAPI[sidlx_rmi_UnexpectedCloseException__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  module = Py_InitModule("UnexpectedCloseException",                          \
    _UnexpectedCloseExceptionModuleMethods);
  dict = PyModule_GetDict(module);
  ExternalAPI[sidlx_rmi_UnexpectedCloseException__wrap_NUM] = (               \
    void*)sidlx_rmi_UnexpectedCloseException__wrap;
  ExternalAPI[sidlx_rmi_UnexpectedCloseException__convert_NUM] = (            \
    void*)sidlx_rmi_UnexpectedCloseException__convert;
  ExternalAPI[sidlx_rmi_UnexpectedCloseException__convert_python_array_NUM] = \
    (void*)sidlx_rmi_UnexpectedCloseException__convert_python_array;
  ExternalAPI[sidlx_rmi_UnexpectedCloseException__convert_sidl_array_NUM] = ( \
    void*)sidlx_rmi_UnexpectedCloseException__convert_sidl_array;
  ExternalAPI[sidlx_rmi_UnexpectedCloseException__weakRef_NUM] = (            \
    void*)sidlx_rmi_UnexpectedCloseException__weakRef;
  ExternalAPI[sidlx_rmi_UnexpectedCloseException_deref_NUM] = (               \
    void*)sidlx_rmi_UnexpectedCloseException_deref;
  ExternalAPI[sidlx_rmi_UnexpectedCloseException__newRef_NUM] = (             \
    void*)sidlx_rmi_UnexpectedCloseException__newRef;
  ExternalAPI[sidlx_rmi_UnexpectedCloseException__addRef_NUM] = (             \
    void*)sidlx_rmi_UnexpectedCloseException__addRef;
  ExternalAPI[sidlx_rmi_UnexpectedCloseException_PyType_NUM] = (              \
    void*)sidlx_rmi_UnexpectedCloseException_PyType;
#ifdef WITH_RMI
  ExternalAPI[sidlx_rmi_UnexpectedCloseException__connectI_NUM] = (           \
    void*)sidlx_rmi_UnexpectedCloseException__connectI;
#endif /*WITH_RMI*/
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  Py_INCREF(Py_None);
  ExternalAPI[sidlx_rmi_UnexpectedCloseException__type_NUM] = Py_None;
  ...
  sidlx_rmi_UnrecoverableException__import();
  _sidlx_rmi_UnexpectedCloseExceptionType.tp_base =                           \
    sidlx_rmi_UnrecoverableException_PyType();
  _sidlx_rmi_UnexpectedCloseExceptionType.tp_bases = PyTuple_New(1);
  PyTuple_SetItem(_sidlx_rmi_UnexpectedCloseExceptionType.tp_bases,0, (       \
    PyObject *)sidlx_rmi_UnrecoverableException_PyType());
  if (PyType_Ready(&_sidlx_rmi_UnexpectedCloseExceptionType) < 0) {
    PyErr_Print();
    fprintf(stderr, "PyType_Ready on sidlx.rmi.UnexpectedCloseException       \
      failed.\n");
    return;
  }
  Py_INCREF(&_sidlx_rmi_UnexpectedCloseExceptionType);
  PyDict_SetItemString(dict, "UnexpectedCloseException", (PyObject            \
    *)&_sidlx_rmi_UnexpectedCloseExceptionType);
  ...
  PyDict_SetItemString(_exceptionDict, "__module__",
    PyString_InternFromString("sidlx.rmi.UnexpectedCloseException"));
  _exceptionName = PyString_InternFromString("_Exception");
  sidlx_rmi_UnexpectedCloseException__type = PyClass_New(_exceptionBases,     \
    _exceptionDict, _exceptionName);
  Py_XDECREF(_exceptionBases);
  Py_XDECREF(_exceptionDict);
  Py_XDECREF(_exceptionName);
  Py_XINCREF(sidlx_rmi_UnexpectedCloseException__type);
  PyDict_SetItemString(dict, "_Exception",                                    \
    sidlx_rmi_UnexpectedCloseException__type);
  ExternalAPI[sidlx_rmi_UnexpectedCloseException__type_NUM] =                 \
    sidlx_rmi_UnexpectedCloseException__type;
  /*
  ...
  sidl_rmi_ConnectRegistry_registerConnect(                                   \
    ...
    void*)sidlx_rmi_UnexpectedCloseException__IHConnect,                      \
    &throwaway_exception);
