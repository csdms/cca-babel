/*
 * File:          sidlx_rmi_RecoverableException_Module.c
 ...
 * sidl type sidlx.rmi.RecoverableException.
 */
...
#define sidlx_rmi_RecoverableException_INTERNAL 1
...
sidlx_rmi_RecoverableException__connectI(const char * url, sidl_bool ar,      \
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    ...
    retobj = (struct sidlx_rmi_RecoverableException__object*) (               \
      *bi->d_epv->f__cast)(bi->d_object, "sidlx.rmi.RecoverableException",    \
      _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
...
static PyObject *
pStub_RecoverableException__connect(PyObject *_ignored, PyObject *_args,      \
  PyObject *_kwdict) {
  ...
  if (_okay) {
...
#endif /* Python 2.4 or later */
    self = sidlx_rmi_RecoverableException__remoteConnect(url,1,&_exception);
#if (PY_VERSION_HEX >= 0x02040000)
    ...
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)sidlx_rmi_RecoverableException__wrap, self);
    }
  }
...
#endif /*WITH_RMI*/
staticforward PyTypeObject _sidlx_rmi_RecoverableExceptionType;

static const struct sidlx_rmi_RecoverableException__external *_implEPV = NULL;
...
_loadClassImpl(void) {
  if (!_implEPV) {
    ...
    sidl_DLL dll = NULL;
    char *errmsg = NULL;
    struct sidlx_rmi_RecoverableException__external*(*_extFunc)(void) = NULL;
    ...
    if (dll && sidl_DLL_loadLibrary(dll, "main:", TRUE, FALSE,                \
      &throwaway_exception)) {
      _extFunc = (struct sidlx_rmi_RecoverableException__external*(*)(void))
        sidl_DLL_lookupSymbol(dll,                                            \
          "sidlx_rmi_RecoverableException__externals", &throwaway_exception);
    ...
    if (!_implEPV) {
      dll = sidl_Loader_findLibrary("sidlx.rmi.RecoverableException",
      ...
      if (dll) {
        ...
        if (!throwaway_exception && _extFunc) {
          ...
          errmsg = sidl_String_concat3(
            "babel: The shared library containing SIDL type sidlx.rmi.RecoverableException, ",
            name,
            ", was loaded but is missing a required symbol (sidlx_rmi_RecoverableException__externals).");
          sidl_String_free(name);
        }
        sidl_DLL_deleteRef(dll, &throwaway_exception);
      }
      else {
        errmsg = sidl_String_strdup("babel: Unable to find or load a shared library containing the implementation of SIDL type sidlx.rmi.RecoverableException. To get more debugging information trying setting the SIDL_DEBUG_DLOPEN environment variable and rerunning.");
      }
    }
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    ...
    if (!_implEPV) {
      ...
      else PyErr_SetString(PyExc_RuntimeError, "Unexpected error loading SIDL implementation for sidlx.rmi.RecoverableException.");
...
static PyObject *
pStub_RecoverableException__exec(PyObject *_self, PyObject *_args, PyObject   \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_RecoverableException__object *_self_ior =
    ((struct sidlx_rmi_RecoverableException__object *)
     sidl_Cast(_self, "sidlx.rmi.RecoverableException"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a sidlx.rmi.RecoverableException");
  }
  return _return_value;
}

static PyObject *
pStub_RecoverableException__getURL(PyObject *_self, PyObject *_args, PyObject \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_RecoverableException__object *_self_ior =
    ((struct sidlx_rmi_RecoverableException__object *)
...
static PyObject *
pStub_RecoverableException__isLocal(PyObject *_self, PyObject *_args,         \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_RecoverableException__object *_self_ior =
    ((struct sidlx_rmi_RecoverableException__object *)
...
static PyObject *
pStub_RecoverableException__isRemote(PyObject *_self, PyObject *_args,        \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_RecoverableException__object *_self_ior =
    ((struct sidlx_rmi_RecoverableException__object *)
...
static PyObject *
pStub_RecoverableException__set_hooks(PyObject *_self, PyObject *_args,       \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_RecoverableException__object *_self_ior =
    ((struct sidlx_rmi_RecoverableException__object *)
...
static int
sidlx_rmi_RecoverableException_createCast(PyObject *self, PyObject *args,     \
  PyObject *kwds) {
  struct sidlx_rmi_RecoverableException__object *optarg = NULL;
  char* url = NULL;
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)sidlx_rmi_RecoverableException__convert, &optarg, &url, &implObj);
  if (_okay) {
    if (!optarg && !url && !implObj) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      optarg = sidlx_rmi_RecoverableException__remoteCreate(url,&_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
...
static PyMethodDef _RecoverableExceptionModuleMethods[] = {

#ifdef WITH_RMI

  { "_connect", (PyCFunction)pStub_RecoverableException__connect,
  (METH_VARARGS | METH_KEYWORDS),
"\
_connect( in string url)\n\
RETURNS\n\
   ( out sidlx.rmi.RecoverableException self)\n\
RAISES\n\
...
static PyMethodDef _RecoverableExceptionObjectMethods[] = {
  { "_exec", (PyCFunction)pStub_RecoverableException__exec,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Select and execute a method by name"
  ...
  { "_getURL", (PyCFunction)pStub_RecoverableException__getURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
_getURL()\n\
RETURNS\n\
...
Get the URL of the Implementation of this object (for RMI)"
  ...
  { "_isLocal", (PyCFunction)pStub_RecoverableException__isLocal,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isLocal()\n\
RETURNS\n\
...
TRUE if this object is local, false if remote"
  ...
  { "_isRemote", (PyCFunction)pStub_RecoverableException__isRemote,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isRemote()\n\
RETURNS\n\
...
TRUE if this object is remote, false if local"
  ...
  { "_set_hooks", (PyCFunction)pStub_RecoverableException__set_hooks,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyTypeObject _sidlx_rmi_RecoverableExceptionType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "sidlx.rmi.RecoverableException.RecoverableException", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
  ...
  "\
\
 EXCEPTION DEFINITIONS FOR SIMHANDLE BELOW THIS LINE------------------------------", /* tp_doc */
  0,      /* tp_traverse */
  0,       /* tp_clear */
  0,       /* tp_richcompare */
  0,       /* tp_weaklistoffset */
  0,       /* tp_iter */
  0,       /* tp_iternext */
  _RecoverableExceptionObjectMethods, /* tp_methods */
  0,       /* tp_members */
  0,       /* tp_getset */
  0,       /* tp_base */
  0,       /* tp_dict */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  sidlx_rmi_RecoverableException_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};
...
sidlx_rmi_RecoverableException__wrap                                          \
  ...
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_RecoverableExceptionType.tp_new(                      \
      &_sidlx_rmi_RecoverableExceptionType, NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
sidlx_rmi_RecoverableException_PyType                                         \
  ...
  Py_INCREF(&_sidlx_rmi_RecoverableExceptionType);
  return &_sidlx_rmi_RecoverableExceptionType;
}
...
sidlx_rmi_RecoverableException__convert                                       \
  ...
  *sidlobj = sidl_Cast(obj, "sidlx.rmi.RecoverableException");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) sidlx.rmi.RecoverableException");
    return 0;
  }
  return 1;
}
...
{
  struct sidlx_rmi_RecoverableException__object *sidlobj = NULL;
  if (sidlx_rmi_RecoverableException__convert(pyobj, &sidlobj)) {
...
{
  struct sidlx_rmi_RecoverableException__object *sidlobj = (struct            \
    sidlx_rmi_RecoverableException__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = sidlx_rmi_RecoverableException__wrap(sidlobj);
  return (*dest == NULL);
}
...
void
initRecoverableException(void) {
  PyObject *module, *dict, *c_api;
  PyObject *_exceptionBases, *_exceptionDict, *_exceptionName;
  static void *ExternalAPI[sidlx_rmi_RecoverableException__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  module = Py_InitModule3("RecoverableException",                             \
    _RecoverableExceptionModuleMethods, "\
\
 EXCEPTION DEFINITIONS FOR SIMHANDLE BELOW THIS LINE------------------------------"
  );
  dict = PyModule_GetDict(module);
  ExternalAPI[sidlx_rmi_RecoverableException__wrap_NUM] = (                   \
    void*)sidlx_rmi_RecoverableException__wrap;
  ExternalAPI[sidlx_rmi_RecoverableException__convert_NUM] = (                \
    void*)sidlx_rmi_RecoverableException__convert;
  ExternalAPI[sidlx_rmi_RecoverableException__convert_python_array_NUM] = (   \
    void*)sidlx_rmi_RecoverableException__convert_python_array;
  ExternalAPI[sidlx_rmi_RecoverableException__convert_sidl_array_NUM] = (     \
    void*)sidlx_rmi_RecoverableException__convert_sidl_array;
  ExternalAPI[sidlx_rmi_RecoverableException__weakRef_NUM] = (                \
    void*)sidlx_rmi_RecoverableException__weakRef;
  ExternalAPI[sidlx_rmi_RecoverableException_deref_NUM] = (                   \
    void*)sidlx_rmi_RecoverableException_deref;
  ExternalAPI[sidlx_rmi_RecoverableException__newRef_NUM] = (                 \
    void*)sidlx_rmi_RecoverableException__newRef;
  ExternalAPI[sidlx_rmi_RecoverableException__addRef_NUM] = (                 \
    void*)sidlx_rmi_RecoverableException__addRef;
  ExternalAPI[sidlx_rmi_RecoverableException_PyType_NUM] = (                  \
    void*)sidlx_rmi_RecoverableException_PyType;
#ifdef WITH_RMI
  ExternalAPI[sidlx_rmi_RecoverableException__connectI_NUM] = (               \
    void*)sidlx_rmi_RecoverableException__connectI;
#endif /*WITH_RMI*/
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  Py_INCREF(Py_None);
  ExternalAPI[sidlx_rmi_RecoverableException__type_NUM] = Py_None;
  ...
  sidl_rmi_ProtocolException__import();
  _sidlx_rmi_RecoverableExceptionType.tp_base =                               \
    sidl_rmi_ProtocolException_PyType();
  _sidlx_rmi_RecoverableExceptionType.tp_bases = PyTuple_New(1);
  PyTuple_SetItem(_sidlx_rmi_RecoverableExceptionType.tp_bases,0, (PyObject   \
    *)sidl_rmi_ProtocolException_PyType());
  if (PyType_Ready(&_sidlx_rmi_RecoverableExceptionType) < 0) {
    PyErr_Print();
    fprintf(stderr, "PyType_Ready on sidlx.rmi.RecoverableException           \
      failed.\n");
    return;
  }
  Py_INCREF(&_sidlx_rmi_RecoverableExceptionType);
  PyDict_SetItemString(dict, "RecoverableException", (PyObject                \
    *)&_sidlx_rmi_RecoverableExceptionType);
  ...
  sidl_rmi_ConnectRegistry_registerConnect("sidlx.rmi.RecoverableException", (\
    void*)sidlx_rmi_RecoverableException__IHConnect, &throwaway_exception);
