...
static char* remote_sidlx_rmi_SimHandle__getURL(
  struct sidlx_rmi_SimHandle__object* self, struct                            \
    sidl_BaseInterface__object* *_ex)
{
...
static PyObject *
pStub_SimHandle__connect(PyObject *_ignored, PyObject *_args, PyObject        \
  *_kwdict) {
...
static struct sidlx_rmi_SimHandle__sepv *_sepv = NULL;
...
_loadClassImpl(void) {
  if (!_implEPV) {
      ...
      if (dll) {
        ...
        if (!throwaway_exception && _extFunc) {
          ...
          errmsg = sidl_String_concat3(
            "babel: The shared library containing SIDL type sidlx.rmi.SimHandle, ",
            name,
            ", was loaded but is missing a required symbol (sidlx_rmi_SimHandle__externals).");
          sidl_String_free(name);
        }
        sidl_DLL_deleteRef(dll, &throwaway_exception);
      }
      else {
        errmsg = sidl_String_strdup("babel: Unable to find or load a shared library containing the implementation of SIDL type sidlx.rmi.SimHandle. To get more debugging information trying setting the SIDL_DEBUG_DLOPEN environment variable and rerunning.");
      }
    }
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    ...
    if (!_implEPV) {
      ...
      else PyErr_SetString(PyExc_RuntimeError, "Unexpected error loading SIDL implementation for sidlx.rmi.SimHandle.");
...
static PyObject *
pStub_SimHandle__isLocal(PyObject *_self, PyObject *_args, PyObject *_kwdict) \
  {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimHandle__object *_self_ior =
    ((struct sidlx_rmi_SimHandle__object *)
...
static PyObject *
pStub_SimHandle__isRemote(PyObject *_self, PyObject *_args, PyObject          \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimHandle__object *_self_ior =
    ((struct sidlx_rmi_SimHandle__object *)
...
static PyObject *
pStub_SimHandle__set_hooks(PyObject *_self, PyObject *_args, PyObject         \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimHandle__object *_self_ior =
    ((struct sidlx_rmi_SimHandle__object *)
...
static PyObject *
pStub_SimHandle__set_hooks_static(PyObject *_ignored, PyObject *_args,        \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  sidl_bool enable = (sidl_bool) 0;
  struct sidl_BaseInterface__object *_exception = NULL;
...
static PyObject *
pStub_SimHandle_setCookie(PyObject *_ignored, PyObject *_args, PyObject       \
  *_kwdict) {
  PyObject *_return_value = NULL;
  ...
  if (_okay) {
    ...
    sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
    (*(_sepv->f_setCookie))(cookie, &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
...
static int
sidlx_rmi_SimHandle_createCast(PyObject *self, PyObject *args, PyObject       \
  *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)sidlx_rmi_SimHandle__convert, &optarg, &url, &implObj);
  if (_okay) {
...
static PyMethodDef _SimHandleModuleMethods[] = {
  { "setCookie", (PyCFunction)pStub_SimHandle_setCookie,
...
"
  ...
  { "_set_hooks_static", (PyCFunction)pStub_SimHandle__set_hooks_static,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
{
  struct sidlx_rmi_SimHandle__object *sidlobj = NULL;
...
implementation of InstanceHandle using the Simhandle Protocol (written by Jim)"
  ...
  PyTuple_SetItem(_sidlx_rmi_SimHandleType.tp_bases,0, (PyObject              \
    *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_sidlx_rmi_SimHandleType.tp_bases,1, (PyObject              \
  ...
  Py_INCREF(&_sidlx_rmi_SimHandleType);
  PyDict_SetItemString(dict, "SimHandle", (PyObject                           \
    *)&_sidlx_rmi_SimHandleType);
