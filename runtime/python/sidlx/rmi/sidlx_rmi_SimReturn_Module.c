...
static char* remote_sidlx_rmi_SimReturn__getURL(
  struct sidlx_rmi_SimReturn__object* self, struct                            \
    sidl_BaseInterface__object* *_ex)
{
...
static PyObject *
pStub_SimReturn__connect(PyObject *_ignored, PyObject *_args, PyObject        \
  *_kwdict) {
...
_loadClassImpl(void) {
  if (!_implEPV) {
      ...
      if (dll) {
        ...
        if (!throwaway_exception && _extFunc) {
          ...
          errmsg = sidl_String_concat3(
            "babel: The shared library containing SIDL type sidlx.rmi.SimReturn, ",
            name,
            ", was loaded but is missing a required symbol (sidlx_rmi_SimReturn__externals).");
          sidl_String_free(name);
        }
        sidl_DLL_deleteRef(dll, &throwaway_exception);
      }
      else {
        errmsg = sidl_String_strdup("babel: Unable to find or load a shared library containing the implementation of SIDL type sidlx.rmi.SimReturn. To get more debugging information trying setting the SIDL_DEBUG_DLOPEN environment variable and rerunning.");
      }
    }
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    ...
    if (!_implEPV) {
      ...
      else PyErr_SetString(PyExc_RuntimeError, "Unexpected error loading SIDL implementation for sidlx.rmi.SimReturn.");
...
static PyObject *
pStub_SimReturn_SendReturn(PyObject *_self, PyObject *_args, PyObject         \
  *_kwdict) {
  PyObject *_return_value = NULL;
...
static PyObject *
pStub_SimReturn__isLocal(PyObject *_self, PyObject *_args, PyObject *_kwdict) \
  {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimReturn__object *_self_ior =
    ((struct sidlx_rmi_SimReturn__object *)
...
static PyObject *
pStub_SimReturn__isRemote(PyObject *_self, PyObject *_args, PyObject          \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimReturn__object *_self_ior =
    ((struct sidlx_rmi_SimReturn__object *)
...
static PyObject *
pStub_SimReturn__set_hooks(PyObject *_self, PyObject *_args, PyObject         \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimReturn__object *_self_ior =
    ((struct sidlx_rmi_SimReturn__object *)
...
static PyObject *
pStub_SimReturn_getMethodName(PyObject *_self, PyObject *_args, PyObject      \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimReturn__object *_self_ior =
    ((struct sidlx_rmi_SimReturn__object *)
...
static int
sidlx_rmi_SimReturn_createCast(PyObject *self, PyObject *args, PyObject       \
  *kwds) {
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)sidlx_rmi_SimReturn__convert, &optarg, &url, &implObj);
  if (_okay) {
...
{
  struct sidlx_rmi_SimReturn__object *sidlobj = NULL;
...
side after a method has been exececuted."
  ...
  PyTuple_SetItem(_sidlx_rmi_SimReturnType.tp_bases,0, (PyObject              \
    *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_sidlx_rmi_SimReturnType.tp_bases,1, (PyObject              \
  ...
  Py_INCREF(&_sidlx_rmi_SimReturnType);
  PyDict_SetItemString(dict, "SimReturn", (PyObject                           \
    *)&_sidlx_rmi_SimReturnType);
