/*
 * File:          sidlx_rmi_OutOfAddressesException_Module.c
 ...
 * sidl type sidlx.rmi.OutOfAddressesException.
 */
...
#define sidlx_rmi_OutOfAddressesException_INTERNAL 1
#include "sidlx_rmi_OutOfAddressesException_Module.h"
...
static void _loadDependentMods(void) {
  ...
  sidlx_rmi_OutOfAddressesException__import();
...
static void remote_sidlx_rmi_OutOfAddressesException__exec(
  struct sidlx_rmi_OutOfAddressesException__object* self,const char*          \
    methodName,
...
static void sidlx_rmi_OutOfAddressesException__init_remote_epv(void)
{
  ...
  epv->f__delete             =                                                \
    remote_sidlx_rmi_OutOfAddressesException__delete;
  epv->f__exec               = remote_sidlx_rmi_OutOfAddressesException__exec;
  epv->f__getURL             =                                                \
    remote_sidlx_rmi_OutOfAddressesException__getURL;
  epv->f__raddRef            =                                                \
...
static PyObject *
pStub_OutOfAddressesException__connect(PyObject *_ignored, PyObject *_args,   \
  PyObject *_kwdict) {
  ...
  if (_okay) {
...
#endif /* Python 2.4 or later */
    self = sidlx_rmi_OutOfAddressesException__remoteConnect(url,1,            \
      &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
    ...
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)sidlx_rmi_OutOfAddressesException__wrap, self);
    }
  }
...
#endif /*WITH_RMI*/
staticforward PyTypeObject _sidlx_rmi_OutOfAddressesExceptionType;

static const struct sidlx_rmi_OutOfAddressesException__external *_implEPV =   \
  NULL;
...
_loadClassImpl(void) {
  if (!_implEPV) {
    ...
    sidl_DLL dll = NULL;
    char *errmsg = NULL;
    struct sidlx_rmi_OutOfAddressesException__external*(*_extFunc)(void) =    \
      NULL;
    ...
    if (dll && sidl_DLL_loadLibrary(dll, "main:", TRUE, FALSE,                \
      &throwaway_exception)) {
      _extFunc = (struct sidlx_rmi_OutOfAddressesException__external*(*)(     \
        void))
    ...
    if (!_implEPV) {
      dll = sidl_Loader_findLibrary("sidlx.rmi.OutOfAddressesException",
      ...
      if (dll) {
        ...
        if (!throwaway_exception && _extFunc) {
          ...
          errmsg = sidl_String_concat3(
            "babel: The shared library containing SIDL type sidlx.rmi.OutOfAddressesException, ",
            name,
            ", was loaded but is missing a required symbol (sidlx_rmi_OutOfAddressesException__externals).");
          sidl_String_free(name);
        }
        sidl_DLL_deleteRef(dll, &throwaway_exception);
      }
      else {
        errmsg = sidl_String_strdup("babel: Unable to find or load a shared library containing the implementation of SIDL type sidlx.rmi.OutOfAddressesException. To get more debugging information trying setting the SIDL_DEBUG_DLOPEN environment variable and rerunning.");
      }
    }
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    ...
    if (!_implEPV) {
      ...
      else PyErr_SetString(PyExc_RuntimeError, "Unexpected error loading SIDL implementation for sidlx.rmi.OutOfAddressesException.");
...
static PyObject *
pStub_OutOfAddressesException__exec(PyObject *_self, PyObject *_args,         \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_OutOfAddressesException__object *_self_ior =
    ((struct sidlx_rmi_OutOfAddressesException__object *)
     sidl_Cast(_self, "sidlx.rmi.OutOfAddressesException"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a sidlx.rmi.OutOfAddressesException");
  }
  return _return_value;
}

static PyObject *
pStub_OutOfAddressesException__getURL(PyObject *_self, PyObject *_args,       \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_OutOfAddressesException__object *_self_ior =
    ((struct sidlx_rmi_OutOfAddressesException__object *)
...
static PyObject *
pStub_OutOfAddressesException__isLocal(PyObject *_self, PyObject *_args,      \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_OutOfAddressesException__object *_self_ior =
    ((struct sidlx_rmi_OutOfAddressesException__object *)
...
static PyObject *
pStub_OutOfAddressesException__isRemote(PyObject *_self, PyObject *_args,     \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_OutOfAddressesException__object *_self_ior =
    ((struct sidlx_rmi_OutOfAddressesException__object *)
...
static PyObject *
pStub_OutOfAddressesException__set_hooks(PyObject *_self, PyObject *_args,    \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_OutOfAddressesException__object *_self_ior =
    ((struct sidlx_rmi_OutOfAddressesException__object *)
...
static int
sidlx_rmi_OutOfAddressesException_createCast(PyObject *self, PyObject *args,  \
  PyObject *kwds) {
  struct sidlx_rmi_OutOfAddressesException__object *optarg = NULL;
  char* url = NULL;
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)sidlx_rmi_OutOfAddressesException__convert, &optarg, &url, &implObj);
  if (_okay) {
    if (!optarg && !url && !implObj) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      optarg = sidlx_rmi_OutOfAddressesException__remoteCreate(url,           \
        &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
...
static PyMethodDef _OutOfAddressesExceptionModuleMethods[] = {

#ifdef WITH_RMI

  { "_connect", (PyCFunction)pStub_OutOfAddressesException__connect,
  (METH_VARARGS | METH_KEYWORDS),
"\
_connect( in string url)\n\
RETURNS\n\
   ( out sidlx.rmi.OutOfAddressesException self)\n\
RAISES\n\
...
static PyMethodDef _OutOfAddressesExceptionObjectMethods[] = {
  { "_exec", (PyCFunction)pStub_OutOfAddressesException__exec,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Select and execute a method by name"
  ...
  { "_getURL", (PyCFunction)pStub_OutOfAddressesException__getURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
_getURL()\n\
RETURNS\n\
...
Get the URL of the Implementation of this object (for RMI)"
  ...
  { "_isLocal", (PyCFunction)pStub_OutOfAddressesException__isLocal,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isLocal()\n\
RETURNS\n\
...
TRUE if this object is local, false if remote"
  ...
  { "_isRemote", (PyCFunction)pStub_OutOfAddressesException__isRemote,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isRemote()\n\
RETURNS\n\
...
TRUE if this object is remote, false if local"
  ...
  { "_set_hooks", (PyCFunction)pStub_OutOfAddressesException__set_hooks,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyTypeObject _sidlx_rmi_OutOfAddressesExceptionType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "sidlx.rmi.OutOfAddressesException.OutOfAddressesException", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
  ...
  "\
SIDL wrapper for the sidlx.rmi.OutOfAddressesException type.\
", /* tp_doc */
  0,      /* tp_traverse */
  0,       /* tp_clear */
  0,       /* tp_richcompare */
  ...
  0,       /* tp_iter */
  0,       /* tp_iternext */
  _OutOfAddressesExceptionObjectMethods, /* tp_methods */
  0,       /* tp_members */
  0,       /* tp_getset */
  0,       /* tp_base */
  0,       /* tp_dict */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  sidlx_rmi_OutOfAddressesException_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};

sidlx_rmi_OutOfAddressesException__wrap_RETURN
sidlx_rmi_OutOfAddressesException__wrap                                       \
  sidlx_rmi_OutOfAddressesException__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_OutOfAddressesExceptionType.tp_new(                   \
      &_sidlx_rmi_OutOfAddressesExceptionType, NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
sidlx_rmi_OutOfAddressesException__weakRef_RETURN
sidlx_rmi_OutOfAddressesException__weakRef                                    \
  sidlx_rmi_OutOfAddressesException__weakRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_OutOfAddressesExceptionType.tp_new(                   \
      &_sidlx_rmi_OutOfAddressesExceptionType, NULL, NULL);
...
sidlx_rmi_OutOfAddressesException_deref_RETURN
sidlx_rmi_OutOfAddressesException_deref                                       \
  sidlx_rmi_OutOfAddressesException_deref_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
sidlx_rmi_OutOfAddressesException__newRef_RETURN
sidlx_rmi_OutOfAddressesException__newRef                                     \
  sidlx_rmi_OutOfAddressesException__newRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_OutOfAddressesExceptionType.tp_new(                   \
      &_sidlx_rmi_OutOfAddressesExceptionType, NULL, NULL);
...
sidlx_rmi_OutOfAddressesException__addRef_RETURN
sidlx_rmi_OutOfAddressesException__addRef                                     \
  sidlx_rmi_OutOfAddressesException__addRef_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
sidlx_rmi_OutOfAddressesException_PyType_RETURN
sidlx_rmi_OutOfAddressesException_PyType                                      \
  sidlx_rmi_OutOfAddressesException_PyType_PROTO {
  Py_INCREF(&_sidlx_rmi_OutOfAddressesExceptionType);
  return &_sidlx_rmi_OutOfAddressesExceptionType;
}

sidlx_rmi_OutOfAddressesException__convert_RETURN
sidlx_rmi_OutOfAddressesException__convert                                    \
  sidlx_rmi_OutOfAddressesException__convert_PROTO {
  if (*sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
#if (PY_VERSION_HEX >= 0x02040000)
    Py_BEGIN_ALLOW_THREADS
  ...
  *sidlobj = sidl_Cast(obj, "sidlx.rmi.OutOfAddressesException");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) sidlx.rmi.OutOfAddressesException");
    return 0;
  }
  return 1;
}
...
{
  struct sidlx_rmi_OutOfAddressesException__object *sidlobj = NULL;
  if (sidlx_rmi_OutOfAddressesException__convert(pyobj, &sidlobj)) {
...
sidlx_rmi_OutOfAddressesException__convert_python_array_RETURN
sidlx_rmi_OutOfAddressesException__convert_python_array                       \
  sidlx_rmi_OutOfAddressesException__convert_python_array_PROTO {
  int result = 0;
  if (*sidlarray) {
#if (PY_VERSION_HEX >= 0x02040000)
    Py_BEGIN_ALLOW_THREADS
...
{
  struct sidlx_rmi_OutOfAddressesException__object *sidlobj = (struct         \
    sidlx_rmi_OutOfAddressesException__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = sidlx_rmi_OutOfAddressesException__wrap(sidlobj);
  return (*dest == NULL);
}

sidlx_rmi_OutOfAddressesException__convert_sidl_array_RETURN
sidlx_rmi_OutOfAddressesException__convert_sidl_array                         \
  sidlx_rmi_OutOfAddressesException__convert_sidl_array_PROTO {
  PyObject *pya = NULL;
  if (sidlarray) {
...
void
initOutOfAddressesException(void) {
  PyObject *module, *dict, *c_api;
  PyObject *_exceptionBases, *_exceptionDict, *_exceptionName;
  static void *ExternalAPI[sidlx_rmi_OutOfAddressesException__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  module = Py_InitModule("OutOfAddressesException",                           \
    _OutOfAddressesExceptionModuleMethods);
  dict = PyModule_GetDict(module);
  ExternalAPI[sidlx_rmi_OutOfAddressesException__wrap_NUM] = (                \
    void*)sidlx_rmi_OutOfAddressesException__wrap;
  ExternalAPI[sidlx_rmi_OutOfAddressesException__convert_NUM] = (             \
    void*)sidlx_rmi_OutOfAddressesException__convert;
  ExternalAPI[sidlx_rmi_OutOfAddressesException__convert_python_array_NUM] = (\
    void*)sidlx_rmi_OutOfAddressesException__convert_python_array;
  ExternalAPI[sidlx_rmi_OutOfAddressesException__convert_sidl_array_NUM] = (  \
    void*)sidlx_rmi_OutOfAddressesException__convert_sidl_array;
  ExternalAPI[sidlx_rmi_OutOfAddressesException__weakRef_NUM] = (             \
    void*)sidlx_rmi_OutOfAddressesException__weakRef;
  ExternalAPI[sidlx_rmi_OutOfAddressesException_deref_NUM] = (                \
    void*)sidlx_rmi_OutOfAddressesException_deref;
  ExternalAPI[sidlx_rmi_OutOfAddressesException__newRef_NUM] = (              \
    void*)sidlx_rmi_OutOfAddressesException__newRef;
  ExternalAPI[sidlx_rmi_OutOfAddressesException__addRef_NUM] = (              \
    void*)sidlx_rmi_OutOfAddressesException__addRef;
  ExternalAPI[sidlx_rmi_OutOfAddressesException_PyType_NUM] = (               \
    void*)sidlx_rmi_OutOfAddressesException_PyType;
#ifdef WITH_RMI
  ExternalAPI[sidlx_rmi_OutOfAddressesException__connectI_NUM] = (            \
    void*)sidlx_rmi_OutOfAddressesException__connectI;
#endif /*WITH_RMI*/
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  Py_INCREF(Py_None);
  ExternalAPI[sidlx_rmi_OutOfAddressesException__type_NUM] = Py_None;
  ...
  sidlx_rmi_RecoverableException__import();
  _sidlx_rmi_OutOfAddressesExceptionType.tp_base =                            \
    sidlx_rmi_RecoverableException_PyType();
  _sidlx_rmi_OutOfAddressesExceptionType.tp_bases = PyTuple_New(1);
  PyTuple_SetItem(_sidlx_rmi_OutOfAddressesExceptionType.tp_bases,0, (        \
    PyObject *)sidlx_rmi_RecoverableException_PyType());
  if (PyType_Ready(&_sidlx_rmi_OutOfAddressesExceptionType) < 0) {
    PyErr_Print();
    fprintf(stderr, "PyType_Ready on sidlx.rmi.OutOfAddressesException        \
      failed.\n");
    return;
  }
  Py_INCREF(&_sidlx_rmi_OutOfAddressesExceptionType);
  PyDict_SetItemString(dict, "OutOfAddressesException", (PyObject             \
    *)&_sidlx_rmi_OutOfAddressesExceptionType);
  ...
  PyDict_SetItemString(_exceptionDict, "__module__",
    PyString_InternFromString("sidlx.rmi.OutOfAddressesException"));
  _exceptionName = PyString_InternFromString("_Exception");
  sidlx_rmi_OutOfAddressesException__type = PyClass_New(_exceptionBases,      \
    _exceptionDict, _exceptionName);
  Py_XDECREF(_exceptionBases);
  Py_XDECREF(_exceptionDict);
  Py_XDECREF(_exceptionName);
  Py_XINCREF(sidlx_rmi_OutOfAddressesException__type);
  PyDict_SetItemString(dict, "_Exception",                                    \
    sidlx_rmi_OutOfAddressesException__type);
  ExternalAPI[sidlx_rmi_OutOfAddressesException__type_NUM] =                  \
    sidlx_rmi_OutOfAddressesException__type;
  /*
  ...
  sidl_rmi_ConnectRegistry_registerConnect(                                   \
    ...
    void*)sidlx_rmi_OutOfAddressesException__IHConnect, &throwaway_exception);
