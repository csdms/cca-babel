/*
 * File:          sidlx_rmi_TimeoutException_Module.c
 ...
 * sidl type sidlx.rmi.TimeoutException.
 */
...
#define sidlx_rmi_TimeoutException_INTERNAL 1
#include "sidlx_rmi_TimeoutException_Module.h"
...
static void _loadDependentMods(void) {
  ...
  sidlx_rmi_TimeoutException__import();
  ...
  struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    ...
    retobj = (struct sidlx_rmi_TimeoutException__object*) (                   \
      *bi->d_epv->f__cast)(bi->d_object, "sidlx.rmi.TimeoutException", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
    return retobj;
...
static struct sidlx_rmi_TimeoutException__object*
sidlx_rmi_TimeoutException__IHConnect(sidl_rmi_InstanceHandle instance,       \
  struct sidl_BaseInterface__object* *_ex)
{
  struct sidlx_rmi_TimeoutException__object* self = NULL;
  ...
  if (_okay) {
...
#endif /* Python 2.4 or later */
    self = sidlx_rmi_TimeoutException__remoteConnect(url,1,&_exception);
#if (PY_VERSION_HEX >= 0x02040000)
    ...
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)sidlx_rmi_TimeoutException__wrap, self);
    }
  }
...
#endif /*WITH_RMI*/
staticforward PyTypeObject _sidlx_rmi_TimeoutExceptionType;

static const struct sidlx_rmi_TimeoutException__external *_implEPV = NULL;
...
_loadClassImpl(void) {
  if (!_implEPV) {
    ...
    sidl_DLL dll = NULL;
    char *errmsg = NULL;
    struct sidlx_rmi_TimeoutException__external*(*_extFunc)(void) = NULL;
    ...
    if (dll && sidl_DLL_loadLibrary(dll, "main:", TRUE, FALSE,                \
      &throwaway_exception)) {
      _extFunc = (struct sidlx_rmi_TimeoutException__external*(*)(void))
        sidl_DLL_lookupSymbol(dll, "sidlx_rmi_TimeoutException__externals",   \
          &throwaway_exception);
    ...
    if (!_implEPV) {
      dll = sidl_Loader_findLibrary("sidlx.rmi.TimeoutException",
      ...
      if (dll) {
        ...
        if (!throwaway_exception && _extFunc) {
          ...
          errmsg = sidl_String_concat3(
            "babel: The shared library containing SIDL type sidlx.rmi.TimeoutException, ",
            name,
            ", was loaded but is missing a required symbol (sidlx_rmi_TimeoutException__externals).");
          sidl_String_free(name);
        }
        sidl_DLL_deleteRef(dll, &throwaway_exception);
      }
      else {
        errmsg = sidl_String_strdup("babel: Unable to find or load a shared library containing the implementation of SIDL type sidlx.rmi.TimeoutException. To get more debugging information trying setting the SIDL_DEBUG_DLOPEN environment variable and rerunning.");
      }
    }
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    ...
    if (!_implEPV) {
      ...
      else PyErr_SetString(PyExc_RuntimeError, "Unexpected error loading SIDL implementation for sidlx.rmi.TimeoutException.");
...
pStub_TimeoutException__exec(PyObject *_self, PyObject *_args, PyObject       \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_TimeoutException__object *_self_ior =
    ((struct sidlx_rmi_TimeoutException__object *)
     sidl_Cast(_self, "sidlx.rmi.TimeoutException"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a sidlx.rmi.TimeoutException");
  }
  return _return_value;
}
...
static int
sidlx_rmi_TimeoutException_createCast(PyObject *self, PyObject *args,         \
  PyObject *kwds) {
  struct sidlx_rmi_TimeoutException__object *optarg = NULL;
  char* url = NULL;
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)sidlx_rmi_TimeoutException__convert, &optarg, &url, &implObj);
  if (_okay) {
    if (!optarg && !url && !implObj) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      optarg = sidlx_rmi_TimeoutException__remoteCreate(url,&_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
...
RETURNS\n\
   ( out sidlx.rmi.TimeoutException self)\n\
RAISES\n\
...
static PyTypeObject _sidlx_rmi_TimeoutExceptionType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "sidlx.rmi.TimeoutException.TimeoutException", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
  ...
  "\
SIDL wrapper for the sidlx.rmi.TimeoutException type.\
", /* tp_doc */
  0,      /* tp_traverse */
  0,       /* tp_clear */
  0,       /* tp_richcompare */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  sidlx_rmi_TimeoutException_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};

sidlx_rmi_TimeoutException__wrap_RETURN
sidlx_rmi_TimeoutException__wrap sidlx_rmi_TimeoutException__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_TimeoutExceptionType.tp_new(                          \
      &_sidlx_rmi_TimeoutExceptionType, NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
sidlx_rmi_TimeoutException__weakRef_RETURN
sidlx_rmi_TimeoutException__weakRef sidlx_rmi_TimeoutException__weakRef_PROTO \
  {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_TimeoutExceptionType.tp_new(                          \
...
sidlx_rmi_TimeoutException_deref_RETURN
sidlx_rmi_TimeoutException_deref sidlx_rmi_TimeoutException_deref_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
sidlx_rmi_TimeoutException__newRef_RETURN
sidlx_rmi_TimeoutException__newRef sidlx_rmi_TimeoutException__newRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_TimeoutExceptionType.tp_new(                          \
      &_sidlx_rmi_TimeoutExceptionType, NULL, NULL);
...
sidlx_rmi_TimeoutException__addRef_RETURN
sidlx_rmi_TimeoutException__addRef sidlx_rmi_TimeoutException__addRef_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
sidlx_rmi_TimeoutException_PyType_RETURN
sidlx_rmi_TimeoutException_PyType sidlx_rmi_TimeoutException_PyType_PROTO {
  Py_INCREF(&_sidlx_rmi_TimeoutExceptionType);
  return &_sidlx_rmi_TimeoutExceptionType;
}

sidlx_rmi_TimeoutException__convert_RETURN
sidlx_rmi_TimeoutException__convert sidlx_rmi_TimeoutException__convert_PROTO \
  {
  if (*sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
#if (PY_VERSION_HEX >= 0x02040000)
  ...
  *sidlobj = sidl_Cast(obj, "sidlx.rmi.TimeoutException");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) sidlx.rmi.TimeoutException");
    return 0;
  }
  return 1;
}
...
{
  struct sidlx_rmi_TimeoutException__object *sidlobj = NULL;
  if (sidlx_rmi_TimeoutException__convert(pyobj, &sidlobj)) {
...
sidlx_rmi_TimeoutException__convert_python_array_RETURN
sidlx_rmi_TimeoutException__convert_python_array                              \
  sidlx_rmi_TimeoutException__convert_python_array_PROTO {
  int result = 0;
  if (*sidlarray) {
#if (PY_VERSION_HEX >= 0x02040000)
    Py_BEGIN_ALLOW_THREADS
  ...
  if (obj == Py_None) {
    ...
    if (pya) {
      if (PyArray_OBJECT == ((PyArrayObject *)pya)->descr->type_num) {
        ...
        {
            *sidlarray = (struct                                              \
              sidlx_rmi_TimeoutException__array*)sidl_interface__array_createRow
            (dimen, lower, upper);
...
{
  struct sidlx_rmi_TimeoutException__object *sidlobj = (struct                \
    sidlx_rmi_TimeoutException__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = sidlx_rmi_TimeoutException__wrap(sidlobj);
  return (*dest == NULL);
}

sidlx_rmi_TimeoutException__convert_sidl_array_RETURN
sidlx_rmi_TimeoutException__convert_sidl_array                                \
  sidlx_rmi_TimeoutException__convert_sidl_array_PROTO {
  PyObject *pya = NULL;
  if (sidlarray) {
...
initTimeoutException(void) {
  ...
  static void *ExternalAPI[sidlx_rmi_TimeoutException__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  module = Py_InitModule("TimeoutException", _TimeoutExceptionModuleMethods);
  dict = PyModule_GetDict(module);
  ExternalAPI[sidlx_rmi_TimeoutException__wrap_NUM] = (                       \
    void*)sidlx_rmi_TimeoutException__wrap;
  ExternalAPI[sidlx_rmi_TimeoutException__convert_NUM] = (                    \
    void*)sidlx_rmi_TimeoutException__convert;
  ExternalAPI[sidlx_rmi_TimeoutException__convert_python_array_NUM] = (       \
    void*)sidlx_rmi_TimeoutException__convert_python_array;
  ExternalAPI[sidlx_rmi_TimeoutException__convert_sidl_array_NUM] = (         \
    void*)sidlx_rmi_TimeoutException__convert_sidl_array;
  ExternalAPI[sidlx_rmi_TimeoutException__weakRef_NUM] = (                    \
    void*)sidlx_rmi_TimeoutException__weakRef;
  ExternalAPI[sidlx_rmi_TimeoutException_deref_NUM] = (                       \
    void*)sidlx_rmi_TimeoutException_deref;
  ExternalAPI[sidlx_rmi_TimeoutException__newRef_NUM] = (                     \
    void*)sidlx_rmi_TimeoutException__newRef;
  ExternalAPI[sidlx_rmi_TimeoutException__addRef_NUM] = (                     \
    void*)sidlx_rmi_TimeoutException__addRef;
  ExternalAPI[sidlx_rmi_TimeoutException_PyType_NUM] = (                      \
    void*)sidlx_rmi_TimeoutException_PyType;
#ifdef WITH_RMI
  ExternalAPI[sidlx_rmi_TimeoutException__connectI_NUM] = (                   \
    void*)sidlx_rmi_TimeoutException__connectI;
#endif /*WITH_RMI*/
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  Py_INCREF(Py_None);
  ExternalAPI[sidlx_rmi_TimeoutException__type_NUM] = Py_None;
  ...
  sidlx_rmi_RecoverableException__import();
  _sidlx_rmi_TimeoutExceptionType.tp_base =                                   \
    sidlx_rmi_RecoverableException_PyType();
  _sidlx_rmi_TimeoutExceptionType.tp_bases = PyTuple_New(1);
  PyTuple_SetItem(_sidlx_rmi_TimeoutExceptionType.tp_bases,0, (PyObject       \
    *)sidlx_rmi_RecoverableException_PyType());
  if (PyType_Ready(&_sidlx_rmi_TimeoutExceptionType) < 0) {
    PyErr_Print();
    fprintf(stderr, "PyType_Ready on sidlx.rmi.TimeoutException failed.\n");
    return;
  }
  Py_INCREF(&_sidlx_rmi_TimeoutExceptionType);
  PyDict_SetItemString(dict, "TimeoutException", (PyObject                    \
    *)&_sidlx_rmi_TimeoutExceptionType);
  ...
  PyDict_SetItemString(_exceptionDict, "__module__",
    PyString_InternFromString("sidlx.rmi.TimeoutException"));
  _exceptionName = PyString_InternFromString("_Exception");
  sidlx_rmi_TimeoutException__type = PyClass_New(_exceptionBases,             \
    _exceptionDict, _exceptionName);
  Py_XDECREF(_exceptionBases);
  Py_XDECREF(_exceptionDict);
  Py_XDECREF(_exceptionName);
  Py_XINCREF(sidlx_rmi_TimeoutException__type);
  PyDict_SetItemString(dict, "_Exception", sidlx_rmi_TimeoutException__type);
  ExternalAPI[sidlx_rmi_TimeoutException__type_NUM] =                         \
    sidlx_rmi_TimeoutException__type;
  /*
  ...
  if (!PyDict_GetItemString(dict, "Exception")) {
    Py_XINCREF(sidlx_rmi_TimeoutException__type);
    PyDict_SetItemString(dict, "Exception", sidlx_rmi_TimeoutException__type);
  }
  ...
  sidl_rmi_ConnectRegistry_registerConnect("sidlx.rmi.TimeoutException", (    \
    void*)sidlx_rmi_TimeoutException__IHConnect, &throwaway_exception);
