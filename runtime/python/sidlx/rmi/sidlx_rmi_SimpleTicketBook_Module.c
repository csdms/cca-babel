/*
 * File:          sidlx_rmi_SimpleTicketBook_Module.c
 ...
 * sidl type sidlx.rmi.SimpleTicketBook.
 */
...
#define sidlx_rmi_SimpleTicketBook_INTERNAL 1
#include "sidlx_rmi_SimpleTicketBook_Module.h"
...
static void sidlx_rmi_SimpleTicketBook__init_remote_epv(void)
{
  ...
  struct sidl_rmi_TicketBook__epv*        e3  =                               \
    &s_rem_epv__sidl_rmi_ticketbook;

  epv->f__cast                      = remote_sidlx_rmi_SimpleTicketBook__cast;
  epv->f__delete                    =                                         \
    remote_sidlx_rmi_SimpleTicketBook__delete;
  epv->f__exec                      = remote_sidlx_rmi_SimpleTicketBook__exec;
  epv->f__getURL                    =                                         \
    remote_sidlx_rmi_SimpleTicketBook__getURL;
  epv->f__raddRef                   =                                         \
  ...
  e3->f__exec                 = (void (*)(void*,const char*,struct            \
    sidl_rmi_Call__object*,struct sidl_rmi_Return__object*,struct             \
    sidl_BaseInterface__object **)) epv->f__exec;
  e3->f_insertWithID          = (void (*)(void*,struct                        \
  ...
  e3->f_test                  = (sidl_bool (*)(void*,struct                   \
    sidl_BaseInterface__object **)) epv->f_test;
  e3->f_createEmptyTicketBook = (struct sidl_rmi_TicketBook__object* (*)(     \
    void*,struct sidl_BaseInterface__object **)) epv->f_createEmptyTicketBook;
  ...
  struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    ...
    retobj = (struct sidlx_rmi_SimpleTicketBook__object*) (                   \
      *bi->d_epv->f__cast)(bi->d_object, "sidlx.rmi.SimpleTicketBook", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
    return retobj;
...
static PyObject *
pStub_SimpleTicketBook__connect(PyObject *_ignored, PyObject *_args, PyObject \
  *_kwdict) {
  ...
  if (_okay) {
...
#endif /* Python 2.4 or later */
    self = sidlx_rmi_SimpleTicketBook__remoteConnect(url,1,&_exception);
#if (PY_VERSION_HEX >= 0x02040000)
    ...
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)sidlx_rmi_SimpleTicketBook__wrap, self);
    }
  }
...
#endif /*WITH_RMI*/
staticforward PyTypeObject _sidlx_rmi_SimpleTicketBookType;

static const struct sidlx_rmi_SimpleTicketBook__external *_implEPV = NULL;
...
_loadClassImpl(void) {
  if (!_implEPV) {
    ...
    sidl_DLL dll = NULL;
    char *errmsg = NULL;
    struct sidlx_rmi_SimpleTicketBook__external*(*_extFunc)(void) = NULL;
    ...
    if (dll && sidl_DLL_loadLibrary(dll, "main:", TRUE, FALSE,                \
      &throwaway_exception)) {
      _extFunc = (struct sidlx_rmi_SimpleTicketBook__external*(*)(void))
        sidl_DLL_lookupSymbol(dll, "sidlx_rmi_SimpleTicketBook__externals",   \
          &throwaway_exception);
    ...
    if (!_implEPV) {
      dll = sidl_Loader_findLibrary("sidlx.rmi.SimpleTicketBook",
      ...
      if (dll) {
        ...
        if (!throwaway_exception && _extFunc) {
          ...
          errmsg = sidl_String_concat3(
            "babel: The shared library containing SIDL type sidlx.rmi.SimpleTicketBook, ",
            name,
            ", was loaded but is missing a required symbol (sidlx_rmi_SimpleTicketBook__externals).");
          sidl_String_free(name);
        }
        sidl_DLL_deleteRef(dll, &throwaway_exception);
      }
      else {
        errmsg = sidl_String_strdup("babel: Unable to find or load a shared library containing the implementation of SIDL type sidlx.rmi.SimpleTicketBook. To get more debugging information trying setting the SIDL_DEBUG_DLOPEN environment variable and rerunning.");
      }
    }
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    ...
    if (!_implEPV) {
      ...
      else PyErr_SetString(PyExc_RuntimeError, "Unexpected error loading SIDL implementation for sidlx.rmi.SimpleTicketBook.");
...
static PyObject *
pStub_SimpleTicketBook__exec(PyObject *_self, PyObject *_args, PyObject       \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimpleTicketBook__object *_self_ior =
    ((struct sidlx_rmi_SimpleTicketBook__object *)
     sidl_Cast(_self, "sidlx.rmi.SimpleTicketBook"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a sidlx.rmi.SimpleTicketBook");
  }
  return _return_value;
}

static PyObject *
pStub_SimpleTicketBook__getURL(PyObject *_self, PyObject *_args, PyObject     \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimpleTicketBook__object *_self_ior =
    ((struct sidlx_rmi_SimpleTicketBook__object *)
...
static PyObject *
pStub_SimpleTicketBook__isLocal(PyObject *_self, PyObject *_args, PyObject    \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimpleTicketBook__object *_self_ior =
    ((struct sidlx_rmi_SimpleTicketBook__object *)
...
static PyObject *
pStub_SimpleTicketBook__isRemote(PyObject *_self, PyObject *_args, PyObject   \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimpleTicketBook__object *_self_ior =
    ((struct sidlx_rmi_SimpleTicketBook__object *)
...
static PyObject *
pStub_SimpleTicketBook__set_hooks(PyObject *_self, PyObject *_args, PyObject  \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimpleTicketBook__object *_self_ior =
    ((struct sidlx_rmi_SimpleTicketBook__object *)
...
static int
sidlx_rmi_SimpleTicketBook_createCast(PyObject *self, PyObject *args,         \
  PyObject *kwds) {
  struct sidlx_rmi_SimpleTicketBook__object *optarg = NULL;
  char* url = NULL;
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)sidlx_rmi_SimpleTicketBook__convert, &optarg, &url, &implObj);
  if (_okay) {
    if (!optarg && !url && !implObj) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      optarg = sidlx_rmi_SimpleTicketBook__remoteCreate(url,&_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
...
static PyMethodDef _SimpleTicketBookModuleMethods[] = {

#ifdef WITH_RMI

  { "_connect", (PyCFunction)pStub_SimpleTicketBook__connect,
  (METH_VARARGS | METH_KEYWORDS),
"\
_connect( in string url)\n\
RETURNS\n\
   ( out sidlx.rmi.SimpleTicketBook self)\n\
RAISES\n\
...
static PyMethodDef _SimpleTicketBookObjectMethods[] = {
  { "_exec", (PyCFunction)pStub_SimpleTicketBook__exec,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Select and execute a method by name"
  ...
  { "_getURL", (PyCFunction)pStub_SimpleTicketBook__getURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
_getURL()\n\
RETURNS\n\
...
Get the URL of the Implementation of this object (for RMI)"
  ...
  { "_isLocal", (PyCFunction)pStub_SimpleTicketBook__isLocal,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isLocal()\n\
RETURNS\n\
...
TRUE if this object is local, false if remote"
  ...
  { "_isRemote", (PyCFunction)pStub_SimpleTicketBook__isRemote,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isRemote()\n\
RETURNS\n\
...
TRUE if this object is remote, false if local"
  ...
  { "_set_hooks", (PyCFunction)pStub_SimpleTicketBook__set_hooks,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyTypeObject _sidlx_rmi_SimpleTicketBookType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "sidlx.rmi.SimpleTicketBook.SimpleTicketBook", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
  ...
  "\
SIDL wrapper for the sidlx.rmi.SimpleTicketBook type.\
", /* tp_doc */
  0,      /* tp_traverse */
  0,       /* tp_clear */
  0,       /* tp_richcompare */
  ...
  0,       /* tp_iter */
  0,       /* tp_iternext */
  _SimpleTicketBookObjectMethods, /* tp_methods */
  0,       /* tp_members */
  0,       /* tp_getset */
  0,       /* tp_base */
  0,       /* tp_dict */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  sidlx_rmi_SimpleTicketBook_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};

sidlx_rmi_SimpleTicketBook__wrap_RETURN
sidlx_rmi_SimpleTicketBook__wrap sidlx_rmi_SimpleTicketBook__wrap_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_SimpleTicketBookType.tp_new(                          \
      &_sidlx_rmi_SimpleTicketBookType, NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
sidlx_rmi_SimpleTicketBook__weakRef sidlx_rmi_SimpleTicketBook__weakRef_PROTO \
  {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_SimpleTicketBookType.tp_new(                          \
...
sidlx_rmi_SimpleTicketBook_deref sidlx_rmi_SimpleTicketBook_deref_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
sidlx_rmi_SimpleTicketBook__newRef sidlx_rmi_SimpleTicketBook__newRef_PROTO {
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_SimpleTicketBookType.tp_new(                          \
      &_sidlx_rmi_SimpleTicketBookType, NULL, NULL);
...
sidlx_rmi_SimpleTicketBook__addRef sidlx_rmi_SimpleTicketBook__addRef_PROTO {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
sidlx_rmi_SimpleTicketBook_PyType sidlx_rmi_SimpleTicketBook_PyType_PROTO {
  Py_INCREF(&_sidlx_rmi_SimpleTicketBookType);
  return &_sidlx_rmi_SimpleTicketBookType;
}

sidlx_rmi_SimpleTicketBook__convert_RETURN
sidlx_rmi_SimpleTicketBook__convert sidlx_rmi_SimpleTicketBook__convert_PROTO \
  {
  if (*sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
#if (PY_VERSION_HEX >= 0x02040000)
  ...
  *sidlobj = sidl_Cast(obj, "sidlx.rmi.SimpleTicketBook");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) sidlx.rmi.SimpleTicketBook");
    return 0;
  }
  return 1;
}
...
{
  struct sidlx_rmi_SimpleTicketBook__object *sidlobj = NULL;
  if (sidlx_rmi_SimpleTicketBook__convert(pyobj, &sidlobj)) {
  ...
  if (obj == Py_None) {
    ...
    if (pya) {
      if (PyArray_OBJECT == ((PyArrayObject *)pya)->descr->type_num) {
        ...
        {
            *sidlarray = (struct                                              \
              sidlx_rmi_SimpleTicketBook__array*)sidl_interface__array_createRow
            (dimen, lower, upper);
...
{
  struct sidlx_rmi_SimpleTicketBook__object *sidlobj = (struct                \
    sidlx_rmi_SimpleTicketBook__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = sidlx_rmi_SimpleTicketBook__wrap(sidlobj);
  return (*dest == NULL);
}
...
void
initSimpleTicketBook(void) {
  PyObject *module, *dict, *c_api;
  static void *ExternalAPI[sidlx_rmi_SimpleTicketBook__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  module = Py_InitModule("SimpleTicketBook", _SimpleTicketBookModuleMethods);
  dict = PyModule_GetDict(module);
  ExternalAPI[sidlx_rmi_SimpleTicketBook__wrap_NUM] = (                       \
    void*)sidlx_rmi_SimpleTicketBook__wrap;
  ExternalAPI[sidlx_rmi_SimpleTicketBook__convert_NUM] = (                    \
    void*)sidlx_rmi_SimpleTicketBook__convert;
  ExternalAPI[sidlx_rmi_SimpleTicketBook__convert_python_array_NUM] = (       \
    void*)sidlx_rmi_SimpleTicketBook__convert_python_array;
  ExternalAPI[sidlx_rmi_SimpleTicketBook__convert_sidl_array_NUM] = (         \
    void*)sidlx_rmi_SimpleTicketBook__convert_sidl_array;
  ExternalAPI[sidlx_rmi_SimpleTicketBook__weakRef_NUM] = (                    \
    void*)sidlx_rmi_SimpleTicketBook__weakRef;
  ExternalAPI[sidlx_rmi_SimpleTicketBook_deref_NUM] = (                       \
    void*)sidlx_rmi_SimpleTicketBook_deref;
  ExternalAPI[sidlx_rmi_SimpleTicketBook__newRef_NUM] = (                     \
    void*)sidlx_rmi_SimpleTicketBook__newRef;
  ExternalAPI[sidlx_rmi_SimpleTicketBook__addRef_NUM] = (                     \
    void*)sidlx_rmi_SimpleTicketBook__addRef;
  ExternalAPI[sidlx_rmi_SimpleTicketBook_PyType_NUM] = (                      \
    void*)sidlx_rmi_SimpleTicketBook_PyType;
#ifdef WITH_RMI
  ExternalAPI[sidlx_rmi_SimpleTicketBook__connectI_NUM] = (                   \
    void*)sidlx_rmi_SimpleTicketBook__connectI;
#endif /*WITH_RMI*/
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  sidl_BaseClass__import();
  sidl_rmi_TicketBook__import();
  _sidlx_rmi_SimpleTicketBookType.tp_base = sidl_BaseClass_PyType();
  _sidlx_rmi_SimpleTicketBookType.tp_bases = PyTuple_New(2);
  PyTuple_SetItem(_sidlx_rmi_SimpleTicketBookType.tp_bases,0, (PyObject       \
    *)sidl_BaseClass_PyType());
  PyTuple_SetItem(_sidlx_rmi_SimpleTicketBookType.tp_bases,1, (PyObject       \
    *)sidl_rmi_TicketBook_PyType());
  if (PyType_Ready(&_sidlx_rmi_SimpleTicketBookType) < 0) {
    PyErr_Print();
    fprintf(stderr, "PyType_Ready on sidlx.rmi.SimpleTicketBook failed.\n");
    return;
  }
  Py_INCREF(&_sidlx_rmi_SimpleTicketBookType);
  PyDict_SetItemString(dict, "SimpleTicketBook", (PyObject                    \
    *)&_sidlx_rmi_SimpleTicketBookType);

#ifdef WITH_RMI


  sidl_rmi_ConnectRegistry_registerConnect("sidlx.rmi.SimpleTicketBook", (    \
    void*)sidlx_rmi_SimpleTicketBook__IHConnect, &throwaway_exception);
