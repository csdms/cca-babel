  ...
  *_ex = NULL;
  {
    ...
    sidl_rmi_Invocation_packBool( _inv, "value", *value, _ex);SIDL_CHECK(     \
      *_ex);
  ...
  *_ex = NULL;
  {
    ...
    /* pack in and inout arguments */
    sidl_rmi_Invocation_packString( _inv, "key", key, _ex);SIDL_CHECK(*_ex);
    sidl_rmi_Invocation_packChar( _inv, "value", *value, _ex);SIDL_CHECK(     \
      *_ex);
  ...
  *_ex = NULL;
  {
    ...
    /* pack in and inout arguments */
    sidl_rmi_Invocation_packString( _inv, "key", key, _ex);SIDL_CHECK(*_ex);
    sidl_rmi_Invocation_packLong( _inv, "value", *value, _ex);SIDL_CHECK(     \
      *_ex);
  ...
  sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  ...
  instance = sidl_rmi_ProtocolFactory_connectInstance(url,                    \
    "sidlx.rmi.SimCall", ar, _ex ); SIDL_CHECK(*_ex);
...
_loadClassImpl(void) {
  if (!_implEPV) {
      ...
      if (dll) {
        ...
        if (!throwaway_exception && _extFunc) {
          ...
          errmsg = sidl_String_concat3(
            "babel: The shared library containing SIDL type sidlx.rmi.SimCall, ",
            name,
            ", was loaded but is missing a required symbol (sidlx_rmi_SimCall__externals).");
          sidl_String_free(name);
        }
        sidl_DLL_deleteRef(dll, &throwaway_exception);
      }
      else {
        errmsg = sidl_String_strdup("babel: Unable to find or load a shared library containing the implementation of SIDL type sidlx.rmi.SimCall. To get more debugging information trying setting the SIDL_DEBUG_DLOPEN environment variable and rerunning.");
      }
    }
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    ...
    if (!_implEPV) {
      ...
      else PyErr_SetString(PyExc_RuntimeError, "Unexpected error loading SIDL implementation for sidlx.rmi.SimCall.");
...
pStub_SimCall_init(PyObject *_self, PyObject *_args, PyObject *_kwdict) {
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      (*(_self_ior->d_epv->f_init))(_self_ior, sock, cookie, &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      if (_exception) {
        struct sidlx_rmi_UnauthorizedCallException__object *_ex0;
        struct sidl_RuntimeException__object *_ex1;
        if ((_ex0 = (struct sidlx_rmi_UnauthorizedCallException__object *)
        sidl_PyExceptionCast(_exception,                                      \
          "sidlx.rmi.UnauthorizedCallException"))) {
          struct sidl_BaseInterface__object *throwaway_exception;
          PyObject *_obj = sidlx_rmi_UnauthorizedCallException__wrap(_ex0);
          PyObject *_eargs = PyTuple_New(1);
          PyTuple_SetItem(_eargs, 0, _obj);
          _obj = PyObject_CallObject(                                         \
            sidlx_rmi_UnauthorizedCallException__type, _eargs);
          PyErr_SetObject(sidlx_rmi_UnauthorizedCallException__type, _obj);
          Py_XDECREF(_obj);
#if (PY_VERSION_HEX >= 0x02040000)
          Py_BEGIN_ALLOW_THREADS
          sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
        ...
        else if ((_ex1 = (struct sidl_RuntimeException__object *)
        sidl_PyExceptionCast(_exception, "sidl.RuntimeException"))) {
          struct sidl_BaseInterface__object *throwaway_exception;
          PyObject *_obj = sidl_RuntimeException__wrap(_ex1);
          PyObject *_eargs = PyTuple_New(1);
          PyTuple_SetItem(_eargs, 0, _obj);
          _obj = PyObject_CallObject(sidl_RuntimeException__type, _eargs);
          PyErr_SetObject(sidl_RuntimeException__type, _obj);
...
{
  struct sidlx_rmi_SimCall__object *sidlobj = NULL;
