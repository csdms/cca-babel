/*
 * File:          sidlx_rmi_NetworkUnreachableException_Module.c
 ...
 * sidl type sidlx.rmi.NetworkUnreachableException.
 */
...
#define sidlx_rmi_NetworkUnreachableException_INTERNAL 1
#include "sidlx_rmi_NetworkUnreachableException_Module.h"
...
sidlx_rmi_NetworkUnreachableException__connectI(const char * url, sidl_bool   \
    ...
    if (!cmp) {
      ...
      if (!cmp) {
        ...
        if (!cmp) {
          (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
          cast = ((struct                                                     \
            sidlx_rmi_NetworkUnreachableException__object*)self);
          return cast;
        }
      }
    }
...
static PyObject *
pStub_NetworkUnreachableException__connect(PyObject *_ignored, PyObject       \
  ...
  if (_okay) {
...
#endif /* Python 2.4 or later */
    self = sidlx_rmi_NetworkUnreachableException__remoteConnect(url,1,        \
      &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
    ...
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)sidlx_rmi_NetworkUnreachableException__wrap, self);
    }
  }
...
#endif /*WITH_RMI*/
staticforward PyTypeObject _sidlx_rmi_NetworkUnreachableExceptionType;

static const struct sidlx_rmi_NetworkUnreachableException__external *_implEPV \
  = NULL;
...
_loadClassImpl(void) {
  if (!_implEPV) {
    ...
    sidl_DLL dll = NULL;
    char *errmsg = NULL;
    struct sidlx_rmi_NetworkUnreachableException__external*(*_extFunc)(void)  \
      = NULL;
    ...
    if (dll && sidl_DLL_loadLibrary(dll, "main:", TRUE, FALSE,                \
      &throwaway_exception)) {
      _extFunc = (struct sidlx_rmi_NetworkUnreachableException__external*(*)( \
        void))
    ...
    if (!_implEPV) {
      dll = sidl_Loader_findLibrary("sidlx.rmi.NetworkUnreachableException",
      ...
      if (dll) {
        ...
        if (!throwaway_exception && _extFunc) {
          ...
          errmsg = sidl_String_concat3(
            "babel: The shared library containing SIDL type sidlx.rmi.NetworkUnreachableException, ",
            name,
            ", was loaded but is missing a required symbol (sidlx_rmi_NetworkUnreachableException__externals).");
          sidl_String_free(name);
        }
        sidl_DLL_deleteRef(dll, &throwaway_exception);
      }
      else {
        errmsg = sidl_String_strdup("babel: Unable to find or load a shared library containing the implementation of SIDL type sidlx.rmi.NetworkUnreachableException. To get more debugging information trying setting the SIDL_DEBUG_DLOPEN environment variable and rerunning.");
      }
    }
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    ...
    if (!_implEPV) {
      ...
      else PyErr_SetString(PyExc_RuntimeError, "Unexpected error loading SIDL implementation for sidlx.rmi.NetworkUnreachableException.");
...
static PyObject *
pStub_NetworkUnreachableException__exec(PyObject *_self, PyObject *_args,     \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_NetworkUnreachableException__object *_self_ior =
    ((struct sidlx_rmi_NetworkUnreachableException__object *)
     sidl_Cast(_self, "sidlx.rmi.NetworkUnreachableException"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a sidlx.rmi.NetworkUnreachableException");
  }
  return _return_value;
}

static PyObject *
pStub_NetworkUnreachableException__getURL(PyObject *_self, PyObject *_args,   \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_NetworkUnreachableException__object *_self_ior =
    ((struct sidlx_rmi_NetworkUnreachableException__object *)
...
static PyObject *
pStub_NetworkUnreachableException__isLocal(PyObject *_self, PyObject *_args,  \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_NetworkUnreachableException__object *_self_ior =
    ((struct sidlx_rmi_NetworkUnreachableException__object *)
...
static PyObject *
pStub_NetworkUnreachableException__isRemote(PyObject *_self, PyObject *_args, \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_NetworkUnreachableException__object *_self_ior =
    ((struct sidlx_rmi_NetworkUnreachableException__object *)
...
static PyObject *
pStub_NetworkUnreachableException__set_hooks(PyObject *_self, PyObject *_args,\
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_NetworkUnreachableException__object *_self_ior =
    ((struct sidlx_rmi_NetworkUnreachableException__object *)
...
static int
sidlx_rmi_NetworkUnreachableException_createCast(PyObject *self, PyObject     \
  *args, PyObject *kwds) {
  struct sidlx_rmi_NetworkUnreachableException__object *optarg = NULL;
  char* url = NULL;
  ...
  int _okay = PyArg_ParseTupleAndKeywords(args, kwds, "|O&zO", _kwlist, (void \
    *)sidlx_rmi_NetworkUnreachableException__convert, &optarg, &url,          \
    &implObj);
  if (_okay) {
    if (!optarg && !url && !implObj) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      optarg = sidlx_rmi_NetworkUnreachableException__remoteCreate(url,       \
        &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
...
static PyMethodDef _NetworkUnreachableExceptionModuleMethods[] = {

#ifdef WITH_RMI

  { "_connect", (PyCFunction)pStub_NetworkUnreachableException__connect,
  (METH_VARARGS | METH_KEYWORDS),
"\
_connect( in string url)\n\
RETURNS\n\
   ( out sidlx.rmi.NetworkUnreachableException self)\n\
RAISES\n\
...
static PyMethodDef _NetworkUnreachableExceptionObjectMethods[] = {
  { "_exec", (PyCFunction)pStub_NetworkUnreachableException__exec,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Select and execute a method by name"
  ...
  { "_getURL", (PyCFunction)pStub_NetworkUnreachableException__getURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
_getURL()\n\
RETURNS\n\
...
Get the URL of the Implementation of this object (for RMI)"
  ...
  { "_isLocal", (PyCFunction)pStub_NetworkUnreachableException__isLocal,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isLocal()\n\
RETURNS\n\
...
TRUE if this object is local, false if remote"
  ...
  { "_isRemote", (PyCFunction)pStub_NetworkUnreachableException__isRemote,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isRemote()\n\
RETURNS\n\
...
TRUE if this object is remote, false if local"
  ...
  { "_set_hooks", (PyCFunction)pStub_NetworkUnreachableException__set_hooks,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyTypeObject _sidlx_rmi_NetworkUnreachableExceptionType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "sidlx.rmi.NetworkUnreachableException.NetworkUnreachableException", /*     \
    tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  ...
  "\
SIDL wrapper for the sidlx.rmi.NetworkUnreachableException type.\
", /* tp_doc */
  0,      /* tp_traverse */
  0,       /* tp_clear */
  0,       /* tp_richcompare */
  ...
  0,       /* tp_iter */
  0,       /* tp_iternext */
  _NetworkUnreachableExceptionObjectMethods, /* tp_methods */
  0,       /* tp_members */
  0,       /* tp_getset */
  0,       /* tp_base */
  0,       /* tp_dict */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  sidlx_rmi_NetworkUnreachableException_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};
...
sidlx_rmi_NetworkUnreachableException__wrap                                   \
  ...
  PyObject *result;
  if (sidlobj) {
    result = _sidlx_rmi_NetworkUnreachableExceptionType.tp_new(               \
      &_sidlx_rmi_NetworkUnreachableExceptionType, NULL, NULL);
    if (result) {
      if (sidl_Object_Init(
        (SPObject *)result,
...
sidlx_rmi_NetworkUnreachableException_PyType                                  \
  ...
  Py_INCREF(&_sidlx_rmi_NetworkUnreachableExceptionType);
  return &_sidlx_rmi_NetworkUnreachableExceptionType;
}
...
sidlx_rmi_NetworkUnreachableException__convert                                \
  ...
  *sidlobj = sidl_Cast(obj, "sidlx.rmi.NetworkUnreachableException");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) sidlx.rmi.NetworkUnreachableException");
    return 0;
  }
  return 1;
}
...
{
  struct sidlx_rmi_NetworkUnreachableException__object *sidlobj = NULL;
  if (sidlx_rmi_NetworkUnreachableException__convert(pyobj, &sidlobj)) {
...
{
  struct sidlx_rmi_NetworkUnreachableException__object *sidlobj = (struct     \
    sidlx_rmi_NetworkUnreachableException__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = sidlx_rmi_NetworkUnreachableException__wrap(sidlobj);
  return (*dest == NULL);
}
...
void
initNetworkUnreachableException(void) {
  PyObject *module, *dict, *c_api;
  PyObject *_exceptionBases, *_exceptionDict, *_exceptionName;
  static void *ExternalAPI[sidlx_rmi_NetworkUnreachableException__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  module = Py_InitModule("NetworkUnreachableException",                       \
    _NetworkUnreachableExceptionModuleMethods);
  dict = PyModule_GetDict(module);
  ExternalAPI[sidlx_rmi_NetworkUnreachableException__wrap_NUM] = (            \
    void*)sidlx_rmi_NetworkUnreachableException__wrap;
  ExternalAPI[sidlx_rmi_NetworkUnreachableException__convert_NUM] = (         \
    void*)sidlx_rmi_NetworkUnreachableException__convert;
  ExternalAPI[sidlx_rmi_NetworkUnreachableException__convert_python_array_NUM]\
    = (void*)sidlx_rmi_NetworkUnreachableException__convert_python_array;
  ExternalAPI[sidlx_rmi_NetworkUnreachableException__convert_sidl_array_NUM]  \
    = (void*)sidlx_rmi_NetworkUnreachableException__convert_sidl_array;
  ExternalAPI[sidlx_rmi_NetworkUnreachableException__weakRef_NUM] = (         \
    void*)sidlx_rmi_NetworkUnreachableException__weakRef;
  ExternalAPI[sidlx_rmi_NetworkUnreachableException_deref_NUM] = (            \
    void*)sidlx_rmi_NetworkUnreachableException_deref;
  ExternalAPI[sidlx_rmi_NetworkUnreachableException__newRef_NUM] = (          \
    void*)sidlx_rmi_NetworkUnreachableException__newRef;
  ExternalAPI[sidlx_rmi_NetworkUnreachableException__addRef_NUM] = (          \
    void*)sidlx_rmi_NetworkUnreachableException__addRef;
  ExternalAPI[sidlx_rmi_NetworkUnreachableException_PyType_NUM] = (           \
    void*)sidlx_rmi_NetworkUnreachableException_PyType;
#ifdef WITH_RMI
  ExternalAPI[sidlx_rmi_NetworkUnreachableException__connectI_NUM] = (        \
    void*)sidlx_rmi_NetworkUnreachableException__connectI;
#endif /*WITH_RMI*/
  import_SIDLObjA();
  if (PyErr_Occurred()) {
  ...
  Py_INCREF(Py_None);
  ExternalAPI[sidlx_rmi_NetworkUnreachableException__type_NUM] = Py_None;
  ...
  sidlx_rmi_UnrecoverableException__import();
  _sidlx_rmi_NetworkUnreachableExceptionType.tp_base =                        \
    sidlx_rmi_UnrecoverableException_PyType();
  _sidlx_rmi_NetworkUnreachableExceptionType.tp_bases = PyTuple_New(1);
  PyTuple_SetItem(_sidlx_rmi_NetworkUnreachableExceptionType.tp_bases,0, (    \
    PyObject *)sidlx_rmi_UnrecoverableException_PyType());
  if (PyType_Ready(&_sidlx_rmi_NetworkUnreachableExceptionType) < 0) {
    PyErr_Print();
    fprintf(stderr, "PyType_Ready on sidlx.rmi.NetworkUnreachableException    \
      failed.\n");
    return;
  }
  Py_INCREF(&_sidlx_rmi_NetworkUnreachableExceptionType);
  PyDict_SetItemString(dict, "NetworkUnreachableException", (PyObject         \
    *)&_sidlx_rmi_NetworkUnreachableExceptionType);
  ...
  PyDict_SetItemString(_exceptionDict, "__module__",
    PyString_InternFromString("sidlx.rmi.NetworkUnreachableException"));
  _exceptionName = PyString_InternFromString("_Exception");
  sidlx_rmi_NetworkUnreachableException__type = PyClass_New(_exceptionBases,  \
    _exceptionDict, _exceptionName);
  Py_XDECREF(_exceptionBases);
  Py_XDECREF(_exceptionDict);
  Py_XDECREF(_exceptionName);
  Py_XINCREF(sidlx_rmi_NetworkUnreachableException__type);
  PyDict_SetItemString(dict, "_Exception",                                    \
    sidlx_rmi_NetworkUnreachableException__type);
  ExternalAPI[sidlx_rmi_NetworkUnreachableException__type_NUM] =              \
    sidlx_rmi_NetworkUnreachableException__type;
  /*
  ...
  sidl_rmi_ConnectRegistry_registerConnect(                                   \
    ...
    void*)sidlx_rmi_NetworkUnreachableException__IHConnect,                   \
    &throwaway_exception);
