...
static void sidlx_rmi_SimpleServer__init_remote_epv(void)
{
  ...
  epv->f__raddRef                     =                                       \
    remote_sidlx_rmi_SimpleServer__raddRef;
  epv->f__isRemote                    =                                       \
    remote_sidlx_rmi_SimpleServer__isRemote;
  epv->f__set_hooks                   =                                       \
    remote_sidlx_rmi_SimpleServer__set_hooks;
...
_loadClassImpl(void) {
  if (!_implEPV) {
      ...
      if (dll) {
        ...
        if (!throwaway_exception && _extFunc) {
          ...
          errmsg = sidl_String_concat3(
            "babel: The shared library containing SIDL type sidlx.rmi.SimpleServer, ",
            name,
            ", was loaded but is missing a required symbol (sidlx_rmi_SimpleServer__externals).");
          sidl_String_free(name);
        }
        sidl_DLL_deleteRef(dll, &throwaway_exception);
      }
      else {
        errmsg = sidl_String_strdup("babel: Unable to find or load a shared library containing the implementation of SIDL type sidlx.rmi.SimpleServer. To get more debugging information trying setting the SIDL_DEBUG_DLOPEN environment variable and rerunning.");
      }
    }
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    ...
    if (!_implEPV) {
      ...
      else PyErr_SetString(PyExc_RuntimeError, "Unexpected error loading SIDL implementation for sidlx.rmi.SimpleServer.");
...
static PyObject *
pStub_SimpleServer_isRunning(PyObject *_self, PyObject *_args, PyObject       \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimpleServer__object *_self_ior =
    ((struct sidlx_rmi_SimpleServer__object *)
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      _return = (*(_self_ior->d_epv->f_isRunning))(_self_ior, &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
...
static PyObject *
pStub_SimpleServer_requestLocalPort(PyObject *_self, PyObject *_args,         \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimpleServer__object *_self_ior =
    ((struct sidlx_rmi_SimpleServer__object *)
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      _return = (*(_self_ior->d_epv->f_requestLocalPort))(_self_ior, port,    \
        &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
...
static PyObject *
pStub_SimpleServer_requestLocalPortInRange(PyObject *_self, PyObject *_args,  \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimpleServer__object *_self_ior =
    ((struct sidlx_rmi_SimpleServer__object *)
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      _return = (*(_self_ior->d_epv->f_requestLocalPortInRange))(_self_ior,   \
...
static PyObject *
pStub_SimpleServer_shutdownNoWait(PyObject *_self, PyObject *_args, PyObject  \
  *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_SimpleServer__object *_self_ior =
    ((struct sidlx_rmi_SimpleServer__object *)
  ...
  if (_self_ior) {
    ...
    if (_okay) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      (*(_self_ior->d_epv->f_shutdownNoWait))(_self_ior, &_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
...
get the network name of this computer"
  ...
  { "isRunning", (PyCFunction)pStub_SimpleServer_isRunning,
  (METH_VARARGS | METH_KEYWORDS),
"\
isRunning()\n\
RETURNS\n\
...
THIS WHEN THREAD SAFETY IS AN ISSUE."
  ...
  { "requestLocalPort", (PyCFunction)pStub_SimpleServer_requestLocalPort,
  (METH_VARARGS | METH_KEYWORDS),
"\
requestLocalPort( in int port)\n\
RETURNS\n\
   (bool _return)\n\
RAISES\n\
    sidl.RuntimeException\n\
...
Returns true iff request is satisfied."
  ...
  { "requestLocalPortInRange", (                                              \
    PyCFunction)pStub_SimpleServer_requestLocalPortInRange,
  (METH_VARARGS | METH_KEYWORDS),
"\
requestLocalPortInRange( in int minport,\n\
                         in int maxport)\n\
RETURNS\n\
   (bool _return)\n\
RAISES\n\
...
Cleanly shutdown the orb.  Method blocks until orb is fully shutdown."
  ...
  { "shutdownNoWait", (PyCFunction)pStub_SimpleServer_shutdownNoWait,
  (METH_VARARGS | METH_KEYWORDS),
"\
shutdownNoWait()\n\
RETURNS\n\
...
{
  struct sidlx_rmi_SimpleServer__object *sidlobj = NULL;
