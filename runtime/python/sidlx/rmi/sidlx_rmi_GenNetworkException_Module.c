 ...
 * sidl type sidlx.rmi.GenNetworkException.
 */
...
#define sidlx_rmi_GenNetworkException_INTERNAL 1
#include "sidlx_rmi_GenNetworkException_Module.h"
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    ...
    retobj = (struct sidlx_rmi_GenNetworkException__object*) (                \
      *bi->d_epv->f__cast)(bi->d_object, "sidlx.rmi.GenNetworkException",     \
      _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
...
static PyObject *
pStub_GenNetworkException__connect(PyObject *_ignored, PyObject *_args,       \
  PyObject *_kwdict) {
  ...
  if (_okay) {
...
#endif /* Python 2.4 or later */
    self = sidlx_rmi_GenNetworkException__remoteConnect(url,1,&_exception);
#if (PY_VERSION_HEX >= 0x02040000)
    ...
    if (_exception) {
      ...
      _return_value = Py_BuildValue(
        "O&",
        (void *)sidlx_rmi_GenNetworkException__wrap, self);
    }
  }
...
#endif /*WITH_RMI*/
staticforward PyTypeObject _sidlx_rmi_GenNetworkExceptionType;
...
_loadClassImpl(void) {
  if (!_implEPV) {
    ...
    sidl_DLL dll = NULL;
    char *errmsg = NULL;
    struct sidlx_rmi_GenNetworkException__external*(*_extFunc)(void) = NULL;
    ...
    if (dll && sidl_DLL_loadLibrary(dll, "main:", TRUE, FALSE,                \
      &throwaway_exception)) {
      _extFunc = (struct sidlx_rmi_GenNetworkException__external*(*)(void))
        sidl_DLL_lookupSymbol(dll, "sidlx_rmi_GenNetworkException__externals",\
          &throwaway_exception);
    ...
    if (!_implEPV) {
      dll = sidl_Loader_findLibrary("sidlx.rmi.GenNetworkException",
        "ior/impl", sidl_Scope_SCLSCOPE,
        sidl_Resolve_SCLRESOLVE, &throwaway_exception);
      if (dll) {
        _extFunc = (struct sidlx_rmi_GenNetworkException__external*(*)(void))
          sidl_DLL_lookupSymbol(dll,                                          \
            "sidlx_rmi_GenNetworkException__externals", &throwaway_exception);
        if (!throwaway_exception && _extFunc) {
          _implEPV = (*_extFunc)();
        }
        else {
          ...
          errmsg = sidl_String_concat3(
            "babel: The shared library containing SIDL type sidlx.rmi.GenNetworkException, ",
            name,
            ", was loaded but is missing a required symbol (sidlx_rmi_GenNetworkException__externals).");
          sidl_String_free(name);
        }
        sidl_DLL_deleteRef(dll, &throwaway_exception);
      }
      else {
        errmsg = sidl_String_strdup("babel: Unable to find or load a shared library containing the implementation of SIDL type sidlx.rmi.GenNetworkException. To get more debugging information trying setting the SIDL_DEBUG_DLOPEN environment variable and rerunning.");
      }
    }
#if (PY_VERSION_HEX >= 0x02040000)
    Py_END_ALLOW_THREADS
    ...
    if (!_implEPV) {
      ...
      else PyErr_SetString(PyExc_RuntimeError, "Unexpected error loading SIDL implementation for sidlx.rmi.GenNetworkException.");
...
pStub_GenNetworkException__exec(PyObject *_self, PyObject *_args, PyObject    \
  *_kwdict) {
  ...
  struct sidlx_rmi_GenNetworkException__object *_self_ior =
    ((struct sidlx_rmi_GenNetworkException__object *)
     sidl_Cast(_self, "sidlx.rmi.GenNetworkException"));
  if (_self_ior) {
    ...
    PyErr_SetString(PyExc_TypeError, 
      "self pointer is not a sidlx.rmi.GenNetworkException");
  }
  return _return_value;
}
...
static PyObject *
pStub_GenNetworkException__isRemote(PyObject *_self, PyObject *_args,         \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_GenNetworkException__object *_self_ior =
    ((struct sidlx_rmi_GenNetworkException__object *)
...
static PyObject *
pStub_GenNetworkException__set_hooks(PyObject *_self, PyObject *_args,        \
  PyObject *_kwdict) {
  PyObject *_return_value = NULL;
  struct sidlx_rmi_GenNetworkException__object *_self_ior =
    ((struct sidlx_rmi_GenNetworkException__object *)
...
static int
sidlx_rmi_GenNetworkException_createCast(PyObject *self, PyObject *args,      \
  PyObject *kwds) {
  struct sidlx_rmi_GenNetworkException__object *optarg = NULL;
  char* url = NULL;
  ...
  if (_okay) {
    if (!optarg && !url && !implObj) {
      ...
      sidl_Python_LogUnlock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
      optarg = sidlx_rmi_GenNetworkException__remoteCreate(url,&_exception);
#if (PY_VERSION_HEX >= 0x02040000)
      Py_END_ALLOW_THREADS
      sidl_Python_LogRelock(__func__, __FILE__, __LINE__);
#endif /* Python 2.4 or later */
...
static PyMethodDef _GenNetworkExceptionModuleMethods[] = {

#ifdef WITH_RMI

  { "_connect", (PyCFunction)pStub_GenNetworkException__connect,
  (METH_VARARGS | METH_KEYWORDS),
"\
_connect( in string url)\n\
RETURNS\n\
   ( out sidlx.rmi.GenNetworkException self)\n\
RAISES\n\
...
static PyMethodDef _GenNetworkExceptionObjectMethods[] = {
  { "_exec", (PyCFunction)pStub_GenNetworkException__exec,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
Select and execute a method by name"
  ...
  { "_getURL", (PyCFunction)pStub_GenNetworkException__getURL,
  (METH_VARARGS | METH_KEYWORDS),
"\
_getURL()\n\
RETURNS\n\
...
Get the URL of the Implementation of this object (for RMI)"
  ...
  { "_isLocal", (PyCFunction)pStub_GenNetworkException__isLocal,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isLocal()\n\
RETURNS\n\
...
TRUE if this object is local, false if remote"
  ...
  { "_isRemote", (PyCFunction)pStub_GenNetworkException__isRemote,
  (METH_VARARGS | METH_KEYWORDS),
"\
_isRemote()\n\
RETURNS\n\
...
TRUE if this object is remote, false if local"
  ...
  { "_set_hooks", (PyCFunction)pStub_GenNetworkException__set_hooks,
  (METH_VARARGS | METH_KEYWORDS),
"\
...
static PyTypeObject _sidlx_rmi_GenNetworkExceptionType = {
  PyObject_HEAD_INIT(NULL)
  0,      /* ob_size */
  "sidlx.rmi.GenNetworkException.GenNetworkException", /* tp_name */
  0,      /* tp_basicsize */
  0,      /* tp_itemsize */
  0,      /* tp_dealloc */
  0,      /* tp_print */
...
Generic Network Exception", /* tp_doc */
  ...
  0,       /* tp_iter */
  0,       /* tp_iternext */
  _GenNetworkExceptionObjectMethods, /* tp_methods */
  0,       /* tp_members */
  0,       /* tp_getset */
  0,       /* tp_base */
  0,       /* tp_dict */
  ...
  0,       /* tp_descr_set */
  0,       /* tp_dictoffset */
  sidlx_rmi_GenNetworkException_createCast,   /* tp_init */
  0,       /* tp_alloc */
  0,       /* tp_new */
};

sidlx_rmi_GenNetworkException__wrap_RETURN
sidlx_rmi_GenNetworkException__wrap sidlx_rmi_GenNetworkException__wrap_PROTO \
  {
  PyObject *result;
  if (sidlobj) {
...
sidlx_rmi_GenNetworkException_deref sidlx_rmi_GenNetworkException_deref_PROTO \
  {
  if (sidlobj) {
    struct sidl_BaseInterface__object *throwaway_exception;
...
sidlx_rmi_GenNetworkException_PyType                                          \
  ...
  return &_sidlx_rmi_GenNetworkExceptionType;
}
...
sidlx_rmi_GenNetworkException__convert                                        \
  ...
  *sidlobj = sidl_Cast(obj, "sidlx.rmi.GenNetworkException");
  if ((!(*sidlobj)) && (obj != Py_None)) {
    PyErr_SetString(PyExc_TypeError, 
      "argument is not a(n) sidlx.rmi.GenNetworkException");
    return 0;
  }
  return 1;
}
...
{
  struct sidlx_rmi_GenNetworkException__object *sidlobj = NULL;
  if (sidlx_rmi_GenNetworkException__convert(pyobj, &sidlobj)) {
  ...
  if (obj == Py_None) {
    ...
    if (pya) {
      if (PyArray_OBJECT == ((PyArrayObject *)pya)->descr->type_num) {
        ...
        {
            *sidlarray = (struct                                              \
              sidlx_rmi_GenNetworkException__array*)sidl_interface__array_createRow
            (dimen, lower, upper);
...
{
  struct sidlx_rmi_GenNetworkException__object *sidlobj = (struct             \
    sidlx_rmi_GenNetworkException__object*)
  sidl_interface__array_get((struct sidl_interface__array *)
    sidlarray, ind);
  *dest = sidlx_rmi_GenNetworkException__wrap(sidlobj);
  return (*dest == NULL);
}
...
void
initGenNetworkException(void) {
  PyObject *module, *dict, *c_api;
  PyObject *_exceptionBases, *_exceptionDict, *_exceptionName;
  static void *ExternalAPI[sidlx_rmi_GenNetworkException__API_NUM];
  struct sidl_BaseInterface__object *throwaway_exception;
  module = Py_InitModule3("GenNetworkException",                              \
    _GenNetworkExceptionModuleMethods, "\
\
Generic Network Exception"
  );
  ...
  Py_INCREF(Py_None);
  ExternalAPI[sidlx_rmi_GenNetworkException__type_NUM] = Py_None;
