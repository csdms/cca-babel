...
#define sidl_ClassInfo__wrap_PROTO (const struct sidl_ClassInfo__object *sidlobj)
...
#define sidl_ClassInfo__API_NUM 10
...
{ \
  ...
  if (!sidl_ClassInfo__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidl.ClassInfo"); \
    if (_imp_module != NULL) { \
