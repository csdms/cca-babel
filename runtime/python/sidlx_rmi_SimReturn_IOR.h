...
struct sidlx_rmi_SimReturn__epv {
  ...
  void (*f_packSerializableArray)(
    ...
    /* in */ sidl_bool reuse_array,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in sidl.rmi.Return-v0.9.17 */
...
struct sidlx_rmi_SimReturn__cstats {
  sidl_bool use_hooks;
};
...
sidlx_rmi_SimReturn__createObject(void* ddata,struct sidl_BaseInterface__object 
  ** _ex);
