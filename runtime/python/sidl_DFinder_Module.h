...
#define sidl_DFinder__wrap_PROTO (const struct sidl_DFinder__object *sidlobj)
...
#define sidl_DFinder__API_NUM 10
...
{ \
  ...
  if (!sidl_DFinder__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidl.DFinder"); \
    if (_imp_module != NULL) { \
