/*
 * File:          sidlx_rmi_UnrecoverableException_IOR.h
...
#define included_sidlx_rmi_UnrecoverableException_IOR_h
...
struct sidlx_rmi_UnrecoverableException__cstats {
  sidl_bool use_hooks;
};
...
struct sidlx_rmi_UnrecoverableException__object {
  ...
  struct sidlx_rmi_UnrecoverableException__epv* d_epv;
  void*                                         d_data;
};

struct sidlx_rmi_UnrecoverableException__external {
  struct sidlx_rmi_UnrecoverableException__object*
...
extern struct sidlx_rmi_UnrecoverableException__object*
sidlx_rmi_UnrecoverableException__createObject(void* ddata,struct 
  sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_UnrecoverableException__init(
  struct sidlx_rmi_UnrecoverableException__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_UnrecoverableException__getEPVs(
...
extern void sidlx_rmi_UnrecoverableException__fini(
  struct sidlx_rmi_UnrecoverableException__object* self, struct 
    sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_UnrecoverableException__IOR_version(int32_t *major, 
  int32_t *minor);

struct sidl_io_Deserializer__object* 
  skel_sidlx_rmi_UnrecoverableException_fconnect_sidl_io_Deserializer(const 
  char* url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct sidl_BaseInterface__object* 
  skel_sidlx_rmi_UnrecoverableException_fconnect_sidl_BaseInterface(const char* 
  url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct sidl_io_Serializer__object* 
  skel_sidlx_rmi_UnrecoverableException_fconnect_sidl_io_Serializer(const char* 
  url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct sidlx_rmi_UnrecoverableException__remote{
  int d_refcount;
