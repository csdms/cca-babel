...
#define sidl_BaseInterface__wrap_PROTO (const struct sidl_BaseInterface__object *sidlobj)
...
#define sidl_BaseInterface__convert_generic_array_NUM 10
...
#define sidl_BaseInterface__API_NUM 11
...
{ \
  ...
  if (!sidl_BaseInterface__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidl.BaseInterface"); \
    if (_imp_module != NULL) { \
