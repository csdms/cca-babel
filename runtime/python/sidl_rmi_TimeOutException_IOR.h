...
struct sidl_rmi_TimeOutException__epv {
  ...
  int32_t (*f_getErrno)(
    /* in */ struct sidl_rmi_TimeOutException__object* self,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in sidl.rmi.TimeOutException-v0.9.17 */
};
...
struct sidl_rmi_TimeOutException__cstats {
  sidl_bool use_hooks;
};
...
sidl_rmi_TimeOutException__createObject(void* ddata,struct 
