...
struct sidl_ClassInfoI__epv {
  ...
  /* Methods introduced in sidl.ClassInfo-v0.9.17 */
  char* (*f_getName)(
    /* in */ struct sidl_ClassInfoI__object* self,
    /* out */ struct sidl_BaseInterface__object **_ex);
  char* (*f_getVersion)(
  ...
  char* (*f_getIORVersion)(
    /* in */ struct sidl_ClassInfoI__object* self,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in sidl.ClassInfoI-v0.9.17 */
  void (*f_setName)(
    /* in */ struct sidl_ClassInfoI__object* self,
    /* in */ const char* name,
    /* out */ struct sidl_BaseInterface__object **_ex);
...
struct sidl_ClassInfoI__cstats {
  sidl_bool use_hooks;
};
...
sidl_ClassInfoI__createObject(void* ddata,struct sidl_BaseInterface__object ** 
  _ex);
