...
#define sidl_SIDLException__wrap_PROTO (const struct sidl_SIDLException__object *sidlobj)
...
#define sidl_SIDLException__type_NUM 10

#define sidl_SIDLException__API_NUM 11
...
{ \
  ...
  if (!sidl_SIDLException__API) { \
    PyObject *_imp_module = PyImport_ImportModule("sidl.SIDLException"); \
    if (_imp_module != NULL) { \
