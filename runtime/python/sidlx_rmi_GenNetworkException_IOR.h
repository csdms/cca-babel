...
struct sidlx_rmi_GenNetworkException__cstats {
  sidl_bool use_hooks;
};
...
sidlx_rmi_GenNetworkException__createObject(void* ddata,struct 
...
extern void sidlx_rmi_GenNetworkException__IOR_version(int32_t *major, int32_t 
  *minor);
