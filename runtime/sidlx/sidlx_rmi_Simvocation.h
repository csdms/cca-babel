...
#if !defined(SIDLX_RMI_SIMVOCATION_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDLX_RMI_SIMVOCATION_INLINE_DECL inline
#else
#define SIDLX_RMI_SIMVOCATION_INLINE_DECL extern inline
#endif
 ...
 * Method:  initCreate[]
 */
SIDLX_RMI_SIMVOCATION_INLINE_DECL
void
sidlx_rmi_Simvocation_initCreate(
...
#ifdef SIDLX_RMI_SIMVOCATION_INLINE_DECL
{
...
#else
;
#endif /* SIDLX_RMI_SIMVOCATION_INLINE_DECL */
...
SIDLX_RMI_SIMVOCATION_INLINE_DECL
void
sidlx_rmi_Simvocation_initInvocation(
  /* in */ sidlx_rmi_Simvocation self,
...
SIDLX_RMI_SIMVOCATION_INLINE_DECL
void
sidlx_rmi_Simvocation_initUnserialize(
  /* in */ sidlx_rmi_Simvocation self,
  /* in */ const char* objectid,
  /* in */ sidlx_rmi_Socket sock,
  /* in rarray[cookieLen] */ char* cookie,
