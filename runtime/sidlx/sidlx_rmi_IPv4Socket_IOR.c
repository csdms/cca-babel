...
sidlx_rmi_IPv4Socket_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidlx_rmi_IPv4Socket__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "sidlx.rmi.IPv4Socket", _ex);
    if(iobj != NULL) {
...
static void
sidlx_rmi_IPv4Socket__cast__exec(
        struct sidlx_rmi_IPv4Socket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidlx_rmi_IPv4Socket__set_contracts(
  struct sidlx_rmi_IPv4Socket__object* self,
  sidl_bool   enable,
...
static void ior_sidlx_rmi_IPv4Socket__dump_stats(
  struct sidlx_rmi_IPv4Socket__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidlx_rmi_IPv4Socket__method  s_methods[] = {
    { "_cast", sidlx_rmi_IPv4Socket__cast__exec },
 ...
 */
  ...
  struct sidlx_rmi_IPv4Socket__epv*  epv  = &s_my_epv__sidlx_rmi_ipv4socket;
  struct sidl_BaseClass__epv*        e0   = &s_my_epv__sidl_baseclass;
  struct sidl_BaseInterface__epv*    e1   = &s_my_epv__sidl_baseinterface;
  struct sidlx_rmi_Socket__epv*      e2   = &s_my_epv__sidlx_rmi_socket;
  ...
  epv->f__set_contracts        = ior_sidlx_rmi_IPv4Socket__set_contracts;
  epv->f__dump_stats           = ior_sidlx_rmi_IPv4Socket__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_getsockname           = NULL;
  epv->f_getpeername           = NULL;
  epv->f_addRef                = (void (*)(struct sidlx_rmi_IPv4Socket__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidlx_rmi_IPv4Socket__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidlx_rmi_IPv4Socket__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidlx_rmi_IPv4Socket__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidlx_rmi_IPv4Socket__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_close                 = NULL;
  epv->f_readn                 = NULL;
  epv->f_readline              = NULL;
  ...
  e2->f_close                 = (int32_t (*)(void*,struct sidl_BaseInterface__object **)) epv->f_close;
  e2->f_readn                 = (int32_t (*)(void*,int32_t,struct sidl_char__array**,struct sidl_BaseInterface__object **)) epv->f_readn;
  e2->f_readline              = (int32_t (*)(void*,int32_t,struct sidl_char__array**,struct sidl_BaseInterface__object **)) epv->f_readline;
  e2->f_readstring            = (int32_t (*)(void*,int32_t,struct sidl_char__array**,struct sidl_BaseInterface__object **)) epv->f_readstring;
  e2->f_readstring_alloc      = (int32_t (*)(void*,struct sidl_char__array**,struct sidl_BaseInterface__object **)) epv->f_readstring_alloc;
  e2->f_readint               = (int32_t (*)(void*,int32_t*,struct sidl_BaseInterface__object **)) epv->f_readint;
  e2->f_writen                = (int32_t (*)(void*,int32_t,struct sidl_char__array*,struct sidl_BaseInterface__object **)) epv->f_writen;
  e2->f_writestring           = (int32_t (*)(void*,int32_t,struct sidl_char__array*,struct sidl_BaseInterface__object **)) epv->f_writestring;
  e2->f_writeint              = (int32_t (*)(void*,int32_t,struct sidl_BaseInterface__object **)) epv->f_writeint;
  e2->f_setFileDescriptor     = (void (*)(void*,int32_t,struct sidl_BaseInterface__object **)) epv->f_setFileDescriptor;
  e2->f_getFileDescriptor     = (int32_t (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getFileDescriptor;
  e2->f_test                  = (sidl_bool (*)(void*,int32_t,int32_t,struct sidl_BaseInterface__object **)) epv->f_test;
...
/*
 * sidlx_rmi_IPv4Socket__getEPVs: Get my version of all relevant EPVs.
 */
...
static struct sidl_BaseClass__epv* sidlx_rmi_IPv4Socket__getSuperEPV(void) {
...
/*
 * sidlx_rmi_IPv4Socket__createObject: Allocate the object and initialize it.
 */

struct sidlx_rmi_IPv4Socket__object*
sidlx_rmi_IPv4Socket__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidlx_rmi_IPv4Socket__object* self =
    (struct sidlx_rmi_IPv4Socket__object*) sidl_malloc(
      sizeof(struct sidlx_rmi_IPv4Socket__object),
      "Object allocation failed for struct sidlx_rmi_IPv4Socket__object",
        __FILE__, __LINE__, "sidlx_rmi_IPv4Socket__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_sidlx_rmi_socket.d_epv = &s_my_epv__sidlx_rmi_socket;
  s0->d_epv                    = &s_my_epv__sidlx_rmi_ipv4socket;
...
s_externalEntryPoints = {
  sidlx_rmi_IPv4Socket__createObject,
  sidlx_rmi_IPv4Socket__getSuperEPV,
  2, 
  0
};
