/*
 * File:          sidlx_rmi_TooManyOpenFilesException_IOR.h
...
#define included_sidlx_rmi_TooManyOpenFilesException_IOR_h
...
struct sidlx_rmi_TooManyOpenFilesException__epv {
  ...
  /* Methods introduced in sidlx.rmi.TooManyOpenFilesException-v0.1 */
};
...
struct sidlx_rmi_TooManyOpenFilesException__cstats {
  sidl_bool use_hooks;
};
...
struct sidlx_rmi_TooManyOpenFilesException__object {
  ...
  struct sidlx_rmi_TooManyOpenFilesException__epv* d_epv;
  void*                                            d_data;
};

struct sidlx_rmi_TooManyOpenFilesException__external {
  struct sidlx_rmi_TooManyOpenFilesException__object*
...
extern struct sidlx_rmi_TooManyOpenFilesException__object*
sidlx_rmi_TooManyOpenFilesException__createObject(void* ddata,struct 
  sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_TooManyOpenFilesException__init(
  struct sidlx_rmi_TooManyOpenFilesException__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_TooManyOpenFilesException__getEPVs(
  ...
  struct sidlx_rmi_TooManyOpenFilesException__epv 
    **s_arg_epv__sidlx_rmi_toomanyopenfilesexception);

extern void sidlx_rmi_TooManyOpenFilesException__fini(
  struct sidlx_rmi_TooManyOpenFilesException__object* self, struct 
    sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_TooManyOpenFilesException__IOR_version(int32_t *major, 
  int32_t *minor);
...
struct sidl_io_Serializer__object* 
  ...
  char* url, sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct sidlx_rmi_TooManyOpenFilesException__remote{
  int d_refcount;
