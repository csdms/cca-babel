...
static struct sidlx_rmi_SimHandle__epv  s_my_epv__sidlx_rmi_simhandle;
static VAR_UNUSED struct sidlx_rmi_SimHandle__sepv 
  s_stc_epv__sidlx_rmi_simhandle;
...
static struct sidl_rmi_InstanceHandle__epv s_my_epv__sidl_rmi_instancehandle;
...
extern void sidlx_rmi_SimHandle__set_sepv(
  struct sidlx_rmi_SimHandle__sepv* sepv);
...
sidlx_rmi_SimHandle_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidlx_rmi_SimHandle__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "sidlx.rmi.SimHandle", _ex);
    if(iobj != NULL) {
...
static void
sidlx_rmi_SimHandle__cast__exec(
        struct sidlx_rmi_SimHandle__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidlx_rmi_SimHandle__set_contracts_static(
  sidl_bool   enable,
...
static void ior_sidlx_rmi_SimHandle__dump_stats_static(
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
{
...
static void ior_sidlx_rmi_SimHandle__set_contracts(
  struct sidlx_rmi_SimHandle__object* self,
  sidl_bool   enable,
  const char* enfFilename,
  sidl_bool   resetCounters,
...
static void ior_sidlx_rmi_SimHandle__dump_stats(
  struct sidlx_rmi_SimHandle__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  cmp = strcmp(name, "sidl.rmi.InstanceHandle");
  if (!cmp) {
    ...
    cmp = strcmp(name, "sidlx.rmi.SimHandle");
    if (!cmp) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
...
static void ior_sidlx_rmi_SimHandle__set_hooks_static(
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidlx_rmi_SimHandle__method  s_methods[] = {
    { "_cast", sidlx_rmi_SimHandle__cast__exec },
 ...
 */
  ...
  struct sidlx_rmi_SimHandle__epv*     epv  = &s_my_epv__sidlx_rmi_simhandle;
  struct sidl_BaseClass__epv*          e0   = &s_my_epv__sidl_baseclass;
  struct sidl_BaseInterface__epv*      e1   = &s_my_epv__sidl_baseinterface;
  struct sidl_rmi_InstanceHandle__epv* e2   = &s_my_epv__sidl_rmi_instancehandle;
  ...
  epv->f__set_contracts        = ior_sidlx_rmi_SimHandle__set_contracts;
  epv->f__dump_stats           = ior_sidlx_rmi_SimHandle__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct sidlx_rmi_SimHandle__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidlx_rmi_SimHandle__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidlx_rmi_SimHandle__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidlx_rmi_SimHandle__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidlx_rmi_SimHandle__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  ...
  /*
   * Override function pointers for sidl.rmi.InstanceHandle with mine, as needed.
   */
  ...
  e2->f_initCreate            = (sidl_bool (*)(void*,const char*,const char*,struct sidl_BaseInterface__object **)) epv->f_initCreate;
  e2->f_initConnect           = (sidl_bool (*)(void*,const char*,const char*,sidl_bool,struct sidl_BaseInterface__object **)) epv->f_initConnect;
  e2->f_initUnserialize       = (struct sidl_io_Serializable__object* (*)(void*,const char*,struct sidl_BaseInterface__object **)) epv->f_initUnserialize;
  e2->f_getProtocol           = (char* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getProtocol;
  e2->f_getObjectID           = (char* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getObjectID;
  e2->f_getObjectURL          = (char* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getObjectURL;
  e2->f_createInvocation      = (struct sidl_rmi_Invocation__object* (*)(void*,const char*,struct sidl_BaseInterface__object **)) epv->f_createInvocation;
  e2->f_close                 = (sidl_bool (*)(void*,struct sidl_BaseInterface__object **)) epv->f_close;
...
static void sidlx_rmi_SimHandle__init_sepv(void)
{
  /*
   * assert( HAVE_LOCKED_STATIC_GLOBALS );
   */

  struct sidlx_rmi_SimHandle__sepv*  s = &s_stc_epv__sidlx_rmi_simhandle;

  s->f__set_hooks_static                = ior_sidlx_rmi_SimHandle__set_hooks_static;
  s->f__set_contracts_static            = ior_sidlx_rmi_SimHandle__set_contracts_static;
  s->f__dump_stats_static               = ior_sidlx_rmi_SimHandle__dump_stats_static;
  s->f_setCookie    = NULL;

  sidlx_rmi_SimHandle__set_sepv(s);
...
/*
 * sidlx_rmi_SimHandle__getEPVs: Get my version of all relevant EPVs.
 */
  ...
  struct sidlx_rmi_SimHandle__epv **s_arg_epv__sidlx_rmi_simhandle)
{
  ...
  *s_arg_epv__sidl_rmi_instancehandle = &s_my_epv__sidl_rmi_instancehandle;
  *s_arg_epv__sidlx_rmi_simhandle = &s_my_epv__sidlx_rmi_simhandle;
}
/*
 * sidlx_rmi_SimHandle__getStaticEPV: return pointer to static EPV structure.
 */
...
sidlx_rmi_SimHandle__getStaticEPV(void){
  ...
  if (!s_static_initialized) {
    sidlx_rmi_SimHandle__init_sepv();
  }
  UNLOCK_STATIC_GLOBALS;
  return &s_stc_epv__sidlx_rmi_simhandle;
}
...
static struct sidl_BaseClass__epv* sidlx_rmi_SimHandle__getSuperEPV(void) {
...
/*
 * sidlx_rmi_SimHandle__createObject: Allocate the object and initialize it.
 */

struct sidlx_rmi_SimHandle__object*
sidlx_rmi_SimHandle__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidlx_rmi_SimHandle__object* self =
    (struct sidlx_rmi_SimHandle__object*) sidl_malloc(
      sizeof(struct sidlx_rmi_SimHandle__object),
      "Object allocation failed for struct sidlx_rmi_SimHandle__object",
        __FILE__, __LINE__, "sidlx_rmi_SimHandle__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_sidl_rmi_instancehandle.d_epv = &s_my_epv__sidl_rmi_instancehandle;
  s0->d_epv                           = &s_my_epv__sidlx_rmi_simhandle;
...
s_externalEntryPoints = {
  sidlx_rmi_SimHandle__createObject,
  sidlx_rmi_SimHandle__getStaticEPV,
  sidlx_rmi_SimHandle__getSuperEPV,
  2, 
  0
};
