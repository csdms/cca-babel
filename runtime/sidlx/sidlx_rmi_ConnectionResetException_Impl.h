/*
 * File:          sidlx_rmi_ConnectionResetException_Impl.h
...
#ifndef included_sidlx_rmi_ConnectionResetException_Impl_h
#define included_sidlx_rmi_ConnectionResetException_Impl_h
...
#endif
/* DO-NOT-DELETE splicer.begin(sidlx.rmi.ConnectionResetException._hincludes) */
/* insert code here (include files) */
/* DO-NOT-DELETE splicer.end(sidlx.rmi.ConnectionResetException._hincludes) */

/*
 * Private data for class sidlx.rmi.ConnectionResetException
 */

struct sidlx_rmi_ConnectionResetException__data {
  /* DO-NOT-DELETE splicer.begin(sidlx.rmi.ConnectionResetException._data) */
  /* insert code here (private data members) */
  int ignore; /* dummy to force non-empty struct; remove if you add data */
  /* DO-NOT-DELETE splicer.end(sidlx.rmi.ConnectionResetException._data) */
};
...
extern struct sidlx_rmi_ConnectionResetException__data*
sidlx_rmi_ConnectionResetException__get_data(
  sidlx_rmi_ConnectionResetException);

extern void
sidlx_rmi_ConnectionResetException__set_data(
  sidlx_rmi_ConnectionResetException,
  struct sidlx_rmi_ConnectionResetException__data*);
