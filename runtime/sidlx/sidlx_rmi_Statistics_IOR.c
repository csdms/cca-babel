/*
 * File:          sidlx_rmi_Statistics_IOR.c
...
static struct sidlx_rmi_Statistics__epv  s_my_epv__sidlx_rmi_statistics;
static VAR_UNUSED struct sidlx_rmi_Statistics__sepv 
  s_stc_epv__sidlx_rmi_statistics;
...
extern void sidlx_rmi_Statistics__set_epv(
  struct sidlx_rmi_Statistics__epv* epv);

extern void sidlx_rmi_Statistics__set_sepv(
  struct sidlx_rmi_Statistics__sepv* sepv);

extern void sidlx_rmi_Statistics__call_load(void);
#ifdef __cplusplus
}
#endif

static void
sidlx_rmi_Statistics_addRef__exec(
...
static void
sidlx_rmi_Statistics_deleteRef__exec(
        struct sidlx_rmi_Statistics__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_Statistics_isSame__exec(
        struct sidlx_rmi_Statistics__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_sidlx_rmi_Statistics_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidlx_rmi_Statistics__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "sidlx.rmi.Statistics", _ex);
    if(iobj != NULL) {
...
static void
sidlx_rmi_Statistics_isType__exec(
        struct sidlx_rmi_Statistics__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_Statistics_getClassInfo__exec(
        struct sidlx_rmi_Statistics__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_Statistics__cast__exec(
        struct sidlx_rmi_Statistics__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidlx_rmi_Statistics__set_contracts_static(
  sidl_bool   enable,
...
static void ior_sidlx_rmi_Statistics__dump_stats_static(
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
{
...
static void ior_sidlx_rmi_Statistics__set_contracts(
  struct sidlx_rmi_Statistics__object* self,
  sidl_bool   enable,
  const char* enfFilename,
  sidl_bool   resetCounters,
...
static void ior_sidlx_rmi_Statistics__dump_stats(
  struct sidlx_rmi_Statistics__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_sidlx_rmi_Statistics__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    sidlx_rmi_Statistics__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_sidlx_rmi_Statistics__cast(
  struct sidlx_rmi_Statistics__object* self,
...
static void ior_sidlx_rmi_Statistics__set_hooks_static(
...
static void ior_sidlx_rmi_Statistics__set_hooks(
  struct sidlx_rmi_Statistics__object* self,
  sidl_bool enable, struct sidl_BaseInterface__object **_ex )
{
  *_ex  = NULL;
...
static void ior_sidlx_rmi_Statistics__delete(
  struct sidlx_rmi_Statistics__object* self, struct sidl_BaseInterface__object 
    **_ex)
{
  *_ex  = NULL; /* default to no exception */
  sidlx_rmi_Statistics__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct sidlx_rmi_Statistics__object));
  free((void*) self);
}

static char*
ior_sidlx_rmi_Statistics__getURL(
  struct sidlx_rmi_Statistics__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_sidlx_rmi_Statistics__raddRef(
    struct sidlx_rmi_Statistics__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_sidlx_rmi_Statistics__isRemote(
    struct sidlx_rmi_Statistics__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct sidlx_rmi_Statistics__method {
  const char *d_name;
  void (*d_func)(struct sidlx_rmi_Statistics__object*,
...
static void
ior_sidlx_rmi_Statistics__exec(
  struct sidlx_rmi_Statistics__object* self,
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidlx_rmi_Statistics__method  s_methods[] = {
    { "_cast", sidlx_rmi_Statistics__cast__exec },
    { "addRef", sidlx_rmi_Statistics_addRef__exec },
    { "deleteRef", sidlx_rmi_Statistics_deleteRef__exec },
    { "getClassInfo", sidlx_rmi_Statistics_getClassInfo__exec },
    { "isSame", sidlx_rmi_Statistics_isSame__exec },
    { "isType", sidlx_rmi_Statistics_isType__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct sidlx_rmi_Statistics__method);
  *_ex  = NULL; /* default to no exception */
...
static void sidlx_rmi_Statistics__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct sidlx_rmi_Statistics__epv*  epv  = &s_my_epv__sidlx_rmi_statistics;
  ...
  epv->f__cast                 = ior_sidlx_rmi_Statistics__cast;
  epv->f__delete               = ior_sidlx_rmi_Statistics__delete;
  epv->f__exec                 = ior_sidlx_rmi_Statistics__exec;
  epv->f__getURL               = ior_sidlx_rmi_Statistics__getURL;
  epv->f__raddRef              = ior_sidlx_rmi_Statistics__raddRef;
  epv->f__isRemote             = ior_sidlx_rmi_Statistics__isRemote;
  epv->f__set_hooks            = ior_sidlx_rmi_Statistics__set_hooks;
  epv->f__set_contracts        = ior_sidlx_rmi_Statistics__set_contracts;
  epv->f__dump_stats           = ior_sidlx_rmi_Statistics__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct sidlx_rmi_Statistics__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidlx_rmi_Statistics__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidlx_rmi_Statistics__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidlx_rmi_Statistics__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidlx_rmi_Statistics__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;

  sidlx_rmi_Statistics__set_epv(epv);
  ...
  ior_sidlx_rmi_Statistics__ensure_load_called();
}
...
static void sidlx_rmi_Statistics__init_sepv(void)
{
  /*
   * assert( HAVE_LOCKED_STATIC_GLOBALS );
   */

  struct sidlx_rmi_Statistics__sepv*  s = &s_stc_epv__sidlx_rmi_statistics;

  s->f__set_hooks_static                 = ior_sidlx_rmi_Statistics__set_hooks_static;
  s->f__set_contracts_static             = ior_sidlx_rmi_Statistics__set_contracts_static;
  s->f__dump_stats_static                = ior_sidlx_rmi_Statistics__dump_stats_static;
  s->f_getTotalAcceptsFirstTry     = NULL;
  s->f_getTotalAcceptRequests      = NULL;
  s->f_getTotalAcceptSucceded      = NULL;
  s->f_getMaxAcceptRetries         = NULL;
  s->f_getAvgAcceptRetries         = NULL;
  s->f_getTotalConnectsFirstTry    = NULL;
  s->f_getTotalConnectRequests     = NULL;
  s->f_getTotalConnectSucceded     = NULL;
  s->f_getMaxConnectRetries        = NULL;
  s->f_getAvgConnectRetries        = NULL;

  sidlx_rmi_Statistics__set_sepv(s);
...
/*
 * sidlx_rmi_Statistics__getEPVs: Get my version of all relevant EPVs.
 */

void sidlx_rmi_Statistics__getEPVs (
  ...
  struct sidlx_rmi_Statistics__epv **s_arg_epv__sidlx_rmi_statistics)
{
  ...
  if (!s_method_initialized) {
    sidlx_rmi_Statistics__init_epv();
  }
  UNLOCK_STATIC_GLOBALS;

  *s_arg_epv__sidl_baseinterface = &s_my_epv__sidl_baseinterface;
  *s_arg_epv__sidl_baseclass = &s_my_epv__sidl_baseclass;
  *s_arg_epv__sidlx_rmi_statistics = &s_my_epv__sidlx_rmi_statistics;
}
/*
 * sidlx_rmi_Statistics__getStaticEPV: return pointer to static EPV structure.
 */
...
sidlx_rmi_Statistics__getStaticEPV(void){
  ...
  if (!s_static_initialized) {
    sidlx_rmi_Statistics__init_sepv();
  }
  UNLOCK_STATIC_GLOBALS;
  return &s_stc_epv__sidlx_rmi_statistics;
}
...
static struct sidl_BaseClass__epv* sidlx_rmi_Statistics__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidlx.rmi.Statistics", _ex);
...
static void
initMetadata(struct sidlx_rmi_Statistics__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * sidlx_rmi_Statistics__createObject: Allocate the object and initialize it.
 */

struct sidlx_rmi_Statistics__object*
sidlx_rmi_Statistics__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidlx_rmi_Statistics__object* self =
    (struct sidlx_rmi_Statistics__object*) sidl_malloc(
      sizeof(struct sidlx_rmi_Statistics__object),
      "Object allocation failed for struct sidlx_rmi_Statistics__object",
        __FILE__, __LINE__, "sidlx_rmi_Statistics__createObject", _ex);
  if (!self) goto EXIT;
  sidlx_rmi_Statistics__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void sidlx_rmi_Statistics__init(
  struct sidlx_rmi_Statistics__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct sidlx_rmi_Statistics__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_my_epv__sidlx_rmi_statistics;
...
void sidlx_rmi_Statistics__fini(
  struct sidlx_rmi_Statistics__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct sidlx_rmi_Statistics__object* s0 = self;
...
void
sidlx_rmi_Statistics__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct sidlx_rmi_Statistics__external
s_externalEntryPoints = {
  sidlx_rmi_Statistics__createObject,
  sidlx_rmi_Statistics__getStaticEPV,
  sidlx_rmi_Statistics__getSuperEPV,
  2, 
  0
};
