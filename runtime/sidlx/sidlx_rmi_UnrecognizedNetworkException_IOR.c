/*
 * File:          sidlx_rmi_UnrecognizedNetworkException_IOR.c
 * Symbol:        sidlx.rmi.UnrecognizedNetworkException-v0.1
 * Symbol Type:   class
 * Babel Version: 2.0.0 (Revision: 7435  trunk)
 * Description:   Intermediate Object Representation for sidlx.rmi.UnrecognizedNetworkException
 * 
...
#include "sidlOps.h"
#endif
#include "sidlx_rmi_UnrecognizedNetworkException_IOR.h"
...
#ifdef HAVE_PTHREAD
static struct sidl_recursive_mutex_t sidlx_rmi_UnrecognizedNetworkException__mutex= SIDL_RECURSIVE_MUTEX_INITIALIZER;
#define LOCK_STATIC_GLOBALS sidl_recursive_mutex_lock( &sidlx_rmi_UnrecognizedNetworkException__mutex )
#define UNLOCK_STATIC_GLOBALS sidl_recursive_mutex_unlock( &sidlx_rmi_UnrecognizedNetworkException__mutex )
/* #define HAVE_LOCKED_STATIC_GLOBALS (sidl_recursive_mutex_trylock( &sidlx_rmi_UnrecognizedNetworkException__mutex )==EDEADLOCK) */
#else
...
static struct sidlx_rmi_UnrecognizedNetworkException__epv 
  s_my_epv__sidlx_rmi_unrecognizednetworkexception;
...
static struct sidlx_rmi_UnrecoverableException__epv  
  s_my_epv__sidlx_rmi_unrecoverableexception;
static struct sidlx_rmi_UnrecoverableException__epv* 
  s_par_epv__sidlx_rmi_unrecoverableexception;
...
extern void sidlx_rmi_UnrecognizedNetworkException__set_epv(
  struct sidlx_rmi_UnrecognizedNetworkException__epv* epv);

extern void sidlx_rmi_UnrecognizedNetworkException__call_load(void);
#ifdef __cplusplus
}
#endif

static void
sidlx_rmi_UnrecognizedNetworkException_getHopCount__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
...
static void
sidlx_rmi_UnrecognizedNetworkException_setErrno__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnrecognizedNetworkException_getErrno__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnrecognizedNetworkException_addRef__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnrecognizedNetworkException_deleteRef__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnrecognizedNetworkException_isSame__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = 
    skel_sidlx_rmi_UnrecognizedNetworkException_fconnect_sidl_BaseInterface(
    iobj_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidlx_rmi_UnrecognizedNetworkException__object*) (
      *iobj_bc->d_epv->f__cast)(iobj_bc, 
      "sidlx.rmi.UnrecognizedNetworkException", _ex);
    if(iobj != NULL) {
...
static void
sidlx_rmi_UnrecognizedNetworkException_isType__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnrecognizedNetworkException_getClassInfo__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnrecognizedNetworkException_getNote__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnrecognizedNetworkException_setNote__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnrecognizedNetworkException_getTrace__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnrecognizedNetworkException_addLine__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnrecognizedNetworkException_add__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnrecognizedNetworkException_packObj__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  ser = skel_sidlx_rmi_UnrecognizedNetworkException_fconnect_sidl_io_Serializer(
    ser_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  ser_bc = sidl_rmi_InstanceRegistry_getInstanceByString(ser_str, 
    _ex);SIDL_CHECK(*_ex);
  if(ser_bc != NULL) {
    ser= (struct sidlx_rmi_UnrecognizedNetworkException__object*) (
      *ser_bc->d_epv->f__cast)(ser_bc, "sidlx.rmi.UnrecognizedNetworkException",
      _ex);
    if(ser != NULL) {
...
static void
sidlx_rmi_UnrecognizedNetworkException_unpackObj__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  des = 
    skel_sidlx_rmi_UnrecognizedNetworkException_fconnect_sidl_io_Deserializer(
    des_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  des_bc = sidl_rmi_InstanceRegistry_getInstanceByString(des_str, 
    _ex);SIDL_CHECK(*_ex);
  if(des_bc != NULL) {
    des= (struct sidlx_rmi_UnrecognizedNetworkException__object*) (
      *des_bc->d_epv->f__cast)(des_bc, "sidlx.rmi.UnrecognizedNetworkException",
      _ex);
    if(des != NULL) {
...
static void
sidlx_rmi_UnrecognizedNetworkException__cast__exec(
        struct sidlx_rmi_UnrecognizedNetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidlx_rmi_UnrecognizedNetworkException__set_contracts(
  struct sidlx_rmi_UnrecognizedNetworkException__object* self,
  sidl_bool   enable,
...
static void ior_sidlx_rmi_UnrecognizedNetworkException__dump_stats(
  struct sidlx_rmi_UnrecognizedNetworkException__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_sidlx_rmi_UnrecognizedNetworkException__ensure_load_called(
  void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    sidlx_rmi_UnrecognizedNetworkException__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_sidlx_rmi_UnrecognizedNetworkException__cast(
  struct sidlx_rmi_UnrecognizedNetworkException__object* self,
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp) {
    ...
    if (!cmp) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
      cast = &((
        *self).d_sidlx_rmi_unrecoverableexception.d_sidl_rmi_protocolexception.d_sidl_rmi_networkexception.d_sidl_io_ioexception.d_sidl_sidlexception.d_sidl_baseclass.d_sidl_baseinterface);
      return cast;
    }
    else if (cmp < 0) {
      ...
      if (!cmp) {
        (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
        cast = &((
          *self).d_sidlx_rmi_unrecoverableexception.d_sidl_rmi_protocolexception.d_sidl_rmi_networkexception.d_sidl_io_ioexception.d_sidl_sidlexception.d_sidl_baseexception);
        return cast;
      }
      else if (cmp < 0) {
      ...
      if (!cmp) {
        ...
        if (!cmp) {
          (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
          cast = &((
            *self).d_sidlx_rmi_unrecoverableexception.d_sidl_rmi_protocolexception.d_sidl_rmi_networkexception.d_sidl_io_ioexception.d_sidl_runtimeexception);
          return cast;
        }
      }
    }
    ...
    if (!cmp) {
      ...
      if (!cmp) {
        ...
        if (!cmp) {
          (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
          cast = &((
            *self).d_sidlx_rmi_unrecoverableexception.d_sidl_rmi_protocolexception.d_sidl_rmi_networkexception.d_sidl_io_ioexception.d_sidl_sidlexception.d_sidl_io_serializable);
          return cast;
        }
      }
    }
      ...
      if (!cmp) {
        ...
        cmp = strcmp(name, "sidlx.rmi.UnrecognizedNetworkException");
        if (!cmp) {
          (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
          cast = ((struct sidlx_rmi_UnrecognizedNetworkException__object*)self);
          return cast;
        }
      }
    }
...
static void ior_sidlx_rmi_UnrecognizedNetworkException__set_hooks(
  struct sidlx_rmi_UnrecognizedNetworkException__object* self,
...
static void ior_sidlx_rmi_UnrecognizedNetworkException__delete(
  struct sidlx_rmi_UnrecognizedNetworkException__object* self, struct 
    sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  sidlx_rmi_UnrecognizedNetworkException__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct 
    sidlx_rmi_UnrecognizedNetworkException__object));
  free((void*) self);
}

static char*
ior_sidlx_rmi_UnrecognizedNetworkException__getURL(
  struct sidlx_rmi_UnrecognizedNetworkException__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_sidlx_rmi_UnrecognizedNetworkException__raddRef(
    struct sidlx_rmi_UnrecognizedNetworkException__object* self, 
...
static sidl_bool
ior_sidlx_rmi_UnrecognizedNetworkException__isRemote(
    struct sidlx_rmi_UnrecognizedNetworkException__object* self, 
  sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
...
struct sidlx_rmi_UnrecognizedNetworkException__method {
  const char *d_name;
  void (*d_func)(struct sidlx_rmi_UnrecognizedNetworkException__object*,
...
static void
ior_sidlx_rmi_UnrecognizedNetworkException__exec(
  struct sidlx_rmi_UnrecognizedNetworkException__object* self,
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidlx_rmi_UnrecognizedNetworkException__method  
    s_methods[] = {
    { "_cast", sidlx_rmi_UnrecognizedNetworkException__cast__exec },
    { "add", sidlx_rmi_UnrecognizedNetworkException_add__exec },
    { "addLine", sidlx_rmi_UnrecognizedNetworkException_addLine__exec },
    { "addRef", sidlx_rmi_UnrecognizedNetworkException_addRef__exec },
    { "deleteRef", sidlx_rmi_UnrecognizedNetworkException_deleteRef__exec },
    { "getClassInfo", sidlx_rmi_UnrecognizedNetworkException_getClassInfo__exec 
      },
    { "getErrno", sidlx_rmi_UnrecognizedNetworkException_getErrno__exec },
    { "getHopCount", sidlx_rmi_UnrecognizedNetworkException_getHopCount__exec },
    { "getNote", sidlx_rmi_UnrecognizedNetworkException_getNote__exec },
    { "getTrace", sidlx_rmi_UnrecognizedNetworkException_getTrace__exec },
    { "isSame", sidlx_rmi_UnrecognizedNetworkException_isSame__exec },
    { "isType", sidlx_rmi_UnrecognizedNetworkException_isType__exec },
    { "packObj", sidlx_rmi_UnrecognizedNetworkException_packObj__exec },
    { "setErrno", sidlx_rmi_UnrecognizedNetworkException_setErrno__exec },
    { "setNote", sidlx_rmi_UnrecognizedNetworkException_setNote__exec },
    { "unpackObj", sidlx_rmi_UnrecognizedNetworkException_unpackObj__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct 
    sidlx_rmi_UnrecognizedNetworkException__method);
  *_ex  = NULL; /* default to no exception */
...
static void sidlx_rmi_UnrecognizedNetworkException__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct sidlx_rmi_UnrecognizedNetworkException__epv*  epv  = &s_my_epv__sidlx_rmi_unrecognizednetworkexception;
  ...
  struct sidlx_rmi_UnrecoverableException__epv*        e9   = &s_my_epv__sidlx_rmi_unrecoverableexception;

  struct sidlx_rmi_UnrecoverableException__epv*       s1 = NULL;
  ...
  sidlx_rmi_UnrecoverableException__getEPVs(
  ...
  s1  =  s_par_epv__sidlx_rmi_unrecoverableexception;

  epv->f__cast                 = ior_sidlx_rmi_UnrecognizedNetworkException__cast;
  epv->f__delete               = ior_sidlx_rmi_UnrecognizedNetworkException__delete;
  epv->f__exec                 = ior_sidlx_rmi_UnrecognizedNetworkException__exec;
  epv->f__getURL               = ior_sidlx_rmi_UnrecognizedNetworkException__getURL;
  epv->f__raddRef              = ior_sidlx_rmi_UnrecognizedNetworkException__raddRef;
  epv->f__isRemote             = ior_sidlx_rmi_UnrecognizedNetworkException__isRemote;
  epv->f__set_hooks            = ior_sidlx_rmi_UnrecognizedNetworkException__set_hooks;
  epv->f__set_contracts        = ior_sidlx_rmi_UnrecognizedNetworkException__set_contracts;
  epv->f__dump_stats           = ior_sidlx_rmi_UnrecognizedNetworkException__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_getHopCount           = (int32_t (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,struct sidl_BaseInterface__object **)) s1->f_getHopCount;
  epv->f_setErrno              = (void (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,int32_t,struct sidl_BaseInterface__object **)) s1->f_setErrno;
  epv->f_getErrno              = (int32_t (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,struct sidl_BaseInterface__object **)) s1->f_getErrno;
  epv->f_addRef                = (void (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_getNote               = (char* (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,struct sidl_BaseInterface__object **)) s1->f_getNote;
  epv->f_setNote               = (void (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_setNote;
  epv->f_getTrace              = (char* (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,struct sidl_BaseInterface__object **)) s1->f_getTrace;
  epv->f_addLine               = (void (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_addLine;
  epv->f_add                   = (void (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,const char*,int32_t,const char*,struct sidl_BaseInterface__object **)) s1->f_add;
  epv->f_packObj               = (void (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,struct sidl_io_Serializer__object*,struct sidl_BaseInterface__object **)) s1->f_packObj;
  epv->f_unpackObj             = (void (*)(struct sidlx_rmi_UnrecognizedNetworkException__object*,struct sidl_io_Deserializer__object*,struct sidl_BaseInterface__object **)) s1->f_unpackObj;

  sidlx_rmi_UnrecognizedNetworkException__set_epv(epv);
  ...
  /*
   * Override function pointers for sidlx.rmi.UnrecoverableException with mine, as needed.
   */

  e9->f__cast                 = (void* (*)(struct sidlx_rmi_UnrecoverableException__object*,const char*, struct sidl_BaseInterface__object**))epv->f__cast;
  e9->f__delete               = (void (*)(struct sidlx_rmi_UnrecoverableException__object*, struct sidl_BaseInterface__object **)) epv->f__delete;
  e9->f__getURL               = (char* (*)(struct sidlx_rmi_UnrecoverableException__object*, struct sidl_BaseInterface__object **)) epv->f__getURL;
  e9->f__raddRef              = (void (*)(struct sidlx_rmi_UnrecoverableException__object*, struct sidl_BaseInterface__object **)) epv->f__raddRef;
  e9->f__isRemote             = (sidl_bool (*)(struct sidlx_rmi_UnrecoverableException__object*, struct sidl_BaseInterface__object **)) epv->f__isRemote;
  e9->f__exec                 = (void (*)(struct sidlx_rmi_UnrecoverableException__object*,const char*,struct sidl_rmi_Call__object*,struct sidl_rmi_Return__object*,struct sidl_BaseInterface__object **)) epv->f__exec;
  e9->f_getHopCount           = (int32_t (*)(struct sidlx_rmi_UnrecoverableException__object*,struct sidl_BaseInterface__object **)) epv->f_getHopCount;
  e9->f_setErrno              = (void (*)(struct sidlx_rmi_UnrecoverableException__object*,int32_t,struct sidl_BaseInterface__object **)) epv->f_setErrno;
  e9->f_getErrno              = (int32_t (*)(struct sidlx_rmi_UnrecoverableException__object*,struct sidl_BaseInterface__object **)) epv->f_getErrno;
  e9->f_addRef                = (void (*)(struct sidlx_rmi_UnrecoverableException__object*,struct sidl_BaseInterface__object **)) epv->f_addRef;
  e9->f_deleteRef             = (void (*)(struct sidlx_rmi_UnrecoverableException__object*,struct sidl_BaseInterface__object **)) epv->f_deleteRef;
  e9->f_isSame                = (sidl_bool (*)(struct sidlx_rmi_UnrecoverableException__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) epv->f_isSame;
  e9->f_isType                = (sidl_bool (*)(struct sidlx_rmi_UnrecoverableException__object*,const char*,struct sidl_BaseInterface__object **)) epv->f_isType;
  e9->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidlx_rmi_UnrecoverableException__object*,struct sidl_BaseInterface__object **)) epv->f_getClassInfo;
  e9->f_getNote               = (char* (*)(struct sidlx_rmi_UnrecoverableException__object*,struct sidl_BaseInterface__object **)) epv->f_getNote;
  e9->f_setNote               = (void (*)(struct sidlx_rmi_UnrecoverableException__object*,const char*,struct sidl_BaseInterface__object **)) epv->f_setNote;
  e9->f_getTrace              = (char* (*)(struct sidlx_rmi_UnrecoverableException__object*,struct sidl_BaseInterface__object **)) epv->f_getTrace;
  e9->f_addLine               = (void (*)(struct sidlx_rmi_UnrecoverableException__object*,const char*,struct sidl_BaseInterface__object **)) epv->f_addLine;
  e9->f_add                   = (void (*)(struct sidlx_rmi_UnrecoverableException__object*,const char*,int32_t,const char*,struct sidl_BaseInterface__object **)) epv->f_add;
  e9->f_packObj               = (void (*)(struct sidlx_rmi_UnrecoverableException__object*,struct sidl_io_Serializer__object*,struct sidl_BaseInterface__object **)) epv->f_packObj;
  e9->f_unpackObj             = (void (*)(struct sidlx_rmi_UnrecoverableException__object*,struct sidl_io_Deserializer__object*,struct sidl_BaseInterface__object **)) epv->f_unpackObj;



  s_method_initialized = 1;
  ior_sidlx_rmi_UnrecognizedNetworkException__ensure_load_called();
}

/*
 * sidlx_rmi_UnrecognizedNetworkException__getEPVs: Get my version of all relevant EPVs.
 */

void sidlx_rmi_UnrecognizedNetworkException__getEPVs (
  ...
  struct sidlx_rmi_UnrecoverableException__epv **s_arg_epv__sidlx_rmi_unrecoverableexception,
  struct sidlx_rmi_UnrecognizedNetworkException__epv **s_arg_epv__sidlx_rmi_unrecognizednetworkexception)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    sidlx_rmi_UnrecognizedNetworkException__init_epv();
  }
  ...
  *s_arg_epv__sidlx_rmi_unrecoverableexception = &s_my_epv__sidlx_rmi_unrecoverableexception;
  *s_arg_epv__sidlx_rmi_unrecognizednetworkexception = &s_my_epv__sidlx_rmi_unrecognizednetworkexception;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidlx_rmi_UnrecoverableException__epv* sidlx_rmi_UnrecognizedNetworkException__getSuperEPV(void) {
  return s_par_epv__sidlx_rmi_unrecoverableexception;
}
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidlx.rmi.UnrecognizedNetworkException", _ex);
...
static void
initMetadata(struct sidlx_rmi_UnrecognizedNetworkException__object* self, sidl_BaseInterface* _ex)
{
  *_ex = 0; /* default no exception */
  if (self) {
    struct sidl_BaseClass__data *data = (struct sidl_BaseClass__data*)((*self).d_sidlx_rmi_unrecoverableexception.d_sidl_rmi_protocolexception.d_sidl_rmi_networkexception.d_sidl_io_ioexception.d_sidl_sidlexception.d_sidl_baseclass.d_data);
    if (data) {
...
/*
 * sidlx_rmi_UnrecognizedNetworkException__createObject: Allocate the object and initialize it.
 */

struct sidlx_rmi_UnrecognizedNetworkException__object*
sidlx_rmi_UnrecognizedNetworkException__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidlx_rmi_UnrecognizedNetworkException__object* self =
    (struct sidlx_rmi_UnrecognizedNetworkException__object*) sidl_malloc(
      sizeof(struct sidlx_rmi_UnrecognizedNetworkException__object),
      "Object allocation failed for struct sidlx_rmi_UnrecognizedNetworkException__object",
        __FILE__, __LINE__, "sidlx_rmi_UnrecognizedNetworkException__createObject", _ex);
  if (!self) goto EXIT;
  sidlx_rmi_UnrecognizedNetworkException__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void sidlx_rmi_UnrecognizedNetworkException__init(
  struct sidlx_rmi_UnrecognizedNetworkException__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct sidlx_rmi_UnrecognizedNetworkException__object* s0 = self;
  struct sidlx_rmi_UnrecoverableException__object*       s1 = &s0->d_sidlx_rmi_unrecoverableexception;
  ...
  *_ex = 0; /* default no exception */
  ...
  sidlx_rmi_UnrecoverableException__init(s1, NULL, _ex); SIDL_CHECK(*_ex);
  ...
  s1->d_epv    = &s_my_epv__sidlx_rmi_unrecoverableexception;

  s0->d_epv    = &s_my_epv__sidlx_rmi_unrecognizednetworkexception;
...
void sidlx_rmi_UnrecognizedNetworkException__fini(
  struct sidlx_rmi_UnrecognizedNetworkException__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct sidlx_rmi_UnrecognizedNetworkException__object* s0 = self;
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  s1->d_epv    = s_par_epv__sidlx_rmi_unrecoverableexception;

  sidlx_rmi_UnrecoverableException__fini(s1, _ex); SIDL_CHECK(*_ex);
...
void
sidlx_rmi_UnrecognizedNetworkException__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct sidlx_rmi_UnrecognizedNetworkException__external
s_externalEntryPoints = {
  sidlx_rmi_UnrecognizedNetworkException__createObject,
  sidlx_rmi_UnrecognizedNetworkException__getSuperEPV,
  2, 
  0
};
...
const struct sidlx_rmi_UnrecognizedNetworkException__external*
sidlx_rmi_UnrecognizedNetworkException__externals(void)
{
