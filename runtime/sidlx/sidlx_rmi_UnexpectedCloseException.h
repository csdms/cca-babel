...
#if !defined(SIDLX_RMI_UNEXPECTEDCLOSEEXCEPTION_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDLX_RMI_UNEXPECTEDCLOSEEXCEPTION_INLINE_DECL inline
#else
#define SIDLX_RMI_UNEXPECTEDCLOSEEXCEPTION_INLINE_DECL extern inline
#endif
 ...
 * Method:  getHopCount[]
 */
SIDLX_RMI_UNEXPECTEDCLOSEEXCEPTION_INLINE_DECL
int32_t
sidlx_rmi_UnexpectedCloseException_getHopCount(
  /* in */ sidlx_rmi_UnexpectedCloseException self,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDLX_RMI_UNEXPECTEDCLOSEEXCEPTION_INLINE_DECL
{
  int32_t _result;
...
#else
;
#endif /* SIDLX_RMI_UNEXPECTEDCLOSEEXCEPTION_INLINE_DECL */
...
SIDLX_RMI_UNEXPECTEDCLOSEEXCEPTION_INLINE_DECL
void
sidlx_rmi_UnexpectedCloseException__set_hooks(
  /* in */ sidlx_rmi_UnexpectedCloseException self,
  /* in */ sidl_bool enable,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDLX_RMI_UNEXPECTEDCLOSEEXCEPTION_INLINE_DECL
