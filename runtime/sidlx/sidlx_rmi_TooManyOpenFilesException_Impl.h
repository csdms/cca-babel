/*
 * File:          sidlx_rmi_TooManyOpenFilesException_Impl.h
...
#ifndef included_sidlx_rmi_TooManyOpenFilesException_Impl_h
#define included_sidlx_rmi_TooManyOpenFilesException_Impl_h
...
#endif
/* DO-NOT-DELETE splicer.begin(sidlx.rmi.TooManyOpenFilesException._hincludes) */
/* insert code here (include files) */
/* DO-NOT-DELETE splicer.end(sidlx.rmi.TooManyOpenFilesException._hincludes) */

/*
 * Private data for class sidlx.rmi.TooManyOpenFilesException
 */

struct sidlx_rmi_TooManyOpenFilesException__data {
  /* DO-NOT-DELETE splicer.begin(sidlx.rmi.TooManyOpenFilesException._data) */
  /* insert code here (private data members) */
  int ignore; /* dummy to force non-empty struct; remove if you add data */
  /* DO-NOT-DELETE splicer.end(sidlx.rmi.TooManyOpenFilesException._data) */
};
...
extern struct sidlx_rmi_TooManyOpenFilesException__data*
sidlx_rmi_TooManyOpenFilesException__get_data(
  sidlx_rmi_TooManyOpenFilesException);

extern void
sidlx_rmi_TooManyOpenFilesException__set_data(
  sidlx_rmi_TooManyOpenFilesException,
  struct sidlx_rmi_TooManyOpenFilesException__data*);
