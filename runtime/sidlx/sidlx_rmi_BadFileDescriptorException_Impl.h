/*
 * File:          sidlx_rmi_BadFileDescriptorException_Impl.h
...
#ifndef included_sidlx_rmi_BadFileDescriptorException_Impl_h
#define included_sidlx_rmi_BadFileDescriptorException_Impl_h
...
#endif
/* DO-NOT-DELETE splicer.begin(sidlx.rmi.BadFileDescriptorException._hincludes) */
/* insert code here (include files) */
/* DO-NOT-DELETE splicer.end(sidlx.rmi.BadFileDescriptorException._hincludes) */

/*
 * Private data for class sidlx.rmi.BadFileDescriptorException
 */

struct sidlx_rmi_BadFileDescriptorException__data {
  /* DO-NOT-DELETE splicer.begin(sidlx.rmi.BadFileDescriptorException._data) */
  /* insert code here (private data members) */
  int ignore; /* dummy to force non-empty struct; remove if you add data */
  /* DO-NOT-DELETE splicer.end(sidlx.rmi.BadFileDescriptorException._data) */
};
...
extern struct sidlx_rmi_BadFileDescriptorException__data*
sidlx_rmi_BadFileDescriptorException__get_data(
  sidlx_rmi_BadFileDescriptorException);

extern void
sidlx_rmi_BadFileDescriptorException__set_data(
  sidlx_rmi_BadFileDescriptorException,
  struct sidlx_rmi_BadFileDescriptorException__data*);
