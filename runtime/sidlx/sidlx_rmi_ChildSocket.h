...
#if !defined(SIDLX_RMI_CHILDSOCKET_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDLX_RMI_CHILDSOCKET_INLINE_DECL inline
#else
#define SIDLX_RMI_CHILDSOCKET_INLINE_DECL extern inline
#endif
 ...
 * Method:  init[]
 */
SIDLX_RMI_CHILDSOCKET_INLINE_DECL
void
sidlx_rmi_ChildSocket_init(
  /* in */ sidlx_rmi_ChildSocket self,
  /* in */ int32_t fileDes,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDLX_RMI_CHILDSOCKET_INLINE_DECL
{
  (*self->d_epv->f_init)(
    self,
    fileDes,
...
#else
;
#endif /* SIDLX_RMI_CHILDSOCKET_INLINE_DECL */
...
SIDLX_RMI_CHILDSOCKET_INLINE_DECL
void
sidlx_rmi_ChildSocket__set_hooks(
  /* in */ sidlx_rmi_ChildSocket self,
  /* in */ sidl_bool enable,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDLX_RMI_CHILDSOCKET_INLINE_DECL
