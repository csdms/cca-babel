/*
 * File:          sidlx_rmi_TimeoutException_IOR.h
...
#define included_sidlx_rmi_TimeoutException_IOR_h
...
struct sidlx_rmi_TimeoutException__epv {
  ...
  /* Methods introduced in sidlx.rmi.TimeoutException-v0.1 */
};
...
struct sidlx_rmi_TimeoutException__cstats {
  sidl_bool use_hooks;
};
...
struct sidlx_rmi_TimeoutException__object {
  ...
  struct sidlx_rmi_TimeoutException__epv*       d_epv;
  void*                                         d_data;
};

struct sidlx_rmi_TimeoutException__external {
  struct sidlx_rmi_TimeoutException__object*
...
extern struct sidlx_rmi_TimeoutException__object*
sidlx_rmi_TimeoutException__createObject(void* ddata,struct 
  sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_TimeoutException__init(
  struct sidlx_rmi_TimeoutException__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_TimeoutException__getEPVs(
  ...
  struct sidlx_rmi_TimeoutException__epv 
    **s_arg_epv__sidlx_rmi_timeoutexception);

extern void sidlx_rmi_TimeoutException__fini(
  struct sidlx_rmi_TimeoutException__object* self, struct 
    sidl_BaseInterface__object ** _ex);

extern void sidlx_rmi_TimeoutException__IOR_version(int32_t *major, int32_t 
  *minor);
...
struct sidl_io_Serializer__object* 
  ...
  sidl_bool ar, struct sidl_BaseInterface__object * *_ex);
struct sidlx_rmi_TimeoutException__remote{
  int d_refcount;
