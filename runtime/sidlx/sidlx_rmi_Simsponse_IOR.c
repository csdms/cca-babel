...
static struct sidlx_rmi_Simsponse__epv s_my_epv__sidlx_rmi_simsponse;
...
static struct sidl_rmi_Response__epv s_my_epv__sidl_rmi_response;
...
sidlx_rmi_Simsponse_init__exec(
  ...
  sock_bc = sidl_rmi_InstanceRegistry_getInstanceByString(sock_str, 
    _ex);SIDL_CHECK(*_ex);
  if(sock_bc != NULL) {
    sock= (struct sidlx_rmi_Simsponse__object*) (*sock_bc->d_epv->f__cast)(
      sock_bc, "sidlx.rmi.Simsponse", _ex);
    if(sock != NULL) {
...
sidlx_rmi_Simsponse_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidlx_rmi_Simsponse__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "sidlx.rmi.Simsponse", _ex);
    if(iobj != NULL) {
...
sidlx_rmi_Simsponse_unpackSerializable__exec(
  ...
  *value = skel_sidlx_rmi_Simsponse_fconnect_sidl_io_Serializable(value_str, 
    FALSE, _ex);SIDL_CHECK(*_ex);
#else
  value_bc = sidl_rmi_InstanceRegistry_getInstanceByString(value_str, 
    _ex);SIDL_CHECK(*_ex);
  if(value_bc != NULL) {
    *value= (struct sidlx_rmi_Simsponse__object*) (*value_bc->d_epv->f__cast)(
      value_bc, "sidlx.rmi.Simsponse", _ex);
    if(*value != NULL) {
...
static void
sidlx_rmi_Simsponse__cast__exec(
        struct sidlx_rmi_Simsponse__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidlx_rmi_Simsponse__set_contracts(
  struct sidlx_rmi_Simsponse__object* self,
  sidl_bool   enable,
...
static void ior_sidlx_rmi_Simsponse__dump_stats(
  struct sidlx_rmi_Simsponse__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidlx_rmi_Simsponse__method  s_methods[] = {
    { "_cast", sidlx_rmi_Simsponse__cast__exec },
 ...
 */
  ...
  struct sidlx_rmi_Simsponse__epv*  epv  = &s_my_epv__sidlx_rmi_simsponse;
  ...
  struct sidl_rmi_Response__epv*    e3   = &s_my_epv__sidl_rmi_response;
  ...
  epv->f__set_contracts          = ior_sidlx_rmi_Simsponse__set_contracts;
  epv->f__dump_stats             = ior_sidlx_rmi_Simsponse__dump_stats;
  epv->f__ctor                   = NULL;
  epv->f__ctor2                  = NULL;
  epv->f__dtor                   = NULL;
  epv->f_init                    = NULL;
  ...
  epv->f_addRef                  = (void (*)(struct sidlx_rmi_Simsponse__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef               = (void (*)(struct sidlx_rmi_Simsponse__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                  = (sidl_bool (*)(struct sidlx_rmi_Simsponse__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                  = (sidl_bool (*)(struct sidlx_rmi_Simsponse__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo            = (struct sidl_ClassInfo__object* (*)(struct sidlx_rmi_Simsponse__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  ...
  /*
   * Override function pointers for sidl.rmi.Response with mine, as needed.
   */
  ...
  e3->f_getExceptionThrown      = (struct sidl_BaseException__object* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getExceptionThrown;
...
/*
 * sidlx_rmi_Simsponse__getEPVs: Get my version of all relevant EPVs.
 */
  ...
  struct sidlx_rmi_Simsponse__epv **s_arg_epv__sidlx_rmi_simsponse)
{
  ...
  *s_arg_epv__sidl_rmi_response = &s_my_epv__sidl_rmi_response;
  *s_arg_epv__sidlx_rmi_simsponse = &s_my_epv__sidlx_rmi_simsponse;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* sidlx_rmi_Simsponse__getSuperEPV(void) {
...
/*
 * sidlx_rmi_Simsponse__createObject: Allocate the object and initialize it.
 */

struct sidlx_rmi_Simsponse__object*
sidlx_rmi_Simsponse__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidlx_rmi_Simsponse__object* self =
    (struct sidlx_rmi_Simsponse__object*) sidl_malloc(
      sizeof(struct sidlx_rmi_Simsponse__object),
      "Object allocation failed for struct sidlx_rmi_Simsponse__object",
        __FILE__, __LINE__, "sidlx_rmi_Simsponse__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_sidl_rmi_response.d_epv    = &s_my_epv__sidl_rmi_response;
  s0->d_epv                        = &s_my_epv__sidlx_rmi_simsponse;
...
s_externalEntryPoints = {
  sidlx_rmi_Simsponse__createObject,
  sidlx_rmi_Simsponse__getSuperEPV,
  2, 
  0
};
