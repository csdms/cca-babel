...
sidlx_rmi_CallType__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct sidlx_rmi_CallType__array*)sidl_long__array_createCol(dimen, 
    lower, upper);
}
...
sidlx_rmi_CallType__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct sidlx_rmi_CallType__array*)sidl_long__array_createRow(dimen, 
    lower, upper);
}
...
{
  return (struct sidlx_rmi_CallType__array*)sidl_long__array_create1d(len);
}
...
sidlx_rmi_CallType__array_create1dInit(
  ...
  int64_t* data)
{
  return (struct sidlx_rmi_CallType__array*)sidl_long__array_create1dInit(len, (
    int64_t*)data);
}
...
{
  return (struct sidlx_rmi_CallType__array*)sidl_long__array_create2dCol(m, n);
}
...
{
  return (struct sidlx_rmi_CallType__array*)sidl_long__array_create2dRow(m, n);
}
...
{
  return (struct sidlx_rmi_CallType__array*)sidl_long__array_borrow(
