...
#define included_sidlx_rmi_SimCall_h
...
typedef struct sidlx_rmi_SimCall__object* sidlx_rmi_SimCall;
...
#if !defined(SIDLX_RMI_SIMCALL_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDLX_RMI_SIMCALL_INLINE_DECL inline
#else
#define SIDLX_RMI_SIMCALL_INLINE_DECL extern inline
#endif
 ...
 */
sidlx_rmi_SimCall
sidlx_rmi_SimCall__connect(const char *, sidl_BaseInterface *_ex);
...
#ifdef SIDLX_RMI_SIMCALL_INLINE_DECL
{
...
#else
;
#endif /* SIDLX_RMI_SIMCALL_INLINE_DECL */
...
#ifdef SIDLX_RMI_SIMCALL_INLINE_DECL
{
  ...
  _result = (enum sidlx_rmi_CallType__enum)(*self->d_epv->f_getCallType)(
    self,
    _ex);
  return (enum sidlx_rmi_CallType__enum)_result;
}
#else
;
#endif /* SIDLX_RMI_SIMCALL_INLINE_DECL */
