/*
 * File:          sidlx_rmi_NetworkUnreachableException_Impl.h
...
#ifndef included_sidlx_rmi_NetworkUnreachableException_Impl_h
#define included_sidlx_rmi_NetworkUnreachableException_Impl_h
...
#endif
/* DO-NOT-DELETE splicer.begin(sidlx.rmi.NetworkUnreachableException._hincludes) */
/* insert code here (include files) */
/* DO-NOT-DELETE splicer.end(sidlx.rmi.NetworkUnreachableException._hincludes) */

/*
 * Private data for class sidlx.rmi.NetworkUnreachableException
 */

struct sidlx_rmi_NetworkUnreachableException__data {
  /* DO-NOT-DELETE splicer.begin(sidlx.rmi.NetworkUnreachableException._data) */
  /* insert code here (private data members) */
  int ignore; /* dummy to force non-empty struct; remove if you add data */
  /* DO-NOT-DELETE splicer.end(sidlx.rmi.NetworkUnreachableException._data) */
};
...
extern struct sidlx_rmi_NetworkUnreachableException__data*
sidlx_rmi_NetworkUnreachableException__get_data(
  sidlx_rmi_NetworkUnreachableException);

extern void
sidlx_rmi_NetworkUnreachableException__set_data(
  sidlx_rmi_NetworkUnreachableException,
  struct sidlx_rmi_NetworkUnreachableException__data*);
