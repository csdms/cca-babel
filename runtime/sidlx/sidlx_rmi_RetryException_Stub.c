/*
 * File:          sidlx_rmi_RetryException_Stub.c
 * Symbol:        sidlx.rmi.RetryException-v0.1
 * Symbol Type:   class
 * Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
 * Description:   Client-side glue code for sidlx.rmi.RetryException
 * 
 * WARNING: Automatically generated; changes will be lost
 * 
 */

#define SIDLX_RMI_RETRYEXCEPTION_INLINE_DECL
...
static const struct sidlx_rmi_RetryException__external *_externals = NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct sidlx_rmi_RetryException__external* _loadIOR(void)
/*
...

{
  ...
  _externals = sidlx_rmi_RetryException__externals();
#else
  _externals = (struct sidlx_rmi_RetryException__external*)sidl_dynamicLoadIOR(
    "sidlx.rmi.RetryException","sidlx_rmi_RetryException__externals") ;
  sidl_checkIORVersion("sidlx.rmi.RetryException", 
...
sidlx_rmi_RetryException__create(sidl_BaseInterface* _ex)
{
  return (*(_getExternals()->createObject))(NULL,_ex);
}

/**
 * Wraps up the private data struct pointer (struct sidlx_rmi_RetryException__data) passed in rather than running the constructor.
 */
sidlx_rmi_RetryException
sidlx_rmi_RetryException__wrapObj(void* data, sidl_BaseInterface* _ex)
{
...
static sidlx_rmi_RetryException sidlx_rmi_RetryException__remoteCreate(const 
...
sidlx_rmi_RetryException
sidlx_rmi_RetryException__createRemote(const char* url, sidl_BaseInterface *_ex)
{
  return sidlx_rmi_RetryException__remoteCreate(url, _ex);
}

static struct sidlx_rmi_RetryException__object* 
  sidlx_rmi_RetryException__remoteConnect(const char* url, sidl_bool ar, 
  sidl_BaseInterface *_ex);
static struct sidlx_rmi_RetryException__object* 
  sidlx_rmi_RetryException__IHConnect(struct sidl_rmi_InstanceHandle__object* 
...
sidlx_rmi_RetryException
sidlx_rmi_RetryException__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidlx_rmi_RetryException__remoteConnect(url, TRUE, _ex);
}
...
void
sidlx_rmi_RetryException__set_contracts(
...
void
sidlx_rmi_RetryException__dump_stats(
  sidlx_rmi_RetryException self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
sidlx_rmi_RetryException
sidlx_rmi_RetryException__cast(
  void* obj,
  sidl_BaseInterface* _ex)
{
  sidlx_rmi_RetryException cast = NULL;

#ifdef WITH_RMI
  static int connect_loaded = 0;
  if (!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("sidlx.rmi.RetryException", (
      void*)sidlx_rmi_RetryException__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
#endif /*WITH_RMI*/
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidlx_rmi_RetryException) (*base->d_epv->f__cast)(
      base->d_object,
      "sidlx.rmi.RetryException", _ex); SIDL_CHECK(*_ex);
  }
...
void*
sidlx_rmi_RetryException__cast2(
  void* obj,
  const char* type,
  sidl_BaseInterface* _ex)
{
...
sidl_bool
sidlx_rmi_RetryException__isLocal(
  /* in */ sidlx_rmi_RetryException self,
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidlx_rmi_RetryException__isRemote(self, _ex);
}
 ...
 * NULL.
 */
struct sidlx_rmi_RetryException__array*
sidlx_rmi_RetryException__array_createCol(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct 
    sidlx_rmi_RetryException__array*)sidl_interface__array_createCol(dimen, 
    lower, upper);
}
 ...
 */
struct sidlx_rmi_RetryException__array*
sidlx_rmi_RetryException__array_createRow(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct 
    sidlx_rmi_RetryException__array*)sidl_interface__array_createRow(dimen, 
    lower, upper);
}
 ...
 */
struct sidlx_rmi_RetryException__array*
sidlx_rmi_RetryException__array_create1d(int32_t len)
{
  return (struct 
    sidlx_rmi_RetryException__array*)sidl_interface__array_create1d(len);
}
 ...
 */
struct sidlx_rmi_RetryException__array*
sidlx_rmi_RetryException__array_create1dInit(
  int32_t len, 
  sidlx_rmi_RetryException* data)
{
  return (struct 
    sidlx_rmi_RetryException__array*)sidl_interface__array_create1dInit(len, (
 ...
 */
struct sidlx_rmi_RetryException__array*
sidlx_rmi_RetryException__array_create2dCol(int32_t m, int32_t n)
{
  return (struct 
    sidlx_rmi_RetryException__array*)sidl_interface__array_create2dCol(m, n);
}
 ...
 */
struct sidlx_rmi_RetryException__array*
sidlx_rmi_RetryException__array_create2dRow(int32_t m, int32_t n)
{
  return (struct 
    sidlx_rmi_RetryException__array*)sidl_interface__array_create2dRow(m, n);
}
 ...
 */
struct sidlx_rmi_RetryException__array*
sidlx_rmi_RetryException__array_borrow(
  sidlx_rmi_RetryException* firstElement,
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[],
  const int32_t stride[])
{
  return (struct sidlx_rmi_RetryException__array*)sidl_interface__array_borrow(
 ...
 */
struct sidlx_rmi_RetryException__array*
sidlx_rmi_RetryException__array_smartCopy(
  struct sidlx_rmi_RetryException__array *array)
{
  return (struct sidlx_rmi_RetryException__array*)
 ...
 */
void
sidlx_rmi_RetryException__array_addRef(
  struct sidlx_rmi_RetryException__array* array)
{
 ...
 */
void
sidlx_rmi_RetryException__array_deleteRef(
  struct sidlx_rmi_RetryException__array* array)
{
 ...
 */
sidlx_rmi_RetryException
sidlx_rmi_RetryException__array_get1(
  const struct sidlx_rmi_RetryException__array* array,
  const int32_t i1)
{
  return (sidlx_rmi_RetryException)
 ...
 */
sidlx_rmi_RetryException
sidlx_rmi_RetryException__array_get2(
  const struct sidlx_rmi_RetryException__array* array,
  const int32_t i1,
  const int32_t i2)
{
 ...
 */
sidlx_rmi_RetryException
sidlx_rmi_RetryException__array_get3(
  const struct sidlx_rmi_RetryException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3)
 ...
 */
sidlx_rmi_RetryException
sidlx_rmi_RetryException__array_get4(
  const struct sidlx_rmi_RetryException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidlx_rmi_RetryException
sidlx_rmi_RetryException__array_get5(
  const struct sidlx_rmi_RetryException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidlx_rmi_RetryException
sidlx_rmi_RetryException__array_get6(
  const struct sidlx_rmi_RetryException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidlx_rmi_RetryException
sidlx_rmi_RetryException__array_get7(
  const struct sidlx_rmi_RetryException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidlx_rmi_RetryException
sidlx_rmi_RetryException__array_get(
  const struct sidlx_rmi_RetryException__array* array,
 ...
 */
void
sidlx_rmi_RetryException__array_set1(
  struct sidlx_rmi_RetryException__array* array,
  const int32_t i1,
  sidlx_rmi_RetryException const value)
{
 ...
 */
void
sidlx_rmi_RetryException__array_set2(
  struct sidlx_rmi_RetryException__array* array,
  const int32_t i1,
  const int32_t i2,
  sidlx_rmi_RetryException const value)
 ...
 */
void
sidlx_rmi_RetryException__array_set3(
  struct sidlx_rmi_RetryException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_RetryException__array_set4(
  struct sidlx_rmi_RetryException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_RetryException__array_set5(
  struct sidlx_rmi_RetryException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_RetryException__array_set6(
  struct sidlx_rmi_RetryException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_RetryException__array_set7(
  struct sidlx_rmi_RetryException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_RetryException__array_set(
  struct sidlx_rmi_RetryException__array* array,
  const int32_t indices[],
  sidlx_rmi_RetryException const value)
{
 ...
 */
int32_t
sidlx_rmi_RetryException__array_dimen(
  const struct sidlx_rmi_RetryException__array* array)
{
 ...
 */
int32_t
sidlx_rmi_RetryException__array_lower(
  const struct sidlx_rmi_RetryException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidlx_rmi_RetryException__array_upper(
  const struct sidlx_rmi_RetryException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidlx_rmi_RetryException__array_length(
  const struct sidlx_rmi_RetryException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidlx_rmi_RetryException__array_stride(
  const struct sidlx_rmi_RetryException__array* array,
  const int32_t ind)
{
 ...
 */
int
sidlx_rmi_RetryException__array_isColumnOrder(
  const struct sidlx_rmi_RetryException__array* array)
{
 ...
 */
int
sidlx_rmi_RetryException__array_isRowOrder(
  const struct sidlx_rmi_RetryException__array* array)
{
 ...
 */
void
sidlx_rmi_RetryException__array_copy(
  const struct sidlx_rmi_RetryException__array* src,
  struct sidlx_rmi_RetryException__array* dest)
{
 ...
 */
struct sidlx_rmi_RetryException__array*
sidlx_rmi_RetryException__array_slice(
  struct sidlx_rmi_RetryException__array* src,
  int32_t        dimen,
 ...
 */
struct sidlx_rmi_RetryException__array*
sidlx_rmi_RetryException__array_ensure(
  struct sidlx_rmi_RetryException__array* src,
  int32_t dimen,
  int     ordering)
{
...
#ifdef HAVE_PTHREAD
static struct sidl_recursive_mutex_t sidlx_rmi_RetryException__mutex= SIDL_RECURSIVE_MUTEX_INITIALIZER;
#define LOCK_STATIC_GLOBALS sidl_recursive_mutex_lock( &sidlx_rmi_RetryException__mutex )
#define UNLOCK_STATIC_GLOBALS sidl_recursive_mutex_unlock( &sidlx_rmi_RetryException__mutex )
/* #define HAVE_LOCKED_STATIC_GLOBALS (sidl_recursive_mutex_trylock( &sidlx_rmi_RetryException__mutex )==EDEADLOCK) */
#else
...
static struct sidlx_rmi_RetryException__epv s_rem_epv__sidlx_rmi_retryexception;
...
static void* remote_sidlx_rmi_RetryException__cast(
  struct sidlx_rmi_RetryException__object* self,
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp) {
    ...
    if (!cmp) {
      ...
      cmp = strcmp(name, "sidlx.rmi.RetryException");
      if (!cmp) {
        (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
        cast = ((struct sidlx_rmi_RetryException__object*)self);
        return cast;
      }
      else if (cmp < 0) {
  ...
  if ((*self->d_epv->f_isType)(self,name, _ex)) {
    ...
    cast =  (*func)(((struct 
      sidlx_rmi_RetryException__remote*)self->d_data)->d_ih, _ex);
  }
...
static void remote_sidlx_rmi_RetryException__delete(
  struct sidlx_rmi_RetryException__object* self,
  struct sidl_BaseInterface__object* *_ex)
{
  *_ex = NULL;
...
static char* remote_sidlx_rmi_RetryException__getURL(
  struct sidlx_rmi_RetryException__object* self, struct 
    sidl_BaseInterface__object* *_ex)
{
  struct sidl_rmi_InstanceHandle__object *conn = ((struct 
    sidlx_rmi_RetryException__remote*)self->d_data)->d_ih;
  *_ex = NULL;
  if(conn != NULL) {
...
static void remote_sidlx_rmi_RetryException__raddRef(
  struct sidlx_rmi_RetryException__object* self,struct 
    sidl_BaseInterface__object* *_ex)
{
...
static sidl_bool
remote_sidlx_rmi_RetryException__isRemote(
    struct sidlx_rmi_RetryException__object* self, 
    struct sidl_BaseInterface__object* *_ex) {
  *_ex = NULL;
  return TRUE;
...
static void
remote_sidlx_rmi_RetryException__set_hooks(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  /* in */ sidl_bool enable,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      ...
      "Exception unserialized from sidlx.rmi.RetryException._set_hooks.",
        &throwaway_exception);
...
static void
remote_sidlx_rmi_RetryException__set_contracts(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  /* in */ sidl_bool enable,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException._set_contracts.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidlx_rmi_RetryException__dump_stats(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException._dump_stats.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void remote_sidlx_rmi_RetryException__exec(
  struct sidlx_rmi_RetryException__object* self,const char* methodName,
...
static int32_t
remote_sidlx_rmi_RetryException_getHopCount(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException.getHopCount.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidlx_rmi_RetryException_setErrno(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  /* in */ int32_t err,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException.setErrno.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static int32_t
remote_sidlx_rmi_RetryException_getErrno(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException.getErrno.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidlx_rmi_RetryException_addRef(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    struct sidlx_rmi_RetryException__remote* r_obj = (struct 
      sidlx_rmi_RetryException__remote*)self->d_data;
    LOCK_STATIC_GLOBALS;
    r_obj->d_refcount++;
#ifdef SIDL_DEBUG_REFCOUNT
    fprintf(stderr, "babel: addRef %p new count %d (type %s)\n",
      r_obj, r_obj->d_refcount, 
      "sidlx.rmi.RetryException Remote Stub");
...
static void
remote_sidlx_rmi_RetryException_deleteRef(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    r_obj->d_refcount--;
#ifdef SIDL_DEBUG_REFCOUNT
    fprintf(stderr, "babel: deleteRef %p new count %d (type %s)\n",r_obj, r_obj->d_refcount, "sidlx.rmi.RetryException Remote Stub");
#endif /* SIDL_DEBUG_REFCOUNT */ 
...
static sidl_bool
remote_sidlx_rmi_RetryException_isSame(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException.isSame.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static sidl_bool
remote_sidlx_rmi_RetryException_isType(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  /* in */ const char* name,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException.isType.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
remote_sidlx_rmi_RetryException_getClassInfo(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException.getClassInfo.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static char*
remote_sidlx_rmi_RetryException_getNote(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException.getNote.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidlx_rmi_RetryException_setNote(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException.setNote.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static char*
remote_sidlx_rmi_RetryException_getTrace(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException.getTrace.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidlx_rmi_RetryException_addLine(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException.addLine.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidlx_rmi_RetryException_add(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  /* in */ const char* filename,
  /* in */ int32_t lineno,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException.add.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidlx_rmi_RetryException_packObj(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException.packObj.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidlx_rmi_RetryException_unpackObj(
  /* in */ struct sidlx_rmi_RetryException__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.RetryException.unpackObj.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void sidlx_rmi_RetryException__init_remote_epv(void)
{
  /* assert( HAVE_LOCKED_STATIC_GLOBALS ); */
  struct sidlx_rmi_RetryException__epv*       epv = 
    &s_rem_epv__sidlx_rmi_retryexception;
  ...
  epv->f__cast               = remote_sidlx_rmi_RetryException__cast;
  epv->f__delete             = remote_sidlx_rmi_RetryException__delete;
  epv->f__exec               = remote_sidlx_rmi_RetryException__exec;
  epv->f__getURL             = remote_sidlx_rmi_RetryException__getURL;
  epv->f__raddRef            = remote_sidlx_rmi_RetryException__raddRef;
  epv->f__isRemote           = remote_sidlx_rmi_RetryException__isRemote;
  epv->f__set_hooks          = remote_sidlx_rmi_RetryException__set_hooks;
  epv->f__set_contracts      = remote_sidlx_rmi_RetryException__set_contracts;
  epv->f__dump_stats         = remote_sidlx_rmi_RetryException__dump_stats;
  epv->f__ctor               = NULL;
  epv->f__ctor2              = NULL;
  epv->f__dtor               = NULL;
  epv->f_getHopCount         = remote_sidlx_rmi_RetryException_getHopCount;
  epv->f_setErrno            = remote_sidlx_rmi_RetryException_setErrno;
  epv->f_getErrno            = remote_sidlx_rmi_RetryException_getErrno;
  epv->f_addRef              = remote_sidlx_rmi_RetryException_addRef;
  epv->f_deleteRef           = remote_sidlx_rmi_RetryException_deleteRef;
  epv->f_isSame              = remote_sidlx_rmi_RetryException_isSame;
  epv->f_isType              = remote_sidlx_rmi_RetryException_isType;
  epv->f_getClassInfo        = remote_sidlx_rmi_RetryException_getClassInfo;
  epv->f_getNote             = remote_sidlx_rmi_RetryException_getNote;
  epv->f_setNote             = remote_sidlx_rmi_RetryException_setNote;
  epv->f_getTrace            = remote_sidlx_rmi_RetryException_getTrace;
  epv->f_addLine             = remote_sidlx_rmi_RetryException_addLine;
  epv->f_add                 = remote_sidlx_rmi_RetryException_add;
  epv->f_packObj             = remote_sidlx_rmi_RetryException_packObj;
  epv->f_unpackObj           = remote_sidlx_rmi_RetryException_unpackObj;
...
static struct sidlx_rmi_RetryException__object*
sidlx_rmi_RetryException__remoteConnect(const char *url, sidl_bool ar, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct sidlx_rmi_RetryException__object* self = NULL;

  struct sidlx_rmi_RetryException__object* s0;
  ...
  struct sidlx_rmi_RetryException__remote* r_obj = NULL;
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    struct sidlx_rmi_RetryException__object* retobj = NULL;
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_BaseInterface bi = (
      sidl_BaseInterface)sidl_rmi_InstanceRegistry_getInstanceByString(objectID,
      _ex); SIDL_CHECK(*_ex);
    (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    retobj = (struct sidlx_rmi_RetryException__object*) (*bi->d_epv->f__cast)(
      bi->d_object, "sidlx.rmi.RetryException", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
    return retobj;
  ...
  instance = sidl_rmi_ProtocolFactory_connectInstance(url, 
    "sidlx.rmi.RetryException", ar, _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidlx_rmi_RetryException__object*) malloc(
      sizeof(struct sidlx_rmi_RetryException__object));

  r_obj =
    (struct sidlx_rmi_RetryException__remote*) malloc(
      sizeof(struct sidlx_rmi_RetryException__remote));
  ...
  if(!self || !r_obj) {
    ...
    sidl_MemAllocException_add(ex, __FILE__, __LINE__, 
      "sidlx.rmi.RetryException.EPVgeneration", _ex);
    SIDL_CHECK(*_ex);
  ...
  if (!s_remote_initialized) {
    sidlx_rmi_RetryException__init_remote_epv();
  }
  UNLOCK_STATIC_GLOBALS;
  ...
  s0->d_epv  = &s_rem_epv__sidlx_rmi_retryexception;
...
static struct sidlx_rmi_RetryException__object*
sidlx_rmi_RetryException__IHConnect(sidl_rmi_InstanceHandle instance, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct sidlx_rmi_RetryException__object* self = NULL;
...
static struct sidlx_rmi_RetryException__object*
sidlx_rmi_RetryException__remoteCreate(const char *url, struct 
  sidl_BaseInterface__object **_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "sidlx.rmi.RetryException", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidlx_rmi_RetryException__object*) malloc(
      sizeof(struct sidlx_rmi_RetryException__object));
...
struct sidlx_rmi_RetryException__object*
sidlx_rmi_RetryException__connectI(const char* url, sidl_bool ar, struct 
  sidl_BaseInterface__object **_ex)
{
  return sidlx_rmi_RetryException__remoteConnect(url, ar, _ex);
}
