...
static struct sidlx_rmi_SimpleTicketBook__epv 
  s_my_epv__sidlx_rmi_simpleticketbook;
...
static struct sidl_rmi_TicketBook__epv s_my_epv__sidl_rmi_ticketbook;
...
sidlx_rmi_SimpleTicketBook_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidlx_rmi_SimpleTicketBook__object*) (
      *iobj_bc->d_epv->f__cast)(iobj_bc, "sidlx.rmi.SimpleTicketBook", _ex);
    if(iobj != NULL) {
...
sidlx_rmi_SimpleTicketBook_insertWithID__exec(
  ...
  t = skel_sidlx_rmi_SimpleTicketBook_fconnect_sidl_rmi_Ticket(t_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  t_bc = sidl_rmi_InstanceRegistry_getInstanceByString(t_str, _ex);SIDL_CHECK(
    *_ex);
  if(t_bc != NULL) {
    t= (struct sidlx_rmi_SimpleTicketBook__object*) (*t_bc->d_epv->f__cast)(
      t_bc, "sidlx.rmi.SimpleTicketBook", _ex);
    if(t != NULL) {
      (((struct sidl_BaseInterface__object*)(t))->d_epv->f_deleteRef)(((struct 
        sidl_BaseInterface__object*)t)->d_object, _ex); SIDL_CHECK(*_ex);
    } else {
      (*t_bc->d_epv->f_deleteRef)(t_bc, _ex);
    }
  }
#endif /* WITH_RMI */
  ...
  if(t_str) {free(t_str);}
  if(t) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)t, &_ex3); EXEC_CHECK(
      _ex3);
  }
  EXEC_ERR:
  if(*_ex) { 
...
sidlx_rmi_SimpleTicketBook_removeReady__exec(
  ...
  EXIT:
  /* clean-up dangling references */
  if(*t && sidl_BaseInterface__isRemote((sidl_BaseInterface)*t, 
    &_throwaway_exception)) {
    (*((sidl_BaseInterface)*t)->d_epv->f__raddRef)(((
      sidl_BaseInterface)*t)->d_object, &_ex3); EXEC_CHECK(_ex3);
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)*t, &_ex3); EXEC_CHECK(
      _ex3);
  }
  EXEC_ERR:
...
static void
sidlx_rmi_SimpleTicketBook__cast__exec(
        struct sidlx_rmi_SimpleTicketBook__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidlx_rmi_SimpleTicketBook__set_contracts(
  struct sidlx_rmi_SimpleTicketBook__object* self,
  sidl_bool   enable,
...
static void ior_sidlx_rmi_SimpleTicketBook__dump_stats(
  struct sidlx_rmi_SimpleTicketBook__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp) {
    ...
    cmp = strcmp(name, "sidlx.rmi.SimpleTicketBook");
    if (!cmp) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
      ...
      cmp = strcmp(name, "sidl.rmi.TicketBook");
      if (!cmp) {
        (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidlx_rmi_SimpleTicketBook__method  s_methods[] = {
    { "_cast", sidlx_rmi_SimpleTicketBook__cast__exec },
 ...
 */
  ...
  struct sidlx_rmi_SimpleTicketBook__epv*  epv  = &s_my_epv__sidlx_rmi_simpleticketbook;
  ...
  struct sidl_rmi_TicketBook__epv*         e3   = &s_my_epv__sidl_rmi_ticketbook;
  ...
  epv->f__set_contracts        = ior_sidlx_rmi_SimpleTicketBook__set_contracts;
  epv->f__dump_stats           = ior_sidlx_rmi_SimpleTicketBook__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct sidlx_rmi_SimpleTicketBook__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidlx_rmi_SimpleTicketBook__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidlx_rmi_SimpleTicketBook__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidlx_rmi_SimpleTicketBook__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidlx_rmi_SimpleTicketBook__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  ...
  /*
   * Override function pointers for sidl.rmi.TicketBook with mine, as needed.
   */
  ...
  e3->f_insertWithID          = (void (*)(void*,struct sidl_rmi_Ticket__object*,int32_t,struct sidl_BaseInterface__object **)) epv->f_insertWithID;
  e3->f_insert                = (int32_t (*)(void*,struct sidl_rmi_Ticket__object*,struct sidl_BaseInterface__object **)) epv->f_insert;
  e3->f_removeReady           = (int32_t (*)(void*,struct sidl_rmi_Ticket__object**,struct sidl_BaseInterface__object **)) epv->f_removeReady;
  e3->f_isEmpty               = (sidl_bool (*)(void*,struct sidl_BaseInterface__object **)) epv->f_isEmpty;
  e3->f_block                 = (void (*)(void*,struct sidl_BaseInterface__object **)) epv->f_block;
  e3->f_test                  = (sidl_bool (*)(void*,struct sidl_BaseInterface__object **)) epv->f_test;
  e3->f_createEmptyTicketBook = (struct sidl_rmi_TicketBook__object* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_createEmptyTicketBook;
  e3->f_getResponse           = (struct sidl_rmi_Response__object* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getResponse;
...
/*
 * sidlx_rmi_SimpleTicketBook__getEPVs: Get my version of all relevant EPVs.
 */
...
void sidlx_rmi_SimpleTicketBook__getEPVs (
  ...
  struct sidlx_rmi_SimpleTicketBook__epv **s_arg_epv__sidlx_rmi_simpleticketbook)
{
  LOCK_STATIC_GLOBALS;
  ...
  *s_arg_epv__sidl_rmi_ticketbook = &s_my_epv__sidl_rmi_ticketbook;
  *s_arg_epv__sidlx_rmi_simpleticketbook = &s_my_epv__sidlx_rmi_simpleticketbook;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* sidlx_rmi_SimpleTicketBook__getSuperEPV(void) {
...
static void
initMetadata(struct sidlx_rmi_SimpleTicketBook__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * sidlx_rmi_SimpleTicketBook__createObject: Allocate the object and initialize it.
 */

struct sidlx_rmi_SimpleTicketBook__object*
sidlx_rmi_SimpleTicketBook__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidlx_rmi_SimpleTicketBook__object* self =
    (struct sidlx_rmi_SimpleTicketBook__object*) sidl_malloc(
      sizeof(struct sidlx_rmi_SimpleTicketBook__object),
      "Object allocation failed for struct sidlx_rmi_SimpleTicketBook__object",
        __FILE__, __LINE__, "sidlx_rmi_SimpleTicketBook__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_sidl_rmi_ticketbook.d_epv = &s_my_epv__sidl_rmi_ticketbook;
  s0->d_epv                       = &s_my_epv__sidlx_rmi_simpleticketbook;
...
s_externalEntryPoints = {
  sidlx_rmi_SimpleTicketBook__createObject,
  sidlx_rmi_SimpleTicketBook__getSuperEPV,
  2, 
  0
};
