...
#if !defined(SIDLX_RMI_SERVERSOCKET_INLINE_DECL)
...
#define SIDLX_RMI_SERVERSOCKET_INLINE_DECL inline
#else
#define SIDLX_RMI_SERVERSOCKET_INLINE_DECL extern inline
#endif /* can inline */
#else  /* still need definition */
#define SIDLX_RMI_SERVERSOCKET_INLINE_DECL
#endif /* inline definition needed */
#endif /* SIDLX_RMI_SERVERSOCKET_INLINE_DECL */
 ...
 */
SIDLX_RMI_SERVERSOCKET_INLINE_DECL
int32_t
sidlx_rmi_ServerSocket_init(
  /* in */ sidlx_rmi_ServerSocket self,
  /* in */ int32_t port,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDLX_RMI_SERVERSOCKET_INLINE_DECL
{
  int32_t _result;
...
SIDLX_RMI_SERVERSOCKET_INLINE_DECL
int32_t
sidlx_rmi_ServerSocket_initLocal(
  /* in */ sidlx_rmi_ServerSocket self,
  /* in */ int32_t port,
...
{
  int32_t _result;
  _result = (*self->d_epv->f_initLocal)(
    self,
    port,
    loopback,
    _ex);
