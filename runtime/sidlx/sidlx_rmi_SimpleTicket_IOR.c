/*
 * File:          sidlx_rmi_SimpleTicket_IOR.c
...
static struct sidlx_rmi_SimpleTicket__epv s_my_epv__sidlx_rmi_simpleticket;
...
static struct sidl_rmi_Ticket__epv s_my_epv__sidl_rmi_ticket;
...
extern void sidlx_rmi_SimpleTicket__set_epv(
  struct sidlx_rmi_SimpleTicket__epv* epv);

extern void sidlx_rmi_SimpleTicket__call_load(void);
#ifdef __cplusplus
}
#endif

static void
sidlx_rmi_SimpleTicket_setResponse__exec(
  ...
  sidl_rmi_Call_unpackString( inArgs, "r", &r_str, _ex);SIDL_CHECK(*_ex);
#ifdef WITH_RMI

  r = skel_sidlx_rmi_SimpleTicket_fconnect_sidl_rmi_Response(r_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  r_bc = sidl_rmi_InstanceRegistry_getInstanceByString(r_str, _ex);SIDL_CHECK(
    *_ex);
  if(r_bc != NULL) {
    r= (struct sidlx_rmi_SimpleTicket__object*) (*r_bc->d_epv->f__cast)(r_bc, 
      "sidlx.rmi.SimpleTicket", _ex);
    if(r != NULL) {
      (((struct sidl_BaseInterface__object*)(r))->d_epv->f_deleteRef)(((struct 
        sidl_BaseInterface__object*)r)->d_object, _ex); SIDL_CHECK(*_ex);
    } else {
      (*r_bc->d_epv->f_deleteRef)(r_bc, _ex);
    }
  }
#endif /* WITH_RMI */
  ...
  if(r_str) {free(r_str);}
  if(r) {
    sidl_BaseInterface_deleteRef((sidl_BaseInterface)r, &_ex3); EXEC_CHECK(
      _ex3);
  }
  EXEC_ERR:
  if(*_ex) { 
...
static void
sidlx_rmi_SimpleTicket_addRef__exec(
        struct sidlx_rmi_SimpleTicket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_SimpleTicket_deleteRef__exec(
        struct sidlx_rmi_SimpleTicket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_SimpleTicket_isSame__exec(
        struct sidlx_rmi_SimpleTicket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_sidlx_rmi_SimpleTicket_fconnect_sidl_BaseInterface(iobj_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidlx_rmi_SimpleTicket__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "sidlx.rmi.SimpleTicket", _ex);
    if(iobj != NULL) {
...
static void
sidlx_rmi_SimpleTicket_isType__exec(
        struct sidlx_rmi_SimpleTicket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_SimpleTicket_getClassInfo__exec(
        struct sidlx_rmi_SimpleTicket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_SimpleTicket_block__exec(
        struct sidlx_rmi_SimpleTicket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_SimpleTicket_test__exec(
        struct sidlx_rmi_SimpleTicket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_SimpleTicket_createEmptyTicketBook__exec(
        struct sidlx_rmi_SimpleTicket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_SimpleTicket_getResponse__exec(
        struct sidlx_rmi_SimpleTicket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_SimpleTicket__cast__exec(
        struct sidlx_rmi_SimpleTicket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidlx_rmi_SimpleTicket__set_contracts(
  struct sidlx_rmi_SimpleTicket__object* self,
  sidl_bool   enable,
...
static void ior_sidlx_rmi_SimpleTicket__dump_stats(
  struct sidlx_rmi_SimpleTicket__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_sidlx_rmi_SimpleTicket__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    sidlx_rmi_SimpleTicket__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_sidlx_rmi_SimpleTicket__cast(
  struct sidlx_rmi_SimpleTicket__object* self,
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  cmp = strcmp(name, "sidl.rmi.Ticket");
  if (!cmp) {
    ...
    cmp = strcmp(name, "sidlx.rmi.SimpleTicket");
    if (!cmp) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
...
static void ior_sidlx_rmi_SimpleTicket__set_hooks(
  struct sidlx_rmi_SimpleTicket__object* self,
...
static void ior_sidlx_rmi_SimpleTicket__delete(
  struct sidlx_rmi_SimpleTicket__object* self, struct 
    sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  sidlx_rmi_SimpleTicket__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct sidlx_rmi_SimpleTicket__object));
  free((void*) self);
}

static char*
ior_sidlx_rmi_SimpleTicket__getURL(
  struct sidlx_rmi_SimpleTicket__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_sidlx_rmi_SimpleTicket__raddRef(
    struct sidlx_rmi_SimpleTicket__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_sidlx_rmi_SimpleTicket__isRemote(
    struct sidlx_rmi_SimpleTicket__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct sidlx_rmi_SimpleTicket__method {
  const char *d_name;
  void (*d_func)(struct sidlx_rmi_SimpleTicket__object*,
...
static void
ior_sidlx_rmi_SimpleTicket__exec(
  struct sidlx_rmi_SimpleTicket__object* self,
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidlx_rmi_SimpleTicket__method  s_methods[] = {
    { "_cast", sidlx_rmi_SimpleTicket__cast__exec },
    { "addRef", sidlx_rmi_SimpleTicket_addRef__exec },
    { "block", sidlx_rmi_SimpleTicket_block__exec },
    { "createEmptyTicketBook", 
      sidlx_rmi_SimpleTicket_createEmptyTicketBook__exec },
    { "deleteRef", sidlx_rmi_SimpleTicket_deleteRef__exec },
    { "getClassInfo", sidlx_rmi_SimpleTicket_getClassInfo__exec },
    { "getResponse", sidlx_rmi_SimpleTicket_getResponse__exec },
    { "isSame", sidlx_rmi_SimpleTicket_isSame__exec },
    { "isType", sidlx_rmi_SimpleTicket_isType__exec },
    { "setResponse", sidlx_rmi_SimpleTicket_setResponse__exec },
    { "test", sidlx_rmi_SimpleTicket_test__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct sidlx_rmi_SimpleTicket__method);
  *_ex  = NULL; /* default to no exception */
...
static void sidlx_rmi_SimpleTicket__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct sidlx_rmi_SimpleTicket__epv*  epv  = &s_my_epv__sidlx_rmi_simpleticket;
  struct sidl_BaseClass__epv*          e0   = &s_my_epv__sidl_baseclass;
  struct sidl_BaseInterface__epv*      e1   = &s_my_epv__sidl_baseinterface;
  struct sidl_rmi_Ticket__epv*         e2   = &s_my_epv__sidl_rmi_ticket;
  ...
  epv->f__cast                 = ior_sidlx_rmi_SimpleTicket__cast;
  epv->f__delete               = ior_sidlx_rmi_SimpleTicket__delete;
  epv->f__exec                 = ior_sidlx_rmi_SimpleTicket__exec;
  epv->f__getURL               = ior_sidlx_rmi_SimpleTicket__getURL;
  epv->f__raddRef              = ior_sidlx_rmi_SimpleTicket__raddRef;
  epv->f__isRemote             = ior_sidlx_rmi_SimpleTicket__isRemote;
  epv->f__set_hooks            = ior_sidlx_rmi_SimpleTicket__set_hooks;
  epv->f__set_contracts        = ior_sidlx_rmi_SimpleTicket__set_contracts;
  epv->f__dump_stats           = ior_sidlx_rmi_SimpleTicket__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_setResponse           = NULL;
  epv->f_addRef                = (void (*)(struct sidlx_rmi_SimpleTicket__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidlx_rmi_SimpleTicket__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidlx_rmi_SimpleTicket__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidlx_rmi_SimpleTicket__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidlx_rmi_SimpleTicket__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_block                 = NULL;
  epv->f_test                  = NULL;
  epv->f_createEmptyTicketBook = NULL;
  epv->f_getResponse           = NULL;

  sidlx_rmi_SimpleTicket__set_epv(epv);
  ...
  /*
   * Override function pointers for sidl.rmi.Ticket with mine, as needed.
   */
  ...
  e2->f_block                 = (void (*)(void*,struct sidl_BaseInterface__object **)) epv->f_block;
  e2->f_test                  = (sidl_bool (*)(void*,struct sidl_BaseInterface__object **)) epv->f_test;
  e2->f_createEmptyTicketBook = (struct sidl_rmi_TicketBook__object* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_createEmptyTicketBook;
  e2->f_getResponse           = (struct sidl_rmi_Response__object* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getResponse;
  ...
  ior_sidlx_rmi_SimpleTicket__ensure_load_called();
}

/*
 * sidlx_rmi_SimpleTicket__getEPVs: Get my version of all relevant EPVs.
 */

void sidlx_rmi_SimpleTicket__getEPVs (
  ...
  struct sidlx_rmi_SimpleTicket__epv **s_arg_epv__sidlx_rmi_simpleticket)
{
  ...
  if (!s_method_initialized) {
    sidlx_rmi_SimpleTicket__init_epv();
  }
  UNLOCK_STATIC_GLOBALS;

  *s_arg_epv__sidl_baseinterface = &s_my_epv__sidl_baseinterface;
  *s_arg_epv__sidl_baseclass = &s_my_epv__sidl_baseclass;
  *s_arg_epv__sidl_rmi_ticket = &s_my_epv__sidl_rmi_ticket;
  *s_arg_epv__sidlx_rmi_simpleticket = &s_my_epv__sidlx_rmi_simpleticket;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* sidlx_rmi_SimpleTicket__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidlx.rmi.SimpleTicket", _ex);
...
static void
initMetadata(struct sidlx_rmi_SimpleTicket__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * sidlx_rmi_SimpleTicket__createObject: Allocate the object and initialize it.
 */

struct sidlx_rmi_SimpleTicket__object*
sidlx_rmi_SimpleTicket__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidlx_rmi_SimpleTicket__object* self =
    (struct sidlx_rmi_SimpleTicket__object*) sidl_malloc(
      sizeof(struct sidlx_rmi_SimpleTicket__object),
      "Object allocation failed for struct sidlx_rmi_SimpleTicket__object",
        __FILE__, __LINE__, "sidlx_rmi_SimpleTicket__createObject", _ex);
  if (!self) goto EXIT;
  sidlx_rmi_SimpleTicket__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void sidlx_rmi_SimpleTicket__init(
  struct sidlx_rmi_SimpleTicket__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct sidlx_rmi_SimpleTicket__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_sidl_rmi_ticket.d_epv = &s_my_epv__sidl_rmi_ticket;
  s0->d_epv                   = &s_my_epv__sidlx_rmi_simpleticket;
...
void sidlx_rmi_SimpleTicket__fini(
  struct sidlx_rmi_SimpleTicket__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct sidlx_rmi_SimpleTicket__object* s0 = self;
...
void
sidlx_rmi_SimpleTicket__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct sidlx_rmi_SimpleTicket__external
s_externalEntryPoints = {
  sidlx_rmi_SimpleTicket__createObject,
  sidlx_rmi_SimpleTicket__getSuperEPV,
  2, 
  0
};
