/*
 * File:          sidlx_rmi_UnrecoverableException_Stub.c
 * Symbol:        sidlx.rmi.UnrecoverableException-v0.1
 * Symbol Type:   class
 * Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
 * Description:   Client-side glue code for sidlx.rmi.UnrecoverableException
 * 
 * WARNING: Automatically generated; changes will be lost
 * 
 */

#define SIDLX_RMI_UNRECOVERABLEEXCEPTION_INLINE_DECL
...
static const struct sidlx_rmi_UnrecoverableException__external *_externals = 
  NULL;
/*
 * Lookup the symbol to get the IOR functions.
 */

static const struct sidlx_rmi_UnrecoverableException__external* _loadIOR(void)
/*
...

{
  ...
  _externals = sidlx_rmi_UnrecoverableException__externals();
#else
  _externals = (struct 
    sidlx_rmi_UnrecoverableException__external*)sidl_dynamicLoadIOR(
    "sidlx.rmi.UnrecoverableException",
    "sidlx_rmi_UnrecoverableException__externals") ;
  sidl_checkIORVersion("sidlx.rmi.UnrecoverableException", 
...
sidlx_rmi_UnrecoverableException
sidlx_rmi_UnrecoverableException__create(sidl_BaseInterface* _ex)
{
  return (*(_getExternals()->createObject))(NULL,_ex);
}

/**
 * Wraps up the private data struct pointer (struct sidlx_rmi_UnrecoverableException__data) passed in rather than running the constructor.
 */
sidlx_rmi_UnrecoverableException
sidlx_rmi_UnrecoverableException__wrapObj(void* data, sidl_BaseInterface* _ex)
{
...
static sidlx_rmi_UnrecoverableException 
  sidlx_rmi_UnrecoverableException__remoteCreate(const char* url, 
...
sidlx_rmi_UnrecoverableException
sidlx_rmi_UnrecoverableException__createRemote(const char* url, 
  sidl_BaseInterface *_ex)
{
  return sidlx_rmi_UnrecoverableException__remoteCreate(url, _ex);
}
...
static struct sidlx_rmi_UnrecoverableException__object* 
  ...
  sidl_BaseInterface *_ex);
static struct sidlx_rmi_UnrecoverableException__object* 
  sidlx_rmi_UnrecoverableException__IHConnect(struct 
...
sidlx_rmi_UnrecoverableException
sidlx_rmi_UnrecoverableException__connect(const char* url, sidl_BaseInterface 
  *_ex)
{
  return sidlx_rmi_UnrecoverableException__remoteConnect(url, TRUE, _ex);
}
...
void
sidlx_rmi_UnrecoverableException__set_contracts(
  sidlx_rmi_UnrecoverableException self,
  sidl_bool   enable,
...
void
sidlx_rmi_UnrecoverableException__dump_stats(
  sidlx_rmi_UnrecoverableException self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
sidlx_rmi_UnrecoverableException
sidlx_rmi_UnrecoverableException__cast(
  void* obj,
  sidl_BaseInterface* _ex)
{
  sidlx_rmi_UnrecoverableException cast = NULL;
  ...
  if (!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("sidlx.rmi.UnrecoverableException",
      (void*)sidlx_rmi_UnrecoverableException__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
#endif /*WITH_RMI*/
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidlx_rmi_UnrecoverableException) (*base->d_epv->f__cast)(
      base->d_object,
      "sidlx.rmi.UnrecoverableException", _ex); SIDL_CHECK(*_ex);
  }
...
void*
sidlx_rmi_UnrecoverableException__cast2(
  void* obj,
  const char* type,
  sidl_BaseInterface* _ex)
{
...
sidl_bool
sidlx_rmi_UnrecoverableException__isLocal(
  /* in */ sidlx_rmi_UnrecoverableException self,
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidlx_rmi_UnrecoverableException__isRemote(self, _ex);
}
 ...
 * NULL.
 */
struct sidlx_rmi_UnrecoverableException__array*
sidlx_rmi_UnrecoverableException__array_createCol(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct 
    sidlx_rmi_UnrecoverableException__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
 ...
 */
struct sidlx_rmi_UnrecoverableException__array*
sidlx_rmi_UnrecoverableException__array_createRow(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
 ...
 */
struct sidlx_rmi_UnrecoverableException__array*
sidlx_rmi_UnrecoverableException__array_create1d(int32_t len)
{
  return (struct 
    sidlx_rmi_UnrecoverableException__array*)sidl_interface__array_create1d(
    len);
}
 ...
 */
struct sidlx_rmi_UnrecoverableException__array*
sidlx_rmi_UnrecoverableException__array_create1dInit(
  int32_t len, 
  sidlx_rmi_UnrecoverableException* data)
{
  return (struct 
    sidlx_rmi_UnrecoverableException__array*)sidl_interface__array_create1dInit(
 ...
 */
struct sidlx_rmi_UnrecoverableException__array*
sidlx_rmi_UnrecoverableException__array_create2dCol(int32_t m, int32_t n)
{
  return (struct 
    sidlx_rmi_UnrecoverableException__array*)sidl_interface__array_create2dCol(
    m, n);
}
 ...
 */
struct sidlx_rmi_UnrecoverableException__array*
sidlx_rmi_UnrecoverableException__array_create2dRow(int32_t m, int32_t n)
{
  return (struct 
    sidlx_rmi_UnrecoverableException__array*)sidl_interface__array_create2dRow(
    m, n);
}
 ...
 */
struct sidlx_rmi_UnrecoverableException__array*
sidlx_rmi_UnrecoverableException__array_borrow(
  sidlx_rmi_UnrecoverableException* firstElement,
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[],
...
{
  return (struct 
    sidlx_rmi_UnrecoverableException__array*)sidl_interface__array_borrow(
 ...
 */
struct sidlx_rmi_UnrecoverableException__array*
sidlx_rmi_UnrecoverableException__array_smartCopy(
  struct sidlx_rmi_UnrecoverableException__array *array)
{
  return (struct sidlx_rmi_UnrecoverableException__array*)
 ...
 */
void
sidlx_rmi_UnrecoverableException__array_addRef(
  struct sidlx_rmi_UnrecoverableException__array* array)
{
 ...
 */
void
sidlx_rmi_UnrecoverableException__array_deleteRef(
  struct sidlx_rmi_UnrecoverableException__array* array)
{
 ...
 */
sidlx_rmi_UnrecoverableException
sidlx_rmi_UnrecoverableException__array_get1(
  const struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t i1)
{
  return (sidlx_rmi_UnrecoverableException)
 ...
 */
sidlx_rmi_UnrecoverableException
sidlx_rmi_UnrecoverableException__array_get2(
  const struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t i1,
  const int32_t i2)
{
 ...
 */
sidlx_rmi_UnrecoverableException
sidlx_rmi_UnrecoverableException__array_get3(
  const struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3)
 ...
 */
sidlx_rmi_UnrecoverableException
sidlx_rmi_UnrecoverableException__array_get4(
  const struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidlx_rmi_UnrecoverableException
sidlx_rmi_UnrecoverableException__array_get5(
  const struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidlx_rmi_UnrecoverableException
sidlx_rmi_UnrecoverableException__array_get6(
  const struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidlx_rmi_UnrecoverableException
sidlx_rmi_UnrecoverableException__array_get7(
  const struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidlx_rmi_UnrecoverableException
sidlx_rmi_UnrecoverableException__array_get(
  const struct sidlx_rmi_UnrecoverableException__array* array,
 ...
 */
void
sidlx_rmi_UnrecoverableException__array_set1(
  struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t i1,
  sidlx_rmi_UnrecoverableException const value)
{
 ...
 */
void
sidlx_rmi_UnrecoverableException__array_set2(
  struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t i1,
  const int32_t i2,
  sidlx_rmi_UnrecoverableException const value)
 ...
 */
void
sidlx_rmi_UnrecoverableException__array_set3(
  struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_UnrecoverableException__array_set4(
  struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_UnrecoverableException__array_set5(
  struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_UnrecoverableException__array_set6(
  struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_UnrecoverableException__array_set7(
  struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidlx_rmi_UnrecoverableException__array_set(
  struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t indices[],
  sidlx_rmi_UnrecoverableException const value)
{
 ...
 */
int32_t
sidlx_rmi_UnrecoverableException__array_dimen(
  const struct sidlx_rmi_UnrecoverableException__array* array)
{
 ...
 */
int32_t
sidlx_rmi_UnrecoverableException__array_lower(
  const struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidlx_rmi_UnrecoverableException__array_upper(
  const struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidlx_rmi_UnrecoverableException__array_length(
  const struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidlx_rmi_UnrecoverableException__array_stride(
  const struct sidlx_rmi_UnrecoverableException__array* array,
  const int32_t ind)
{
 ...
 */
int
sidlx_rmi_UnrecoverableException__array_isColumnOrder(
  const struct sidlx_rmi_UnrecoverableException__array* array)
{
 ...
 */
int
sidlx_rmi_UnrecoverableException__array_isRowOrder(
  const struct sidlx_rmi_UnrecoverableException__array* array)
{
 ...
 */
void
sidlx_rmi_UnrecoverableException__array_copy(
  const struct sidlx_rmi_UnrecoverableException__array* src,
  struct sidlx_rmi_UnrecoverableException__array* dest)
{
 ...
 */
struct sidlx_rmi_UnrecoverableException__array*
sidlx_rmi_UnrecoverableException__array_slice(
  struct sidlx_rmi_UnrecoverableException__array* src,
  int32_t        dimen,
 ...
 */
struct sidlx_rmi_UnrecoverableException__array*
sidlx_rmi_UnrecoverableException__array_ensure(
  struct sidlx_rmi_UnrecoverableException__array* src,
  int32_t dimen,
  int     ordering)
{
...
static void remote_sidlx_rmi_UnrecoverableException__exec(
  struct sidlx_rmi_UnrecoverableException__object* self,const char* methodName,
...
static void sidlx_rmi_UnrecoverableException__init_remote_epv(void)
{
  ...
  epv->f__delete             = remote_sidlx_rmi_UnrecoverableException__delete;
  epv->f__exec               = remote_sidlx_rmi_UnrecoverableException__exec;
  epv->f__getURL             = remote_sidlx_rmi_UnrecoverableException__getURL;
  epv->f__raddRef            = remote_sidlx_rmi_UnrecoverableException__raddRef;
  epv->f__isRemote           = 
    remote_sidlx_rmi_UnrecoverableException__isRemote;
  epv->f__set_hooks          = 
    remote_sidlx_rmi_UnrecoverableException__set_hooks;
  ...
  epv->f_getHopCount         = 
    remote_sidlx_rmi_UnrecoverableException_getHopCount;
  epv->f_setErrno            = remote_sidlx_rmi_UnrecoverableException_setErrno;
  epv->f_getErrno            = remote_sidlx_rmi_UnrecoverableException_getErrno;
  ...
  epv->f_getClassInfo        = 
    remote_sidlx_rmi_UnrecoverableException_getClassInfo;
  epv->f_getNote             = remote_sidlx_rmi_UnrecoverableException_getNote;
  epv->f_setNote             = remote_sidlx_rmi_UnrecoverableException_setNote;
  epv->f_getTrace            = remote_sidlx_rmi_UnrecoverableException_getTrace;
  epv->f_addLine             = remote_sidlx_rmi_UnrecoverableException_addLine;
  epv->f_add                 = remote_sidlx_rmi_UnrecoverableException_add;
  epv->f_packObj             = remote_sidlx_rmi_UnrecoverableException_packObj;
  epv->f_unpackObj           = 
    remote_sidlx_rmi_UnrecoverableException_unpackObj;
