...
#if !defined(SIDLX_RMI_IPV4SOCKET_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDLX_RMI_IPV4SOCKET_INLINE_DECL inline
#else
#define SIDLX_RMI_IPV4SOCKET_INLINE_DECL extern inline
#endif
 ...
 * Method:  getsockname[]
 */
SIDLX_RMI_IPV4SOCKET_INLINE_DECL
int32_t
...
#ifdef SIDLX_RMI_IPV4SOCKET_INLINE_DECL
{
  int32_t _result;
...
#else
;
#endif /* SIDLX_RMI_IPV4SOCKET_INLINE_DECL */
