...
#define included_sidlx_rmi_JimEchoServer_h
...
typedef struct sidlx_rmi_JimEchoServer__object* sidlx_rmi_JimEchoServer;
...
#if !defined(SIDLX_RMI_JIMECHOSERVER_INLINE_DECL)
...
#define SIDLX_RMI_JIMECHOSERVER_INLINE_DECL inline
#else
#define SIDLX_RMI_JIMECHOSERVER_INLINE_DECL extern inline
#endif /* can inline */
#else  /* still need definition */
#define SIDLX_RMI_JIMECHOSERVER_INLINE_DECL
#endif /* inline definition needed */
#endif /* SIDLX_RMI_JIMECHOSERVER_INLINE_DECL */
 ...
 */
sidlx_rmi_JimEchoServer
sidlx_rmi_JimEchoServer__connect(const char *, sidl_BaseInterface *_ex);
...
SIDLX_RMI_JIMECHOSERVER_INLINE_DECL
sidl_bool
sidlx_rmi_JimEchoServer_requestLocalPort(
  /* in */ sidlx_rmi_JimEchoServer self,
  /* in */ int32_t port,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDLX_RMI_JIMECHOSERVER_INLINE_DECL
{
  sidl_bool _result;
  _result = (*self->d_epv->f_requestLocalPort)(
    self,
    port,
    _ex);
  return _result;
...
SIDLX_RMI_JIMECHOSERVER_INLINE_DECL
sidl_bool
sidlx_rmi_JimEchoServer_requestLocalPortInRange(
  /* in */ sidlx_rmi_JimEchoServer self,
  /* in */ int32_t minport,
  /* in */ int32_t maxport,
  /* out */ sidl_BaseInterface *_ex)
...
{
  sidl_bool _result;
  _result = (*self->d_epv->f_requestLocalPortInRange)(
    self,
    minport,
    maxport,
    _ex);
...
SIDLX_RMI_JIMECHOSERVER_INLINE_DECL
void
sidlx_rmi_JimEchoServer_shutdownNoWait(
  /* in */ sidlx_rmi_JimEchoServer self,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDLX_RMI_JIMECHOSERVER_INLINE_DECL
{
...
SIDLX_RMI_JIMECHOSERVER_INLINE_DECL
sidl_bool
sidlx_rmi_JimEchoServer_isRunning(
  /* in */ sidlx_rmi_JimEchoServer self,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDLX_RMI_JIMECHOSERVER_INLINE_DECL
{
...
#pragma weak sidlx_rmi_JimEchoServer__connectI
