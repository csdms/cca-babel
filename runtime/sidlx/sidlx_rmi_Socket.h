...
#if !defined(SIDLX_RMI_SOCKET_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDLX_RMI_SOCKET_INLINE_DECL inline
#else
#define SIDLX_RMI_SOCKET_INLINE_DECL extern inline
#endif
 ...
 */
sidlx_rmi_Socket
sidlx_rmi_Socket__createRemote(const char * url, sidl_BaseInterface *_ex);
 ...
 * Method:  close[]
 */
SIDLX_RMI_SOCKET_INLINE_DECL
int32_t
sidlx_rmi_Socket_close(
  /* in */ sidlx_rmi_Socket self,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDLX_RMI_SOCKET_INLINE_DECL
{
  int32_t _result;
...
#else
;
#endif /* SIDLX_RMI_SOCKET_INLINE_DECL */
