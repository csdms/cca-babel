...
static struct sidlx_rmi_Common__epv  s_my_epv__sidlx_rmi_common;
static VAR_UNUSED struct sidlx_rmi_Common__sepv s_stc_epv__sidlx_rmi_common;
...
sidlx_rmi_Common_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidlx_rmi_Common__object*) (*iobj_bc->d_epv->f__cast)(iobj_bc,
      "sidlx.rmi.Common", _ex);
    if(iobj != NULL) {
...
static void ior_sidlx_rmi_Common__set_contracts_static(
  sidl_bool   enable,
...
static void ior_sidlx_rmi_Common__dump_stats_static(
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
{
...
static void ior_sidlx_rmi_Common__set_contracts(
  struct sidlx_rmi_Common__object* self,
  sidl_bool   enable,
  const char* enfFilename,
  sidl_bool   resetCounters,
...
static void ior_sidlx_rmi_Common__dump_stats(
  struct sidlx_rmi_Common__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp) {
    ...
    cmp = strcmp(name, "sidlx.rmi.Common");
    if (!cmp) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidlx_rmi_Common__method  s_methods[] = {
    { "_cast", sidlx_rmi_Common__cast__exec },
 ...
 */
  ...
  struct sidlx_rmi_Common__epv*   epv  = &s_my_epv__sidlx_rmi_common;
  ...
  epv->f__set_contracts        = ior_sidlx_rmi_Common__set_contracts;
  epv->f__dump_stats           = ior_sidlx_rmi_Common__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct sidlx_rmi_Common__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidlx_rmi_Common__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidlx_rmi_Common__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidlx_rmi_Common__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidlx_rmi_Common__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
...
static void sidlx_rmi_Common__init_sepv(void)
{
  ...
  s->f__set_contracts_static         = ior_sidlx_rmi_Common__set_contracts_static;
  s->f__dump_stats_static            = ior_sidlx_rmi_Common__dump_stats_static;
  s->f_fork                = NULL;
  s->f_getHostIP           = NULL;
...
/*
 * sidlx_rmi_Common__getEPVs: Get my version of all relevant EPVs.
 */
  ...
  struct sidlx_rmi_Common__epv **s_arg_epv__sidlx_rmi_common)
{
  ...
  *s_arg_epv__sidlx_rmi_common = &s_my_epv__sidlx_rmi_common;
}
/*
 * sidlx_rmi_Common__getStaticEPV: return pointer to static EPV structure.
 */

struct sidlx_rmi_Common__sepv*
sidlx_rmi_Common__getStaticEPV(void){
  LOCK_STATIC_GLOBALS;
...
static struct sidl_BaseClass__epv* sidlx_rmi_Common__getSuperEPV(void) {
...
/*
 * sidlx_rmi_Common__createObject: Allocate the object and initialize it.
 */

struct sidlx_rmi_Common__object*
sidlx_rmi_Common__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidlx_rmi_Common__object* self =
    (struct sidlx_rmi_Common__object*) sidl_malloc(
      sizeof(struct sidlx_rmi_Common__object),
      "Object allocation failed for struct sidlx_rmi_Common__object",
        __FILE__, __LINE__, "sidlx_rmi_Common__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_my_epv__sidlx_rmi_common;
...
s_externalEntryPoints = {
  sidlx_rmi_Common__createObject,
  sidlx_rmi_Common__getStaticEPV,
  sidlx_rmi_Common__getSuperEPV,
  2, 
  0
};
