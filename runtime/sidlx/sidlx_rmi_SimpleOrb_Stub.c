...
#define SIDLX_RMI_SIMPLEORB_INLINE_DECL
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      ...
      "Exception unserialized from sidlx.rmi.SimpleOrb._set_hooks.",
        &throwaway_exception);
...
static void
remote_sidlx_rmi_SimpleOrb__set_contracts(
  /* in */ struct sidlx_rmi_SimpleOrb__object*self ,
  /* in */ sidl_bool enable,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb._set_contracts.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidlx_rmi_SimpleOrb__dump_stats(
  /* in */ struct sidlx_rmi_SimpleOrb__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb._dump_stats.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
/* REMOTE METHOD STUB:setCookie */
static void
remote_sidlx_rmi_SimpleOrb_setCookie(
  /* in */ struct sidlx_rmi_SimpleOrb__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    struct sidl_rmi_InstanceHandle__object * _conn = ((struct 
      sidlx_rmi_SimpleOrb__remote*)self->d_data)->d_ih;
    sidl_rmi_Invocation _inv = sidl_rmi_InstanceHandle_createInvocation( _conn, 
      "setCookie", _ex ); SIDL_CHECK(*_ex);

    /* pack in and inout arguments */
    sidl_rmi_Invocation_packCharArray( _inv, "cookie",cookie,
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.setCookie.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
/* REMOTE METHOD STUB:setNumSecurityRetries */
static void
remote_sidlx_rmi_SimpleOrb_setNumSecurityRetries(
  /* in */ struct sidlx_rmi_SimpleOrb__object*self ,
  /* in */ int32_t retries,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    struct sidl_rmi_InstanceHandle__object * _conn = ((struct 
      sidlx_rmi_SimpleOrb__remote*)self->d_data)->d_ih;
    sidl_rmi_Invocation _inv = sidl_rmi_InstanceHandle_createInvocation( _conn, 
      "setNumSecurityRetries", _ex ); SIDL_CHECK(*_ex);

    /* pack in and inout arguments */
    sidl_rmi_Invocation_packInt( _inv, "retries", retries, _ex);SIDL_CHECK(
      *_ex);
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.setNumSecurityRetries.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.serviceRequest.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.isLocalObject.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.getProtocol.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.getExceptions.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.setMaxThreadPool.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.requestPort.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.requestPortInRange.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
/* REMOTE METHOD STUB:requestLocalPort */
static sidl_bool
remote_sidlx_rmi_SimpleOrb_requestLocalPort(
  /* in */ struct sidlx_rmi_SimpleOrb__object*self ,
  /* in */ int32_t port,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    struct sidl_rmi_InstanceHandle__object * _conn = ((struct 
      sidlx_rmi_SimpleOrb__remote*)self->d_data)->d_ih;
    sidl_rmi_Invocation _inv = sidl_rmi_InstanceHandle_createInvocation( _conn, 
      "requestLocalPort", _ex ); SIDL_CHECK(*_ex);
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.requestLocalPort.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
/* REMOTE METHOD STUB:requestLocalPortInRange */
static sidl_bool
remote_sidlx_rmi_SimpleOrb_requestLocalPortInRange(
  /* in */ struct sidlx_rmi_SimpleOrb__object*self ,
  /* in */ int32_t minport,
  /* in */ int32_t maxport,
  /* out */ struct sidl_BaseInterface__object **_ex)
  ...
  *_ex = NULL;
  {
    ...
    struct sidl_rmi_InstanceHandle__object * _conn = ((struct 
      sidlx_rmi_SimpleOrb__remote*)self->d_data)->d_ih;
    sidl_rmi_Invocation _inv = sidl_rmi_InstanceHandle_createInvocation( _conn, 
      "requestLocalPortInRange", _ex ); SIDL_CHECK(*_ex);
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.requestLocalPortInRange.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.getPort.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.getServerName.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.getServerURL.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.run.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.shutdown.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidlx_rmi_SimpleOrb_shutdownNoWait(
  /* in */ struct sidlx_rmi_SimpleOrb__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.shutdownNoWait.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static sidl_bool
remote_sidlx_rmi_SimpleOrb_isRunning(
  /* in */ struct sidlx_rmi_SimpleOrb__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.isRunning.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    fprintf(stderr, "babel: addRef %p new count %d (type %s)\n",
      ...
      "sidlx.rmi.SimpleOrb Remote Stub");
  ...
  *_ex = NULL;
  {
    ...
    r_obj->d_refcount--;
#ifdef SIDL_DEBUG_REFCOUNT
    fprintf(stderr, "babel: deleteRef %p new count %d (type %s)\n",r_obj, r_obj->d_refcount, "sidlx.rmi.SimpleOrb Remote Stub");
#endif /* SIDL_DEBUG_REFCOUNT */ 
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.isSame.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.isType.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.SimpleOrb.getClassInfo.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void sidlx_rmi_SimpleOrb__init_remote_epv(void)
{
  ...
  epv->f__set_contracts               = 
    remote_sidlx_rmi_SimpleOrb__set_contracts;
  epv->f__dump_stats                  = remote_sidlx_rmi_SimpleOrb__dump_stats;
  epv->f__ctor                        = NULL;
  epv->f__ctor2                       = NULL;
  epv->f__dtor                        = NULL;
  epv->f_setCookie                    = remote_sidlx_rmi_SimpleOrb_setCookie;
  epv->f_setNumSecurityRetries        = 
    remote_sidlx_rmi_SimpleOrb_setNumSecurityRetries;
  ...
  epv->f_shutdownNoWait               = 
    remote_sidlx_rmi_SimpleOrb_shutdownNoWait;
  epv->f_isRunning                    = remote_sidlx_rmi_SimpleOrb_isRunning;
  ...
  e3->f__cast                   = (void* (*)(struct 
    ...
    sidl_BaseInterface__object**)) epv->f__cast;
  e3->f__delete                 = (void (*)(struct 
    sidlx_rmi_SimpleServer__object*, struct sidl_BaseInterface__object**)) 
    epv->f__delete;
  e3->f__getURL                 = (char* (*)(struct 
    sidlx_rmi_SimpleServer__object*, struct sidl_BaseInterface__object**)) 
    epv->f__getURL;
  e3->f__raddRef                = (void (*)(struct 
    sidlx_rmi_SimpleServer__object*, struct sidl_BaseInterface__object**)) 
    epv->f__raddRef;
  e3->f__isRemote               = (sidl_bool (*)(struct 
    sidlx_rmi_SimpleServer__object*, struct sidl_BaseInterface__object**)) 
    epv->f__isRemote;
  e3->f__set_hooks              = (void (*)(struct 
    sidlx_rmi_SimpleServer__object*, sidl_bool, struct 
    sidl_BaseInterface__object**)) epv->f__set_hooks;
  e3->f__set_contracts          = (void (*)(struct 
    sidlx_rmi_SimpleServer__object*, sidl_bool, const char*, sidl_bool, struct 
    sidl_BaseInterface__object**)) epv->f__set_contracts;
  e3->f__dump_stats             = (void (*)(struct 
    sidlx_rmi_SimpleServer__object*, const char*, const char*, struct 
    sidl_BaseInterface__object**)) epv->f__dump_stats;
  e3->f__exec                   = (void (*)(struct 
    sidlx_rmi_SimpleServer__object*,const char*,struct sidl_rmi_Call__object*,
    struct sidl_rmi_Return__object*,struct sidl_BaseInterface__object **)) 
    epv->f__exec;
  e3->f_setMaxThreadPool        = (void (*)(struct 
  ...
  e3->f_requestLocalPort        = (sidl_bool (*)(struct 
    sidlx_rmi_SimpleServer__object*,int32_t,struct sidl_BaseInterface__object 
    **)) epv->f_requestLocalPort;
  e3->f_requestLocalPortInRange = (sidl_bool (*)(struct 
    sidlx_rmi_SimpleServer__object*,int32_t,int32_t,struct 
    sidl_BaseInterface__object **)) epv->f_requestLocalPortInRange;
  ...
  e3->f_run                     = (int64_t (*)(struct 
    sidlx_rmi_SimpleServer__object*,struct sidl_BaseInterface__object **)) 
    epv->f_run;
  e3->f_shutdown                = (void (*)(struct 
    sidlx_rmi_SimpleServer__object*,struct sidl_BaseInterface__object **)) 
    epv->f_shutdown;
  e3->f_shutdownNoWait          = (void (*)(struct 
    sidlx_rmi_SimpleServer__object*,struct sidl_BaseInterface__object **)) 
    epv->f_shutdownNoWait;
  e3->f_isRunning               = (sidl_bool (*)(struct 
    sidlx_rmi_SimpleServer__object*,struct sidl_BaseInterface__object **)) 
    epv->f_isRunning;
  e3->f_serviceRequest          = (void (*)(struct 
    sidlx_rmi_SimpleServer__object*,struct sidlx_rmi_Socket__object*,struct 
    sidl_BaseInterface__object **)) epv->f_serviceRequest;
  e3->f_getExceptions           = (struct sidl_io_Serializable__array* (*)(
    struct sidlx_rmi_SimpleServer__object*,struct sidl_BaseInterface__object 
    **)) epv->f_getExceptions;
  e3->f_addRef                  = (void (*)(struct 
    sidlx_rmi_SimpleServer__object*,struct sidl_BaseInterface__object **)) 
    epv->f_addRef;
  e3->f_deleteRef               = (void (*)(struct 
    sidlx_rmi_SimpleServer__object*,struct sidl_BaseInterface__object **)) 
    epv->f_deleteRef;
...
sidlx_rmi_SimpleOrb__remoteConnect(const char *url, sidl_bool ar, struct 
  sidl_BaseInterface__object* *_ex)
{
  ...
  struct sidlx_rmi_SimpleOrb__remote* r_obj = NULL;
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    struct sidlx_rmi_SimpleOrb__object* retobj = NULL;
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_BaseInterface bi = (
      sidl_BaseInterface)sidl_rmi_InstanceRegistry_getInstanceByString(objectID,
      _ex); SIDL_CHECK(*_ex);
    (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    retobj = (struct sidlx_rmi_SimpleOrb__object*) (*bi->d_epv->f__cast)(
      bi->d_object, "sidlx.rmi.SimpleOrb", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
    return retobj;
  ...
  instance = sidl_rmi_ProtocolFactory_connectInstance(url, 
    "sidlx.rmi.SimpleOrb", ar, _ex ); SIDL_CHECK(*_ex);
  ...
  if(!self || !r_obj) {
    ...
    sidl_MemAllocException_add(ex, __FILE__, __LINE__, 
      "sidlx.rmi.SimpleOrb.EPVgeneration", _ex);
    SIDL_CHECK(*_ex);
...
static VAR_UNUSED struct sidlx_rmi_SimpleOrb__object*
sidlx_rmi_SimpleOrb__IHConnect(sidl_rmi_InstanceHandle instance, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct sidlx_rmi_SimpleOrb__object* self = NULL;
...
static struct sidlx_rmi_SimpleOrb__object*
sidlx_rmi_SimpleOrb__remoteCreate(const char *url, struct 
  sidl_BaseInterface__object **_ex)
{
