...
static struct sidlx_rmi_ChildSocket__epv s_my_epv__sidlx_rmi_childsocket;
...
sidlx_rmi_ChildSocket_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidlx_rmi_ChildSocket__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "sidlx.rmi.ChildSocket", _ex);
    if(iobj != NULL) {
...
static void
sidlx_rmi_ChildSocket__cast__exec(
        struct sidlx_rmi_ChildSocket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidlx_rmi_ChildSocket__set_contracts(
  struct sidlx_rmi_ChildSocket__object* self,
  sidl_bool   enable,
...
static void ior_sidlx_rmi_ChildSocket__dump_stats(
  struct sidlx_rmi_ChildSocket__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  cmp = strcmp(name, "sidlx.rmi.ChildSocket");
  if (!cmp) {
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidlx_rmi_ChildSocket__method  s_methods[] = {
    { "_cast", sidlx_rmi_ChildSocket__cast__exec },
 ...
 */
  ...
  struct sidlx_rmi_ChildSocket__epv*  epv  = &s_my_epv__sidlx_rmi_childsocket;
  ...
  epv->f__set_contracts        = ior_sidlx_rmi_ChildSocket__set_contracts;
  epv->f__dump_stats           = ior_sidlx_rmi_ChildSocket__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_init                  = NULL;
  epv->f_getsockname           = (int32_t (*)(struct sidlx_rmi_ChildSocket__object*,int32_t*,int32_t*,struct sidl_BaseInterface__object **)) s1->f_getsockname;
  epv->f_getpeername           = (int32_t (*)(struct sidlx_rmi_ChildSocket__object*,int32_t*,int32_t*,struct sidl_BaseInterface__object **)) s1->f_getpeername;
  epv->f_addRef                = (void (*)(struct sidlx_rmi_ChildSocket__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidlx_rmi_ChildSocket__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidlx_rmi_ChildSocket__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidlx_rmi_ChildSocket__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidlx_rmi_ChildSocket__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_close                 = (int32_t (*)(struct sidlx_rmi_ChildSocket__object*,struct sidl_BaseInterface__object **)) s1->f_close;
  epv->f_readn                 = (int32_t (*)(struct sidlx_rmi_ChildSocket__object*,int32_t,struct sidl_char__array**,struct sidl_BaseInterface__object **)) s1->f_readn;
  epv->f_readline              = (int32_t (*)(struct sidlx_rmi_ChildSocket__object*,int32_t,struct sidl_char__array**,struct sidl_BaseInterface__object **)) s1->f_readline;
  epv->f_readstring            = (int32_t (*)(struct sidlx_rmi_ChildSocket__object*,int32_t,struct sidl_char__array**,struct sidl_BaseInterface__object **)) s1->f_readstring;
  epv->f_readstring_alloc      = (int32_t (*)(struct sidlx_rmi_ChildSocket__object*,struct sidl_char__array**,struct sidl_BaseInterface__object **)) s1->f_readstring_alloc;
  epv->f_readint               = (int32_t (*)(struct sidlx_rmi_ChildSocket__object*,int32_t*,struct sidl_BaseInterface__object **)) s1->f_readint;
  epv->f_writen                = (int32_t (*)(struct sidlx_rmi_ChildSocket__object*,int32_t,struct sidl_char__array*,struct sidl_BaseInterface__object **)) s1->f_writen;
  epv->f_writestring           = (int32_t (*)(struct sidlx_rmi_ChildSocket__object*,int32_t,struct sidl_char__array*,struct sidl_BaseInterface__object **)) s1->f_writestring;
  epv->f_writeint              = (int32_t (*)(struct sidlx_rmi_ChildSocket__object*,int32_t,struct sidl_BaseInterface__object **)) s1->f_writeint;
  epv->f_setFileDescriptor     = (void (*)(struct sidlx_rmi_ChildSocket__object*,int32_t,struct sidl_BaseInterface__object **)) s1->f_setFileDescriptor;
  epv->f_getFileDescriptor     = (int32_t (*)(struct sidlx_rmi_ChildSocket__object*,struct sidl_BaseInterface__object **)) s1->f_getFileDescriptor;
  epv->f_test                  = (sidl_bool (*)(struct sidlx_rmi_ChildSocket__object*,int32_t,int32_t,struct sidl_BaseInterface__object **)) s1->f_test;
...
/*
 * sidlx_rmi_ChildSocket__getEPVs: Get my version of all relevant EPVs.
 */
  ...
  struct sidlx_rmi_ChildSocket__epv **s_arg_epv__sidlx_rmi_childsocket)
{
  ...
  *s_arg_epv__sidlx_rmi_childsocket = &s_my_epv__sidlx_rmi_childsocket;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidlx_rmi_IPv4Socket__epv* sidlx_rmi_ChildSocket__getSuperEPV(void) {
...
static void
initMetadata(struct sidlx_rmi_ChildSocket__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * sidlx_rmi_ChildSocket__createObject: Allocate the object and initialize it.
 */

struct sidlx_rmi_ChildSocket__object*
sidlx_rmi_ChildSocket__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidlx_rmi_ChildSocket__object* self =
    (struct sidlx_rmi_ChildSocket__object*) sidl_malloc(
      sizeof(struct sidlx_rmi_ChildSocket__object),
      "Object allocation failed for struct sidlx_rmi_ChildSocket__object",
        __FILE__, __LINE__, "sidlx_rmi_ChildSocket__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_my_epv__sidlx_rmi_childsocket;
...
s_externalEntryPoints = {
  sidlx_rmi_ChildSocket__createObject,
  sidlx_rmi_ChildSocket__getSuperEPV,
  2, 
  0
};
