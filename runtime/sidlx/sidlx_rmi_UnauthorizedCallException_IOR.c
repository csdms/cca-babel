/*
 * File:          sidlx_rmi_UnauthorizedCallException_IOR.c
 * Symbol:        sidlx.rmi.UnauthorizedCallException-v0.1
 * Symbol Type:   class
 * Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
 * Description:   Intermediate Object Representation for sidlx.rmi.UnauthorizedCallException
 * 
...
static struct sidlx_rmi_UnauthorizedCallException__epv 
  s_my_epv__sidlx_rmi_unauthorizedcallexception;
...
extern void sidlx_rmi_UnauthorizedCallException__set_epv(
  struct sidlx_rmi_UnauthorizedCallException__epv* epv);

extern void sidlx_rmi_UnauthorizedCallException__call_load(void);
#ifdef __cplusplus
}
#endif

static void
sidlx_rmi_UnauthorizedCallException_addRef__exec(
...
static void
sidlx_rmi_UnauthorizedCallException_deleteRef__exec(
        struct sidlx_rmi_UnauthorizedCallException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnauthorizedCallException_isSame__exec(
        struct sidlx_rmi_UnauthorizedCallException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_sidlx_rmi_UnauthorizedCallException_fconnect_sidl_BaseInterface(
    iobj_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidlx_rmi_UnauthorizedCallException__object*) (
      *iobj_bc->d_epv->f__cast)(iobj_bc, "sidlx.rmi.UnauthorizedCallException", 
      _ex);
    if(iobj != NULL) {
...
static void
sidlx_rmi_UnauthorizedCallException_isType__exec(
        struct sidlx_rmi_UnauthorizedCallException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnauthorizedCallException_getClassInfo__exec(
        struct sidlx_rmi_UnauthorizedCallException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnauthorizedCallException_getNote__exec(
        struct sidlx_rmi_UnauthorizedCallException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnauthorizedCallException_setNote__exec(
        struct sidlx_rmi_UnauthorizedCallException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnauthorizedCallException_getTrace__exec(
        struct sidlx_rmi_UnauthorizedCallException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnauthorizedCallException_addLine__exec(
        struct sidlx_rmi_UnauthorizedCallException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnauthorizedCallException_add__exec(
        struct sidlx_rmi_UnauthorizedCallException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidlx_rmi_UnauthorizedCallException_packObj__exec(
        struct sidlx_rmi_UnauthorizedCallException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  ser = skel_sidlx_rmi_UnauthorizedCallException_fconnect_sidl_io_Serializer(
    ser_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  ser_bc = sidl_rmi_InstanceRegistry_getInstanceByString(ser_str, 
    _ex);SIDL_CHECK(*_ex);
  if(ser_bc != NULL) {
    ser= (struct sidlx_rmi_UnauthorizedCallException__object*) (
      *ser_bc->d_epv->f__cast)(ser_bc, "sidlx.rmi.UnauthorizedCallException", 
      _ex);
    if(ser != NULL) {
...
static void
sidlx_rmi_UnauthorizedCallException_unpackObj__exec(
        struct sidlx_rmi_UnauthorizedCallException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  des = skel_sidlx_rmi_UnauthorizedCallException_fconnect_sidl_io_Deserializer(
    des_str, TRUE, _ex);SIDL_CHECK(*_ex);
#else
  des_bc = sidl_rmi_InstanceRegistry_getInstanceByString(des_str, 
    _ex);SIDL_CHECK(*_ex);
  if(des_bc != NULL) {
    des= (struct sidlx_rmi_UnauthorizedCallException__object*) (
      *des_bc->d_epv->f__cast)(des_bc, "sidlx.rmi.UnauthorizedCallException", 
      _ex);
    if(des != NULL) {
...
static void
sidlx_rmi_UnauthorizedCallException__cast__exec(
        struct sidlx_rmi_UnauthorizedCallException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidlx_rmi_UnauthorizedCallException__set_contracts(
  struct sidlx_rmi_UnauthorizedCallException__object* self,
  sidl_bool   enable,
...
static void ior_sidlx_rmi_UnauthorizedCallException__dump_stats(
  struct sidlx_rmi_UnauthorizedCallException__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_sidlx_rmi_UnauthorizedCallException__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    sidlx_rmi_UnauthorizedCallException__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_sidlx_rmi_UnauthorizedCallException__cast(
  struct sidlx_rmi_UnauthorizedCallException__object* self,
...
static void ior_sidlx_rmi_UnauthorizedCallException__set_hooks(
  struct sidlx_rmi_UnauthorizedCallException__object* self,
...
static void ior_sidlx_rmi_UnauthorizedCallException__delete(
  struct sidlx_rmi_UnauthorizedCallException__object* self, struct 
    sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  sidlx_rmi_UnauthorizedCallException__fini(self, _ex);
...
static char*
ior_sidlx_rmi_UnauthorizedCallException__getURL(
  struct sidlx_rmi_UnauthorizedCallException__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_sidlx_rmi_UnauthorizedCallException__raddRef(
    struct sidlx_rmi_UnauthorizedCallException__object* self, 
...
static sidl_bool
ior_sidlx_rmi_UnauthorizedCallException__isRemote(
    struct sidlx_rmi_UnauthorizedCallException__object* self, 
  sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
...
struct sidlx_rmi_UnauthorizedCallException__method {
  const char *d_name;
  void (*d_func)(struct sidlx_rmi_UnauthorizedCallException__object*,
...
static void
ior_sidlx_rmi_UnauthorizedCallException__exec(
  struct sidlx_rmi_UnauthorizedCallException__object* self,
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidlx_rmi_UnauthorizedCallException__method  s_methods[] 
    = {
    { "_cast", sidlx_rmi_UnauthorizedCallException__cast__exec },
    { "add", sidlx_rmi_UnauthorizedCallException_add__exec },
    { "addLine", sidlx_rmi_UnauthorizedCallException_addLine__exec },
    { "addRef", sidlx_rmi_UnauthorizedCallException_addRef__exec },
    { "deleteRef", sidlx_rmi_UnauthorizedCallException_deleteRef__exec },
    { "getClassInfo", sidlx_rmi_UnauthorizedCallException_getClassInfo__exec },
    { "getNote", sidlx_rmi_UnauthorizedCallException_getNote__exec },
    { "getTrace", sidlx_rmi_UnauthorizedCallException_getTrace__exec },
    { "isSame", sidlx_rmi_UnauthorizedCallException_isSame__exec },
    { "isType", sidlx_rmi_UnauthorizedCallException_isType__exec },
    { "packObj", sidlx_rmi_UnauthorizedCallException_packObj__exec },
    { "setNote", sidlx_rmi_UnauthorizedCallException_setNote__exec },
    { "unpackObj", sidlx_rmi_UnauthorizedCallException_unpackObj__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct 
    sidlx_rmi_UnauthorizedCallException__method);
  *_ex  = NULL; /* default to no exception */
...
static void sidlx_rmi_UnauthorizedCallException__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct sidlx_rmi_UnauthorizedCallException__epv*  epv  = &s_my_epv__sidlx_rmi_unauthorizedcallexception;
  ...
  struct sidl_SIDLException__epv*                   e3   = &s_my_epv__sidl_sidlexception;
  struct sidl_io_Serializable__epv*                 e4   = &s_my_epv__sidl_io_serializable;
  ...
  s1  =  s_par_epv__sidl_sidlexception;

  epv->f__cast                 = ior_sidlx_rmi_UnauthorizedCallException__cast;
  epv->f__delete               = ior_sidlx_rmi_UnauthorizedCallException__delete;
  epv->f__exec                 = ior_sidlx_rmi_UnauthorizedCallException__exec;
  epv->f__getURL               = ior_sidlx_rmi_UnauthorizedCallException__getURL;
  epv->f__raddRef              = ior_sidlx_rmi_UnauthorizedCallException__raddRef;
  epv->f__isRemote             = ior_sidlx_rmi_UnauthorizedCallException__isRemote;
  epv->f__set_hooks            = ior_sidlx_rmi_UnauthorizedCallException__set_hooks;
  epv->f__set_contracts        = ior_sidlx_rmi_UnauthorizedCallException__set_contracts;
  epv->f__dump_stats           = ior_sidlx_rmi_UnauthorizedCallException__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct sidlx_rmi_UnauthorizedCallException__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidlx_rmi_UnauthorizedCallException__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidlx_rmi_UnauthorizedCallException__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidlx_rmi_UnauthorizedCallException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidlx_rmi_UnauthorizedCallException__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_getNote               = (char* (*)(struct sidlx_rmi_UnauthorizedCallException__object*,struct sidl_BaseInterface__object **)) s1->f_getNote;
  epv->f_setNote               = (void (*)(struct sidlx_rmi_UnauthorizedCallException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_setNote;
  epv->f_getTrace              = (char* (*)(struct sidlx_rmi_UnauthorizedCallException__object*,struct sidl_BaseInterface__object **)) s1->f_getTrace;
  epv->f_addLine               = (void (*)(struct sidlx_rmi_UnauthorizedCallException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_addLine;
  epv->f_add                   = (void (*)(struct sidlx_rmi_UnauthorizedCallException__object*,const char*,int32_t,const char*,struct sidl_BaseInterface__object **)) s1->f_add;
  epv->f_packObj               = (void (*)(struct sidlx_rmi_UnauthorizedCallException__object*,struct sidl_io_Serializer__object*,struct sidl_BaseInterface__object **)) s1->f_packObj;
  epv->f_unpackObj             = (void (*)(struct sidlx_rmi_UnauthorizedCallException__object*,struct sidl_io_Deserializer__object*,struct sidl_BaseInterface__object **)) s1->f_unpackObj;

  sidlx_rmi_UnauthorizedCallException__set_epv(epv);
  ...
  e3->f__cast                 = (void* (*)(struct sidl_SIDLException__object*,const char*, struct sidl_BaseInterface__object**))epv->f__cast;
  e3->f__delete               = (void (*)(struct sidl_SIDLException__object*, struct sidl_BaseInterface__object **)) epv->f__delete;
  e3->f__getURL               = (char* (*)(struct sidl_SIDLException__object*, struct sidl_BaseInterface__object **)) epv->f__getURL;
  e3->f__raddRef              = (void (*)(struct sidl_SIDLException__object*, struct sidl_BaseInterface__object **)) epv->f__raddRef;
  e3->f__isRemote             = (sidl_bool (*)(struct sidl_SIDLException__object*, struct sidl_BaseInterface__object **)) epv->f__isRemote;
  e3->f__exec                 = (void (*)(struct sidl_SIDLException__object*,const char*,struct sidl_rmi_Call__object*,struct sidl_rmi_Return__object*,struct sidl_BaseInterface__object **)) epv->f__exec;
  e3->f_addRef                = (void (*)(struct sidl_SIDLException__object*,struct sidl_BaseInterface__object **)) epv->f_addRef;
  e3->f_deleteRef             = (void (*)(struct sidl_SIDLException__object*,struct sidl_BaseInterface__object **)) epv->f_deleteRef;
  e3->f_isSame                = (sidl_bool (*)(struct sidl_SIDLException__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) epv->f_isSame;
  e3->f_isType                = (sidl_bool (*)(struct sidl_SIDLException__object*,const char*,struct sidl_BaseInterface__object **)) epv->f_isType;
  e3->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidl_SIDLException__object*,struct sidl_BaseInterface__object **)) epv->f_getClassInfo;
  e3->f_getNote               = (char* (*)(struct sidl_SIDLException__object*,struct sidl_BaseInterface__object **)) epv->f_getNote;
  e3->f_setNote               = (void (*)(struct sidl_SIDLException__object*,const char*,struct sidl_BaseInterface__object **)) epv->f_setNote;
  e3->f_getTrace              = (char* (*)(struct sidl_SIDLException__object*,struct sidl_BaseInterface__object **)) epv->f_getTrace;
  e3->f_addLine               = (void (*)(struct sidl_SIDLException__object*,const char*,struct sidl_BaseInterface__object **)) epv->f_addLine;
  e3->f_add                   = (void (*)(struct sidl_SIDLException__object*,const char*,int32_t,const char*,struct sidl_BaseInterface__object **)) epv->f_add;
  e3->f_packObj               = (void (*)(struct sidl_SIDLException__object*,struct sidl_io_Serializer__object*,struct sidl_BaseInterface__object **)) epv->f_packObj;
  e3->f_unpackObj             = (void (*)(struct sidl_SIDLException__object*,struct sidl_io_Deserializer__object*,struct sidl_BaseInterface__object **)) epv->f_unpackObj;
  ...
  e4->f_packObj               = (void (*)(void*,struct sidl_io_Serializer__object*,struct sidl_BaseInterface__object **)) epv->f_packObj;
  e4->f_unpackObj             = (void (*)(void*,struct sidl_io_Deserializer__object*,struct sidl_BaseInterface__object **)) epv->f_unpackObj;
  ...
  ior_sidlx_rmi_UnauthorizedCallException__ensure_load_called();
}

/*
 * sidlx_rmi_UnauthorizedCallException__getEPVs: Get my version of all relevant EPVs.
 */

void sidlx_rmi_UnauthorizedCallException__getEPVs (
  ...
  struct sidlx_rmi_UnauthorizedCallException__epv **s_arg_epv__sidlx_rmi_unauthorizedcallexception)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    sidlx_rmi_UnauthorizedCallException__init_epv();
  }
  ...
  *s_arg_epv__sidlx_rmi_unauthorizedcallexception = &s_my_epv__sidlx_rmi_unauthorizedcallexception;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_SIDLException__epv* sidlx_rmi_UnauthorizedCallException__getSuperEPV(void) {
  return s_par_epv__sidl_sidlexception;
}
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidlx.rmi.UnauthorizedCallException", _ex);
...
static void
initMetadata(struct sidlx_rmi_UnauthorizedCallException__object* self, sidl_BaseInterface* _ex)
{
  *_ex = 0; /* default no exception */
  if (self) {
    struct sidl_BaseClass__data *data = (struct sidl_BaseClass__data*)((*self).d_sidl_sidlexception.d_sidl_baseclass.d_data);
    if (data) {
...
/*
 * sidlx_rmi_UnauthorizedCallException__createObject: Allocate the object and initialize it.
 */

struct sidlx_rmi_UnauthorizedCallException__object*
sidlx_rmi_UnauthorizedCallException__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidlx_rmi_UnauthorizedCallException__object* self =
    (struct sidlx_rmi_UnauthorizedCallException__object*) sidl_malloc(
      sizeof(struct sidlx_rmi_UnauthorizedCallException__object),
      "Object allocation failed for struct sidlx_rmi_UnauthorizedCallException__object",
        __FILE__, __LINE__, "sidlx_rmi_UnauthorizedCallException__createObject", _ex);
  if (!self) goto EXIT;
  sidlx_rmi_UnauthorizedCallException__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void sidlx_rmi_UnauthorizedCallException__init(
  struct sidlx_rmi_UnauthorizedCallException__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct sidlx_rmi_UnauthorizedCallException__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s1->d_sidl_baseexception.d_epv   = &s_my_epv__sidl_baseexception;
  s1->d_sidl_io_serializable.d_epv = &s_my_epv__sidl_io_serializable;
  s1->d_epv                        = &s_my_epv__sidl_sidlexception;

  s0->d_epv    = &s_my_epv__sidlx_rmi_unauthorizedcallexception;
...
void sidlx_rmi_UnauthorizedCallException__fini(
  struct sidlx_rmi_UnauthorizedCallException__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct sidlx_rmi_UnauthorizedCallException__object* s0 = self;
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  s1->d_sidl_baseexception.d_epv   = s_par_epv__sidl_baseexception;
  s1->d_sidl_io_serializable.d_epv = s_par_epv__sidl_io_serializable;
  s1->d_epv                        = s_par_epv__sidl_sidlexception;
...
void
sidlx_rmi_UnauthorizedCallException__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct sidlx_rmi_UnauthorizedCallException__external
s_externalEntryPoints = {
  sidlx_rmi_UnauthorizedCallException__createObject,
  sidlx_rmi_UnauthorizedCallException__getSuperEPV,
  2, 
  0
};
...
const struct sidlx_rmi_UnauthorizedCallException__external*
sidlx_rmi_UnauthorizedCallException__externals(void)
{
