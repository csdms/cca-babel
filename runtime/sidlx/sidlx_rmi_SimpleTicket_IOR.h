...
struct sidlx_rmi_SimpleTicket__epv {
  ...
  /* Methods introduced in sidl.rmi.Ticket-v0.9.17 */
  void (*f_block)(
    /* in */ struct sidlx_rmi_SimpleTicket__object* self,
    /* out */ struct sidl_BaseInterface__object **_ex);
  sidl_bool (*f_test)(
...
struct sidlx_rmi_SimpleTicket__cstats {
  sidl_bool use_hooks;
};
...
sidlx_rmi_SimpleTicket__createObject(void* ddata,struct 
...
extern void sidlx_rmi_SimpleTicket__IOR_version(int32_t *major, int32_t *minor);
