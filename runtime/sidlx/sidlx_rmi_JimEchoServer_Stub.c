...
#define SIDLX_RMI_JIMECHOSERVER_INLINE_DECL
...
static sidl_bool
remote_sidlx_rmi_JimEchoServer_requestLocalPort(
  /* in */ struct sidlx_rmi_JimEchoServer__object*self ,
  /* in */ int32_t port,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.JimEchoServer.requestLocalPort.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static sidl_bool
remote_sidlx_rmi_JimEchoServer_requestLocalPortInRange(
  /* in */ struct sidlx_rmi_JimEchoServer__object*self ,
  /* in */ int32_t minport,
  /* in */ int32_t maxport,
  /* out */ struct sidl_BaseInterface__object **_ex)
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidlx.rmi.JimEchoServer.requestLocalPortInRange.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static VAR_UNUSED struct sidlx_rmi_JimEchoServer__object*
