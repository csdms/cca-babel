...
static struct sidlx_rmi_ServerSocket__epv s_my_epv__sidlx_rmi_serversocket;
...
static void
sidlx_rmi_ServerSocket_initLocal__exec(
        struct sidlx_rmi_ServerSocket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  /* unpack in and inout argments */
  sidl_rmi_Call_unpackInt( inArgs, "port", &port, _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackBool( inArgs, "loopback", &loopback, _ex);SIDL_CHECK(
    *_ex);

  /* make the call */
  _retval = (self->d_epv->f_initLocal)(
    self,
    port,
    loopback,
    _ex);  SIDL_CHECK(*_ex);
...
sidlx_rmi_ServerSocket_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidlx_rmi_ServerSocket__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "sidlx.rmi.ServerSocket", _ex);
    if(iobj != NULL) {
...
static void
sidlx_rmi_ServerSocket__cast__exec(
        struct sidlx_rmi_ServerSocket__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidlx_rmi_ServerSocket__set_contracts(
  struct sidlx_rmi_ServerSocket__object* self,
  sidl_bool   enable,
...
static void ior_sidlx_rmi_ServerSocket__dump_stats(
  struct sidlx_rmi_ServerSocket__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp) {
    ...
    cmp = strcmp(name, "sidlx.rmi.ServerSocket");
    if (!cmp) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidlx_rmi_ServerSocket__method  s_methods[] = {
    { "_cast", sidlx_rmi_ServerSocket__cast__exec },
    ...
    { "initLocal", sidlx_rmi_ServerSocket_initLocal__exec },
 ...
 */
  ...
  struct sidlx_rmi_ServerSocket__epv*  epv  = &s_my_epv__sidlx_rmi_serversocket;
  ...
  epv->f__set_contracts        = ior_sidlx_rmi_ServerSocket__set_contracts;
  epv->f__dump_stats           = ior_sidlx_rmi_ServerSocket__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_init                  = NULL;
  epv->f_initLocal             = NULL;
  epv->f_accept                = NULL;
  epv->f_close                 = NULL;
  epv->f_addRef                = (void (*)(struct sidlx_rmi_ServerSocket__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidlx_rmi_ServerSocket__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidlx_rmi_ServerSocket__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidlx_rmi_ServerSocket__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidlx_rmi_ServerSocket__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
...
/*
 * sidlx_rmi_ServerSocket__getEPVs: Get my version of all relevant EPVs.
 */
  ...
  struct sidlx_rmi_ServerSocket__epv **s_arg_epv__sidlx_rmi_serversocket)
{
  ...
  *s_arg_epv__sidlx_rmi_serversocket = &s_my_epv__sidlx_rmi_serversocket;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* sidlx_rmi_ServerSocket__getSuperEPV(void) {
...
static void
initMetadata(struct sidlx_rmi_ServerSocket__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * sidlx_rmi_ServerSocket__createObject: Allocate the object and initialize it.
 */

struct sidlx_rmi_ServerSocket__object*
sidlx_rmi_ServerSocket__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidlx_rmi_ServerSocket__object* self =
    (struct sidlx_rmi_ServerSocket__object*) sidl_malloc(
      sizeof(struct sidlx_rmi_ServerSocket__object),
      "Object allocation failed for struct sidlx_rmi_ServerSocket__object",
        __FILE__, __LINE__, "sidlx_rmi_ServerSocket__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_my_epv__sidlx_rmi_serversocket;
...
s_externalEntryPoints = {
  sidlx_rmi_ServerSocket__createObject,
  sidlx_rmi_ServerSocket__getSuperEPV,
  2, 
  0
};
