...
struct sidlx_rmi_Simsponse__epv {
  ...
  void (*f_unpackSerializableArray)(
    ...
    /* in */ sidl_bool isRarray,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in sidl.rmi.Response-v0.9.17 */
...
struct sidlx_rmi_Simsponse__cstats {
  sidl_bool use_hooks;
};
...
sidlx_rmi_Simsponse__createObject(void* ddata,struct sidl_BaseInterface__object 
  ** _ex);
