/*
 * File:          sidlx_rmi_OutOfAddressesException.h
...
#define included_sidlx_rmi_OutOfAddressesException_h
...
typedef struct sidlx_rmi_OutOfAddressesException__object* 
...
#if !defined(SIDLX_RMI_OUTOFADDRESSESEXCEPTION_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDLX_RMI_OUTOFADDRESSESEXCEPTION_INLINE_DECL inline
#else
#define SIDLX_RMI_OUTOFADDRESSESEXCEPTION_INLINE_DECL extern inline
#endif
 ...
 */
sidlx_rmi_OutOfAddressesException
sidlx_rmi_OutOfAddressesException__wrapObj(void * data, sidl_BaseInterface 
  *_ex);
 ...
 */
sidlx_rmi_OutOfAddressesException
sidlx_rmi_OutOfAddressesException__connect(const char *, sidl_BaseInterface 
  *_ex);
 ...
 * Method:  getHopCount[]
 */
SIDLX_RMI_OUTOFADDRESSESEXCEPTION_INLINE_DECL
int32_t
sidlx_rmi_OutOfAddressesException_getHopCount(
  /* in */ sidlx_rmi_OutOfAddressesException self,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDLX_RMI_OUTOFADDRESSESEXCEPTION_INLINE_DECL
{
  int32_t _result;
...
#else
;
#endif /* SIDLX_RMI_OUTOFADDRESSESEXCEPTION_INLINE_DECL */
...
#pragma weak sidlx_rmi_OutOfAddressesException__connectI
