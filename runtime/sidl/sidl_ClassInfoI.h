...
#if !defined(SIDL_CLASSINFOI_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDL_CLASSINFOI_INLINE_DECL inline
#else
#define SIDL_CLASSINFOI_INLINE_DECL extern inline
#endif
 ...
 */
SIDL_CLASSINFOI_INLINE_DECL
void
sidl_ClassInfoI_setName(
  /* in */ sidl_ClassInfoI self,
  /* in */ const char* name,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDL_CLASSINFOI_INLINE_DECL
{
...
#else
;
#endif /* SIDL_CLASSINFOI_INLINE_DECL */
