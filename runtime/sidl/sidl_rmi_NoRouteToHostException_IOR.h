...
struct sidl_rmi_NoRouteToHostException__epv {
  ...
  int32_t (*f_getErrno)(
    /* in */ struct sidl_rmi_NoRouteToHostException__object* self,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in sidl.rmi.NoRouteToHostException-v0.9.17 */
};
...
struct sidl_rmi_NoRouteToHostException__cstats {
  sidl_bool use_hooks;
};
...
sidl_rmi_NoRouteToHostException__createObject(void* ddata,struct 
