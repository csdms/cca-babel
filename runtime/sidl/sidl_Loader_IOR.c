...
static struct sidl_Loader__epv  s_my_epv__sidl_loader;
static VAR_UNUSED struct sidl_Loader__sepv s_stc_epv__sidl_loader;
...
sidl_Loader_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidl_Loader__object*) (*iobj_bc->d_epv->f__cast)(iobj_bc, 
      "sidl.Loader", _ex);
    if(iobj != NULL) {
...
static void ior_sidl_Loader__set_contracts_static(
  sidl_bool   enable,
...
static void ior_sidl_Loader__dump_stats_static(
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
{
...
static void ior_sidl_Loader__set_contracts(
  struct sidl_Loader__object* self,
  sidl_bool   enable,
  const char* enfFilename,
  sidl_bool   resetCounters,
...
static void ior_sidl_Loader__dump_stats(
  struct sidl_Loader__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
 ...
 */
  ...
  struct sidl_Loader__epv*        epv  = &s_my_epv__sidl_loader;
  ...
  epv->f__set_contracts        = ior_sidl_Loader__set_contracts;
  epv->f__dump_stats           = ior_sidl_Loader__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct sidl_Loader__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidl_Loader__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidl_Loader__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidl_Loader__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidl_Loader__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
...
static void sidl_Loader__init_sepv(void)
{
  ...
  s->f__set_contracts_static    = ior_sidl_Loader__set_contracts_static;
  s->f__dump_stats_static       = ior_sidl_Loader__dump_stats_static;
...
/*
 * sidl_Loader__getEPVs: Get my version of all relevant EPVs.
 */
  ...
  struct sidl_Loader__epv **s_arg_epv__sidl_loader)
{
  ...
  *s_arg_epv__sidl_loader = &s_my_epv__sidl_loader;
}
/*
 * sidl_Loader__getStaticEPV: return pointer to static EPV structure.
 */

struct sidl_Loader__sepv*
sidl_Loader__getStaticEPV(void){
  LOCK_STATIC_GLOBALS;
...
static struct sidl_BaseClass__epv* sidl_Loader__getSuperEPV(void) {
...
/*
 * sidl_Loader__createObject: Allocate the object and initialize it.
 */

struct sidl_Loader__object*
sidl_Loader__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_Loader__object* self =
    (struct sidl_Loader__object*) sidl_malloc(
      sizeof(struct sidl_Loader__object),
      "Object allocation failed for struct sidl_Loader__object",
        __FILE__, __LINE__, "sidl_Loader__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_my_epv__sidl_loader;
...
s_externalEntryPoints = {
  sidl_Loader__createObject,
  sidl_Loader__getStaticEPV,
  sidl_Loader__getSuperEPV,
  2, 
  0
};
