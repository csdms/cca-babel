...
#define SIDL_CLASSINFO_INLINE_DECL
...
{
  return sidl_ClassInfo__remoteConnect(url, TRUE, _ex);
}
  ...
  sidl_BaseInterface* _ex)
{
  ...
  if (!connect_loaded) {
    ...
    sidl_rmi_ConnectRegistry_registerConnect("sidl.ClassInfo", (
      void*)sidl_ClassInfo__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
#endif /*WITH_RMI*/
  if (obj != NULL) {
...
{
  return !sidl_ClassInfo__isRemote(self, _ex);
}
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp) {
    ...
    cmp = strcmp(name, "sidl._ClassInfo");
    if (!cmp) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
...
static char* remote_sidl__ClassInfo__getURL(
  struct sidl__ClassInfo__object* self, struct sidl_BaseInterface__object* *_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      ...
      "Exception unserialized from sidl._ClassInfo._set_hooks.",
        &throwaway_exception);
...
static void
remote_sidl__ClassInfo__set_contracts(
  /* in */ struct sidl__ClassInfo__object*self ,
  /* in */ sidl_bool enable,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl._ClassInfo._set_contracts.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidl__ClassInfo__dump_stats(
  /* in */ struct sidl__ClassInfo__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl._ClassInfo._dump_stats.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl._ClassInfo.getName.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static char*
remote_sidl__ClassInfo_getVersion(
  /* in */ struct sidl__ClassInfo__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl._ClassInfo.getVersion.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl._ClassInfo.getIORVersion.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl._ClassInfo.isSame.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl._ClassInfo.isType.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl._ClassInfo.getClassInfo.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void sidl__ClassInfo__init_remote_epv(void)
{
  ...
  epv->f__set_contracts      = remote_sidl__ClassInfo__set_contracts;
  epv->f__dump_stats         = remote_sidl__ClassInfo__dump_stats;
  epv->f__ctor               = NULL;
  epv->f__ctor2              = NULL;
  epv->f__dtor               = NULL;
  epv->f_getName             = remote_sidl__ClassInfo_getName;
  epv->f_getVersion          = remote_sidl__ClassInfo_getVersion;
  ...
  e1->f_getName        = (char* (*)(void*,struct sidl_BaseInterface__object 
    **)) epv->f_getName;
  e1->f_getVersion     = (char* (*)(void*,struct sidl_BaseInterface__object 
    **)) epv->f_getVersion;
...
static struct sidl_ClassInfo__object*
sidl_ClassInfo__remoteConnect(const char *url, sidl_bool ar, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct sidl__ClassInfo__object* self = NULL;

  struct sidl__ClassInfo__object* s0;

  struct sidl__ClassInfo__remote* r_obj = NULL;
  sidl_rmi_InstanceHandle instance = NULL;
  struct sidl_ClassInfo__object* ret_self = NULL;
  char* objectID = NULL;
  objectID = sidl_rmi_ServerRegistry_isLocalObject(url, _ex);
  if(objectID) {
    sidl_BaseInterface bi = (sidl_BaseInterface) 
      sidl_rmi_InstanceRegistry_getInstanceByString(objectID, _ex);
    return (struct sidl_ClassInfo__object*)(*bi->d_epv->f__cast)(bi->d_object, 
      "sidl.ClassInfo", _ex);
  }
  instance = sidl_rmi_ProtocolFactory_connectInstance(url, "sidl.ClassInfo", ar,
    _ex );
  ...
  if(!self || !r_obj) {
    ...
    sidl_MemAllocException_add(ex, __FILE__, __LINE__, 
      "sidl._ClassInfo.EPVgeneration", _ex);
    SIDL_CHECK(*_ex);
  ...
  ret_self = (struct sidl_ClassInfo__object*) (*self->d_epv->f__cast)(self, 
    "sidl.ClassInfo", _ex);
...
static struct sidl_ClassInfo__object*
sidl_ClassInfo__IHConnect(sidl_rmi_InstanceHandle instance, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct sidl__ClassInfo__object* self = NULL;
