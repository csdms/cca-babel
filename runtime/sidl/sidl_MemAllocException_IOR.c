/*
 * File:          sidl_MemAllocException_IOR.c
...
#ifdef HAVE_PTHREAD
static struct sidl_recursive_mutex_t sidl_MemAllocException__mutex= SIDL_RECURSIVE_MUTEX_INITIALIZER;
#define LOCK_STATIC_GLOBALS sidl_recursive_mutex_lock( &sidl_MemAllocException__mutex )
#define UNLOCK_STATIC_GLOBALS sidl_recursive_mutex_unlock( &sidl_MemAllocException__mutex )
/* #define HAVE_LOCKED_STATIC_GLOBALS (sidl_recursive_mutex_trylock( &sidl_MemAllocException__mutex )==EDEADLOCK) */
#else
...
static struct sidl_MemAllocException__epv  s_my_epv__sidl_memallocexception;
static VAR_UNUSED struct sidl_MemAllocException__sepv 
  s_stc_epv__sidl_memallocexception;
...
extern void sidl_MemAllocException__set_epv(
  struct sidl_MemAllocException__epv* epv);

extern void sidl_MemAllocException__set_sepv(
  struct sidl_MemAllocException__sepv* sepv);

extern void sidl_MemAllocException__call_load(void);
#ifdef __cplusplus
}
#endif

static void
sidl_MemAllocException_addRef__exec(
        struct sidl_MemAllocException__object* self,
...
static void
sidl_MemAllocException_deleteRef__exec(
        struct sidl_MemAllocException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_MemAllocException_isSame__exec(
        struct sidl_MemAllocException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  iobj = skel_sidl_MemAllocException_fconnect_sidl_BaseInterface(iobj_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidl_MemAllocException__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "sidl.MemAllocException", _ex);
    if(iobj != NULL) {
...
static void
sidl_MemAllocException_isType__exec(
        struct sidl_MemAllocException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_MemAllocException_getClassInfo__exec(
        struct sidl_MemAllocException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_MemAllocException_getNote__exec(
        struct sidl_MemAllocException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_MemAllocException_setNote__exec(
        struct sidl_MemAllocException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_MemAllocException_getTrace__exec(
        struct sidl_MemAllocException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_MemAllocException_addLine__exec(
        struct sidl_MemAllocException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_MemAllocException_add__exec(
        struct sidl_MemAllocException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_MemAllocException_packObj__exec(
        struct sidl_MemAllocException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  ser = skel_sidl_MemAllocException_fconnect_sidl_io_Serializer(ser_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  ser_bc = sidl_rmi_InstanceRegistry_getInstanceByString(ser_str, 
    _ex);SIDL_CHECK(*_ex);
  if(ser_bc != NULL) {
    ser= (struct sidl_MemAllocException__object*) (*ser_bc->d_epv->f__cast)(
      ser_bc, "sidl.MemAllocException", _ex);
    if(ser != NULL) {
...
static void
sidl_MemAllocException_unpackObj__exec(
        struct sidl_MemAllocException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  des = skel_sidl_MemAllocException_fconnect_sidl_io_Deserializer(des_str, TRUE,
    _ex);SIDL_CHECK(*_ex);
#else
  des_bc = sidl_rmi_InstanceRegistry_getInstanceByString(des_str, 
    _ex);SIDL_CHECK(*_ex);
  if(des_bc != NULL) {
    des= (struct sidl_MemAllocException__object*) (*des_bc->d_epv->f__cast)(
      des_bc, "sidl.MemAllocException", _ex);
    if(des != NULL) {
...
static void
sidl_MemAllocException__cast__exec(
        struct sidl_MemAllocException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidl_MemAllocException__set_contracts_static(
  sidl_bool   enable,
...
static void ior_sidl_MemAllocException__dump_stats_static(
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
{
...
static void ior_sidl_MemAllocException__set_contracts(
  struct sidl_MemAllocException__object* self,
  sidl_bool   enable,
  const char* enfFilename,
  sidl_bool   resetCounters,
...
static void ior_sidl_MemAllocException__dump_stats(
  struct sidl_MemAllocException__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_sidl_MemAllocException__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    sidl_MemAllocException__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_sidl_MemAllocException__cast(
  struct sidl_MemAllocException__object* self,
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  cmp = strcmp(name, "sidl.MemAllocException");
  if (!cmp) {
    (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
    cast = ((struct sidl_MemAllocException__object*)self);
    return cast;
  }
  else if (cmp < 0) {
...
static void ior_sidl_MemAllocException__set_hooks_static(
...
static void ior_sidl_MemAllocException__set_hooks(
  struct sidl_MemAllocException__object* self,
  sidl_bool enable, struct sidl_BaseInterface__object **_ex )
{
  *_ex  = NULL;
...
static void ior_sidl_MemAllocException__delete(
  struct sidl_MemAllocException__object* self, struct 
    sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  sidl_MemAllocException__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct sidl_MemAllocException__object));
  free((void*) self);
}

static char*
ior_sidl_MemAllocException__getURL(
  struct sidl_MemAllocException__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_sidl_MemAllocException__raddRef(
    struct sidl_MemAllocException__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_sidl_MemAllocException__isRemote(
    struct sidl_MemAllocException__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct sidl_MemAllocException__method {
  const char *d_name;
  void (*d_func)(struct sidl_MemAllocException__object*,
...
static void
ior_sidl_MemAllocException__exec(
  struct sidl_MemAllocException__object* self,
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidl_MemAllocException__method  s_methods[] = {
    { "_cast", sidl_MemAllocException__cast__exec },
    { "add", sidl_MemAllocException_add__exec },
    { "addLine", sidl_MemAllocException_addLine__exec },
    { "addRef", sidl_MemAllocException_addRef__exec },
    { "deleteRef", sidl_MemAllocException_deleteRef__exec },
    { "getClassInfo", sidl_MemAllocException_getClassInfo__exec },
    { "getNote", sidl_MemAllocException_getNote__exec },
    { "getTrace", sidl_MemAllocException_getTrace__exec },
    { "isSame", sidl_MemAllocException_isSame__exec },
    { "isType", sidl_MemAllocException_isType__exec },
    { "packObj", sidl_MemAllocException_packObj__exec },
    { "setNote", sidl_MemAllocException_setNote__exec },
    { "unpackObj", sidl_MemAllocException_unpackObj__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct sidl_MemAllocException__method);
  *_ex  = NULL; /* default to no exception */
...
static void sidl_MemAllocException__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct sidl_MemAllocException__epv*  epv  = &s_my_epv__sidl_memallocexception;
  ...
  struct sidl_io_Serializable__epv*    e5   = &s_my_epv__sidl_io_serializable;
  ...
  epv->f__cast                 = ior_sidl_MemAllocException__cast;
  epv->f__delete               = ior_sidl_MemAllocException__delete;
  epv->f__exec                 = ior_sidl_MemAllocException__exec;
  epv->f__getURL               = ior_sidl_MemAllocException__getURL;
  epv->f__raddRef              = ior_sidl_MemAllocException__raddRef;
  epv->f__isRemote             = ior_sidl_MemAllocException__isRemote;
  epv->f__set_hooks            = ior_sidl_MemAllocException__set_hooks;
  epv->f__set_contracts        = ior_sidl_MemAllocException__set_contracts;
  epv->f__dump_stats           = ior_sidl_MemAllocException__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct sidl_MemAllocException__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidl_MemAllocException__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidl_MemAllocException__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidl_MemAllocException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidl_MemAllocException__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_getNote               = (char* (*)(struct sidl_MemAllocException__object*,struct sidl_BaseInterface__object **)) s1->f_getNote;
  epv->f_setNote               = (void (*)(struct sidl_MemAllocException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_setNote;
  epv->f_getTrace              = (char* (*)(struct sidl_MemAllocException__object*,struct sidl_BaseInterface__object **)) s1->f_getTrace;
  epv->f_addLine               = (void (*)(struct sidl_MemAllocException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_addLine;
  epv->f_add                   = (void (*)(struct sidl_MemAllocException__object*,const char*,int32_t,const char*,struct sidl_BaseInterface__object **)) s1->f_add;
  epv->f_packObj               = (void (*)(struct sidl_MemAllocException__object*,struct sidl_io_Serializer__object*,struct sidl_BaseInterface__object **)) s1->f_packObj;
  epv->f_unpackObj             = (void (*)(struct sidl_MemAllocException__object*,struct sidl_io_Deserializer__object*,struct sidl_BaseInterface__object **)) s1->f_unpackObj;

  sidl_MemAllocException__set_epv(epv);
  ...
  e5->f__cast                 = (void* (*)(void*,const char*, struct sidl_BaseInterface__object**))epv->f__cast;
  e5->f__delete               = (void (*)(void*, struct sidl_BaseInterface__object **)) epv->f__delete;
  e5->f__getURL               = (char* (*)(void*, struct sidl_BaseInterface__object **)) epv->f__getURL;
  e5->f__raddRef              = (void (*)(void*, struct sidl_BaseInterface__object **)) epv->f__raddRef;
  e5->f__isRemote             = (sidl_bool (*)(void*, struct sidl_BaseInterface__object **)) epv->f__isRemote;
  e5->f__exec                 = (void (*)(void*,const char*,struct sidl_rmi_Call__object*,struct sidl_rmi_Return__object*,struct sidl_BaseInterface__object **)) epv->f__exec;
  e5->f_packObj               = (void (*)(void*,struct sidl_io_Serializer__object*,struct sidl_BaseInterface__object **)) epv->f_packObj;
  e5->f_unpackObj             = (void (*)(void*,struct sidl_io_Deserializer__object*,struct sidl_BaseInterface__object **)) epv->f_unpackObj;
  e5->f_addRef                = (void (*)(void*,struct sidl_BaseInterface__object **)) epv->f_addRef;
  e5->f_deleteRef             = (void (*)(void*,struct sidl_BaseInterface__object **)) epv->f_deleteRef;
  e5->f_isSame                = (sidl_bool (*)(void*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) epv->f_isSame;
  e5->f_isType                = (sidl_bool (*)(void*,const char*,struct sidl_BaseInterface__object **)) epv->f_isType;
  e5->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getClassInfo;



  s_method_initialized = 1;
  ior_sidl_MemAllocException__ensure_load_called();
}
...
static void sidl_MemAllocException__init_sepv(void)
{
  /*
   * assert( HAVE_LOCKED_STATIC_GLOBALS );
   */

  struct sidl_MemAllocException__sepv*  s = &s_stc_epv__sidl_memallocexception;

  s->f__set_hooks_static                   = ior_sidl_MemAllocException__set_hooks_static;
  s->f__set_contracts_static               = ior_sidl_MemAllocException__set_contracts_static;
  s->f__dump_stats_static                  = ior_sidl_MemAllocException__dump_stats_static;
  s->f_getSingletonException    = NULL;

  sidl_MemAllocException__set_sepv(s);
...
/*
 * sidl_MemAllocException__getEPVs: Get my version of all relevant EPVs.
 */

void sidl_MemAllocException__getEPVs (
  ...
  struct sidl_MemAllocException__epv **s_arg_epv__sidl_memallocexception)
{
  ...
  if (!s_method_initialized) {
    sidl_MemAllocException__init_epv();
  }
  ...
  *s_arg_epv__sidl_memallocexception = &s_my_epv__sidl_memallocexception;
}
/*
 * sidl_MemAllocException__getStaticEPV: return pointer to static EPV structure.
 */
...
sidl_MemAllocException__getStaticEPV(void){
  ...
  if (!s_static_initialized) {
    sidl_MemAllocException__init_sepv();
  }
  UNLOCK_STATIC_GLOBALS;
  return &s_stc_epv__sidl_memallocexception;
}
...
static struct sidl_SIDLException__epv* sidl_MemAllocException__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidl.MemAllocException", _ex);
...
static void
initMetadata(struct sidl_MemAllocException__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * sidl_MemAllocException__createObject: Allocate the object and initialize it.
 */

struct sidl_MemAllocException__object*
sidl_MemAllocException__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_MemAllocException__object* self =
    (struct sidl_MemAllocException__object*) sidl_malloc(
      sizeof(struct sidl_MemAllocException__object),
      "Object allocation failed for struct sidl_MemAllocException__object",
        __FILE__, __LINE__, "sidl_MemAllocException__createObject", _ex);
  if (!self) goto EXIT;
  sidl_MemAllocException__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void sidl_MemAllocException__init(
  struct sidl_MemAllocException__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct sidl_MemAllocException__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_sidl_runtimeexception.d_epv = &s_my_epv__sidl_runtimeexception;
  s0->d_epv                         = &s_my_epv__sidl_memallocexception;
...
void sidl_MemAllocException__fini(
  struct sidl_MemAllocException__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  struct sidl_MemAllocException__object* s0 = self;
...
void
sidl_MemAllocException__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct sidl_MemAllocException__external
s_externalEntryPoints = {
  sidl_MemAllocException__createObject,
  sidl_MemAllocException__getStaticEPV,
  sidl_MemAllocException__getSuperEPV,
  2, 
  0
};
