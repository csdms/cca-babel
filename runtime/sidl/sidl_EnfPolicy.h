...
#define included_sidl_EnfPolicy_h
...
typedef struct sidl_EnfPolicy__object* sidl_EnfPolicy;
...
#if !defined(SIDL_ENFPOLICY_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDL_ENFPOLICY_INLINE_DECL inline
#else
#define SIDL_ENFPOLICY_INLINE_DECL extern inline
#endif
 ...
 */
sidl_EnfPolicy
sidl_EnfPolicy__connect(const char *, sidl_BaseInterface *_ex);
 ...
 * </p>
 */
SIDL_ENFPOLICY_INLINE_DECL
void
sidl_EnfPolicy_addRef(
  /* in */ sidl_EnfPolicy self,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDL_ENFPOLICY_INLINE_DECL
{
  (*self->d_epv->f_addRef)(
    self,
    _ex);
...
#else
;
#endif /* SIDL_ENFPOLICY_INLINE_DECL */
