...
/**
 * Symbol "sidl.io.Deserializer" (version 0.9.17)
 * 
...
#if !defined(SIDL_IO_DESERIALIZER_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDL_IO_DESERIALIZER_INLINE_DECL inline
#else
#define SIDL_IO_DESERIALIZER_INLINE_DECL extern inline
#endif
...
sidl_io_Deserializer__createRemote(const char * url, sidl_BaseInterface *_ex);
 ...
 * Method:  unpackBool[]
 */
SIDL_IO_DESERIALIZER_INLINE_DECL
void
...
#ifdef SIDL_IO_DESERIALIZER_INLINE_DECL
{
...
#else
;
#endif /* SIDL_IO_DESERIALIZER_INLINE_DECL */
