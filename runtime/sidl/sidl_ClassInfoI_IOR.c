...
static struct sidl_ClassInfoI__epv s_my_epv__sidl_classinfoi;
...
static struct sidl_ClassInfo__epv s_my_epv__sidl_classinfo;
...
static void
sidl_ClassInfoI_setVersion__exec(
        struct sidl_ClassInfoI__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  sidl_rmi_Call_unpackString( inArgs, "ver", &ver, _ex);SIDL_CHECK(*_ex);

  /* make the call */
  (self->d_epv->f_setVersion)(
    self,
    ver,
    _ex);  SIDL_CHECK(*_ex);
...
sidl_ClassInfoI_setIORVersion__exec(
  ...
  sidl_BaseException _SIDLex = NULL;
  /* unpack in and inout argments */
  sidl_rmi_Call_unpackInt( inArgs, "major", &major, _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Call_unpackInt( inArgs, "minor", &minor, _ex);SIDL_CHECK(*_ex);
...
sidl_ClassInfoI_isSame__exec(
  ...
  iobj = skel_sidl_ClassInfoI_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidl_ClassInfoI__object*) (*iobj_bc->d_epv->f__cast)(iobj_bc, 
      "sidl.ClassInfoI", _ex);
    if(iobj != NULL) {
...
static void
sidl_ClassInfoI_getVersion__exec(
        struct sidl_ClassInfoI__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidl_ClassInfoI__set_contracts(
  struct sidl_ClassInfoI__object* self,
  sidl_bool   enable,
...
static void ior_sidl_ClassInfoI__dump_stats(
  struct sidl_ClassInfoI__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  cmp = strcmp(name, "sidl.ClassInfo");
  if (!cmp) {
    ...
    cmp = strcmp(name, "sidl.ClassInfoI");
    if (!cmp) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
...
static void ior_sidl_ClassInfoI__set_hooks(
  struct sidl_ClassInfoI__object* self,
...
static void ior_sidl_ClassInfoI__delete(
  struct sidl_ClassInfoI__object* self, struct sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  sidl_ClassInfoI__fini(self, _ex);
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidl_ClassInfoI__method  s_methods[] = {
    { "_cast", sidl_ClassInfoI__cast__exec },
    ...
    { "getVersion", sidl_ClassInfoI_getVersion__exec },
    ...
    { "setVersion", sidl_ClassInfoI_setVersion__exec }
  };
  int i, cmp, l = 0;
...
static void sidl_ClassInfoI__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct sidl_ClassInfoI__epv*    epv  = &s_my_epv__sidl_classinfoi;
  struct sidl_BaseClass__epv*     e0   = &s_my_epv__sidl_baseclass;
  struct sidl_BaseInterface__epv* e1   = &s_my_epv__sidl_baseinterface;
  struct sidl_ClassInfo__epv*     e2   = &s_my_epv__sidl_classinfo;
  ...
  epv->f__raddRef              = ior_sidl_ClassInfoI__raddRef;
  epv->f__isRemote             = ior_sidl_ClassInfoI__isRemote;
  epv->f__set_hooks            = ior_sidl_ClassInfoI__set_hooks;
  epv->f__set_contracts        = ior_sidl_ClassInfoI__set_contracts;
  epv->f__dump_stats           = ior_sidl_ClassInfoI__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_setName               = NULL;
  epv->f_setVersion            = NULL;
  epv->f_setIORVersion         = NULL;
  epv->f_addRef                = (void (*)(struct sidl_ClassInfoI__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidl_ClassInfoI__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidl_ClassInfoI__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidl_ClassInfoI__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidl_ClassInfoI__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_getName               = NULL;
  ...
  /*
   * Override function pointers for sidl.ClassInfo with mine, as needed.
   */
  ...
  e2->f_getName               = (char* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getName;
  e2->f_getVersion            = (char* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getVersion;
  e2->f_getIORVersion         = (char* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getIORVersion;
...
/*
 * sidl_ClassInfoI__getEPVs: Get my version of all relevant EPVs.
 */

void sidl_ClassInfoI__getEPVs (
  ...
  struct sidl_ClassInfoI__epv **s_arg_epv__sidl_classinfoi)
{
  ...
  if (!s_method_initialized) {
    sidl_ClassInfoI__init_epv();
  }
  UNLOCK_STATIC_GLOBALS;

  *s_arg_epv__sidl_baseinterface = &s_my_epv__sidl_baseinterface;
  *s_arg_epv__sidl_baseclass = &s_my_epv__sidl_baseclass;
  *s_arg_epv__sidl_classinfo = &s_my_epv__sidl_classinfo;
  *s_arg_epv__sidl_classinfoi = &s_my_epv__sidl_classinfoi;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* sidl_ClassInfoI__getSuperEPV(void) {
  return s_par_epv__sidl_baseclass;
}

static void
cleanupClassInfo(void *ignored) {
  struct sidl_BaseInterface__object *throwaway_exception = NULL;
  if (s_classInfo) {
    struct sidl_BaseClass__object *bc = sidl_BaseClass__cast(s_classInfo, &throwaway_exception);
    struct sidl_BaseClass__data *data = sidl_BaseClass__get_data(bc);
    if (data && data->d_classinfo) {
      struct sidl_ClassInfo__object* ci = data->d_classinfo;
      data->d_classinfo = NULL;
      sidl_BaseClass_deleteRef(bc, &throwaway_exception);
      sidl_ClassInfo_deleteRef(ci, &throwaway_exception);
    }
    sidl_ClassInfo_deleteRef(s_classInfo, &throwaway_exception);
  }
  s_classInfo = NULL;
  s_classInfo_init = 1;
}

static void initMetadata(struct sidl_ClassInfoI__object*,struct sidl_BaseInterface__object **_ex);
...
static void
initMetadata(struct sidl_ClassInfoI__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * sidl_ClassInfoI__createObject: Allocate the object and initialize it.
 */

struct sidl_ClassInfoI__object*
sidl_ClassInfoI__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_ClassInfoI__object* self =
    (struct sidl_ClassInfoI__object*) sidl_malloc(
      sizeof(struct sidl_ClassInfoI__object),
      "Object allocation failed for struct sidl_ClassInfoI__object",
        __FILE__, __LINE__, "sidl_ClassInfoI__createObject", _ex);
  if (!self) goto EXIT;
  sidl_ClassInfoI__init(self, ddata, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_sidl_classinfo.d_epv = &s_my_epv__sidl_classinfo;
  s0->d_epv                  = &s_my_epv__sidl_classinfoi;
...
s_externalEntryPoints = {
  sidl_ClassInfoI__createObject,
  sidl_ClassInfoI__getSuperEPV,
  2, 
  0
};
