...
static struct sidl_rmi_NoServerException__epv 
  s_my_epv__sidl_rmi_noserverexception;
...
static void
sidl_rmi_NoServerException_setErrno__exec(
        struct sidl_rmi_NoServerException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_rmi_NoServerException_getErrno__exec(
        struct sidl_rmi_NoServerException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
sidl_rmi_NoServerException_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidl_rmi_NoServerException__object*) (
      *iobj_bc->d_epv->f__cast)(iobj_bc, "sidl.rmi.NoServerException", _ex);
    if(iobj != NULL) {
...
sidl_rmi_NoServerException_packObj__exec(
  ...
  ser_bc = sidl_rmi_InstanceRegistry_getInstanceByString(ser_str, 
    _ex);SIDL_CHECK(*_ex);
  if(ser_bc != NULL) {
    ser= (struct sidl_rmi_NoServerException__object*) (*ser_bc->d_epv->f__cast)(
      ser_bc, "sidl.rmi.NoServerException", _ex);
    if(ser != NULL) {
...
sidl_rmi_NoServerException_unpackObj__exec(
  ...
  des_bc = sidl_rmi_InstanceRegistry_getInstanceByString(des_str, 
    _ex);SIDL_CHECK(*_ex);
  if(des_bc != NULL) {
    des= (struct sidl_rmi_NoServerException__object*) (*des_bc->d_epv->f__cast)(
      des_bc, "sidl.rmi.NoServerException", _ex);
    if(des != NULL) {
...
static void
sidl_rmi_NoServerException__cast__exec(
        struct sidl_rmi_NoServerException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidl_rmi_NoServerException__set_contracts(
  struct sidl_rmi_NoServerException__object* self,
  sidl_bool   enable,
...
static void ior_sidl_rmi_NoServerException__dump_stats(
  struct sidl_rmi_NoServerException__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp) {
    ...
    if (!cmp) {
      ...
      cmp = strcmp(name, "sidl.rmi.NoServerException");
      if (!cmp) {
        (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidl_rmi_NoServerException__method  s_methods[] = {
    { "_cast", sidl_rmi_NoServerException__cast__exec },
    ...
    { "getErrno", sidl_rmi_NoServerException_getErrno__exec },
    ...
    { "setErrno", sidl_rmi_NoServerException_setErrno__exec },
 ...
 */
  ...
  struct sidl_rmi_NoServerException__epv*  epv  = &s_my_epv__sidl_rmi_noserverexception;
  ...
  epv->f__set_contracts        = ior_sidl_rmi_NoServerException__set_contracts;
  epv->f__dump_stats           = ior_sidl_rmi_NoServerException__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_getHopCount           = (int32_t (*)(struct sidl_rmi_NoServerException__object*,struct sidl_BaseInterface__object **)) s1->f_getHopCount;
  epv->f_setErrno              = (void (*)(struct sidl_rmi_NoServerException__object*,int32_t,struct sidl_BaseInterface__object **)) s1->f_setErrno;
  epv->f_getErrno              = (int32_t (*)(struct sidl_rmi_NoServerException__object*,struct sidl_BaseInterface__object **)) s1->f_getErrno;
  epv->f_addRef                = (void (*)(struct sidl_rmi_NoServerException__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidl_rmi_NoServerException__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidl_rmi_NoServerException__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidl_rmi_NoServerException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidl_rmi_NoServerException__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_getNote               = (char* (*)(struct sidl_rmi_NoServerException__object*,struct sidl_BaseInterface__object **)) s1->f_getNote;
  epv->f_setNote               = (void (*)(struct sidl_rmi_NoServerException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_setNote;
  epv->f_getTrace              = (char* (*)(struct sidl_rmi_NoServerException__object*,struct sidl_BaseInterface__object **)) s1->f_getTrace;
  epv->f_addLine               = (void (*)(struct sidl_rmi_NoServerException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_addLine;
  epv->f_add                   = (void (*)(struct sidl_rmi_NoServerException__object*,const char*,int32_t,const char*,struct sidl_BaseInterface__object **)) s1->f_add;
  epv->f_packObj               = (void (*)(struct sidl_rmi_NoServerException__object*,struct sidl_io_Serializer__object*,struct sidl_BaseInterface__object **)) s1->f_packObj;
  epv->f_unpackObj             = (void (*)(struct sidl_rmi_NoServerException__object*,struct sidl_io_Deserializer__object*,struct sidl_BaseInterface__object **)) s1->f_unpackObj;
...
/*
 * sidl_rmi_NoServerException__getEPVs: Get my version of all relevant EPVs.
 */
...
void sidl_rmi_NoServerException__getEPVs (
  ...
  struct sidl_rmi_NoServerException__epv **s_arg_epv__sidl_rmi_noserverexception)
{
  LOCK_STATIC_GLOBALS;
  ...
  *s_arg_epv__sidl_rmi_noserverexception = &s_my_epv__sidl_rmi_noserverexception;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_rmi_NetworkException__epv* sidl_rmi_NoServerException__getSuperEPV(void) {
...
static void
initMetadata(struct sidl_rmi_NoServerException__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * sidl_rmi_NoServerException__createObject: Allocate the object and initialize it.
 */

struct sidl_rmi_NoServerException__object*
sidl_rmi_NoServerException__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_rmi_NoServerException__object* self =
    (struct sidl_rmi_NoServerException__object*) sidl_malloc(
      sizeof(struct sidl_rmi_NoServerException__object),
      "Object allocation failed for struct sidl_rmi_NoServerException__object",
        __FILE__, __LINE__, "sidl_rmi_NoServerException__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_my_epv__sidl_rmi_noserverexception;
...
s_externalEntryPoints = {
  sidl_rmi_NoServerException__createObject,
  sidl_rmi_NoServerException__getSuperEPV,
  2, 
  0
};
