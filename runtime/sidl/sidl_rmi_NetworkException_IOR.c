...
static void
sidl_rmi_NetworkException_setErrno__exec(
        struct sidl_rmi_NetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
sidl_rmi_NetworkException_getErrno__exec(
        struct sidl_rmi_NetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
sidl_rmi_NetworkException_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidl_rmi_NetworkException__object*) (
      *iobj_bc->d_epv->f__cast)(iobj_bc, "sidl.rmi.NetworkException", _ex);
    if(iobj != NULL) {
...
sidl_rmi_NetworkException_packObj__exec(
  ...
  ser_bc = sidl_rmi_InstanceRegistry_getInstanceByString(ser_str, 
    _ex);SIDL_CHECK(*_ex);
  if(ser_bc != NULL) {
    ser= (struct sidl_rmi_NetworkException__object*) (*ser_bc->d_epv->f__cast)(
      ser_bc, "sidl.rmi.NetworkException", _ex);
    if(ser != NULL) {
...
sidl_rmi_NetworkException_unpackObj__exec(
  ...
  des_bc = sidl_rmi_InstanceRegistry_getInstanceByString(des_str, 
    _ex);SIDL_CHECK(*_ex);
  if(des_bc != NULL) {
    des= (struct sidl_rmi_NetworkException__object*) (*des_bc->d_epv->f__cast)(
      des_bc, "sidl.rmi.NetworkException", _ex);
    if(des != NULL) {
...
static void
sidl_rmi_NetworkException__cast__exec(
        struct sidl_rmi_NetworkException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidl_rmi_NetworkException__set_contracts(
  struct sidl_rmi_NetworkException__object* self,
  sidl_bool   enable,
...
static void ior_sidl_rmi_NetworkException__dump_stats(
  struct sidl_rmi_NetworkException__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidl_rmi_NetworkException__method  s_methods[] = {
    { "_cast", sidl_rmi_NetworkException__cast__exec },
    ...
    { "getErrno", sidl_rmi_NetworkException_getErrno__exec },
    ...
    { "setErrno", sidl_rmi_NetworkException_setErrno__exec },
 ...
 */
  ...
  struct sidl_rmi_NetworkException__epv*  epv  = &s_my_epv__sidl_rmi_networkexception;
  ...
  s3  =  s_par_epv__sidl_baseclass;
  s2  =  s_par_epv__sidl_sidlexception;
  s1  =  s_par_epv__sidl_io_ioexception;
  ...
  epv->f__set_contracts        = ior_sidl_rmi_NetworkException__set_contracts;
  epv->f__dump_stats           = ior_sidl_rmi_NetworkException__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  ...
  epv->f_setErrno              = NULL;
  epv->f_getErrno              = NULL;
  epv->f_addRef                = (void (*)(struct sidl_rmi_NetworkException__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidl_rmi_NetworkException__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidl_rmi_NetworkException__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidl_rmi_NetworkException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidl_rmi_NetworkException__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_getNote               = (char* (*)(struct sidl_rmi_NetworkException__object*,struct sidl_BaseInterface__object **)) s1->f_getNote;
  epv->f_setNote               = (void (*)(struct sidl_rmi_NetworkException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_setNote;
  epv->f_getTrace              = (char* (*)(struct sidl_rmi_NetworkException__object*,struct sidl_BaseInterface__object **)) s1->f_getTrace;
  epv->f_addLine               = (void (*)(struct sidl_rmi_NetworkException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_addLine;
  epv->f_add                   = (void (*)(struct sidl_rmi_NetworkException__object*,const char*,int32_t,const char*,struct sidl_BaseInterface__object **)) s1->f_add;
  epv->f_packObj               = (void (*)(struct sidl_rmi_NetworkException__object*,struct sidl_io_Serializer__object*,struct sidl_BaseInterface__object **)) s1->f_packObj;
  epv->f_unpackObj             = (void (*)(struct sidl_rmi_NetworkException__object*,struct sidl_io_Deserializer__object*,struct sidl_BaseInterface__object **)) s1->f_unpackObj;
...
/*
 * sidl_rmi_NetworkException__getEPVs: Get my version of all relevant EPVs.
 */
...
static struct sidl_io_IOException__epv* sidl_rmi_NetworkException__getSuperEPV(void) {
  return s_par_epv__sidl_io_ioexception;
}
...
static void
initMetadata(struct sidl_rmi_NetworkException__object* self, sidl_BaseInterface* _ex)
{
  *_ex = 0; /* default no exception */
  if (self) {
    struct sidl_BaseClass__data *data = (struct sidl_BaseClass__data*)((*self).d_sidl_io_ioexception.d_sidl_sidlexception.d_sidl_baseclass.d_data);
    if (data) {
...
/*
 * sidl_rmi_NetworkException__createObject: Allocate the object and initialize it.
 */

struct sidl_rmi_NetworkException__object*
sidl_rmi_NetworkException__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_rmi_NetworkException__object* self =
    (struct sidl_rmi_NetworkException__object*) sidl_malloc(
      sizeof(struct sidl_rmi_NetworkException__object),
      "Object allocation failed for struct sidl_rmi_NetworkException__object",
        __FILE__, __LINE__, "sidl_rmi_NetworkException__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s3->d_sidl_baseinterface.d_epv = &s_my_epv__sidl_baseinterface;
  s3->d_epv                      = &s_my_epv__sidl_baseclass;

  s2->d_sidl_baseexception.d_epv   = &s_my_epv__sidl_baseexception;
  s2->d_sidl_io_serializable.d_epv = &s_my_epv__sidl_io_serializable;
  s2->d_epv                        = &s_my_epv__sidl_sidlexception;

  s1->d_sidl_runtimeexception.d_epv = &s_my_epv__sidl_runtimeexception;
  s1->d_epv                         = &s_my_epv__sidl_io_ioexception;

  s0->d_epv    = &s_my_epv__sidl_rmi_networkexception;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  s3->d_sidl_baseinterface.d_epv = s_par_epv__sidl_baseinterface;
  s3->d_epv                      = s_par_epv__sidl_baseclass;

  s2->d_sidl_baseexception.d_epv   = s_par_epv__sidl_baseexception;
  s2->d_sidl_io_serializable.d_epv = s_par_epv__sidl_io_serializable;
  s2->d_epv                        = s_par_epv__sidl_sidlexception;

  s1->d_sidl_runtimeexception.d_epv = s_par_epv__sidl_runtimeexception;
  s1->d_epv                         = s_par_epv__sidl_io_ioexception;
...
s_externalEntryPoints = {
  sidl_rmi_NetworkException__createObject,
  sidl_rmi_NetworkException__getSuperEPV,
  2, 
  0
};
