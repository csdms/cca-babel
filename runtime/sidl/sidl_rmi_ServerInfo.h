...
#if !defined(SIDL_RMI_SERVERINFO_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDL_RMI_SERVERINFO_INLINE_DECL inline
#else
#define SIDL_RMI_SERVERINFO_INLINE_DECL extern inline
#endif
 ...
 */
sidl_rmi_ServerInfo
sidl_rmi_ServerInfo__createRemote(const char * url, sidl_BaseInterface *_ex);
 ...
 * Method:  getServerURL[]
 */
SIDL_RMI_SERVERINFO_INLINE_DECL
char*
sidl_rmi_ServerInfo_getServerURL(
  /* in */ sidl_rmi_ServerInfo self,
  /* in */ const char* objID,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDL_RMI_SERVERINFO_INLINE_DECL
{
  char* _result;
...
#else
;
#endif /* SIDL_RMI_SERVERINFO_INLINE_DECL */
