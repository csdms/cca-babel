...
#if !defined(SIDL_RMI_RETURN_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDL_RMI_RETURN_INLINE_DECL inline
#else
#define SIDL_RMI_RETURN_INLINE_DECL extern inline
#endif
 ...
 */
sidl_rmi_Return
sidl_rmi_Return__createRemote(const char * url, sidl_BaseInterface *_ex);
 ...
 */
void
sidl_rmi_Return__set_contracts(
  sidl_rmi_Return self,
  sidl_bool   enable,
...
#else
;
#endif /* SIDL_RMI_RETURN_INLINE_DECL */
