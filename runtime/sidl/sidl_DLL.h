...
#if !defined(SIDL_DLL_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDL_DLL_INLINE_DECL inline
#else
#define SIDL_DLL_INLINE_DECL extern inline
#endif
