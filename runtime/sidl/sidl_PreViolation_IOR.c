...
static struct sidl_PreViolation__epv s_my_epv__sidl_previolation;
...
sidl_PreViolation_isSame__exec(
  ...
  iobj = skel_sidl_PreViolation_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidl_PreViolation__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "sidl.PreViolation", _ex);
    if(iobj != NULL) {
...
static void
sidl_PreViolation_packObj__exec(
        struct sidl_PreViolation__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  ser = skel_sidl_PreViolation_fconnect_sidl_io_Serializer(ser_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  ser_bc = sidl_rmi_InstanceRegistry_getInstanceByString(ser_str, 
    _ex);SIDL_CHECK(*_ex);
  if(ser_bc != NULL) {
    ser= (struct sidl_PreViolation__object*) (*ser_bc->d_epv->f__cast)(ser_bc, 
      "sidl.PreViolation", _ex);
    if(ser != NULL) {
...
static void
sidl_PreViolation_unpackObj__exec(
        struct sidl_PreViolation__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  des = skel_sidl_PreViolation_fconnect_sidl_io_Deserializer(des_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  des_bc = sidl_rmi_InstanceRegistry_getInstanceByString(des_str, 
    _ex);SIDL_CHECK(*_ex);
  if(des_bc != NULL) {
    des= (struct sidl_PreViolation__object*) (*des_bc->d_epv->f__cast)(des_bc, 
      "sidl.PreViolation", _ex);
    if(des != NULL) {
...
static void ior_sidl_PreViolation__set_contracts(
  struct sidl_PreViolation__object* self,
  sidl_bool   enable,
...
static void ior_sidl_PreViolation__dump_stats(
  struct sidl_PreViolation__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  cmp = strcmp(name, "sidl.PreViolation");
  if (!cmp) {
...
static void ior_sidl_PreViolation__set_hooks(
  struct sidl_PreViolation__object* self,
...
{
  *_ex  = NULL; /* default to no exception */
  sidl_PreViolation__fini(self, _ex);
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidl_PreViolation__method  s_methods[] = {
    { "_cast", sidl_PreViolation__cast__exec },
    ...
    { "packObj", sidl_PreViolation_packObj__exec },
    { "setNote", sidl_PreViolation_setNote__exec },
    { "unpackObj", sidl_PreViolation_unpackObj__exec }
  };
  int i, cmp, l = 0;
...
static void sidl_PreViolation__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct sidl_PreViolation__epv*     epv  = &s_my_epv__sidl_previolation;
  ...
  epv->f__raddRef              = ior_sidl_PreViolation__raddRef;
  epv->f__isRemote             = ior_sidl_PreViolation__isRemote;
  epv->f__set_hooks            = ior_sidl_PreViolation__set_hooks;
  epv->f__set_contracts        = ior_sidl_PreViolation__set_contracts;
  epv->f__dump_stats           = ior_sidl_PreViolation__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct sidl_PreViolation__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidl_PreViolation__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidl_PreViolation__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidl_PreViolation__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidl_PreViolation__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_getNote               = (char* (*)(struct sidl_PreViolation__object*,struct sidl_BaseInterface__object **)) s1->f_getNote;
  epv->f_setNote               = (void (*)(struct sidl_PreViolation__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_setNote;
  epv->f_getTrace              = (char* (*)(struct sidl_PreViolation__object*,struct sidl_BaseInterface__object **)) s1->f_getTrace;
  epv->f_addLine               = (void (*)(struct sidl_PreViolation__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_addLine;
  epv->f_add                   = (void (*)(struct sidl_PreViolation__object*,const char*,int32_t,const char*,struct sidl_BaseInterface__object **)) s1->f_add;
  epv->f_packObj               = (void (*)(struct sidl_PreViolation__object*,struct sidl_io_Serializer__object*,struct sidl_BaseInterface__object **)) s1->f_packObj;
  epv->f_unpackObj             = (void (*)(struct sidl_PreViolation__object*,struct sidl_io_Deserializer__object*,struct sidl_BaseInterface__object **)) s1->f_unpackObj;
...
/*
 * sidl_PreViolation__getEPVs: Get my version of all relevant EPVs.
 */

void sidl_PreViolation__getEPVs (
  ...
  struct sidl_PreViolation__epv **s_arg_epv__sidl_previolation)
{
  ...
  *s_arg_epv__sidl_previolation = &s_my_epv__sidl_previolation;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_SIDLException__epv* sidl_PreViolation__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidl.PreViolation", _ex);
...
static void
initMetadata(struct sidl_PreViolation__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * sidl_PreViolation__createObject: Allocate the object and initialize it.
 */

struct sidl_PreViolation__object*
sidl_PreViolation__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_PreViolation__object* self =
    (struct sidl_PreViolation__object*) sidl_malloc(
      sizeof(struct sidl_PreViolation__object),
      "Object allocation failed for struct sidl_PreViolation__object",
        __FILE__, __LINE__, "sidl_PreViolation__createObject", _ex);
  if (!self) goto EXIT;
  sidl_PreViolation__init(self, ddata, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv                         = &s_my_epv__sidl_previolation;
...
s_externalEntryPoints = {
  sidl_PreViolation__createObject,
  sidl_PreViolation__getSuperEPV,
  2, 
  0
};
