...
struct sidl_rmi_ObjectDoesNotExistException__epv {
  ...
  int32_t (*f_getErrno)(
    /* in */ struct sidl_rmi_ObjectDoesNotExistException__object* self,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in sidl.rmi.ObjectDoesNotExistException-v0.9.17 */
};
...
struct sidl_rmi_ObjectDoesNotExistException__cstats {
  sidl_bool use_hooks;
};
...
sidl_rmi_ObjectDoesNotExistException__createObject(void* ddata,struct 
