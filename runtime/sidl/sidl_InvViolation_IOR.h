...
struct sidl_InvViolation__epv {
  ...
  /* Methods introduced in sidl.InvViolation-v0.9.17 */
};
...
struct sidl_InvViolation__cstats {
  sidl_bool use_hooks;
};
...
sidl_InvViolation__createObject(void* ddata,struct sidl_BaseInterface__object 
  ** _ex);
