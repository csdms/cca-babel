...
/**
 * Symbol "sidl.rmi.Invocation" (version 0.9.17)
 * 
...
#if !defined(SIDL_RMI_INVOCATION_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDL_RMI_INVOCATION_INLINE_DECL inline
#else
#define SIDL_RMI_INVOCATION_INLINE_DECL extern inline
#endif
 ...
 */
sidl_rmi_Invocation
sidl_rmi_Invocation__createRemote(const char * url, sidl_BaseInterface *_ex);
 ...
 */
void
sidl_rmi_Invocation__set_contracts(
  sidl_rmi_Invocation self,
  sidl_bool   enable,
 ...
 */
void
sidl_rmi_Invocation__dump_stats(
  sidl_rmi_Invocation self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex);
 ...
 */
SIDL_RMI_INVOCATION_INLINE_DECL
sidl_rmi_Response
sidl_rmi_Invocation_invokeMethod(
  /* in */ sidl_rmi_Invocation self,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDL_RMI_INVOCATION_INLINE_DECL
{
...
#else
;
#endif /* SIDL_RMI_INVOCATION_INLINE_DECL */
