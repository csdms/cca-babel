...
static struct sidl_InvViolation__epv s_my_epv__sidl_invviolation;
...
sidl_InvViolation_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidl_InvViolation__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "sidl.InvViolation", _ex);
    if(iobj != NULL) {
...
sidl_InvViolation_packObj__exec(
  ...
  ser_bc = sidl_rmi_InstanceRegistry_getInstanceByString(ser_str, 
    _ex);SIDL_CHECK(*_ex);
  if(ser_bc != NULL) {
    ser= (struct sidl_InvViolation__object*) (*ser_bc->d_epv->f__cast)(ser_bc, 
      "sidl.InvViolation", _ex);
    if(ser != NULL) {
...
sidl_InvViolation_unpackObj__exec(
  ...
  des_bc = sidl_rmi_InstanceRegistry_getInstanceByString(des_str, 
    _ex);SIDL_CHECK(*_ex);
  if(des_bc != NULL) {
    des= (struct sidl_InvViolation__object*) (*des_bc->d_epv->f__cast)(des_bc, 
      "sidl.InvViolation", _ex);
    if(des != NULL) {
...
static void ior_sidl_InvViolation__set_contracts(
  struct sidl_InvViolation__object* self,
  sidl_bool   enable,
...
static void ior_sidl_InvViolation__dump_stats(
  struct sidl_InvViolation__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  cmp = strcmp(name, "sidl.InvViolation");
  if (!cmp) {
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidl_InvViolation__method  s_methods[] = {
    { "_cast", sidl_InvViolation__cast__exec },
 ...
 */
  ...
  struct sidl_InvViolation__epv*     epv  = &s_my_epv__sidl_invviolation;
  ...
  epv->f__set_contracts        = ior_sidl_InvViolation__set_contracts;
  epv->f__dump_stats           = ior_sidl_InvViolation__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct sidl_InvViolation__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidl_InvViolation__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidl_InvViolation__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidl_InvViolation__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidl_InvViolation__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_getNote               = (char* (*)(struct sidl_InvViolation__object*,struct sidl_BaseInterface__object **)) s1->f_getNote;
  epv->f_setNote               = (void (*)(struct sidl_InvViolation__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_setNote;
  epv->f_getTrace              = (char* (*)(struct sidl_InvViolation__object*,struct sidl_BaseInterface__object **)) s1->f_getTrace;
  epv->f_addLine               = (void (*)(struct sidl_InvViolation__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_addLine;
  epv->f_add                   = (void (*)(struct sidl_InvViolation__object*,const char*,int32_t,const char*,struct sidl_BaseInterface__object **)) s1->f_add;
  epv->f_packObj               = (void (*)(struct sidl_InvViolation__object*,struct sidl_io_Serializer__object*,struct sidl_BaseInterface__object **)) s1->f_packObj;
  epv->f_unpackObj             = (void (*)(struct sidl_InvViolation__object*,struct sidl_io_Deserializer__object*,struct sidl_BaseInterface__object **)) s1->f_unpackObj;
...
/*
 * sidl_InvViolation__getEPVs: Get my version of all relevant EPVs.
 */
  ...
  struct sidl_InvViolation__epv **s_arg_epv__sidl_invviolation)
{
  ...
  *s_arg_epv__sidl_invviolation = &s_my_epv__sidl_invviolation;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_SIDLException__epv* sidl_InvViolation__getSuperEPV(void) {
...
/*
 * sidl_InvViolation__createObject: Allocate the object and initialize it.
 */

struct sidl_InvViolation__object*
sidl_InvViolation__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_InvViolation__object* self =
    (struct sidl_InvViolation__object*) sidl_malloc(
      sizeof(struct sidl_InvViolation__object),
      "Object allocation failed for struct sidl_InvViolation__object",
        __FILE__, __LINE__, "sidl_InvViolation__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv                         = &s_my_epv__sidl_invviolation;
...
s_externalEntryPoints = {
  sidl_InvViolation__createObject,
  sidl_InvViolation__getSuperEPV,
  2, 
  0
};
