/*
 * File:          sidl_MemAllocException_Stub.c
 * Symbol:        sidl.MemAllocException-v0.9.17
 * Symbol Type:   class
 * Babel Version: 1.4.0 (Revision: 6607 release-1-4-0-branch)
 * Release:       $Name:  $
 * Revision:      @(#) $Id: $
 * Description:   Client-side glue code for sidl.MemAllocException
 * 
...
#define SIDL_MEMALLOCEXCEPTION_INLINE_DECL
...
static const struct sidl_MemAllocException__sepv *_sepv = NULL;
/*
...
sidl_MemAllocException__create(sidl_BaseInterface* _ex)
{
...
static sidl_MemAllocException sidl_MemAllocException__remoteCreate(const char* 
...
sidl_MemAllocException
sidl_MemAllocException__createRemote(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_MemAllocException__remoteCreate(url, _ex);
}

static struct sidl_MemAllocException__object* 
  sidl_MemAllocException__remoteConnect(const char* url, sidl_bool ar, 
  sidl_BaseInterface *_ex);
static struct sidl_MemAllocException__object* sidl_MemAllocException__IHConnect(
...
sidl_MemAllocException
sidl_MemAllocException__connect(const char* url, sidl_BaseInterface *_ex)
{
  return sidl_MemAllocException__remoteConnect(url, TRUE, _ex);
}
...
void
sidl_MemAllocException__set_contracts_static(
  sidl_bool   enable,
...
void
sidl_MemAllocException__dump_stats_static(
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
{
...
void
sidl_MemAllocException__set_contracts(
...
void
sidl_MemAllocException__dump_stats(
  sidl_MemAllocException self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
sidl_MemAllocException
sidl_MemAllocException_getSingletonException(
  /* out */ sidl_BaseInterface *_ex)
{
  sidl_MemAllocException _result;
  _result = (_getSEPV()->f_getSingletonException)(
    _ex);
  return _result;
}
...
sidl_MemAllocException
sidl_MemAllocException__cast(
  void* obj,
  sidl_BaseInterface* _ex)
{
  sidl_MemAllocException cast = NULL;

#ifdef WITH_RMI
  static int connect_loaded = 0;
  if (!connect_loaded) {
    connect_loaded = 1;
    sidl_rmi_ConnectRegistry_registerConnect("sidl.MemAllocException", (
      void*)sidl_MemAllocException__IHConnect,_ex);SIDL_CHECK(*_ex);
  }
#endif /*WITH_RMI*/
  if (obj != NULL) {
    sidl_BaseInterface base = (sidl_BaseInterface) obj;
    cast = (sidl_MemAllocException) (*base->d_epv->f__cast)(
      base->d_object,
      "sidl.MemAllocException", _ex); SIDL_CHECK(*_ex);
  }
...
void
sidl_MemAllocException__set_hooks_static(
  sidl_bool enable,
  struct sidl_BaseInterface__object **_ex)
{
...
sidl_bool
sidl_MemAllocException__isLocal(
  /* in */ sidl_MemAllocException self,
  /* out */ sidl_BaseInterface *_ex)
{
  return !sidl_MemAllocException__isRemote(self, _ex);
}
...
sidl_MemAllocException__array_createCol(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_MemAllocException__array*)sidl_interface__array_createCol(
    dimen, lower, upper);
}
 ...
 */
struct sidl_MemAllocException__array*
sidl_MemAllocException__array_createRow(
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[])
{
  return (struct sidl_MemAllocException__array*)sidl_interface__array_createRow(
    dimen, lower, upper);
}
 ...
 */
struct sidl_MemAllocException__array*
sidl_MemAllocException__array_create1d(int32_t len)
{
  return (struct sidl_MemAllocException__array*)sidl_interface__array_create1d(
    len);
}
 ...
 */
struct sidl_MemAllocException__array*
sidl_MemAllocException__array_create1dInit(
  int32_t len, 
  sidl_MemAllocException* data)
{
  return (struct 
    sidl_MemAllocException__array*)sidl_interface__array_create1dInit(len, (
 ...
 */
struct sidl_MemAllocException__array*
sidl_MemAllocException__array_create2dCol(int32_t m, int32_t n)
{
  return (struct 
    sidl_MemAllocException__array*)sidl_interface__array_create2dCol(m, n);
}
 ...
 */
struct sidl_MemAllocException__array*
sidl_MemAllocException__array_create2dRow(int32_t m, int32_t n)
{
  return (struct 
    sidl_MemAllocException__array*)sidl_interface__array_create2dRow(m, n);
}
 ...
 */
struct sidl_MemAllocException__array*
sidl_MemAllocException__array_borrow(
  sidl_MemAllocException* firstElement,
  int32_t       dimen,
  const int32_t lower[],
  const int32_t upper[],
  const int32_t stride[])
{
  return (struct sidl_MemAllocException__array*)sidl_interface__array_borrow(
 ...
 */
struct sidl_MemAllocException__array*
sidl_MemAllocException__array_smartCopy(
  struct sidl_MemAllocException__array *array)
{
  return (struct sidl_MemAllocException__array*)
 ...
 */
void
sidl_MemAllocException__array_addRef(
  struct sidl_MemAllocException__array* array)
{
 ...
 */
void
sidl_MemAllocException__array_deleteRef(
  struct sidl_MemAllocException__array* array)
{
 ...
 */
sidl_MemAllocException
sidl_MemAllocException__array_get1(
  const struct sidl_MemAllocException__array* array,
  const int32_t i1)
{
  return (sidl_MemAllocException)
 ...
 */
sidl_MemAllocException
sidl_MemAllocException__array_get2(
  const struct sidl_MemAllocException__array* array,
  const int32_t i1,
  const int32_t i2)
{
 ...
 */
sidl_MemAllocException
sidl_MemAllocException__array_get3(
  const struct sidl_MemAllocException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3)
 ...
 */
sidl_MemAllocException
sidl_MemAllocException__array_get4(
  const struct sidl_MemAllocException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_MemAllocException
sidl_MemAllocException__array_get5(
  const struct sidl_MemAllocException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_MemAllocException
sidl_MemAllocException__array_get6(
  const struct sidl_MemAllocException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_MemAllocException
sidl_MemAllocException__array_get7(
  const struct sidl_MemAllocException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
sidl_MemAllocException
sidl_MemAllocException__array_get(
  const struct sidl_MemAllocException__array* array,
 ...
 */
void
sidl_MemAllocException__array_set1(
  struct sidl_MemAllocException__array* array,
  const int32_t i1,
  sidl_MemAllocException const value)
{
 ...
 */
void
sidl_MemAllocException__array_set2(
  struct sidl_MemAllocException__array* array,
  const int32_t i1,
  const int32_t i2,
  sidl_MemAllocException const value)
 ...
 */
void
sidl_MemAllocException__array_set3(
  struct sidl_MemAllocException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_MemAllocException__array_set4(
  struct sidl_MemAllocException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_MemAllocException__array_set5(
  struct sidl_MemAllocException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_MemAllocException__array_set6(
  struct sidl_MemAllocException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_MemAllocException__array_set7(
  struct sidl_MemAllocException__array* array,
  const int32_t i1,
  const int32_t i2,
  const int32_t i3,
 ...
 */
void
sidl_MemAllocException__array_set(
  struct sidl_MemAllocException__array* array,
  const int32_t indices[],
  sidl_MemAllocException const value)
{
 ...
 */
int32_t
sidl_MemAllocException__array_dimen(
  const struct sidl_MemAllocException__array* array)
{
 ...
 */
int32_t
sidl_MemAllocException__array_lower(
  const struct sidl_MemAllocException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_MemAllocException__array_upper(
  const struct sidl_MemAllocException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_MemAllocException__array_length(
  const struct sidl_MemAllocException__array* array,
  const int32_t ind)
{
 ...
 */
int32_t
sidl_MemAllocException__array_stride(
  const struct sidl_MemAllocException__array* array,
  const int32_t ind)
{
 ...
 */
int
sidl_MemAllocException__array_isColumnOrder(
  const struct sidl_MemAllocException__array* array)
{
 ...
 */
int
sidl_MemAllocException__array_isRowOrder(
  const struct sidl_MemAllocException__array* array)
{
 ...
 */
void
sidl_MemAllocException__array_copy(
  const struct sidl_MemAllocException__array* src,
  struct sidl_MemAllocException__array* dest)
{
 ...
 */
struct sidl_MemAllocException__array*
sidl_MemAllocException__array_slice(
  struct sidl_MemAllocException__array* src,
  int32_t        dimen,
 ...
 */
struct sidl_MemAllocException__array*
sidl_MemAllocException__array_ensure(
  struct sidl_MemAllocException__array* src,
  int32_t dimen,
  int     ordering)
{
...
static struct sidl_MemAllocException__epv s_rem_epv__sidl_memallocexception;
...
static void* remote_sidl_MemAllocException__cast(
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if ((*self->d_epv->f_isType)(self,name, _ex)) {
    ...
    cast =  (*func)(((struct 
      sidl_MemAllocException__remote*)self->d_data)->d_ih, _ex);
  }
...
static void remote_sidl_MemAllocException__delete(
  struct sidl_MemAllocException__object* self,
  struct sidl_BaseInterface__object* *_ex)
{
  *_ex = NULL;
...
static char* remote_sidl_MemAllocException__getURL(
  struct sidl_MemAllocException__object* self, struct 
    sidl_BaseInterface__object* *_ex)
{
  struct sidl_rmi_InstanceHandle__object *conn = ((struct 
    sidl_MemAllocException__remote*)self->d_data)->d_ih;
  *_ex = NULL;
  if(conn != NULL) {
...
static void remote_sidl_MemAllocException__raddRef(
  struct sidl_MemAllocException__object* self,struct 
    sidl_BaseInterface__object* *_ex)
{
...
static sidl_bool
remote_sidl_MemAllocException__isRemote(
    struct sidl_MemAllocException__object* self, 
    struct sidl_BaseInterface__object* *_ex) {
  *_ex = NULL;
  return TRUE;
...
static void
remote_sidl_MemAllocException__set_hooks(
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      ...
      "Exception unserialized from sidl.MemAllocException._set_hooks.",
        &throwaway_exception);
...
static void
remote_sidl_MemAllocException__set_contracts(
  /* in */ struct sidl_MemAllocException__object*self ,
  /* in */ sidl_bool enable,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.MemAllocException._set_contracts.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidl_MemAllocException__dump_stats(
  /* in */ struct sidl_MemAllocException__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.MemAllocException._dump_stats.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void remote_sidl_MemAllocException__exec(
  struct sidl_MemAllocException__object* self,const char* methodName,
...
static void
remote_sidl_MemAllocException_addRef(
  /* in */ struct sidl_MemAllocException__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    struct sidl_MemAllocException__remote* r_obj = (struct 
      sidl_MemAllocException__remote*)self->d_data;
    LOCK_STATIC_GLOBALS;
    r_obj->d_refcount++;
#ifdef SIDL_DEBUG_REFCOUNT
    fprintf(stderr, "babel: addRef %p new count %d (type %s)\n",
      r_obj, r_obj->d_refcount, 
      "sidl.MemAllocException Remote Stub");
...
static void
remote_sidl_MemAllocException_deleteRef(
  /* in */ struct sidl_MemAllocException__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    r_obj->d_refcount--;
#ifdef SIDL_DEBUG_REFCOUNT
    fprintf(stderr, "babel: deleteRef %p new count %d (type %s)\n",r_obj, r_obj->d_refcount, "sidl.MemAllocException Remote Stub");
#endif /* SIDL_DEBUG_REFCOUNT */ 
...
static sidl_bool
remote_sidl_MemAllocException_isSame(
  /* in */ struct sidl_MemAllocException__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.MemAllocException.isSame.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static sidl_bool
remote_sidl_MemAllocException_isType(
  /* in */ struct sidl_MemAllocException__object*self ,
  /* in */ const char* name,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.MemAllocException.isType.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
remote_sidl_MemAllocException_getClassInfo(
  /* in */ struct sidl_MemAllocException__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.MemAllocException.getClassInfo.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static char*
remote_sidl_MemAllocException_getNote(
  /* in */ struct sidl_MemAllocException__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.MemAllocException.getNote.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidl_MemAllocException_setNote(
  /* in */ struct sidl_MemAllocException__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.MemAllocException.setNote.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static char*
remote_sidl_MemAllocException_getTrace(
  /* in */ struct sidl_MemAllocException__object*self ,
  /* out */ struct sidl_BaseInterface__object **_ex)
{
  LANG_SPECIFIC_INIT();
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.MemAllocException.getTrace.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidl_MemAllocException_addLine(
  /* in */ struct sidl_MemAllocException__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.MemAllocException.addLine.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidl_MemAllocException_add(
  /* in */ struct sidl_MemAllocException__object*self ,
  /* in */ const char* filename,
  /* in */ int32_t lineno,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.MemAllocException.add.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidl_MemAllocException_packObj(
  /* in */ struct sidl_MemAllocException__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.MemAllocException.packObj.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidl_MemAllocException_unpackObj(
  /* in */ struct sidl_MemAllocException__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.MemAllocException.unpackObj.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void sidl_MemAllocException__init_remote_epv(void)
{
  /* assert( HAVE_LOCKED_STATIC_GLOBALS ); */
  struct sidl_MemAllocException__epv* epv = &s_rem_epv__sidl_memallocexception;
  ...
  epv->f__cast               = remote_sidl_MemAllocException__cast;
  epv->f__delete             = remote_sidl_MemAllocException__delete;
  epv->f__exec               = remote_sidl_MemAllocException__exec;
  epv->f__getURL             = remote_sidl_MemAllocException__getURL;
  epv->f__raddRef            = remote_sidl_MemAllocException__raddRef;
  epv->f__isRemote           = remote_sidl_MemAllocException__isRemote;
  epv->f__set_hooks          = remote_sidl_MemAllocException__set_hooks;
  epv->f__set_contracts      = remote_sidl_MemAllocException__set_contracts;
  epv->f__dump_stats         = remote_sidl_MemAllocException__dump_stats;
  epv->f__ctor               = NULL;
  epv->f__ctor2              = NULL;
  epv->f__dtor               = NULL;
  epv->f_addRef              = remote_sidl_MemAllocException_addRef;
  epv->f_deleteRef           = remote_sidl_MemAllocException_deleteRef;
  epv->f_isSame              = remote_sidl_MemAllocException_isSame;
  epv->f_isType              = remote_sidl_MemAllocException_isType;
  epv->f_getClassInfo        = remote_sidl_MemAllocException_getClassInfo;
  epv->f_getNote             = remote_sidl_MemAllocException_getNote;
  epv->f_setNote             = remote_sidl_MemAllocException_setNote;
  epv->f_getTrace            = remote_sidl_MemAllocException_getTrace;
  epv->f_addLine             = remote_sidl_MemAllocException_addLine;
  epv->f_add                 = remote_sidl_MemAllocException_add;
  epv->f_packObj             = remote_sidl_MemAllocException_packObj;
  epv->f_unpackObj           = remote_sidl_MemAllocException_unpackObj;
  ...
  e5->f__cast          = (void* (*)(void*, const char*, struct 
    sidl_BaseInterface__object**)) epv->f__cast;
  e5->f__delete        = (void (*)(void*, struct sidl_BaseInterface__object**)) 
    epv->f__delete;
  e5->f__getURL        = (char* (*)(void*, struct 
    sidl_BaseInterface__object**)) epv->f__getURL;
  e5->f__raddRef       = (void (*)(void*, struct sidl_BaseInterface__object**)) 
    epv->f__raddRef;
  e5->f__isRemote      = (sidl_bool (*)(void*, struct 
    sidl_BaseInterface__object**)) epv->f__isRemote;
  e5->f__set_hooks     = (void (*)(void*, sidl_bool, struct 
    sidl_BaseInterface__object**)) epv->f__set_hooks;
  e5->f__set_contracts = (void (*)(void*, sidl_bool, const char*, sidl_bool, 
    struct sidl_BaseInterface__object**)) epv->f__set_contracts;
  e5->f__dump_stats    = (void (*)(void*, const char*, const char*, struct 
    sidl_BaseInterface__object**)) epv->f__dump_stats;
...
static struct sidl_MemAllocException__object*
sidl_MemAllocException__remoteConnect(const char *url, sidl_bool ar, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct sidl_MemAllocException__object* self = NULL;

  struct sidl_MemAllocException__object* s0;
  struct sidl_SIDLException__object* s1;
  struct sidl_BaseClass__object* s2;

  struct sidl_MemAllocException__remote* r_obj = NULL;
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    struct sidl_MemAllocException__object* retobj = NULL;
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_BaseInterface bi = (
      sidl_BaseInterface)sidl_rmi_InstanceRegistry_getInstanceByString(objectID,
      _ex); SIDL_CHECK(*_ex);
    (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    retobj = (struct sidl_MemAllocException__object*) (*bi->d_epv->f__cast)(
      bi->d_object, "sidl.MemAllocException", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
    return retobj;
  ...
  instance = sidl_rmi_ProtocolFactory_connectInstance(url, 
    "sidl.MemAllocException", ar, _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidl_MemAllocException__object*) malloc(
      sizeof(struct sidl_MemAllocException__object));

  r_obj =
    (struct sidl_MemAllocException__remote*) malloc(
      sizeof(struct sidl_MemAllocException__remote));
  ...
  if(!self || !r_obj) {
    ...
    sidl_MemAllocException_add(ex, __FILE__, __LINE__, 
      "sidl.MemAllocException.EPVgeneration", _ex);
    SIDL_CHECK(*_ex);
  ...
  if (!s_remote_initialized) {
    sidl_MemAllocException__init_remote_epv();
  }
  UNLOCK_STATIC_GLOBALS;
  ...
  s0->d_epv  = &s_rem_epv__sidl_memallocexception;
...
static struct sidl_MemAllocException__object*
sidl_MemAllocException__IHConnect(sidl_rmi_InstanceHandle instance, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct sidl_MemAllocException__object* self = NULL;
...
static struct sidl_MemAllocException__object*
sidl_MemAllocException__remoteCreate(const char *url, struct 
  sidl_BaseInterface__object **_ex)
{
  ...
  sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
    url, "sidl.MemAllocException", _ex ); SIDL_CHECK(*_ex);
  if ( instance == NULL) { return NULL; }
  self =
    (struct sidl_MemAllocException__object*) malloc(
      sizeof(struct sidl_MemAllocException__object));
...
sidl_MemAllocException__connectI(const char* url, sidl_bool ar, struct 
  sidl_BaseInterface__object **_ex)
{
  return sidl_MemAllocException__remoteConnect(url, ar, _ex);
}
