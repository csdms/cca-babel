...
sidl_SIDLException_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidl_SIDLException__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "sidl.SIDLException", _ex);
    if(iobj != NULL) {
...
sidl_SIDLException_packObj__exec(
  ...
  ser_bc = sidl_rmi_InstanceRegistry_getInstanceByString(ser_str, 
    _ex);SIDL_CHECK(*_ex);
  if(ser_bc != NULL) {
    ser= (struct sidl_SIDLException__object*) (*ser_bc->d_epv->f__cast)(ser_bc, 
      "sidl.SIDLException", _ex);
    if(ser != NULL) {
...
sidl_SIDLException_unpackObj__exec(
  ...
  des_bc = sidl_rmi_InstanceRegistry_getInstanceByString(des_str, 
    _ex);SIDL_CHECK(*_ex);
  if(des_bc != NULL) {
    des= (struct sidl_SIDLException__object*) (*des_bc->d_epv->f__cast)(des_bc, 
      "sidl.SIDLException", _ex);
    if(des != NULL) {
...
static void
sidl_SIDLException__cast__exec(
        struct sidl_SIDLException__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidl_SIDLException__set_contracts(
  struct sidl_SIDLException__object* self,
  sidl_bool   enable,
...
static void ior_sidl_SIDLException__dump_stats(
  struct sidl_SIDLException__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidl_SIDLException__method  s_methods[] = {
    { "_cast", sidl_SIDLException__cast__exec },
 ...
 */
  ...
  struct sidl_SIDLException__epv*   epv  = &s_my_epv__sidl_sidlexception;
  ...
  struct sidl_io_Serializable__epv* e3   = &s_my_epv__sidl_io_serializable;
  ...
  epv->f__set_contracts        = ior_sidl_SIDLException__set_contracts;
  epv->f__dump_stats           = ior_sidl_SIDLException__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct sidl_SIDLException__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidl_SIDLException__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidl_SIDLException__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidl_SIDLException__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidl_SIDLException__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_getNote               = NULL;
  epv->f_setNote               = NULL;
  epv->f_getTrace              = NULL;
  epv->f_addLine               = NULL;
...
/*
 * sidl_SIDLException__getEPVs: Get my version of all relevant EPVs.
 */
...
static struct sidl_BaseClass__epv* sidl_SIDLException__getSuperEPV(void) {
...
/*
 * sidl_SIDLException__createObject: Allocate the object and initialize it.
 */

struct sidl_SIDLException__object*
sidl_SIDLException__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_SIDLException__object* self =
    (struct sidl_SIDLException__object*) sidl_malloc(
      sizeof(struct sidl_SIDLException__object),
      "Object allocation failed for struct sidl_SIDLException__object",
        __FILE__, __LINE__, "sidl_SIDLException__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_sidl_baseexception.d_epv   = &s_my_epv__sidl_baseexception;
  s0->d_sidl_io_serializable.d_epv = &s_my_epv__sidl_io_serializable;
  s0->d_epv                        = &s_my_epv__sidl_sidlexception;
...
s_externalEntryPoints = {
  sidl_SIDLException__createObject,
  sidl_SIDLException__getSuperEPV,
  2, 
  0
};
