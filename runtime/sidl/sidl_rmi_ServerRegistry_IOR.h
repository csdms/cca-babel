...
struct sidl_rmi_ServerRegistry__sepv {
  ...
  /* Methods introduced in sidl.rmi.ServerRegistry-v0.9.17 */
  void (*f_registerServer)(
    /* in */ struct sidl_rmi_ServerInfo__object* si,
    /* out */ struct sidl_BaseInterface__object **_ex);
  struct sidl_rmi_ServerInfo__object* (*f_getServer)(
    /* out */ struct sidl_BaseInterface__object **_ex);
  char* (*f_getServerURL)(
    /* in */ const char* objID,
    /* out */ struct sidl_BaseInterface__object **_ex);
...
struct sidl_rmi_ServerRegistry__cstats {
  sidl_bool use_hooks;
};
...
sidl_rmi_ServerRegistry__createObject(void* ddata,struct 
