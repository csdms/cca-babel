...
static struct sidl_rmi_ProtocolFactory__epv  s_my_epv__sidl_rmi_protocolfactory;
static VAR_UNUSED struct sidl_rmi_ProtocolFactory__sepv 
...
sidl_rmi_ProtocolFactory_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidl_rmi_ProtocolFactory__object*) (*iobj_bc->d_epv->f__cast)(
      iobj_bc, "sidl.rmi.ProtocolFactory", _ex);
    if(iobj != NULL) {
...
static void
sidl_rmi_ProtocolFactory__cast__exec(
        struct sidl_rmi_ProtocolFactory__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidl_rmi_ProtocolFactory__set_contracts_static(
  sidl_bool   enable,
...
static void ior_sidl_rmi_ProtocolFactory__dump_stats_static(
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
{
...
static void ior_sidl_rmi_ProtocolFactory__set_contracts(
  struct sidl_rmi_ProtocolFactory__object* self,
  sidl_bool   enable,
  const char* enfFilename,
  sidl_bool   resetCounters,
...
static void ior_sidl_rmi_ProtocolFactory__dump_stats(
  struct sidl_rmi_ProtocolFactory__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  ...
  if (!cmp) {
    ...
    cmp = strcmp(name, "sidl.rmi.ProtocolFactory");
    if (!cmp) {
      (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidl_rmi_ProtocolFactory__method  s_methods[] = {
    { "_cast", sidl_rmi_ProtocolFactory__cast__exec },
 ...
 */
  ...
  struct sidl_rmi_ProtocolFactory__epv*  epv  = &s_my_epv__sidl_rmi_protocolfactory;
  ...
  epv->f__set_contracts        = ior_sidl_rmi_ProtocolFactory__set_contracts;
  epv->f__dump_stats           = ior_sidl_rmi_ProtocolFactory__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct sidl_rmi_ProtocolFactory__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidl_rmi_ProtocolFactory__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidl_rmi_ProtocolFactory__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidl_rmi_ProtocolFactory__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidl_rmi_ProtocolFactory__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
...
static void sidl_rmi_ProtocolFactory__init_sepv(void)
{
  ...
  struct sidl_rmi_ProtocolFactory__sepv*  s = &s_stc_epv__sidl_rmi_protocolfactory;

  s->f__set_hooks_static                     = ior_sidl_rmi_ProtocolFactory__set_hooks_static;
  s->f__set_contracts_static                 = ior_sidl_rmi_ProtocolFactory__set_contracts_static;
  s->f__dump_stats_static                    = ior_sidl_rmi_ProtocolFactory__dump_stats_static;
...
/*
 * sidl_rmi_ProtocolFactory__getEPVs: Get my version of all relevant EPVs.
 */
  ...
  struct sidl_rmi_ProtocolFactory__epv **s_arg_epv__sidl_rmi_protocolfactory)
{
  ...
  *s_arg_epv__sidl_rmi_protocolfactory = &s_my_epv__sidl_rmi_protocolfactory;
}
/*
 * sidl_rmi_ProtocolFactory__getStaticEPV: return pointer to static EPV structure.
 */

struct sidl_rmi_ProtocolFactory__sepv*
sidl_rmi_ProtocolFactory__getStaticEPV(void){
  LOCK_STATIC_GLOBALS;
...
static struct sidl_BaseClass__epv* sidl_rmi_ProtocolFactory__getSuperEPV(void) {
...
static void
initMetadata(struct sidl_rmi_ProtocolFactory__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * sidl_rmi_ProtocolFactory__createObject: Allocate the object and initialize it.
 */

struct sidl_rmi_ProtocolFactory__object*
sidl_rmi_ProtocolFactory__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_rmi_ProtocolFactory__object* self =
    (struct sidl_rmi_ProtocolFactory__object*) sidl_malloc(
      sizeof(struct sidl_rmi_ProtocolFactory__object),
      "Object allocation failed for struct sidl_rmi_ProtocolFactory__object",
        __FILE__, __LINE__, "sidl_rmi_ProtocolFactory__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_my_epv__sidl_rmi_protocolfactory;
...
s_externalEntryPoints = {
  sidl_rmi_ProtocolFactory__createObject,
  sidl_rmi_ProtocolFactory__getStaticEPV,
  sidl_rmi_ProtocolFactory__getSuperEPV,
  2, 
  0
};
