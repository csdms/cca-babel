...
struct sidl_NotImplementedException__epv {
  ...
  /* Methods introduced in sidl.NotImplementedException-v0.9.17 */
};
...
struct sidl_NotImplementedException__cstats {
  sidl_bool use_hooks;
};
...
sidl_NotImplementedException__createObject(void* ddata,struct 
