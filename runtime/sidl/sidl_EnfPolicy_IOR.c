...
static struct sidl_EnfPolicy__epv  s_my_epv__sidl_enfpolicy;
static VAR_UNUSED struct sidl_EnfPolicy__sepv s_stc_epv__sidl_enfpolicy;
...
extern void sidl_EnfPolicy__set_epv(
  struct sidl_EnfPolicy__epv* epv);

extern void sidl_EnfPolicy__set_sepv(
  struct sidl_EnfPolicy__sepv* sepv);

extern void sidl_EnfPolicy__call_load(void);
#ifdef __cplusplus
}
#endif

static void
sidl_EnfPolicy_addRef__exec(
...
static void
sidl_EnfPolicy_deleteRef__exec(
        struct sidl_EnfPolicy__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
sidl_EnfPolicy_isSame__exec(
  ...
  iobj = skel_sidl_EnfPolicy_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidl_EnfPolicy__object*) (*iobj_bc->d_epv->f__cast)(iobj_bc, 
      "sidl.EnfPolicy", _ex);
    if(iobj != NULL) {
...
static void
sidl_EnfPolicy_getClassInfo__exec(
        struct sidl_EnfPolicy__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void ior_sidl_EnfPolicy__set_contracts_static(
  sidl_bool   enable,
...
static void ior_sidl_EnfPolicy__dump_stats_static(
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
{
...
static void ior_sidl_EnfPolicy__set_contracts(
  struct sidl_EnfPolicy__object* self,
  sidl_bool   enable,
  const char* enfFilename,
  sidl_bool   resetCounters,
...
static void ior_sidl_EnfPolicy__dump_stats(
  struct sidl_EnfPolicy__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_sidl_EnfPolicy__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    sidl_EnfPolicy__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_sidl_EnfPolicy__cast(
  struct sidl_EnfPolicy__object* self,
...
static void ior_sidl_EnfPolicy__set_hooks_static(
...
static void ior_sidl_EnfPolicy__set_hooks(
  struct sidl_EnfPolicy__object* self,
  sidl_bool enable, struct sidl_BaseInterface__object **_ex )
{
  *_ex  = NULL;
...
static void ior_sidl_EnfPolicy__delete(
  struct sidl_EnfPolicy__object* self, struct sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  sidl_EnfPolicy__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct sidl_EnfPolicy__object));
  free((void*) self);
}

static char*
ior_sidl_EnfPolicy__getURL(
  struct sidl_EnfPolicy__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_sidl_EnfPolicy__raddRef(
    struct sidl_EnfPolicy__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_sidl_EnfPolicy__isRemote(
    struct sidl_EnfPolicy__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct sidl_EnfPolicy__method {
  const char *d_name;
  void (*d_func)(struct sidl_EnfPolicy__object*,
...
ior_sidl_EnfPolicy__exec(
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidl_EnfPolicy__method  s_methods[] = {
    { "_cast", sidl_EnfPolicy__cast__exec },
    { "addRef", sidl_EnfPolicy_addRef__exec },
    { "deleteRef", sidl_EnfPolicy_deleteRef__exec },
    { "getClassInfo", sidl_EnfPolicy_getClassInfo__exec },
    { "isSame", sidl_EnfPolicy_isSame__exec },
    { "isType", sidl_EnfPolicy_isType__exec },
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct sidl_EnfPolicy__method);
  *_ex  = NULL; /* default to no exception */
...
static void sidl_EnfPolicy__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct sidl_EnfPolicy__epv*     epv  = &s_my_epv__sidl_enfpolicy;
  ...
  epv->f__cast                 = ior_sidl_EnfPolicy__cast;
  epv->f__delete               = ior_sidl_EnfPolicy__delete;
  epv->f__exec                 = ior_sidl_EnfPolicy__exec;
  epv->f__getURL               = ior_sidl_EnfPolicy__getURL;
  epv->f__raddRef              = ior_sidl_EnfPolicy__raddRef;
  epv->f__isRemote             = ior_sidl_EnfPolicy__isRemote;
  epv->f__set_hooks            = ior_sidl_EnfPolicy__set_hooks;
  epv->f__set_contracts        = ior_sidl_EnfPolicy__set_contracts;
  epv->f__dump_stats           = ior_sidl_EnfPolicy__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct sidl_EnfPolicy__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidl_EnfPolicy__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidl_EnfPolicy__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidl_EnfPolicy__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidl_EnfPolicy__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;

  sidl_EnfPolicy__set_epv(epv);
  ...
  ior_sidl_EnfPolicy__ensure_load_called();
}
...
static void sidl_EnfPolicy__init_sepv(void)
{
  /*
   * assert( HAVE_LOCKED_STATIC_GLOBALS );
   */

  struct sidl_EnfPolicy__sepv*  s = &s_stc_epv__sidl_enfpolicy;

  s->f__set_hooks_static           = ior_sidl_EnfPolicy__set_hooks_static;
  s->f__set_contracts_static       = ior_sidl_EnfPolicy__set_contracts_static;
  s->f__dump_stats_static          = ior_sidl_EnfPolicy__dump_stats_static;
  s->f_setEnforceAll          = NULL;
  s->f_setEnforceNone         = NULL;
  s->f_setPolicy              = NULL;
  s->f_areEnforcing           = NULL;
  s->f_getContractClass       = NULL;
  s->f_getEnforceFreq         = NULL;
  s->f_getSamplingInterval    = NULL;
  s->f_getOverheadLimit       = NULL;
  s->f_getAppAvgPerCall       = NULL;
  s->f_getAnnealLimit         = NULL;
  s->f_getPolicyName          = NULL;
  s->f_dumpStats              = NULL;
  s->f_startTrace             = NULL;
  s->f_areTracing             = NULL;
  s->f_getTraceFilename       = NULL;
  s->f_getTraceLevel          = NULL;
  s->f_endTrace               = NULL;

  sidl_EnfPolicy__set_sepv(s);
...
/*
 * sidl_EnfPolicy__getEPVs: Get my version of all relevant EPVs.
 */

void sidl_EnfPolicy__getEPVs (
  ...
  struct sidl_EnfPolicy__epv **s_arg_epv__sidl_enfpolicy)
{
  ...
  if (!s_method_initialized) {
    sidl_EnfPolicy__init_epv();
  }
  UNLOCK_STATIC_GLOBALS;

  *s_arg_epv__sidl_baseinterface = &s_my_epv__sidl_baseinterface;
  *s_arg_epv__sidl_baseclass = &s_my_epv__sidl_baseclass;
  *s_arg_epv__sidl_enfpolicy = &s_my_epv__sidl_enfpolicy;
}
/*
 * sidl_EnfPolicy__getStaticEPV: return pointer to static EPV structure.
 */
...
sidl_EnfPolicy__getStaticEPV(void){
  ...
  if (!s_static_initialized) {
    sidl_EnfPolicy__init_sepv();
  }
  UNLOCK_STATIC_GLOBALS;
  return &s_stc_epv__sidl_enfpolicy;
}
...
static struct sidl_BaseClass__epv* sidl_EnfPolicy__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "sidl.EnfPolicy", _ex);
...
static void
initMetadata(struct sidl_EnfPolicy__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * sidl_EnfPolicy__createObject: Allocate the object and initialize it.
 */

struct sidl_EnfPolicy__object*
sidl_EnfPolicy__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_EnfPolicy__object* self =
    (struct sidl_EnfPolicy__object*) sidl_malloc(
      sizeof(struct sidl_EnfPolicy__object),
      "Object allocation failed for struct sidl_EnfPolicy__object",
        __FILE__, __LINE__, "sidl_EnfPolicy__createObject", _ex);
  if (!self) goto EXIT;
  sidl_EnfPolicy__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void sidl_EnfPolicy__init(
  struct sidl_EnfPolicy__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct sidl_EnfPolicy__object* s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv    = &s_my_epv__sidl_enfpolicy;
...
void
sidl_EnfPolicy__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct sidl_EnfPolicy__external
s_externalEntryPoints = {
  sidl_EnfPolicy__createObject,
  sidl_EnfPolicy__getStaticEPV,
  sidl_EnfPolicy__getSuperEPV,
  2, 
  0
};
