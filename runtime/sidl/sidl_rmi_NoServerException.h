...
#define included_sidl_rmi_NoServerException_h
...
typedef struct sidl_rmi_NoServerException__object* sidl_rmi_NoServerException;
...
#if !defined(SIDL_RMI_NOSERVEREXCEPTION_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDL_RMI_NOSERVEREXCEPTION_INLINE_DECL inline
#else
#define SIDL_RMI_NOSERVEREXCEPTION_INLINE_DECL extern inline
#endif
 ...
 */
sidl_rmi_NoServerException
sidl_rmi_NoServerException__connect(const char *, sidl_BaseInterface *_ex);
 ...
 * Method:  getHopCount[]
 */
SIDL_RMI_NOSERVEREXCEPTION_INLINE_DECL
int32_t
sidl_rmi_NoServerException_getHopCount(
  /* in */ sidl_rmi_NoServerException self,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDL_RMI_NOSERVEREXCEPTION_INLINE_DECL
{
  int32_t _result;
...
#else
;
#endif /* SIDL_RMI_NOSERVEREXCEPTION_INLINE_DECL */
...
SIDL_RMI_NOSERVEREXCEPTION_INLINE_DECL
void
sidl_rmi_NoServerException_setErrno(
  /* in */ sidl_rmi_NoServerException self,
  /* in */ int32_t err,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDL_RMI_NOSERVEREXCEPTION_INLINE_DECL
...
SIDL_RMI_NOSERVEREXCEPTION_INLINE_DECL
int32_t
sidl_rmi_NoServerException_getErrno(
  /* in */ sidl_rmi_NoServerException self,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDL_RMI_NOSERVEREXCEPTION_INLINE_DECL
{
