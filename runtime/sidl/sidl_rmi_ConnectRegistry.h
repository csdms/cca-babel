...
#if !defined(SIDL_RMI_CONNECTREGISTRY_INLINE_DECL) && defined(SIDL_C_HAS_INLINE)
#if (defined(__STDC_VERSION__) && (__STDC_VERSION__ >= 199901L)) || defined(__INTEL_COMPILER) || !defined(__GNUC__)
#define SIDL_RMI_CONNECTREGISTRY_INLINE_DECL inline
#else
#define SIDL_RMI_CONNECTREGISTRY_INLINE_DECL extern inline
#endif
 ...
 * </p>
 */
SIDL_RMI_CONNECTREGISTRY_INLINE_DECL
void
sidl_rmi_ConnectRegistry_addRef(
  /* in */ sidl_rmi_ConnectRegistry self,
  /* out */ sidl_BaseInterface *_ex)
#ifdef SIDL_RMI_CONNECTREGISTRY_INLINE_DECL
{
  (*self->d_epv->f_addRef)(
    self,
    _ex);
...
#else
;
#endif /* SIDL_RMI_CONNECTREGISTRY_INLINE_DECL */
