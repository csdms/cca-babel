...
sidl_BaseClass_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidl_BaseClass__object*) (*iobj_bc->d_epv->f__cast)(iobj_bc, 
      "sidl.BaseClass", _ex);
    if(iobj != NULL) {
...
static void ior_sidl_BaseClass__set_contracts(
  struct sidl_BaseClass__object* self,
  sidl_bool   enable,
...
static void ior_sidl_BaseClass__dump_stats(
  struct sidl_BaseClass__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidl_BaseClass__method  s_methods[] = {
    { "_cast", sidl_BaseClass__cast__exec },
 ...
 */
  ...
  struct sidl_BaseClass__epv*     epv  = &s_my_epv__sidl_baseclass;
  struct sidl_BaseInterface__epv* e0   = &s_my_epv__sidl_baseinterface;
  ...
  epv->f__set_contracts        = ior_sidl_BaseClass__set_contracts;
  epv->f__dump_stats           = ior_sidl_BaseClass__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = NULL;
...
/*
 * sidl_BaseClass__getEPVs: Get my version of all relevant EPVs.
 */
...
initMetadata(struct sidl_BaseClass__object* self, sidl_BaseInterface* _ex)
{
  *_ex = 0; /* default no exception */
  if (self) {
    struct sidl_BaseClass__data *data = (struct sidl_BaseClass__data*)((*self).d_data);
    if (data) {
...
/*
 * sidl_BaseClass__createObject: Allocate the object and initialize it.
 */

struct sidl_BaseClass__object*
sidl_BaseClass__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_BaseClass__object* self =
    (struct sidl_BaseClass__object*) sidl_malloc(
      sizeof(struct sidl_BaseClass__object),
      "Object allocation failed for struct sidl_BaseClass__object",
        __FILE__, __LINE__, "sidl_BaseClass__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_sidl_baseinterface.d_epv = &s_my_epv__sidl_baseinterface;
  s0->d_epv                      = &s_my_epv__sidl_baseclass;
