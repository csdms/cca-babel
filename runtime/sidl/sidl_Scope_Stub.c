...
sidl_Scope__array_createCol(
  ...
  const int32_t upper[])
{
  return (struct sidl_Scope__array*)sidl_long__array_createCol(dimen, lower, 
    upper);
}
...
sidl_Scope__array_createRow(
  ...
  const int32_t upper[])
{
  return (struct sidl_Scope__array*)sidl_long__array_createRow(dimen, lower, 
    upper);
}
...
{
  return (struct sidl_Scope__array*)sidl_long__array_create1d(len);
}
...
sidl_Scope__array_create1dInit(
  ...
  int64_t* data)
{
  return (struct sidl_Scope__array*)sidl_long__array_create1dInit(len, (
    int64_t*)data);
}
...
{
  return (struct sidl_Scope__array*)sidl_long__array_create2dCol(m, n);
}
...
{
  return (struct sidl_Scope__array*)sidl_long__array_create2dRow(m, n);
}
...
{
  return (struct sidl_Scope__array*)sidl_long__array_borrow(
