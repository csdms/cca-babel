...
static struct sidl_DFinder__epv s_my_epv__sidl_dfinder;
...
static struct sidl_Finder__epv s_my_epv__sidl_finder;
...
sidl_DFinder_isSame__exec(
  ...
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct sidl_DFinder__object*) (*iobj_bc->d_epv->f__cast)(iobj_bc, 
      "sidl.DFinder", _ex);
    if(iobj != NULL) {
...
sidl_DFinder_findLibrary__exec(
  ...
  char* sidl_name= NULL;
  char* target= NULL;
  int64_t lScope_tmp= 0;
  int64_t lScope = sidl_Scope_LOCAL;
  int64_t lResolve_tmp= 0;
  int64_t lResolve = sidl_Resolve_LAZY;
  ...
  sidl_rmi_Call_unpackLong( inArgs, "lScope", &lScope_tmp, _ex);SIDL_CHECK(
    *_ex);
  lScope = (int64_t)lScope_tmp;
  sidl_rmi_Call_unpackLong( inArgs, "lResolve", &lResolve_tmp, _ex);SIDL_CHECK(
    *_ex);
  lResolve = (int64_t)lResolve_tmp;
...
static void ior_sidl_DFinder__set_contracts(
  struct sidl_DFinder__object* self,
  sidl_bool   enable,
...
static void ior_sidl_DFinder__dump_stats(
  struct sidl_DFinder__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct sidl_DFinder__method  s_methods[] = {
    { "_cast", sidl_DFinder__cast__exec },
 ...
 */
  ...
  epv->f__set_contracts        = ior_sidl_DFinder__set_contracts;
  epv->f__dump_stats           = ior_sidl_DFinder__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct sidl_DFinder__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct sidl_DFinder__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct sidl_DFinder__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct sidl_DFinder__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct sidl_DFinder__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  ...
  /*
   * Override function pointers for sidl.Finder with mine, as needed.
   */
  ...
  e2->f_findLibrary           = (struct sidl_DLL__object* (*)(void*,const char*,const char*,int64_t,int64_t,struct sidl_BaseInterface__object **)) epv->f_findLibrary;
  e2->f_setSearchPath         = (void (*)(void*,const char*,struct sidl_BaseInterface__object **)) epv->f_setSearchPath;
  e2->f_getSearchPath         = (char* (*)(void*,struct sidl_BaseInterface__object **)) epv->f_getSearchPath;
  e2->f_addSearchPath         = (void (*)(void*,const char*,struct sidl_BaseInterface__object **)) epv->f_addSearchPath;
...
/*
 * sidl_DFinder__getEPVs: Get my version of all relevant EPVs.
 */
  ...
  struct sidl_DFinder__epv **s_arg_epv__sidl_dfinder)
{
  ...
  *s_arg_epv__sidl_finder = &s_my_epv__sidl_finder;
  *s_arg_epv__sidl_dfinder = &s_my_epv__sidl_dfinder;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* sidl_DFinder__getSuperEPV(void) {
...
/*
 * sidl_DFinder__createObject: Allocate the object and initialize it.
 */

struct sidl_DFinder__object*
sidl_DFinder__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct sidl_DFinder__object* self =
    (struct sidl_DFinder__object*) sidl_malloc(
      sizeof(struct sidl_DFinder__object),
      "Object allocation failed for struct sidl_DFinder__object",
        __FILE__, __LINE__, "sidl_DFinder__createObject", _ex);
  if (!self) goto EXIT;
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_sidl_finder.d_epv = &s_my_epv__sidl_finder;
  s0->d_epv               = &s_my_epv__sidl_dfinder;
...
s_externalEntryPoints = {
  sidl_DFinder__createObject,
  sidl_DFinder__getSuperEPV,
  2, 
  0
};
