...
#define SIDL_LOADER_INLINE_DECL
...
void
sidl_Loader__set_contracts_static(
  sidl_bool   enable,
...
void
sidl_Loader__dump_stats_static(
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      ...
      "Exception unserialized from sidl.Loader._set_hooks.",
        &throwaway_exception);
...
static void
remote_sidl_Loader__set_contracts(
  /* in */ struct sidl_Loader__object*self ,
  /* in */ sidl_bool enable,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.Loader._set_contracts.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void
remote_sidl_Loader__dump_stats(
  /* in */ struct sidl_Loader__object*self ,
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.Loader._dump_stats.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.Loader.isSame.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.Loader.isType.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
  ...
  *_ex = NULL;
  {
    ...
    if (_be != NULL) {
      struct sidl_BaseInterface__object* throwaway_exception = NULL;
      sidl_BaseException_addLine(_be, 
      "Exception unserialized from sidl.Loader.getClassInfo.",
        &throwaway_exception);
      *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(_be,
        &throwaway_exception);
      goto EXIT;
...
static void sidl_Loader__init_remote_epv(void)
{
  ...
  epv->f__set_contracts      = remote_sidl_Loader__set_contracts;
  epv->f__dump_stats         = remote_sidl_Loader__dump_stats;
  epv->f__ctor               = NULL;
  epv->f__ctor2              = NULL;
  epv->f__dtor               = NULL;
...
sidl_Loader__remoteConnect(const char *url, sidl_bool ar, struct 
  sidl_BaseInterface__object* *_ex)
{
  ...
  struct sidl_Loader__remote* r_obj = NULL;
  ...
  *_ex = NULL;
  ...
  if(objectID) {
    struct sidl_Loader__object* retobj = NULL;
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_BaseInterface bi = (
      sidl_BaseInterface)sidl_rmi_InstanceRegistry_getInstanceByString(objectID,
      _ex); SIDL_CHECK(*_ex);
    (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    retobj = (struct sidl_Loader__object*) (*bi->d_epv->f__cast)(bi->d_object, 
      "sidl.Loader", _ex);
    if(!ar) { 
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
    }
  ...
  instance = sidl_rmi_ProtocolFactory_connectInstance(url, "sidl.Loader", ar, 
    _ex ); SIDL_CHECK(*_ex);
...
static struct sidl_Loader__object*
sidl_Loader__IHConnect(sidl_rmi_InstanceHandle instance, struct 
  sidl_BaseInterface__object* *_ex)
{
  struct sidl_Loader__object* self = NULL;
...
static struct sidl_Loader__object*
sidl_Loader__remoteCreate(const char *url, struct sidl_BaseInterface__object 
  **_ex)
{
